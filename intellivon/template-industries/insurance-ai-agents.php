<?php /* Template Name: Insurance AI Agents */ ?>
<?php get_header(); ?>
    ...
    <div class="flex">
        <div class="lg:w-1/2 flex flex-col gap-5 px-10 justify-center py-10 lg:py-0">
            <h1 class="font-bold text-4xl lg:text-5xl text-white">
                Enterprise-Grade AI Agents for the Future of
                <span class="text-gradient">Insurance </span>
            </h1>
            <p class="text-white text-lg font-medium">
                Intellivon’s enterprise-ready AI agents automate complex insurance workflows, enhance customer
                engagement, and improve operational decision-making, enabling insurers to achieve efficiency,
                compliance, and growth at scale.
            </p>
        ...
        <div class="w-full lg:w-2/3 lg:pl-10 px-10 lg:px-0">
            <div class="flex flex-col gap-5 items-start">
                ...
                <h2
                    ...
                    Leading Insurers Trust Intellivon’s AI Agents for Operational Excellence
                ...
                <p class="mb-4 md:mb-0 text-base font-medium text-grey1 mt-2 w-full tracking-[0.25px] pr-5 mb-12">
                    Global insurers use Intellivon’s AI agents to streamline claims, underwriting, compliance, and
                    policyholder support while reducing costs and delivering measurable performance improvements across
            ...
            <div class="w-full flex flex-col gap-5 items-start">
                ...
                <div class="flex flex-col gap-5 lg:gap-0 lg:flex-row justify-between w-full">
                    <h2
                        ...
                        How Intellivon Delivered Enterprise
                        <span class="text-gradient">AI Agent Success</span>
                    </h2>
                </div>
                                ...
                                <div class="w-full lg:w-1/2 flex flex-col gap-5 px-5 py-4">
                                    <div class="flex flex-col w-full gap-2 pb-4 border-b border-b-[#99899d]">
                                        <h3 class="text-xl md:text-3xl font-semibold">
                                            Robust AI Agents for a Global Insurance Leader
                                        </h3>
                                        <div class="text-[#333] leading-7 tracking-wide">
                                            <p class="hidden xl:block text-md">
                                                A global insurer needed intelligent automation for underwriting and
                                                claims processing. Intellivon implemented AI agents to handle claims
                                                verification, compliance checks, and policy recommendations. The
                                                platform accelerated decision-making, lowered costs, and improved
                                                service outcomes dramatically.
                                    ...
                                    <ul class="flex flex-col gap-2 list-disc pl-5">
                                        <li class="">
                                            <span class="xl:text-xl font-semibold">49%</span>
                                            faster claims verification
                                        </li>
                                        <li class="">
                                            <span class="xl:text-xl font-semibold">41%</span>
        ...
        <div class="w-full">
            ...
            <h2
                ...
                <span class="text-gradient">
                    Enterprise Applications of Insurance AI Agents
                </span>
            </h2>
        </div>
        <p class="text-[#333333] w-full lg:w-4/4 text-base font-medium pb-12">
            Intellivon’s enterprise-ready AI agents automate underwriting, claims, compliance, and policyholder
            engagement, ensuring faster, smarter, and more efficient operations across global insurance ecosystems.
                ...
                <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide h-full">
                        <div
                            ...
                            <p class="text-center md:text-start">
                                AI agents instantly validate claims with high precision, eliminating costly delays,
                                reducing settlement errors, and improving operational speed across global insurance
                    ...
                    <div class="swiper-slide h-full">
                        <div
                            ...
                            <p class="text-center md:text-start">
                                Agents analyze customer data, predict needs, and recommend tailored policies that
                                enhance engagement, increase conversions, and strengthen enterprise-level customer
                                relationships in competitive insurance markets globally.
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="swiper-slide h-full">
                        <div
                            ...
                            <p class="text-center md:text-start">
                                AI automates risk evaluations using predictive analytics, ensuring consistent decisions,
                                improving compliance, and significantly reducing manual errors in enterprise-scale
                                underwriting processes across global insurers.
                            </p>
                        </div>
                    </div>
                    <!-- CARD 4 -->
                    <div class="swiper-slide h-full">
                        <div
                            ...
                            <p class="text-center md:text-start">
                                Agents deliver real-time, personalized engagement across multiple communication
                                channels, increasing satisfaction, strengthening loyalty, and ensuring consistent
                                customer experiences in global-scale insurance operations effectively.
                    ...
                    <div class="swiper-slide h-full">
                        <div
                            ...
                            <p class="text-center md:text-start">
                                AI agents enforce insurance regulations, automate compliance checks, generate
                                audit-ready documentation, and reduce enterprise risk exposure by ensuring every
                                workflow aligns seamlessly with industry standards.
                    ...
                    <div class="swiper-slide h-full">
                        <div
                            ...
                            <p class="text-center md:text-start">
                                Agents continuously monitor claims, detect anomalies, and flag potential fraud in real
                                time, supporting fraud prevention teams with actionable intelligence across large-scale
                    ...
                    <div class="swiper-slide h-full">
                        <div
                            ...
                            <p class="text-center md:text-start">
                                Agents process enterprise portfolio performance data, identifying actionable insights,
                                refining strategies, and enhancing decision-making to maximize operational efficiency
                                and sustainable growth across insurance organizations.
                    ...
                    <div class="swiper-slide h-full">
                        <div
                            ...
                            <p class="text-center md:text-start">
                                Agents engage customers proactively, personalize renewal offers, reduce churn
                                significantly, and strengthen long-term customer loyalty while improving retention
                                strategies across global insurance enterprises consistently.
                ...
                <div class="w-full flex flex-col gap-5 items-start">
                    ...
                    <div class="flex flex-col gap-5 lg:gap-0 lg:flex-row justify-between">
                        <h2
                            ...
                            Why Insurance Leaders Choose
                            <span class="text-gradient"> Intellivon’s AI Agents</span>
                        </h2>
                        <a href="https://intellivon.com/ai-strategy-call-booking-confirmation/" target="_blank">
                            <div>
                                <button type="button"
                    ...
                    <p class="text-grey1 text-base font-medium">
                        Intellivon empowers insurers with AI agents designed for automation, compliance, and engagement,
                        delivering measurable ROI and innovation at enterprise scale.
                    </p>
                </div>
            </div>
        </div>
        <div class="mt-16 grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-5">
            ...
            <div class="choose-card-wrapper w-full h-[212px] md:w-[409px] m-auto lg:m-0 z-10">
                <div class="choose-card shadow-[0_24px_34px_0_rgba(0,0,0,.078)]">
                    ...
                    <div
                        ...
                        <!-- SVG Icon -->
                        <p class="text-sm">
                            Our AI agents streamline underwriting, claims, and service processes enterprise-wide,
                            eliminating inefficiencies, reducing errors, and ensuring minimal workflow disruption during
                            large-scale insurance operations.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="choose-card-wrapper w-full h-[212px] md:w-[409px] m-auto lg:m-0 z-10">
                <div class="choose-card shadow-[0_24px_34px_0_rgba(0,0,0,.078)]">
                    ...
                    <div class="choose-card-front bg-white p-6 flex flex-col gap-8 items-center justify-center">
                        <!-- SVG Icon -->
                        <h3 class="text-xl font-semibold text-center">Real-Time Engagement</h3>
                    </div>
                    <!-- Back Side -->
                    <div
                        class="choose-card-back bg-white p-6 flex flex-col gap-4 items-center justify-center text-center text-gray-800">
                        <!-- SVG Icon -->
                        <p class="text-sm">
                            AI agents deliver contextual, personalized support instantly, enhancing policyholder
                            experiences, building trust, and ensuring insurers deliver globally consistent engagement at
                            every touchpoint.
                        </p>
                    </div>
                </div>
            ...
            <div class="choose-card-wrapper w-full h-[212px] md:w-[409px] m-auto lg:m-0 z-10">
                <div class="choose-card shadow-[0_24px_34px_0_rgba(0,0,0,.078)]">
                    ...
                    <div
                        ...
                        <!-- SVG Icon -->
                        <p class="text-sm">
                            Our platform ensures compliance with strict insurance regulations, automating monitoring,
                            producing audit-ready documentation, and minimizing costly risks of non-compliance for
                            enterprise insurers.
                        </p>
                    </div>
                </div>
            ...
            <div class="choose-card-wrapper w-full h-[212px] md:w-[409px] m-auto lg:m-0 z-10">
                <div class="choose-card shadow-[0_24px_34px_0_rgba(0,0,0,.078)]">
                    ...
                    <div
                        ...
                        <!-- SVG Icon -->
                        <p class="text-sm">
                            AI agents handle massive workloads seamlessly, scaling with enterprise growth while
                            maintaining operational efficiency, speed, and reliability across insurance markets
                            worldwide.
            ...
            <div class="choose-card-wrapper w-full h-[212px] md:w-[409px] m-auto lg:m-0 z-10">
                <div class="choose-card shadow-[0_24px_34px_0_rgba(0,0,0,.078)]">
                    ...
                    <div
                        ...
                        <!-- SVG Icon -->
                        <p class="text-sm">
                            By reducing manual workloads, cutting operational costs, and improving accuracy,
                            Intellivon’s AI agents deliver measurable enterprise-level ROI and long-term business value.
            ...
            <div class="choose-card-wrapper w-full h-[212px] md:w-[409px] m-auto lg:m-0 z-10">
                <div class="choose-card shadow-[0_24px_34px_0_rgba(0,0,0,.078)]">
                    ...
                    <div
                        ...
                        <!-- SVG Icon -->
                        <p class="text-sm">
                            We continuously enhance AI models with evolving market intelligence, ensuring insurers
                            remain competitive, adaptable, and always ahead of shifting industry demands.
        ...
        <div class="flex items-end justify-between mt-6 mb-3">
            ...
            <div class="flex flex-col gap-3 w-full">
                ...
                <h2
                    ...
                    How We Deploy AI Agents for
                    <span class="text-gradient">Insurance Enterprises</span>
                </h2>
                <p class="text-[#333333] w-full lg:w-3/4 text-base font-medium">
                    Our proven process delivers tailored AI agents that streamline workflows, ensure compliance, enhance
                    accuracy, and continuously adapt to evolving insurer demands.
                </p>
            </div>
        </div>
        <!-- Consulting Cards -->
                ...
                <div class="grid grid-cols-2 gap-1 mt-4">
                    <div class="p-3 bg-[#F7F7F7] h-44">
                        ...
                        <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
                            Review workflows thoroughly to identify opportunities for automation in claims.
                        </p>
                    </div>
                    <div class="p-3 bg-[#F7F7F7] h-44">
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                        ...
                        <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
                            Analyze underwriting inefficiencies carefully.
                        </p>
                    </div>
                    <div class="p-3 bg-[#F7F7F7] h-44">
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                        ...
                        <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
                            Assess integration readiness across claims and compliance.
                        </p>
                    </div>
                    <div class="p-3 bg-[#F7F7F7] h-44">
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                        ...
                        <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
                            Define KPIs, ensuring measurable improvements in compliance.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="card w-full lg:w-1/3 p-6 border-2 border-transparent rounded-md"
                ...
                <div class="grid grid-cols-2 gap-1 mt-4">
                    <div class="p-3 bg-[#F7F7F7] h-44">
                        ...
                        <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
                            Design custom AI workflows aligned with insurance claims and underwriting.
                        </p>
                    </div>
                    <div class="p-3 bg-[#F7F7F7] h-44">
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                        ...
                        <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
                            Prototype automation solutions quickly to demonstrate efficiency.
                        </p>
                    </div>
                    <div class="p-3 bg-[#F7F7F7] h-44">
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                        ...
                        <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
                            Validate integration compatibility with legacy systems.
                        </p>
                    </div>
                    <div class="p-3 bg-[#F7F7F7] h-44">
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                        ...
                        <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
                            Simulate ROI projections to ensure adoption confidence at enterprise scale.
                        </p>
                    </div>
                </div>
            </div>
                ...
                <div class="grid grid-cols-2 gap-1 mt-4">
                    <div class="p-3 bg-[#F7F7F7] h-44">
                        ...
                        <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
                            ...
                            Deploy AI agents effectively across underwriting, claims, and service workflows.
                    ...
                    <div class="p-3 bg-[#F7F7F7] h-44">
                        ...
                        <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
                            Train enterprise teams extensively for seamless adoption and operational alignment.
                        </p>
                    </div>
                    <div class="p-3 bg-[#F7F7F7] h-44">
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                        ...
                        <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
                            Integrate AI agents with claims, compliance, and underwriting systems seamlessly.
                        </p>
                    </div>
                    <div class="p-3 bg-[#F7F7F7] h-44">
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                        ...
                        <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
                            Continuously refine models, ensuring efficiency and compliance.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="flex items-end justify-between mt-6 mb-3">
                <div class="w-full flex flex-col gap-5">
                    ...
                    <div class="flex flex-col gap-5 lg:gap-0 lg:flex-row justify-between w-full">
                        <h2
                            class="w-full lg:w-11/12 text-4xl gap-3 font-bold text-black1 font-urbanist leading-snug tracking-[0.5px]">
                            <span class="text-gradient">What Insurance Leaders Say About Intellivon’s AI Agents</span>
                        </h2>
                ...
                <div id="testimonial-slider" class="overflow-hidden relative w-full max-w-full order-1 lg:order-2 z-20">
                    <div id="testimonial-track" class="flex transition-transform duration-500 ease-in-out w-full"
                        ...
                        <div
                            ...
                            <div class="pl-6 h-fit pt-4">
                                <div class="flex flex-col gap-5 font-normal text-black1 mt-5">
                                    Intellivon’s AI agents automated our underwriting and claims seamlessly, saving costs while improving accuracy and customer confidence significantly.

                                    <div class="text-xl font-medium font-urbanist text-black1">
                                      VP of Underwriting, Fortune 500 Insurer
                        ...
                        <div
                            ...
                            <div class="pl-6 h-fit pt-4">
                                <div class="flex flex-col gap-5 font-normal text-black1 mt-5">
                                    AI agents improved customer engagement globally, providing instant, reliable support that increased satisfaction and brand loyalty enterprise-wide
                                    <div class="text-xl font-medium font-urbanist text-black1">
                                        COO, Global Insurance Provider
                        ...
                        <div
                            ...
                            <div class="pl-6 h-fit pt-4">
                                <div class="flex flex-col gap-5 font-normal text-black1 mt-5">
                                    Compliance became effortless with Intellivon’s AI agents. They eliminated manual errors, ensured audit readiness, and improved transparency across claims.

                                    <div class="text-xl font-medium font-urbanist text-black1">
                                        Director of Operations, International Enterprise
                        ...
                        <div
                            ...
                            <div class="pl-6 h-fit pt-4">
                                <div class="flex flex-col gap-5 font-normal text-black1 mt-5">
                                    Scaling our services was simple. Intellivon’s AI agents handled demand surges with ease, maintaining service quality and operational consistency.
                                    <div class="text-xl font-medium font-urbanist text-black1">
                                        Head of Strategy, Regional Insurer
                        ...
                        <div
                            ...
                            <div class="pl-6 h-fit pt-4">
                                <div class="flex flex-col gap-5 font-normal text-black1 mt-5">
                                    Beyond automation, Intellivon’s AI agents provided strategic insights into portfolio performance, enabling smarter planning and enterprise-wide efficiency.
                                    <div class="text-xl font-medium font-urbanist text-black1">
                                        CTO, Global Insurance Provider
