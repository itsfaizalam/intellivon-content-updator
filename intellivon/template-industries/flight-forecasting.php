<?php /* Template Name: Flight Forecasting */ ?>
<?php get_header(); ?>
  ...
  <div class="flex">
    <div class="lg:w-full flex flex-col gap-5 px-10 justify-center py-10 lg:p-[150px] lg:text-center">
      <h1 class="font-bold text-4xl lg:text-5xl text-white">
        Flight Forecasting and Delay Prediction Built for 
        <span class="text-gradient">Enterprise-Grade Operations</span>
      </h1>
      <p class="text-white text-lg font-medium">Our enterprise-grade AI delivers actionable predictions, reducing costly delays while enabling airlines to optimize fleet performance and enhance passenger trust.</p>
    ...
    <div class="w-full lg:w-2/3 lg:pl-10 px-10 lg:px-0">
      <div class="flex flex-col gap-5 items-start">
        ...
        <h2 class="text-4xl items-center font-bold text-black1 font-urbanist leading-snug tracking-[0.5px] gap-1">
          Supporting Enterprise Airlines in 
          <span class="text-gradient">Achieving Operational Excellence</span>
        </h2>
      ...
      <div class="w-full flex flex-col gap-5 items-start">
        ...
        <div class="flex flex-col gap-5 lg:gap-0 lg:flex-row justify-between w-full">
          <h2
            ...
            Real-World Impact: 
            <span class="text-gradient">Flight Delay Prediction at Scale</span>
          </h2>
        </div>
                ...
                <div class="w-full lg:w-1/2 flex flex-col gap-5 px-5 py-4">
                  <div class="flex flex-col w-full gap-2 pb-4 border-b border-b-[#99899d]">
                    <h3 class="text-xl md:text-3xl font-semibold">
                      Flight Forecasting and Delay Prediction for a Leading Global Airline
                    </h3>
                    <div class="text-[#333] leading-7 tracking-wide">
                      <p class="hidden xl:block text-md">
                        Intellivon deployed an AI-powered flight forecasting and delay prediction system for a global airline operating across multiple continents. The solution integrated historical flight records, real-time weather data, and live air traffic conditions to deliver highly accurate delay predictions. By embedding predictive insights directly into the airline’s scheduling and operations workflow, the enterprise gained better visibility over potential disruptions, improved crew and aircraft allocation, and reduced cascading delays across its network.
                      </p>
                  ...
                  <ul class="flex flex-col gap-2 list-disc pl-5">
                    ...
                    <li class="">
                      ...
                      faster decision-making in flight scheduling
                    </li>
                  </ul>
                  <!-- Explore More button -->
                  <a href="https://intellivon.com/ai-strategy-call-booking-confirmation/" target="_blank">
    ...
    <div class="w-full">
      ...
      <h2 class="w-full lg:w-11/12 text-4xl gap-3 font-bold text-black1 font-urbanist leading-snug tracking-[0.5px]">
        <span class="text-gradient">
          Practical Enterprise Use Cases of Predictive Flight Analytics
        </span>
      </h2>
    </div>
        ...
        <div class="swiper-wrapper">
            ...
            <div
              ...
              <div class="flex flex-col md:flex-row gap-5 items-center">
                ...
                <h3 class="font-bold text-lg text-center md:text-start">
                  Network-Wide Schedule Optimization
                </h3>
              </div>
              <p class="text-center md:text-start">
                Predict delays across multiple hubs, enabling airlines to proactively adjust timetables and minimize cascading disruptions across global flight networks.
              </p>
            </div>
          </div>
          ...
          <div class="swiper-slide h-full">
            <div
              ...
              <div class="flex flex-col md:flex-row gap-5 items-center">
                <!-- SVG Icon -->
                <h3 class="font-bold text-lg text-center md:text-start">
                  Crew and Fleet Allocation
                </h3>
              </div>
              <p class="text-center md:text-start">
                Forecast delays early, allowing enterprises to reassign crews and reposition aircraft efficiently, reducing unplanned downtime and compliance risks.
              </p>
            </div>
          </div>
          ...
          <div class="swiper-slide h-full">
            <div
              ...
              <p class="text-center md:text-start">
                Integrate predictive delays with maintenance schedules to avoid unnecessary ground time, improve fleet availability, and reduce cost-heavy aircraft idle periods.
              </p>
            </div>
          </div>
          <!-- CARD 4 -->
          <div class="swiper-slide h-full">
            <div
              ...
              <div class="flex flex-col md:flex-row gap-5 items-center">
                <!-- SVG Icon -->
                <h3 class="font-bold text-lg text-center md:text-start">
                  Hub and Gate Management
                </h3>
              </div>
              <p class="text-center md:text-start">
                Improve airport gate utilization by forecasting disruptions, preventing overcrowding at terminals, and streamlining aircraft turnaround times.
              </p>
            </div>
          </div>
          ...
          <div class="swiper-slide h-full">
            <div
              ...
              <p class="text-center md:text-start">
                Anticipate disruptions to optimize fuel planning, reduce unnecessary fuel burn, and ensure efficient use of costly operational resources.
              </p>
            </div>
          </div>
          ...
          <div class="swiper-slide h-full">
            <div
              ...
              <div class="flex flex-col md:flex-row gap-5 items-center">
                <!-- SVG Icon -->
                <h3 class="font-bold text-lg text-center md:text-start">
                  Alliance and Codeshare Coordination
                </h3>
              </div>
              <p class="text-center md:text-start">
                Enable accurate delay forecasting across partner airlines, safeguarding shared routes, minimizing passenger rebookings, and strengthening alliance operational reliability.
              </p>
            </div>
          </div>
          ...
          <div class="swiper-slide h-full">
            <div
              ...
              <p class="text-center md:text-start">
                Provide regulators with proactive reports on delay causes and mitigation, reducing penalties, compliance risks, and reputation damage for large carriers.
              </p>
            </div>
          </div>
          ...
          <div class="swiper-slide h-full">
            <div
              ...
              <div class="flex flex-col md:flex-row gap-5 items-center">
                <!-- SVG Icon -->
                <h3 class="font-bold text-lg text-center md:text-start">
                  Crisis and Weather Disruption Response
                </h3>
              </div>
              <p class="text-center md:text-start">
                Offer actionable forecasts during extreme weather or traffic surges, empowering enterprises to implement contingency plans and maintain operational continuity.
              </p>
            </div>
          </div>
        ...
        <div class="w-full flex flex-col gap-5 items-start">
          ...
          <div class="flex flex-col gap-5 lg:gap-0 lg:flex-row justify-between">
            <h2 class="w-full lg:w-7/12 text-4xl flex-wrap gap-3 flex items-center font-bold text-black1 font-urbanist">
              What Sets Our 
              <span class="text-gradient">Flight Forecasting Apart From the Rest</span>
            </h2>
            <a href="https://intellivon.com/ai-strategy-call-booking-confirmation/" target="_blank">
              <div>
                <button type="button"
          ...
          <p class="text-grey1 text-base font-medium">
            We deliver enterprise-grade accuracy, unmatched scalability, and rapid deployment, empowering airlines to stay ahead of disruptions with measurable ROI.
          </p>
        </div>
      </div>
    </div>
    <div class="mt-16 grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-5">
      ...
      <div class="choose-card-wrapper w-full h-[212px] md:w-[409px] m-auto lg:m-0 z-10">
        <div class="choose-card shadow-[0_24px_34px_0_rgba(0,0,0,.078)]">
          ...
          <div class="choose-card-front bg-white p-6 flex flex-col gap-8 items-center justify-center">
            <!-- SVG Icon -->
            <h3 class="text-xl font-semibold text-center">Seamless Fit</h3>
          </div>
          <!-- Back Side -->
          <div
            class="choose-card-back bg-white p-6 flex flex-col gap-4 items-center justify-center text-center text-gray-800">
    ...
    <div class="flex items-end justify-between mt-6 mb-3">
      ...
      <div class="flex flex-col gap-3 w-full">
        ...
        <h2 class="text-4xl md:gap-3 items-center font-bold text-black1 font-urbanist leading-snug tracking-[0.5px]">
          Our Proven Process for Flight Forecasting and Delay Prediction
      ...
      <div class="flex items-end justify-between mt-6 mb-3">
        <div class="w-full flex flex-col gap-5">
          ...
          <div class="flex flex-col gap-5 lg:gap-0 lg:flex-row justify-between w-full">
            <h2
              class="w-full lg:w-11/12 text-4xl gap-3 font-bold text-black1 font-urbanist leading-snug tracking-[0.5px]">
              <span class="text-gradient">Trusted Voices From the Aviation Industry</span>
            </h2>
        ...
        <div id="testimonial-slider" class="overflow-hidden relative w-full max-w-full order-1 lg:order-2 z-20">
          <div id="testimonial-track" class="flex transition-transform duration-500 ease-in-out w-full"
            ...
            <div
              ...
              <div class="pl-6 h-fit pt-4">
                <div class="flex flex-col gap-5 font-normal text-black1 mt-5">
                  The unpredictability of delays was costing us millions in disruptions. Intellivon’s forecasting system gave us clarity we never had before, helping us reassign crews, manage gates, and avoid cascading delays with unmatched precision.
                  <div class="text-xl font-medium font-urbanist text-black1">
                    Chief Operations Officer, Global Airline Alliance
                  </div>
                </div>
              </div>
            </div>
            ...
            <div
              ...
              <div class="pl-6 h-fit pt-4">
                <div class="flex flex-col gap-5 font-normal text-black1 mt-5">
                  The scale and complexity of our international routes required reliability. Intellivon’s predictive engine integrated effortlessly into our scheduling systems, enabling faster decisions, optimized resources, and a measurable drop in disruption costs.
                  <div class="text-xl font-medium font-urbanist text-black1">
                    VP of Operations, Leading European Carrier
                  </div>
                </div>
              </div>
            </div>
            ...
            <div
              ...
              <div class="pl-6 h-fit pt-4">
                <div class="flex flex-col gap-5 font-normal text-black1 mt-5">
                  Intellivon’s delay prediction system transformed our approach to operational planning. For the first time, we could anticipate bottlenecks days ahead and proactively adjust schedules without hurting passenger confidence.
                  <div class="text-xl font-medium font-urbanist text-black1">
                    Head of Flight Operations, North American Airline
                  </div>
                </div>
              </div>
            </div>
            ...
            <div
              ...
              <div class="pl-6 h-fit pt-4">
                <div class="flex flex-col gap-5 font-normal text-black1 mt-5">
                  Our operations span multiple continents, and delays in one hub often ripple across the network. With Intellivon, we gained real-time visibility to contain disruptions before they escalated.
                  <div class="text-xl font-medium font-urbanist text-black1">
                    Director of Network Management, Asia-Pacific Airline
                  </div>
                </div>
              </div>
            </div>
            ...
            <div
              ...
              <div class="pl-6 h-fit pt-4">
                <div class="flex flex-col gap-5 font-normal text-black1 mt-5">
                  Intellivon’s forecasting solution gave us a competitive edge. Not only did we reduce costs, but our regulatory compliance and on-time performance significantly improved—something our partners immediately noticed.
                  <div class="text-xl font-medium font-urbanist text-black1">
                    Senior VP, Operations Strategy, Middle Eastern Airline
                  </div>
                </div>
              </div>
            </div>
