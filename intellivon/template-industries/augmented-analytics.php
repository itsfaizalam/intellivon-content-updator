<?php /* Template Name: Augmented Analytics */ ?>
<?php get_header(); ?>
  ...
  <div class="flex">
    <div class="lg:w-full flex flex-col gap-5 px-10 justify-center py-10 lg:p-[150px] lg:text-center">
      <h1 class="font-bold text-4xl lg:text-5xl text-white">
        Drive Business Intelligence With Our 
        <span class="text-gradient">AI-Powered Augmented Analytics</span>
      </h1>
      <p class="text-white text-lg font-medium">
        Experience the next generation of business intelligence with our augmented analytics, offering intuitive, data-driven insights that enable faster decision-making and drive smarter business strategies without technical barriers.
      </p>
    ...
    <div class="w-full lg:w-2/3 lg:pl-10 px-10 lg:px-0">
      <div class="flex flex-col gap-5 items-start">
        ...
        <h2 class="text-4xl items-center font-bold text-black1 font-urbanist leading-snug tracking-[0.5px] gap-1">
          Trusted by Leading Retailers for 

          <span class="text-gradient">Augmented Analytics</span>
        </h2>
        <p class="mb-4 md:mb-0 text-base font-medium text-grey1 mt-2 w-full tracking-[0.25px] pr-5 mb-12">
          We’ve empowered top retail brands to achieve faster, more informed decision-making through next-gen augmented analytics, helping them stay competitive and grow in a rapidly evolving market.
        </p>
      </div>
    </div>
    <!-- Right column: Image -->
      ...
      <div class="w-full flex flex-col gap-5 items-start">
        ...
        <div class="flex flex-col gap-5 lg:gap-0 lg:flex-row justify-between w-full">
          <h2
            ...
            Discover How Our Augmented Analytics Transformed Leading Enterprises
                ...
                <div class="w-full lg:w-1/2 flex flex-col gap-5 px-5 py-4">
                  <div class="flex flex-col w-full gap-2 pb-4 border-b border-b-[#99899d]">
                    <h3 class="text-xl md:text-3xl font-semibold">
                      AI-Driven Augmented Analytics For Business Intelligence
                    </h3>
                    <div class="text-[#333] leading-7 tracking-wide">
                      <p class="hidden xl:block text-md">
                        We partnered with a large retail enterprise to enhance their business intelligence using our augmented analytics solutions. By automating data integration and exploration, we enabled real-time insights, allowing for faster and more informed decisions. This streamlined their workflows, improved sales forecasting accuracy, and optimized inventory management, ultimately driving growth and reducing operational costs across the business.
                      </p>
    ...
    <div class="w-full">
      ...
      <h2 class="w-full lg:w-11/12 text-4xl gap-3 font-bold text-black1 font-urbanist leading-snug tracking-[0.5px]">
        <span class="text-gradient">
          Drive Scalable BI With Our Augmented Analytics Use Cases  
        </span>
      </h2>
    </div>
    <p class="text-[#333333] w-full lg:w-4/4 text-base font-medium pb-12">
   
Discover how our AI-augmented analytics solutions are transforming business intelligence among retail giants. From enhanced data-driven decisions to optimized operations, see real-world examples of how we help enterprises thrive..
        ...
        <div class="swiper-wrapper">
          ...
          <div class="swiper-slide h-full">
            <div
              ...
              <p class="text-center md:text-start">
                Intellivon’s augmented analytics helped retail enterprises analyze customer purchase patterns, browsing habits, and demographics. This enabled precise segmentation and targeted marketing, resulting in increased engagement and a sales boost.
              </p>
            </div>
          </div>
          ...
          <div class="swiper-slide h-full">
            <div
              ...
              <p class="text-center md:text-start">
                By leveraging Intellivon’s AI-driven solutions, retail enterprises were able to deliver personalized product recommendations and tailored marketing campaigns, driving customer loyalty and significantly improving conversion rates.
              </p>
            </div>
          </div>
          ...
          <div class="swiper-slide h-full">
            <div
              ...
              <p class="text-center md:text-start">
                With Intellivon’s augmented analytics, retail companies were able to forecast demand and automate inventory management. This ensured optimal stock levels, reduced waste, and maintained product availability across all channels, improving efficiency and customer satisfaction.
              </p>
            </div>
          </div>
          <!-- CARD 4 -->
          <div class="swiper-slide h-full">
            <div
              ...
              <p class="text-center md:text-start">
                Intellivon’s dynamic pricing solutions helped retailers analyze market trends, competitor pricing, and consumer demand. This enabled them to implement competitive pricing strategies that maximized profitability while staying competitive in the market.
              </p>
            </div>
          </div>
          ...
          <div class="swiper-slide h-full">
            <div
              ...
              <p class="text-center md:text-start">
                Intellivon’s analytics platforms provided accurate sales forecasts, allowing retailers to anticipate demand, optimize staffing, and plan promotions effectively for peak periods and seasonal trends, driving operational efficiency and sales growth.
              </p>
            </div>
          </div>
          ...
          <div class="swiper-slide h-full">
            <div
              ...
              <p class="text-center md:text-start">
                By analyzing in-store movement and engagement data, Intellivon helped retailers optimize product placement and store layouts, resulting in higher sales and an improved overall shopping experience for customers.
              </p>
            </div>
          </div>
          ...
          <div class="swiper-slide h-full">
            <div
              ...
              <p class="text-center md:text-start">
                Intellivon’s platform automates routine analytics tasks, delivering real-time insights and actionable recommendations to retail teams. This allowed them to make faster, smarter decisions without relying on technical expertise, improving overall business agility
              </p>
            </div>
          </div>
        ...
        <div class="w-full flex flex-col gap-5 items-start">
          ...
          <div class="flex flex-col gap-5 lg:gap-0 lg:flex-row justify-between">
            <h2 class="w-full lg:w-7/12 text-4xl flex-wrap gap-3 flex items-center font-bold text-black1 font-urbanist">
              No. 1 Trusted Partner of Retail Enterprises For
              <span class="text-gradient"> Augmented Analytics </span>
            </h2>
            <a href="https://intellivon.com/ai-strategy-call-booking-confirmation/" target="_blank">
              <div>
          ...
          <p class="text-grey1 text-base font-medium">
            Retail leaders trust us for our ability to turn complex data into actionable insights. Our augmented analytics solutions help optimize inventory, pricing, and customer engagement, empowering retailers to make smarter decisions more quickly.
          </p>
        </div>
      </div>
    </div>
    <div class="mt-16 grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-5">
      ...
      <div class="choose-card-wrapper w-full h-[212px] md:w-[409px] m-auto lg:m-0 z-10">
        <div class="choose-card shadow-[0_24px_34px_0_rgba(0,0,0,.078)]">
          ...
          <div
            ...
            <!-- SVG Icon -->
            <p class="text-sm">
              Intellivon specializes in retail AI, offering solutions that address the unique challenges of the industry, such as customer personalization, inventory optimization, and omnichannel experience, rather than generic, one-size-fits-all analytics platforms. Our deep understanding of retail operations ensures that every deployment is customized to your business needs, driving measurable improvements in efficiency and profitability. 
            </p>
          </div>
        </div>
      </div>
      ...
      <div class="choose-card-wrapper w-full h-[212px] md:w-[409px] m-auto lg:m-0 z-10">
        <div class="choose-card shadow-[0_24px_34px_0_rgba(0,0,0,.078)]">
          ...
          <div
            ...
            <!-- SVG Icon -->
            <p class="text-sm">
              We streamline the entire analytics journey, from seamless data integration across POS, e-commerce, and supply chain systems to advanced insight generation and intuitive dashboards. This holistic approach eliminates data silos and manual bottlenecks, enabling faster and more accurate decision-making at every level of your organization.
            </p>
          </div>
        </div>
      </div>
      ...
      <div class="choose-card-wrapper w-full h-[212px] md:w-[409px] m-auto lg:m-0 z-10">
        <div class="choose-card shadow-[0_24px_34px_0_rgba(0,0,0,.078)]">
          ...
          <div class="choose-card-front bg-white p-6 flex flex-col gap-8 items-center justify-center">
            <!-- SVG Icon -->
            <h3 class="text-xl font-semibold text-center">Advanced Personalization </h3>
          </div>
          <!-- Back Side -->
          <div
            class="choose-card-back bg-white p-6 flex flex-col gap-4 items-center justify-center text-center text-gray-800">
            <!-- SVG Icon -->
            <p class="text-sm">
              Intellivon leverages AI to deliver hyper-personalized shopping experiences by segmenting customers, predicting preferences, and automating targeted marketing campaigns. This not only boosts engagement and loyalty but also increases conversion rates and average order values, meeting the modern consumer’s demand for tailored interactions. 
            </p>
          </div>
        </div>
      </div>
      ...
      <div class="choose-card-wrapper w-full h-[212px] md:w-[409px] m-auto lg:m-0 z-10">
        <div class="choose-card shadow-[0_24px_34px_0_rgba(0,0,0,.078)]">
          ...
          <div
            ...
            <!-- SVG Icon -->
            <p class="text-sm">
              Our solutions use predictive analytics to forecast demand, optimize inventory, and reduce stockouts or overstock scenarios. By analyzing historical data, market trends, and external factors, we help retailers stay ahead of demand cycles and respond proactively to market shifts, which are capabilities proven to increase sales and operational efficiency. 
            </p>
          </div>
        </div>
      </div>
      ...
      <div class="choose-card-wrapper w-full h-[212px] md:w-[409px] m-auto lg:m-0 z-10">
        <div class="choose-card shadow-[0_24px_34px_0_rgba(0,0,0,.078)]">
          ...
          <div class="choose-card-front bg-white p-6 flex flex-col gap-8 items-center justify-center">
            <!-- SVG Icon -->
            <h3 class="text-xl font-semibold text-center">
              User-Centric, Accessible Insights 
            </h3>
          </div>
          <!-- Back Side -->
          <div
            ...
            <!-- SVG Icon -->
            <p class="text-sm">
              Intellivon democratizes data by providing intuitive interfaces and natural language query capabilities, making insights accessible to all users, not just data scientists. This empowers every team member to make data-driven decisions, accelerating innovation and responsiveness across your organization. 
            </p>
          </div>
        </div>
      </div>
      ...
      <div class="choose-card-wrapper w-full h-[212px] md:w-[409px] m-auto lg:m-0 z-10">
        <div class="choose-card shadow-[0_24px_34px_0_rgba(0,0,0,.078)]">
          ...
          <div class="choose-card-front bg-white p-6 flex flex-col gap-8 items-center justify-center">
            <!-- SVG Icon -->
            <h3 class="text-xl font-semibold text-center">
              Proven Results and Continuous Innovation 
            </h3>
          </div>
          <!-- Back Side -->
          <div
            ...
            <!-- SVG Icon -->
            <p class="text-sm">
              Retailers that implement AI-powered analytics consistently report improved customer experiences, higher operational efficiency, and greater profitability. Intellivon’s solutions are continuously updated with the latest AI advancements, ensuring you remain competitive as technology and consumer expectations evolve. 
            </p>
          </div>
        </div>
      </div>
    ...
    <div class="flex items-end justify-between mt-6 mb-3">
      ...
      <div class="flex flex-col gap-3 w-full">
        ...
        <h2 class="text-4xl md:gap-3 items-center font-bold text-black1 font-urbanist leading-snug tracking-[0.5px]">
          Our Proven Process To Deliver 
          <span class="text-gradient"> Augmented Analytics Solutions </span>
        </h2>
        <p class="text-[#333333] w-full lg:w-3/4 text-base font-medium">
          Our proven process helps retail businesses harness the power of augmented analytics, turning complex data into clear insights that drive faster, smarter decisions across all areas of your business.
        </p>
      </div>
    </div>
    <!-- Consulting Cards -->
        ...
        <div class="grid grid-cols-2 gap-1 mt-4">
          <div class="p-3 bg-[#F7F7F7] h-44">
            ...
            <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
              Understand business goals, data landscape, and challenges for alignment.
            </p>
          </div>
          <div class="p-3 bg-[#F7F7F7] h-44">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
            ...
            <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
              Assess data sources, infrastructure readiness, and system compatibility.
            </p>
          </div>
          <div class="p-3 bg-[#F7F7F7] h-44">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
            ...
            <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
              Identify pain points, gaps, and AI integration opportunities in operations.
            </p>
          </div>
          <div class="p-3 bg-[#F7F7F7] h-44">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
            ...
            <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
              Define success metrics, expected outcomes, and AI objectives for integration.
            </p>
          </div>
        </div>
      </div>
      ...
      <div class="card w-full lg:w-1/3 p-6 border-2 border-transparent rounded-md"
        ...
        <div class="grid grid-cols-2 gap-1 mt-4">
          <div class="p-3 bg-[#F7F7F7] h-44">
            ...
            <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
              Integrate data from POS, e-commerce, and supply chain systems seamlessly.
            </p>
          </div>
          <div class="p-3 bg-[#F7F7F7] h-44">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
            ...
            <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
              Develop tailored Proof of Concept (POC) to demonstrate value.
            </p>
          </div>
          <div class="p-3 bg-[#F7F7F7] h-44">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
            ...
            <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
              Collaborate with stakeholders to refine expectations and solution scope.
            </p>
          </div>
          <div class="p-3 bg-[#F7F7F7] h-44">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
            ...
            <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
              Showcase actionable insights from POC to demonstrate AI potential impact.
            </p>
          </div>
        </div>
      </div>
      ...
      <div class="card w-full lg:w-1/3 p-6 border-2 border-transparent rounded-md"
        ...
        <div class="grid grid-cols-2 gap-1 mt-4">
          <div class="p-3 bg-[#F7F7F7] h-44">
            ...
            <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
              Build and deploy AI models for segmentation, forecasting, and optimization.
            </p>
          </div>
          <div class="p-3 bg-[#F7F7F7] h-44">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
            ...
            <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
              Integrate solutions into existing BI tools and operational workflows.
            </p>
          </div>
          <div class="p-3 bg-[#F7F7F7] h-44">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
            ...
            <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
              Implement intuitive dashboards and natural language interfaces for accessibility.
            </p>
          </div>
          <div class="p-3 bg-[#F7F7F7] h-44">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
            ...
            <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
              Provide comprehensive training and ongoing support for smooth adoption.
            </p>
          </div>
        </div>
      </div>
      ...
      <div class="flex items-end justify-between mt-6 mb-3">
        <div class="w-full flex flex-col gap-5">
          ...
          <div class="flex flex-col gap-5 lg:gap-0 lg:flex-row justify-between w-full">
            <h2
              class="w-full lg:w-11/12 text-4xl gap-3 font-bold text-black1 font-urbanist leading-snug tracking-[0.5px]">
              <span class="text-gradient">See What Retail Leaders Are Saying About Us</span>
            </h2>
        ...
        <div id="testimonial-slider" class="overflow-hidden relative w-full max-w-full order-1 lg:order-2 z-20">
          <div id="testimonial-track" class="flex transition-transform duration-500 ease-in-out w-full"
            ...
            <div
              ...
              <div class="pl-6 h-fit pt-4">
                <div class="flex flex-col gap-5 font-normal text-black1 mt-5">
                  Intellivon’s augmented analytics solution completely reshaped our approach to data. Their team expertly guided us from concept to integration, helping us unlock insights that drove immediate business improvements.
                  <div class="text-xl font-medium font-urbanist text-black1">
                    Sarah T., Chief Operating Officer, Retail Leader 
                  </div>
                </div>
              </div>
            </div>
            ...
            <div
              ...
              <div class="pl-6 h-fit pt-4">
                <div class="flex flex-col gap-5 font-normal text-black1 mt-5">
                  Thanks to Intellivon’s personalized augmented analytics, we were able to optimize our pricing and inventory strategies, which resulted in increased sales and reduced overhead. Their hands-on approach made the integration process smooth.
                  <div class="text-xl font-medium font-urbanist text-black1">
                    David K., Director of Retail Operations, Global Retailer
                  </div>
                </div>
              </div>
            </div>
            ...
            <div
              ...
              <div class="pl-6 h-fit pt-4">
                <div class="flex flex-col gap-5 font-normal text-black1 mt-5">
                  With Intellivon’s augmented analytics, we gained an in-depth understanding of customer preferences and behaviors, enabling us to craft targeted campaigns that resonated with our audience. Their support made the transition seamless.
                  <div class="text-xl font-medium font-urbanist text-black1">
                    Emily P., VP of Marketing, Fashion Retailer
                  </div>
                </div>
              </div>
            </div>
            ...
            <div
              ...
              <div class="pl-6 h-fit pt-4">
                <div class="flex flex-col gap-5 font-normal text-black1 mt-5">
                  Intellivon’s analytics enabled us to predict demand with far greater accuracy, allowing us to manage our stock efficiently and reduce waste. Their expertise during implementation ensured the solution fit perfectly into our operations.
                  <div class="text-xl font-medium font-urbanist text-black1">
                    John M., Supply Chain Manager, National Retail Chain
                  </div>
                </div>
              </div>
            </div>
            ...
            <div
              ...
              <div class="pl-6 h-fit pt-4">
                <div class="flex flex-col gap-5 font-normal text-black1 mt-5">
                  The insights we’ve gained through Intellivon’s augmented analytics have been a game-changer for our marketing efforts. Their team provided top-notch support and ensured the solution was perfectly tailored to our needs.
                  <div class="text-xl font-medium font-urbanist text-black1">
                    Olivia W., Senior Data Analyst, E-Commerce Retailer
                  </div>
                </div>
              </div>
            </div>
