<?php /* Template Name: Predictive Maintenance */ ?>
<?php get_header(); ?>
  ...
  <div class="flex">
    <div class="lg:w-1/2 flex flex-col gap-5 px-10 justify-center py-10 lg:py-0">
      <h1 class="font-bold text-4xl lg:text-5xl text-white">
        Predictive Machinery Maintenance for 
        <span class="text-gradient">Enterprise-Grade Construction Reliability</span>
      </h1>
      <p class="text-white text-lg font-medium">Intellivon’s predictive maintenance systems use AI and IoT sensors to monitor machinery health in real time, reducing downtime, extending equipment lifespan, and ensuring projects run on schedule.</p>
    ...
    <div class="w-full lg:w-2/3 lg:pl-10 px-10 lg:px-0">
      <div class="flex flex-col gap-5 items-start">
        ...
        <h2 class="text-4xl items-center font-bold text-black1 font-urbanist leading-snug tracking-[0.5px] gap-1">
          ...
          <span class="text-gradient">Demand Operational Continuity</span>
        </h2>
        <p class="mb-4 md:mb-0 text-base font-medium text-grey1 mt-2 w-full tracking-[0.25px] pr-5 mb-12">
          Global construction enterprises rely on Intellivon’s predictive maintenance to eliminate costly downtime, optimize asset performance, and safeguard billion-dollar projects from equipment failures.
        </p>
      </div>
    </div>
    <!-- Right column: Image -->
      ...
      <div class="w-full flex flex-col gap-5 items-start">
        ...
        <div class="flex flex-col gap-5 lg:gap-0 lg:flex-row justify-between w-full">
          <h2
            ...
            Real Results From 
            <span class="text-gradient">Enterprise Predictive Maintenance Deployments</span>
          </h2>
        </div>
                ...
                <div class="w-full lg:w-1/2 flex flex-col gap-5 px-5 py-4">
                  <div class="flex flex-col w-full gap-2 pb-4 border-b border-b-[#99899d]">
                    <h3 class="text-xl md:text-3xl font-semibold">
                      AI-Powered Predictive Maintenance for a Global Construction Enterprise
                    </h3>
                    <div class="text-[#333] leading-7 tracking-wide">
                      <p class="hidden xl:block text-md">
                        A multinational construction enterprise faced costly delays caused by unexpected equipment failures on large-scale infrastructure projects. Intellivon implemented an AI-powered predictive maintenance platform that integrated IoT sensors, real-time analytics, and machine learning models to monitor equipment health across cranes, excavators, and heavy machinery fleets. The system detected anomalies early, predicted potential breakdowns, and automatically scheduled preventative maintenance. 
                      </p>
                  ...
                  <ul class="flex flex-col gap-2 list-disc pl-5">
                    <li class="">
                      <span class="xl:text-xl font-semibold">47%</span>
                      reduction in unplanned machinery downtime
                    </li>
                    <li class="">
                      <span class="xl:text-xl font-semibold">39%</span>
...
<section class="w-full px-5 lg:px-10 py-14 lg:py-20 bg-[#F2F7FF] relative overflow-hidden">
  <div class="container flex flex-col gap-5 items-center">
    ...
    <p class="text-[#333333] w-full lg:w-4/4 text-base font-medium pb-12">
      Intellivon’s predictive maintenance solutions deliver measurable impact by ensuring equipment reliability, safety, and cost-efficiency across enterprise-scale construction operations.
    </p>
        ...
        <div class="swiper-wrapper">
            ...
            <div
              ...
              <div class="flex flex-col md:flex-row gap-5 items-center">
                ...
                <h3 class="font-bold text-lg text-center md:text-start">
                  Heavy Machinery Fleet Monitoring
                </h3>
              </div>
              <p class="text-center md:text-start">
                IoT sensors and AI track vibration, temperature, and performance metrics to detect wear and tear early, preventing costly breakdowns across large fleets.
              </p>
            </div>
          </div>
          ...
          <div class="swiper-slide h-full">
            <div
              ...
              <p class="text-center md:text-start">
                AI models analyze live equipment data streams to spot irregularities, alerting teams before small issues escalate into critical failures.
              </p>
            </div>
          </div>
          ...
          <div class="swiper-slide h-full">
            <div
              ...
              <p class="text-center md:text-start">
                Predictive analytics automatically trigger maintenance requests based on usage patterns, reducing reliance on manual scheduling and avoiding missed service cycles.
              </p>
            </div>
          </div>
          <!-- CARD 4 -->
          <div class="swiper-slide h-full">
            <div
              ...
              <p class="text-center md:text-start">
                AI forecasts spare part demand based on predicted equipment needs, ensuring availability while reducing unnecessary inventory costs.
              </p>
            </div>
          </div>
          ...
          <div class="swiper-slide h-full">
            <div
              ...
              <p class="text-center md:text-start">
                Predictive systems monitor compliance-critical equipment, ensuring inspections and maintenance are completed on time, avoiding penalties or site shutdowns.
              </p>
            </div>
          </div>
          ...
          <div class="swiper-slide h-full">
            <div
              ...
              <p class="text-center md:text-start">
                Centralized dashboards provide enterprise leaders with real-time visibility into machinery health across global projects, ensuring consistency and performance at scale.
              </p>
            </div>
          </div>
          ...
          <div class="swiper-slide h-full">
            <div
              ...
              <div class="flex flex-col md:flex-row gap-5 items-center">
                <!-- SVG Icon -->
                <h3 class="font-bold text-lg text-center md:text-start">
                  Lifecycle Extension of Assets
                </h3>
              </div>
              <p class="text-center md:text-start">
                By reducing strain and addressing early issues, predictive maintenance extends the useful lifespan of machinery, maximizing ROI on capital equipment investments.
              </p>
            </div>
          </div>
          ...
          <div class="swiper-slide h-full">
            <div
              ...
              <p class="text-center md:text-start">
                Seamlessly connect predictive maintenance insights with ERP and project management tools to streamline reporting, resource allocation, and project planning.
              </p>
            </div>
          </div>
        ...
        <div class="w-full flex flex-col gap-5 items-start">
          ...
          <div class="flex flex-col gap-5 lg:gap-0 lg:flex-row justify-between">
            <h2 class="w-full lg:w-7/12 text-4xl flex-wrap gap-3 flex items-center font-bold text-black1 font-urbanist">
              Why Enterprises Trust Intellivon for Predictive Maintenance
              <span class="text-gradient">Predictive Maintenance</span>
            </h2>
            <a href="https://intellivon.com/ai-strategy-call-booking-confirmation/" target="_blank">
              <div>
                <button type="button"
          ...
          <p class="text-grey1 text-base font-medium">
            Intellivon delivers AI-first predictive maintenance platforms built for scale, combining machine learning, IoT, and real-time analytics to reduce downtime and maximize construction productivity worldwide.
          </p>
        </div>
      </div>
    </div>
    <div class="mt-16 grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-5">
      ...
      <div class="choose-card-wrapper w-full h-[212px] md:w-[409px] m-auto lg:m-0 z-10">
        <div class="choose-card shadow-[0_24px_34px_0_rgba(0,0,0,.078)]">
          ...
          <div
            ...
            <!-- SVG Icon -->
            <p class="text-sm">
              Ensure every machine meets safety and regulatory standards with automated compliance checks and audit-ready records generated by AI-powered systems.
            </p>
          </div>
        </div>
      </div>
      ...
      <div class="choose-card-wrapper w-full h-[212px] md:w-[409px] m-auto lg:m-0 z-10">
        <div class="choose-card shadow-[0_24px_34px_0_rgba(0,0,0,.078)]">
          ...
          <div
            ...
            <!-- SVG Icon -->
            <p class="text-sm">
              Our predictive platforms monitor thousands of assets simultaneously, delivering actionable insights without overwhelming operations teams.
            </p>
          </div>
        </div>
      </div>
      ...
      <div class="choose-card-wrapper w-full h-[212px] md:w-[409px] m-auto lg:m-0 z-10">
        <div class="choose-card shadow-[0_24px_34px_0_rgba(0,0,0,.078)]">
          ...
          <div class="choose-card-front bg-white p-6 flex flex-col gap-8 items-center justify-center">
            <!-- SVG Icon -->
            <h3 class="text-xl font-semibold text-center">Data-Driven Accuracy</h3>
          </div>
          <!-- Back Side -->
          <div
            class="choose-card-back bg-white p-6 flex flex-col gap-4 items-center justify-center text-center text-gray-800">
            <!-- SVG Icon -->
            <p class="text-sm">
              Machine learning continuously refines predictions using live and historical data, improving accuracy over time for reliable decision-making.
            </p>
          </div>
        </div>
      </div>
      ...
      <div class="choose-card-wrapper w-full h-[212px] md:w-[409px] m-auto lg:m-0 z-10">
        <div class="choose-card shadow-[0_24px_34px_0_rgba(0,0,0,.078)]">
          ...
          <div
            ...
            <!-- SVG Icon -->
            <p class="text-sm">
              Our solutions integrate with ERP, project management, and asset tracking systems, ensuring smooth adoption and maximum operational value.
            </p>
          </div>
        </div>
      </div>
      ...
      <div class="choose-card-wrapper w-full h-[212px] md:w-[409px] m-auto lg:m-0 z-10">
        <div class="choose-card shadow-[0_24px_34px_0_rgba(0,0,0,.078)]">
          ...
          <div
            ...
            <!-- SVG Icon -->
            <p class="text-sm">
              Reduce unnecessary maintenance and avoid costly breakdowns, delivering direct savings to the bottom line without compromising safety or performance.
            </p>
          </div>
        </div>
      </div>
      ...
      <div class="choose-card-wrapper w-full h-[212px] md:w-[409px] m-auto lg:m-0 z-10">
        <div class="choose-card shadow-[0_24px_34px_0_rgba(0,0,0,.078)]">
          ...
          <div
            ...
            <!-- SVG Icon -->
            <p class="text-sm">
              By extending asset lifecycles and minimizing downtime, enterprises achieve long-lasting financial and operational gains at scale.
            </p>
          </div>
        </div>
      </div>
    ...
    <div class="flex items-end justify-between mt-6 mb-3">
      ...
      <div class="flex flex-col gap-3 w-full">
        ...
        <h2 class="text-4xl md:gap-3 items-center font-bold text-black1 font-urbanist leading-snug tracking-[0.5px]">
          How We Transform Equipment Maintenance Into Predictive Precision
          <span class="text-gradient"> in 3 Steps </span>
        </h2>
        <p class="text-[#333333] w-full lg:w-3/4 text-base font-medium">
          Intellivon’s proven process aligns predictive maintenance with enterprise construction needs, ensuring smooth implementation and measurable performance improvements.
        </p>
      </div>
    </div>
    <!-- Consulting Cards -->
        ...
        <div class="grid grid-cols-2 gap-1 mt-4">
          <div class="p-3 bg-[#F7F7F7] h-44">
            ...
            <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
              Assess current maintenance practices and equipment health data.
            </p>
          </div>
          <div class="p-3 bg-[#F7F7F7] h-44">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
            ...
            <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
              Identify inefficiencies in reactive and preventive strategies.
            </p>
          </div>
          <div class="p-3 bg-[#F7F7F7] h-44">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
            ...
            <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
              Review IoT readiness across machinery.
            </p>
          </div>
          <div class="p-3 bg-[#F7F7F7] h-44">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
            ...
            <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
              Define enterprise-wide KPIs for predictive adoption.
            </p>
          </div>
        </div>
      </div>
      ...
      <div class="card w-full lg:w-1/3 p-6 border-2 border-transparent rounded-md"
        ...
        <div class="grid grid-cols-2 gap-1 mt-4">
          <div class="p-3 bg-[#F7F7F7] h-44">
            ...
            <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
              Design predictive models tailored to construction machinery.
            </p>
          </div>
          <div class="p-3 bg-[#F7F7F7] h-44">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
            ...
            <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
              Prototype anomaly detection on selected assets.
            </p>
          </div>
          <div class="p-3 bg-[#F7F7F7] h-44">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
            ...
            <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
              Validate predictions against historical breakdown data.
            </p>
          </div>
          <div class="p-3 bg-[#F7F7F7] h-44">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
            ...
            <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
              Simulate ROI impact for enterprise rollouts.
            </p>
          </div>
        </div>
      </div>
      ...
      <div class="card w-full lg:w-1/3 p-6 border-2 border-transparent rounded-md"
        ...
        <div class="grid grid-cols-2 gap-1 mt-4">
          <div class="p-3 bg-[#F7F7F7] h-44">
            ...
            <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
              Deploy IoT sensors and AI monitoring systems enterprise-wide.
            </p>
          </div>
          <div class="p-3 bg-[#F7F7F7] h-44">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
            ...
            <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
              Integrate predictive insights with ERP and project tools.
            </p>
          </div>
          <div class="p-3 bg-[#F7F7F7] h-44">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
            ...
            <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
              Train teams to interpret insights and act proactively.
            </p>
          </div>
          <div class="p-3 bg-[#F7F7F7] h-44">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
            ...
            <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
              Continuously optimize models for accuracy and reliability.
            </p>
          </div>
        </div>
      </div>
    ...
    <a href="https://intellivon.com/ai-strategy-call-booking-confirmation/" target="_blank">
      <div class="w-full flex items-center justify-center mt-4">
        <button type="button"
          ...
          <span class="relative z-10 text-blue text-nowrap"> Book a Free Consultation</span>
      ...
      <div class="flex items-end justify-between mt-6 mb-3">
        <div class="w-full flex flex-col gap-5">
          ...
          <div class="flex flex-col gap-5 lg:gap-0 lg:flex-row justify-between w-full">
            <h2
              class="w-full lg:w-11/12 text-4xl gap-3 font-bold text-black1 font-urbanist leading-snug tracking-[0.5px]">
              What Construction Leaders Say About Our 
              <span class="text-gradient">Predictive Maintenance Solutions</span>
            </h2>
        ...
        <div id="testimonial-slider" class="overflow-hidden relative w-full max-w-full order-1 lg:order-2 z-20">
          <div id="testimonial-track" class="flex transition-transform duration-500 ease-in-out w-full"
            ...
            <div
              ...
              <div class="pl-6 h-fit pt-4">
                <div class="flex flex-col gap-5 font-normal text-black1 mt-5">
                  Unexpected machinery failures were costing us millions in delays. Intellivon’s predictive platform now flags issues early, allowing us to fix them before breakdowns occur.
                  <div class="text-xl font-medium font-urbanist text-black1">
                    Director of Equipment Operations, Global Infrastructure Enterprise
                  </div>
                </div>
              </div>
            </div>
            ...
            <div
              ...
              <div class="pl-6 h-fit pt-4">
                <div class="flex flex-col gap-5 font-normal text-black1 mt-5">
                  ...
                  With projects spanning continents, keeping track of equipment health was a nightmare. Intellivon gave us centralized visibility across all assets, improving uptime and performance.
                  <div class="text-xl font-medium font-urbanist text-black1">
            ...
            <div
              ...
              <div class="pl-6 h-fit pt-4">
                <div class="flex flex-col gap-5 font-normal text-black1 mt-5">
                  Our old maintenance schedules were inefficient and expensive. Intellivon’s AI-driven approach helped us automate and optimize scheduling, cutting costs significantly while improving compliance.
                  <div class="text-xl font-medium font-urbanist text-black1">
                    Head of Maintenance, Multinational Real Estate Developer
                  </div>
                </div>
              </div>
            </div>
            ...
            <div
              ...
              <div class="pl-6 h-fit pt-4">
                <div class="flex flex-col gap-5 font-normal text-black1 mt-5">
                  Safety compliance used to be reactive and time-consuming. With Intellivon, we now get real-time alerts and automated compliance records, improving both safety and audit readiness.
                  <div class="text-xl font-medium font-urbanist text-black1">
                    Chief Project Officer, Engineering & Construction Enterprise
                  </div>
                </div>
              </div>
            </div>
            ...
            <div
              ...
              <div class="pl-6 h-fit pt-4">
                <div class="flex flex-col gap-5 font-normal text-black1 mt-5">
                  Predictive insights have extended the lifespan of our machinery fleet by years. Intellivon’s platform is a true game-changer for capital-intensive construction.
                  <div class="text-xl font-medium font-urbanist text-black1">
                    SVP of Strategy, Global Construction Firm
                  </div>
                </div>
              </div>
            </div>
      ...
      <div class="w-full">
        <div class="w-full flex flex-col gap-5 items-start">
          ...
          <h3 class="text-grey1 text-base font-medium lg:w-1/2">
            Our exclusive platform where we share expert perspectives and guidance for your AI 
          </h3>
