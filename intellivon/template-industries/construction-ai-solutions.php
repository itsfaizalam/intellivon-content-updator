<?php /* Template Name: Construction AI Solutions */ ?>
<?php get_header(); ?>
  ...
  <div class="flex">
    <div class="lg:w-full flex flex-col gap-5 px-10 justify-center py-10 lg:p-[150px] lg:text-center">
      <h1 class="font-bold text-4xl lg:text-5xl text-white">
        Construction AI Solutions Powering the 
        <span class="text-gradient">Future of Infrastructure</span>
      </h1>
      <p class="text-white text-lg font-medium">We empower enterprise construction leaders with AI solutions engineered for large-scale efficiency, project predictability, cost reduction, and strategic growth.</p>
      <div class="glex lg:justify-center">
        <a
      ...
      >
        <button class="w-fit flex gap-2 bg-gradient-to-r from-[#9A37B2] to-[#E61C42] text-white font-medium px-6 py-3 rounded-full shadow-lg hover:scale-105 transition border border-[#7C3BAF]">
          Talk To Our Construction AI Experts
          <svg
    ...
    <div class="w-full lg:w-2/3 lg:pl-10 px-10 lg:px-0">
      <div class="flex flex-col gap-5 items-start">
        ...
        <h2 class="text-4xl items-center font-bold text-black1 font-urbanist leading-snug tracking-[0.5px] gap-1">
          Trusted by 
          <span class="text-gradient">Enterprise Leaders in Construction</span>
        </h2>
        <p class="mb-4 md:mb-0 text-base font-medium text-grey1 mt-2 w-full tracking-[0.25px] pr-5 mb-12">
          Enterprise construction innovators rely on Intellivon’s AI to achieve scalability, productivity, and risk-free project management at unprecedented levels.
        </p>
      </div>
    </div>
    <!-- Right column: Image -->
      ...
      <div class="w-full flex flex-col gap-5 items-start">
        ...
        <div class="flex flex-col gap-5 lg:gap-0 lg:flex-row justify-between w-full">
          <h2 class="w-full lg:w-11/12 text-4xl gap-3 font-bold text-black1 font-urbanist leading-snug tracking-[0.5px]">            
            <span class="text-gradient">Transforming Construction Through AI</span>
          </h2>
            ...
            <div class="swiper-wrapper bg-[#F2F7FF]">
                ...
                <div class="w-full lg:w-1/2 flex flex-col gap-5 px-5 py-4">
                  <div class="flex flex-col w-full gap-2 pb-4 border-b border-b-[#99899d]">
                    <h3 class="text-xl md:text-3xl font-semibold">
                      3D Construction Modeling for Global Infrastructure Firm
                    </h3>
                    <div class="text-[#333] leading-7 tracking-wide">
                      <p class="hidden xl:block text-md">
                        We partnered with a global infrastructure firm facing challenges in visualizing large-scale projects in 3D, leading to delays and miscommunication. Intellivon’s AI-powered 3D construction modeling solution transformed their workflow. By generating detailed, real-time 3D models from design blueprints, the firm could better visualize the entire construction process and detect potential conflicts before breaking ground.
                      </p>
                      <p
              ...
              >
                <div class="w-full lg:w-1/2 flex flex-col gap-5 px-5 py-4">
                  <div class="flex flex-col w-full gap-2 pb-4 border-b border-b-[#99899d]">
                    <h3 class="text-xl md:text-3xl font-semibold">
                      Document & Plan Digitization for Regional Construction Giant
                    </h3>
                    <div class="text-[#333] leading-7 tracking-wide">
                      <p class="hidden xl:block text-md">
                        A regional construction company was overwhelmed with managing thousands of paper plans and documents for multiple projects. Intellivon introduced an AI-driven document and plan digitization solution that scanned, indexed, and made these documents easily searchable. The new system eliminated paper-based bottlenecks and improved collaboration among teams.
                      </p>
              ...
              <div class="swiper-slide w-full h-[500px] shrink-0 flex flex-col lg:flex-row rounded-xl shadow-purple bg-white case-study-slide">
                <div class="w-full lg:w-1/2 flex flex-col gap-5 px-5 py-4">
                  <div class="flex flex-col w-full gap-2 pb-4 border-b border-b-[#99899d]">
                    <h3 class="text-xl md:text-3xl font-semibold">
                      Material & Equipment Recognition for Commercial Construction Leader
                    </h3>
                    <div class="text-[#333] leading-7 tracking-wide">
                      <p class="hidden xl:block text-md">
                        A large commercial construction company struggled with manually tracking materials and equipment across multiple job sites, leading to supply chain delays and cost overruns. We deployed an AI-based material and equipment recognition system, enabling the team to track resources in real-time through machine vision. This automated solution improved resource allocation and minimized losses.
                      </p>
                      <p class="xl:hidden leading-0 line-clamp-5 read-more-content text-sm">
                        A large commercial construction company struggled with manually tracking materials and equipment across multiple job sites, leading to supply chain delays and cost overruns. We deployed an AI-based material and equipment recognition system, enabling the team to track resources in real-time through machine vision. This automated solution improved resource allocation and minimized losses.
                      </p>
                  ...
                  <ul class="flex flex-col gap-2 list-disc pl-5">
                    <li class="">
                      ...
                      improvement in resource tracking accuracy
                    </li>
                    <li class="">
              ...
              <div class="swiper-slide w-full h-[500px] shrink-0 flex flex-col lg:flex-row rounded-xl shadow-purple bg-white case-study-slide">
                <div class="w-full lg:w-1/2 flex flex-col gap-5 px-5 py-4">
                  <div class="flex flex-col w-full gap-2 pb-4 border-b border-b-[#99899d]">
                    <h3 class="text-xl md:text-3xl font-semibold">
                      AI Blueprint Reader for Urban Development Firm
                    </h3>
                    <div class="text-[#333] leading-7 tracking-wide">
                      <p class="hidden xl:block text-md">
                        An urban development firm faced difficulties in quickly interpreting blueprints for large, complex construction projects, leading to slow approvals and costly revisions. Intellivon’s AI blueprint reader automated the process, instantly extracting and interpreting key data from architectural plans and codes. This enabled faster decision-making and reduced errors.
                      </p>
                      <p class="xl:hidden leading-0 line-clamp-5 read-more-content text-sm">
                        An urban development firm faced difficulties in quickly interpreting blueprints for large, complex construction projects, leading to slow approvals and costly revisions. Intellivon’s AI blueprint reader automated the process, instantly extracting and interpreting key data from architectural plans and codes. This enabled faster decision-making and reduced errors.
                      </p>
                  ...
                  <ul class="flex flex-col gap-2 list-disc pl-5">
                    <li class="">
                      <span class="xl:text-xl font-semibold">35% </span>
                      reduction in blueprint review time
                    </li>
                    <li class="">
                      <span class="xl:text-xl font-semibold">50% </span>
                      fewer revisions needed during construction
                    </li>
                    <li class="">
                      <span class="xl:text-xl font-semibold">25% </span>
              ...
              <div class="swiper-slide w-full h-[500px] shrink-0 flex flex-col lg:flex-row rounded-xl shadow-purple bg-white case-study-slide">
                <div class="w-full lg:w-1/2 flex flex-col gap-5 px-5 py-4">
                  <div class="flex flex-col w-full gap-2 pb-4 border-b border-b-[#99899d]">
                    <h3 class="text-xl md:text-3xl font-semibold">
                      Estimations and Bidding for International Construction Enterprise
                    </h3>
                    <div class="text-[#333] leading-7 tracking-wide">
                      <p class="hidden xl:block text-md">
                        An international construction enterprise struggled with the accuracy and speed of project estimations and bids, often resulting in lost opportunities and budget overruns. We implemented an AI-driven estimation and bidding tool that used historical project data to generate more accurate bids. The solution streamlined their bidding process and increased project win rates.
                      </p>
                      <p class="xl:hidden leading-0 line-clamp-5 read-more-content text-sm">
                        An international construction enterprise struggled with the accuracy and speed of project estimations and bids, often resulting in lost opportunities and budget overruns. We implemented an AI-driven estimation and bidding tool that used historical project data to generate more accurate bids. The solution streamlined their bidding process and increased project win rates.
                      </p>
    ...
    <div class="w-full">
      ...
      <h2 class="w-full lg:w-11/12 text-4xl gap-3 font-bold text-black1 font-urbanist leading-snug tracking-[0.5px]">
        <span class="text-gradient">
          Applications of AI in Construction at Scale
        </span>
      </h2>
    </div>
    <p class="text-[#333333] w-full lg:w-4/4 text-base font-medium pb-12">
          We apply AI to enterprise construction challenges, unlocking efficiency in planning, execution, workforce safety, equipment management, and risk reduction.
        </p>
        ...
        <div class="swiper-wrapper">
            ...
            <div class="flex flex-col gap-5 py-5 px-3 bg-white rounded-2xl border border-[#333333] h-[450px] md:h-[320px] lg:h-[240px]">
              <div class="flex flex-col md:flex-row gap-5 items-center">
                ...
                <h3 class="font-bold text-lg text-center md:text-start">
                  AI-Powered 3D Construction Modeling
                </h3>
              </div>
              <p class="text-center md:text-start">
                AI-driven 3D modeling generates real-time visualizations from blueprints, helping construction teams detect design errors, streamline approvals, and improve collaboration, ultimately reducing costly mistakes and delays.
              </p>
            </div>
          </div>
          ...
          <div class="swiper-slide h-full">
            <div class="flex flex-col gap-5 py-5 px-3 bg-white rounded-2xl border border-[#333333] h-[450px] md:h-[320px] lg:h-[240px]">
              <div class="flex flex-col md:flex-row gap-5 items-center">
                <!-- SVG Icon -->
                <h3 class="font-bold text-lg text-center md:text-start">
                  AI-Driven Document & Plan Digitization
                </h3>
              </div>
              <p class="text-center md:text-start">
                AI digitizes and organizes construction documents, transforming them into searchable formats. This improves accessibility, reduces time spent searching, and enhances communication across project teams, speeding up decision-making.
              </p>
            </div>
          </div>
          ...
          <div class="swiper-slide h-full">
            <div class="flex flex-col gap-5 py-5 px-3 bg-white rounded-2xl border border-[#333333] h-[450px] md:h-[320px] lg:h-[240px]">
              ...
              <p class="text-center md:text-start">
                AI identifies and tracks materials and equipment in real-time using computer vision. This ensures optimal resource allocation, reduces inventory errors, and prevents shortages, improving on-site efficiency.
              </p>
            </div>
          </div>
          <!-- CARD 4 -->
          <div class="swiper-slide h-full">
            <div class="flex flex-col gap-5 py-5 px-3 bg-white rounded-2xl border border-[#333333] h-[450px] md:h-[320px] lg:h-[240px]">
              ...
              <p class="text-center md:text-start">
                AI blueprint readers automatically interpret complex construction plans, extracting key data. This accelerates approvals, enhances planning accuracy, and reduces errors, leading to quicker project execution and fewer revisions.
              </p>
            </div>
          </div>
          ...
          <div class="swiper-slide h-full">
            <div class="flex flex-col gap-5 py-5 px-3 bg-white rounded-2xl border border-[#333333] h-[450px] md:h-[320px] lg:h-[240px]">
              <div class="flex flex-col md:flex-row gap-5 items-center">
                <!-- SVG Icon -->
                <h3 class="font-bold text-lg text-center md:text-start">
                  AI for Estimations and Bidding
                </h3>
              </div>
              <p class="text-center md:text-start">
                AI leverages historical data to generate more accurate cost estimations and competitive bids. This helps construction firms win projects with precise budgeting and minimizes the risk of cost overruns.
              </p>
            </div>
          </div>
          ...
          <div class="swiper-slide h-full">
            <div class="flex flex-col gap-5 py-5 px-3 bg-white rounded-2xl border border-[#333333] h-[450px] md:h-[320px] lg:h-[240px]">
              ...
              <p class="text-center md:text-start">
                AI-powered safety systems use real-time sensors and cameras to detect hazards and non-compliance, sending instant alerts to managers. This improves site safety and reduces the risk of workplace injuries.
              </p>
            </div>
          </div>
          ...
          <div class="swiper-slide h-full">
            <div class="flex flex-col gap-5 py-5 px-3 bg-white rounded-2xl border border-[#333333] h-[450px] md:h-[320px] lg:h-[240px]">
              ...
              <p class="text-center md:text-start">
                AI optimizes project schedules and resource allocation by analyzing real-time data. This ensures timely project delivery, minimizes downtime, and maximizes labor and material efficiency throughout the construction process.
              </p>
            </div>
          </div>
          ...
          <div class="swiper-slide h-full">
            <div class="flex flex-col gap-5 py-5 px-3 bg-white rounded-2xl border border-[#333333] h-[450px] md:h-[320px] lg:h-[240px]">
              ...
              <p class="text-center md:text-start">
                AI risk management tools predict potential issues like delays or budget overruns. By offering proactive insights, they help construction firms mitigate risks, leading to smoother project execution and fewer disruptions.
              </p>
            </div>
          </div>
        </div>
        ...
        <div class="w-full flex flex-col gap-5 items-start">
          ...
          <div class="flex flex-col gap-5 lg:gap-0 lg:flex-row justify-between">
            ...
            >
              ...
              <span class="text-gradient">Construction AI Excellence</span>
            </h2>
            <a
              href="https://intellivon.com/ai-strategy-call-booking-confirmation/"
              target="_blank"
          ...
          <p class="text-grey1 text-base font-medium">
            We provide not just AI, but enterprise transformation, ensuring construction leaders achieve lasting efficiency, predictable delivery, and market leadership.
          </p>
        </div>
      </div>
    </div>
    <div class="mt-16 grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-5">
      ...
      <div class="choose-card-wrapper w-full h-[212px] md:w-[409px] m-auto lg:m-0 z-10">
        <div class="choose-card shadow-[0_24px_34px_0_rgba(0,0,0,.078)]">
          ...
          <div class="choose-card-back bg-white p-6 flex flex-col gap-4 items-center justify-center text-center text-gray-800">
            <!-- SVG Icon -->
            <p class="text-sm">
              Our AI is built to tackle complex, large-scale projects, ensuring seamless integration with your enterprise’s specific needs and project requirements.
            </p>
          </div>
        </div>
      </div>
      ...
      <div class="choose-card-wrapper w-full h-[212px] md:w-[409px] m-auto lg:m-0 z-10">
        <div class="choose-card shadow-[0_24px_34px_0_rgba(0,0,0,.078)]">
          ...
          <div class="choose-card-back bg-white p-6 flex flex-col gap-4 items-center justify-center text-center text-gray-800">
            <!-- SVG Icon -->
            <p class="text-sm">
              Access real-time data insights to make informed decisions quickly, keeping projects on schedule and minimizing risks in rapidly changing environments.
            </p>
          </div>
        </div>
      </div>
      ...
      <div class="choose-card-wrapper w-full h-[212px] md:w-[409px] m-auto lg:m-0 z-10">
        <div class="choose-card shadow-[0_24px_34px_0_rgba(0,0,0,.078)]">
          ...
          <div class="choose-card-front bg-white p-6 flex flex-col gap-8 items-center justify-center">
            <!-- SVG Icon -->
            <h3 class="text-xl font-semibold text-center">Easy Integration</h3>
          </div>
          <!-- Back Side -->
          <div class="choose-card-back bg-white p-6 flex flex-col gap-4 items-center justify-center text-center text-gray-800">
            <!-- SVG Icon -->
            <p class="text-sm">
              Our AI integrates smoothly with existing tools, reducing disruption and providing instant value without the need for extensive implementation.
            </p>
          </div>
        </div>
      </div>
      ...
      <div class="choose-card-wrapper w-full h-[212px] md:w-[409px] m-auto lg:m-0 z-10">
        <div class="choose-card shadow-[0_24px_34px_0_rgba(0,0,0,.078)]">
          ...
          <div class="choose-card-back bg-white p-6 flex flex-col gap-4 items-center justify-center text-center text-gray-800">
            <!-- SVG Icon -->
            <p class="text-sm">
              Experience measurable improvements in cost reduction, efficiency, and project timelines, with clear ROI visible from the start.
            </p>
          </div>
        </div>
      </div>
      ...
      <div class="choose-card-wrapper w-full h-[212px] md:w-[409px] m-auto lg:m-0 z-10">
        <div class="choose-card shadow-[0_24px_34px_0_rgba(0,0,0,.078)]">
          ...
          <div class="choose-card-back bg-white p-6 flex flex-col gap-4 items-center justify-center text-center text-gray-800">
            <!-- SVG Icon -->
            <p class="text-sm">
              We offer continuous support and optimization, ensuring our AI evolves with your growing needs, maintaining efficiency over the long term.
            </p>
          </div>
        </div>
      </div>
      ...
      <div class="choose-card-wrapper w-full h-[212px] md:w-[409px] m-auto lg:m-0 z-10">
        <div class="choose-card shadow-[0_24px_34px_0_rgba(0,0,0,.078)]">
          ...
          <div class="choose-card-back bg-white p-6 flex flex-col gap-4 items-center justify-center text-center text-gray-800">
            <!-- SVG Icon -->
            <p class="text-sm">
              Our solutions come with enterprise-grade security and comply with industry regulations, safeguarding your sensitive construction data and ensuring compliance.
            </p>
          </div>
        </div>
      </div>
    ...
    <div class="flex items-end justify-between mt-6 mb-3">
      ...
      <div class="flex flex-col gap-3 w-full">
        ...
        <h2 class="text-4xl md:gap-3 items-center font-bold text-black1 font-urbanist leading-snug tracking-[0.5px]">
          How We Engineer AI for Construction Success
          <span class="text-gradient"> in 3 Steps </span>
        </h2>
        <p class="text-[#333333] w-full lg:w-3/4 text-base font-medium">
          From consultation to post-deployment monitoring, our process ensures AI delivers immediate value, mitigating risks and creating scalable benefits for construction enterprises.
        </p>
      </div>
    </div>
    <!-- Consulting Cards -->
        ...
        <div class="grid grid-cols-2 gap-1 mt-4">
          <div class="p-3 bg-[#F7F7F7] h-44">
            ...
            <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
              Assess current technology and identify construction-specific challenges.
            </p>
          </div>
          <div class="p-3 bg-[#F7F7F7] h-44">
            <svg
            ...
            <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
              Map out regulatory and compliance requirements for AI integration.
            </p>
          </div>
          <div class="p-3 bg-[#F7F7F7] h-44">
            <svg
            ...
            <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
              Identify high-value AI opportunities to improve project efficiency.
            </p>
          </div>
          <div class="p-3 bg-[#F7F7F7] h-44">
            <svg
            ...
            <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
              Calculate potential ROI and develop a proof of concept.
            </p>
          </div>
        </div>
      </div>
      ...
      <div class="card w-full lg:w-1/3 p-6 border-2 border-transparent rounded-md" style="background: linear-gradient(142deg, #fff 0%, #d4d6ff 99.14%)">
        ...
        <div class="grid grid-cols-2 gap-1 mt-4">
          <div class="p-3 bg-[#F7F7F7] h-44">
            ...
            <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
              Design custom AI solutions tailored to your construction needs.
            </p>
          </div>
          <div class="p-3 bg-[#F7F7F7] h-44">
            <svg
            ...
            <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
              Select the most effective AI models and integration strategies.
            </p>
          </div>
          <div class="p-3 bg-[#F7F7F7] h-44">
            <svg
            ...
            <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
              Implement secure data governance and ensure compliance frameworks.
            </p>
          </div>
          <div class="p-3 bg-[#F7F7F7] h-44">
            <svg
            ...
            <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
              Prepare data for seamless integration across your systems.
            </p>
          </div>
        </div>
      </div>
      ...
      <div class="card w-full lg:w-1/3 p-6 border-2 border-transparent rounded-md" style="background: linear-gradient(142deg, #fff 0%, #ffddfb 99.14%)">
        ...
        <div class="grid grid-cols-2 gap-1 mt-4">
          <div class="p-3 bg-[#F7F7F7] h-44">
            ...
            <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
              Develop and train AI models for optimal accuracy and compliance.
            </p>
          </div>
          <div class="p-3 bg-[#F7F7F7] h-44">
            <svg
            ...
            <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
              Roll out AI solutions in staged phases for smooth implementation.
            </p>
          </div>
          <div class="p-3 bg-[#F7F7F7] h-44">
            <svg
            ...
            <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
              Provide comprehensive user training and ensure smooth adoption.
            </p>
          </div>
          <div class="p-3 bg-[#F7F7F7] h-44">
            <svg
            ...
            <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
              Continuously monitor and optimize AI to meet evolving project goals.
            </p>
          </div>
        </div>
      </div>
      ...
      <div class="flex items-end justify-between mt-6 mb-3">
        <div class="w-full flex flex-col gap-5">
          ...
          >
            ...
            >
            Trusted by
              <span class="text-gradient"> Global Construction Innovators</span>
            </h2>
        ...
        <div id="testimonial-slider" class="overflow-hidden relative w-full max-w-full order-1 lg:order-2 z-20">
          ...
          >
            ...
            <div class="slide min-w-full shrink-0 common-whitebox2 px-6 p-5 rounded-lg flex h-fit relative w-full shadow-lg md:shadow-none">
              ...
              <div class="pl-6 h-fit pt-4">
                <div class="flex flex-col gap-5 font-normal text-black1 mt-5">
                  Managing large-scale projects was a challenge with manual scheduling. Intellivon’s AI-powered scheduling solution helped us streamline resource allocation and minimize delays, improving our project timelines and overall productivity.
                  <div class="text-xl font-medium font-urbanist text-black1">
                    Project Manager, Global Construction Firm
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="slide min-w-full shrink-0 common-whitebox2 px-6 p-5 rounded-lg flex h-fit relative w-full shadow-lg md:shadow-none">
              ...
              <div class="pl-6 h-fit pt-4">
                <div class="flex flex-col gap-5 font-normal text-black1 mt-5">
                  We had trouble tracking materials and equipment across multiple sites. Intellivon’s AI-based solution allowed us to track resources in real-time, reducing shortages and optimizing usage across all projects.
                  <div class="text-xl font-medium font-urbanist text-black1">
                    Operations Lead, National Construction Company
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="slide min-w-full shrink-0 common-whitebox2 px-6 p-5 rounded-lg flex h-fit relative w-full shadow-lg md:shadow-none">
              ...
              <div class="pl-6 h-fit pt-4">
                <div class="flex flex-col gap-5 font-normal text-black1 mt-5">
                  Construction planning was often delayed due to outdated and manual processes. With Intellivon’s AI-driven document digitization, our teams now access critical information instantly, improving project flow and decision-making.
                  <div class="text-xl font-medium font-urbanist text-black1">
                    Construction Coordinator, Regional Developer
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="slide min-w-full shrink-0 common-whitebox2 px-6 p-5 rounded-lg flex h-fit relative w-full shadow-lg md:shadow-none">
              ...
              <div class="pl-6 h-fit pt-4">
                <div class="flex flex-col gap-5 font-normal text-black1 mt-5">
                  Safety compliance was difficult to monitor across numerous job sites. Intellivon’s AI-powered safety monitoring system helped us identify hazards in real time, ensuring a safer environment and reducing accidents.
                  <div class="text-xl font-medium font-urbanist text-black1">
                    Safety Officer, International Contractor
                  </div>
                </div>
              </div>
            </div>
            ...
            >
              ...
              <div class="pl-6 h-fit pt-4">
                <div class="flex flex-col gap-5 font-normal text-black1 mt-5">
                  Estimating costs and preparing bids used to be time-consuming and error-prone. Intellivon’s AI solution significantly improved our bidding accuracy and helped us win more projects with better cost control.
                  <div class="text-xl font-medium font-urbanist text-black1">
                    Bid Manager, Large-Scale Construction Enterprise
                  </div>
                </div>
              </div>
            </div>
  ...
  <div class="container flex flex-col gap-5 items-center">
    ...
    <div class="flex flex-col w-5/6 mt-5">
      ...
      <div class="faq-item">
        <div class="border-t border-[#7C3BAF] flex justify-between py-5 cursor-pointer">
          <div class="font-medium text-xl">
            Q1. What are Construction AI Solutions?
          </div>
          <div class="faq-icon">
            <svg
              xmlns="http://www.w3.org/2000/svg"
        ...
        <div class="faq-answer overflow-hidden max-h-0 opacity-0 transition-all duration-300 ease-in-out px-4 pb-8">
          <p class="text-base text-[#333]">
            Construction AI solutions use artificial intelligence to optimize planning, scheduling, resource allocation, and risk management for large-scale construction projects, improving efficiency, cost savings, and safety.
          </p>
        </div>
      </div>
      <!-- FAQ Item 2 -->
      <div class="faq-item">
        <div class="border-t border-[#7C3BAF] flex justify-between py-5 cursor-pointer">
          <div class="font-medium text-xl">
            Q2. How can AI improve project management in construction?
          </div>
          <div class="faq-icon">
            <svg
              xmlns="http://www.w3.org/2000/svg"
        ...
        <div class="faq-answer overflow-hidden max-h-0 opacity-0 transition-all duration-300 ease-in-out px-4 pb-8">
          <p class="text-base text-[#333]">
            AI enhances project management by providing real-time data insights, automating repetitive tasks, predicting risks, and optimizing resource use, leading to faster timelines and cost-effective project delivery.
          </p>
        </div>
      </div>
      <!-- FAQ Item 3 -->
      <div class="faq-item">
        <div class="border-t border-[#7C3BAF] flex justify-between py-5 cursor-pointer">
          <div class="font-medium text-xl">
            Q3. What benefits does AI offer for construction safety?
          </div>
          <div class="faq-icon">
            <svg
              xmlns="http://www.w3.org/2000/svg"
        ...
        <div class="faq-answer overflow-hidden max-h-0 opacity-0 transition-all duration-300 ease-in-out px-4 pb-8">
          <p class="text-base text-[#333]">
            AI-powered systems monitor job sites in real-time, detecting safety hazards, ensuring compliance with regulations, and providing instant alerts, helping reduce accidents and ensuring worker safety.
          </p>
        </div>
      </div>
      <!-- FAQ Item 4 -->
      <div class="faq-item">
        <div class="border-t border-[#7C3BAF] flex justify-between py-5 cursor-pointer">
          <div class="font-medium text-xl">
            Q4. How does AI optimize resource allocation on construction sites?
          </div>
          <div class="faq-icon">
            <svg
              xmlns="http://www.w3.org/2000/svg"
        ...
        <div class="faq-answer overflow-hidden max-h-0 opacity-0 transition-all duration-300 ease-in-out px-4 pb-8">
          <p class="text-base text-[#333]">
            AI optimizes resource allocation by analyzing real-time data to ensure efficient use of materials, machinery, and labor, minimizing waste, and preventing delays or shortages on construction projects.
          </p>
        </div>
      </div>
      <!-- FAQ Item 5 -->
      <div class="faq-item">
        <div class="border-t border-[#7C3BAF] flex justify-between py-5 cursor-pointer">
          <div class="font-medium text-xl">
            Q5. Can AI help with construction cost estimation and bidding?
          </div>
          <div class="faq-icon">
            <svg
              xmlns="http://www.w3.org/2000/svg"
        ...
        <div class="faq-answer overflow-hidden max-h-0 opacity-0 transition-all duration-300 ease-in-out px-4 pb-8">
          <p class="text-base text-[#333]">
            Yes, AI uses historical data and predictive analytics to improve the accuracy of cost estimations, helping construction companies submit more competitive bids while minimizing budget overruns during projects.
          </p>
        </div>
      </div>
      ...
      <div class="faq-item">
        <div class="border-t border-[#7C3BAF] flex justify-between py-5 cursor-pointer">
          <div class="font-medium text-xl">
            Q6. How do AI solutions integrate with existing construction systems?
          </div>
          <div class="faq-icon">
            <svg
              xmlns="http://www.w3.org/2000/svg"
        ...
        <div class="faq-answer overflow-hidden max-h-0 opacity-0 transition-all duration-300 ease-in-out px-4 pb-8">
          <p class="text-base text-[#333]">
            Intellivon’s AI solutions seamlessly integrate with your current project management and ERP systems, ensuring minimal disruption and quick implementation without the need for a complete overhaul of existing tools.
          </p>
        </div>
      </div>
      ...
      <div class="faq-item">
        <div class="border-t border-[#7C3BAF] flex justify-between py-5 cursor-pointer">
          <div class="font-medium text-xl">
            Q7. Is Construction AI secure and compliant with regulations?
          </div>
          <div class="faq-icon">
            <svg
              xmlns="http://www.w3.org/2000/svg"
        ...
        <div class="faq-answer overflow-hidden max-h-0 opacity-0 transition-all duration-300 ease-in-out px-4 pb-8">
          <p class="text-base text-[#333]">
            Absolutely. Intellivon’s AI solutions are built with enterprise-grade security and comply with industry-specific regulations, ensuring your data is protected and compliant with local and global standards.
          </p>
        </div>
      </div>
      ...
      <div class="faq-item">
        <div class="border-t border-[#7C3BAF] flex justify-between py-5 cursor-pointer">
          <div class="font-medium text-xl">
            Q8. How quickly can AI be implemented in construction projects?
          </div>
          <div class="faq-icon">
            <svg
              xmlns="http://www.w3.org/2000/svg"
        ...
        <div class="faq-answer overflow-hidden max-h-0 opacity-0 transition-all duration-300 ease-in-out px-4 pb-8">
          <p class="text-base text-[#333]">
            Intellivon’s AI solutions are designed for quick deployment, with most of the setup completed in weeks. We ensure minimal disruption during implementation, allowing teams to see immediate benefits.
          </p>
        </div>
      </div>
    </div>
