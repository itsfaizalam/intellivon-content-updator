<?php /* Template Name: Product Design and Simulation */ ?>
<?php get_header(); ?>
  ...
  <div class="flex">
    <div class="lg:w-1/2 flex flex-col gap-5 px-10 justify-center py-10 lg:py-0">
      <h1 class="font-bold text-4xl lg:text-5xl text-white">
        Product Design and Simulation Built for 
        <span class="text-gradient">Enterprise-Scale Manufacturing Innovation</span>
      </h1>
      <p class="text-white text-lg font-medium">Intellivon enables manufacturing leaders to accelerate product innovation using AI-powered simulations, reducing prototyping costs, increasing design accuracy, and delivering market-ready products faster with enterprise-grade reliability.</p>
      <a href="https://intellivon.com/ai-strategy-call-booking-confirmation/" target="_blank">
        <button
          ...
          Talk to Our AI Manufacturing Experts
    ...
    <div class="w-full lg:w-2/3 lg:pl-10 px-10 lg:px-0">
      <div class="flex flex-col gap-5 items-start">
        ...
        <h2 class="text-4xl items-center font-bold text-black1 font-urbanist leading-snug tracking-[0.5px] gap-1">
          Trusted by Global Manufacturers to 
          <span class="text-gradient">Drive Innovation at Scale</span>
        </h2>
        <p class="mb-4 md:mb-0 text-base font-medium text-grey1 mt-2 w-full tracking-[0.25px] pr-5 mb-12">
         Intellivon partners with manufacturing giants worldwide, providing AI-driven design and simulation platforms that reduce costs, shorten development cycles, and enhance collaboration across engineering teams and enterprise operations.
        </p>
      </div>
    </div>
    <!-- Right column: Image -->
  ...
  <div class="container">
    <div class="flex flex-col items-end justify-between mt-6 mb-3 w-full">
      <div class="w-full flex flex-col gap-5 items-start">
        ...
        <div class="flex flex-col gap-5 lg:gap-0 lg:flex-row justify-between w-full">
          <h2
            ...
            How Enterprises Transformed Their 
            <span class="text-gradient">Design Operations with Intellivon</span>
          </h2>
        </div>
                ...
                <div class="w-full lg:w-1/2 flex flex-col gap-5 px-5 py-4">
                  <div class="flex flex-col w-full gap-2 pb-4 border-b border-b-[#99899d]">
                    <h3 class="text-xl md:text-3xl font-semibold">
                      AI-Powered Product Design and Simulation for a Global Industrial Enterprise
                    </h3>
                    <div class="text-[#333] leading-7 tracking-wide">
                      <p class="hidden xl:block text-md">
                        A global industrial manufacturing leader faced high costs and delays caused by physical prototyping and manual design testing. Intellivon deployed an AI-powered design and simulation platform that integrated CAD tools, predictive analytics, and real-time testing environments. The system enabled engineers to run thousands of virtual simulations in hours instead of weeks, accurately modeling stress, performance, and lifecycle outcomes.
                      </p>
                  ...
                  <ul class="flex flex-col gap-2 list-disc pl-5">
                    <li class="">
                      <span class="xl:text-xl font-semibold">48%</span>
                      reduction in prototyping costs
                    </li>
                    <li class="">
                      <span class="xl:text-xl font-semibold">37%</span>
                      faster product development cycles
                    </li>
                    <li class="">
                      <span class="xl:text-xl font-semibold">42%</span>
                      improvement in design accuracy and reliability
                    </li>
                  </ul>
                  <!-- Explore More button -->
                  <a href="https://intellivon.com/ai-strategy-call-booking-confirmation/" target="_blank">
      ...
      <a class="m-auto my-5 rounded-full bg-white flex gap-3 w-fit p-3 z-20 outline-gradient"
        ...
        <div>Know More About Our Projects</div>
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="25" viewBox="0 0 24 25" fill="none">
          <path fill-rule="evenodd" clip-rule="evenodd"
            d="M11.9999 22.1004C14.546 22.1004 16.9878 21.089 18.7881 19.2886C20.5885 17.4883 21.5999 15.0465 21.5999 12.5004C21.5999 9.95431 20.5885 7.51252 18.7881 5.71217C16.9878 3.91182 14.546 2.90039 11.9999 2.90039C9.45382 2.90039 7.01203 3.91182 5.21168 5.71217C3.41133 7.51252 2.3999 9.95431 2.3999 12.5004C2.3999 15.0465 3.41133 17.4883 5.21168 19.2886C7.01203 21.089 9.45382 22.1004 11.9999 22.1004ZM8.0999 11.6004C7.86121 11.6004 7.63229 11.6952 7.46351 11.864C7.29472 12.0328 7.1999 12.2617 7.1999 12.5004C7.1999 12.7391 7.29472 12.968 7.46351 13.1368C7.63229 13.3056 7.86121 13.4004 8.0999 13.4004H13.6079L11.0879 15.7404C10.9129 15.9027 10.8095 16.1279 10.8005 16.3665C10.7915 16.605 10.8776 16.8373 11.0399 17.0124C11.2022 17.1874 11.4274 17.2908 11.666 17.2998C11.9045 17.3088 12.1369 17.2227 12.3119 17.0604L16.5119 13.1604C16.6028 13.0761 16.6753 12.974 16.7249 12.8605C16.7744 12.7469 16.8 12.6243 16.8 12.5004C16.8 12.3765 16.7744 12.2539 16.7249 12.1403C16.6753 12.0267 16.6028 11.9246 16.5119 11.8404L12.3119 7.94039C12.2252 7.86002 12.1236 7.79751 12.0127 7.75643C11.9019 7.71534 11.7841 7.69649 11.666 7.70095C11.4274 7.70995 11.2022 7.81335 11.0399 7.98839C10.8776 8.16343 10.7915 8.39579 10.8005 8.63433C10.8095 8.87288 10.9129 9.09808 11.0879 9.26039L13.6079 11.6004H8.0999Z"
...
<section class="w-full px-5 lg:px-10 py-14 lg:py-20 bg-[#F2F7FF] relative overflow-hidden">
  <div class="container flex flex-col gap-5 items-center">
    ...
    <p class="text-[#333333] w-full lg:w-4/4 text-base font-medium pb-12">
      Intellivon’s enterprise-ready simulations accelerate design, testing, and validation with AI precision, helping manufacturers cut costs, reduce risks, and launch superior products faster with confidence.
    </p>
        ...
        <div class="swiper-wrapper">
          ...
          <div class="swiper-slide h-full">
            <div
              ...
              <p class="text-center md:text-start">
                Run thousands of AI-powered simulations to validate product designs virtually, reducing physical prototype dependency, cutting costs, and speeding up R&D cycles across global enterprise engineering teams.
              </p>
            </div>
          </div>
          ...
          <div class="swiper-slide h-full">
            <div
              ...
              <p class="text-center md:text-start">
                Simulate fatigue, wear, and real-world lifecycle conditions to detect early design flaws, ensuring product safety, reliability, and durability before entering costly large-scale manufacturing production phases.
              </p>
            </div>
          </div>
          ...
          <div class="swiper-slide h-full">
            <div
              ...
              <p class="text-center md:text-start">
                Quickly validate new product concepts with predictive AI simulations, enabling faster executive decision-making, reducing wasted R&D investment, and accelerating successful ideas into market-ready innovations.
              </p>
            </div>
          </div>
          <!-- CARD 4 -->
          <div class="swiper-slide h-full">
            <div
              ...
              <p class="text-center md:text-start">
                Simulate production processes during design stages, minimizing rework, ensuring smooth alignment with manufacturing realities, and allowing seamless transitions from innovative designs to full-scale enterprise manufacturing production.
              </p>
            </div>
          </div>
          ...
          <div class="swiper-slide h-full">
            <div
              ...
              <p class="text-center md:text-start">
                Virtually test multiple material options for cost, performance, and sustainability tradeoffs, enabling enterprises to select the best material combinations without expensive time-consuming physical trials.
              </p>
            </div>
          </div>
          ...
          <div class="swiper-slide h-full">
            <div
              ...
              <p class="text-center md:text-start">
                Model emissions, energy consumption, and recyclability of designs, empowering enterprises to create eco-friendly products that exceed global compliance standards and achieve sustainability-driven competitive advantages.
              </p>
            </div>
          </div>
          ...
          <div class="swiper-slide h-full">
            <div
              ...
              <p class="text-center md:text-start">
                AI-driven personalization enables enterprises to deliver customer-specific product variations efficiently, ensuring mass customization without cost escalation and improving customer satisfaction globally at scale.
              </p>
            </div>
          </div>
          ...
          <div class="swiper-slide h-full">
            <div
              ...
              <p class="text-center md:text-start">
                Simulation insights connect seamlessly with ERP and PLM systems, giving enterprises end-to-end control over design, production workflows, and strategic manufacturing planning.
              </p>
            </div>
          </div>
        ...
        <div class="w-full flex flex-col gap-5 items-start">
          ...
          <div class="flex flex-col gap-5 lg:gap-0 lg:flex-row justify-between">
            <h2 class="w-full lg:w-7/12 text-4xl flex-wrap gap-3 flex items-center font-bold text-black1 font-urbanist">
              Why Enterprises Trust Intellivon for 
              <span class="text-gradient">Product Design and Simulation</span>
            </h2>
            <a href="https://intellivon.com/ai-strategy-call-booking-confirmation/" target="_blank">
              <div>
                <button type="button"
          ...
          <p class="text-grey1 text-base font-medium">
            Intellivon delivers enterprise-grade AI-driven design and simulation solutions that cut costs, accelerate time-to-market, and empower manufacturers to launch innovative, reliable products faster than competitors.
          </p>
        </div>
      </div>
    </div>
    <div class="mt-16 grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-5">
      ...
      <div class="choose-card-wrapper w-full h-[212px] md:w-[409px] m-auto lg:m-0 z-10">
        <div class="choose-card shadow-[0_24px_34px_0_rgba(0,0,0,.078)]">
          ...
          <div
            ...
            <!-- SVG Icon -->
            <p class="text-sm">
              AI-driven simulations provide precise and reliable insights, minimizing design flaws, costly late-stage rework, and risks of product recalls for enterprise-scale manufacturers worldwide.
            </p>
          </div>
        </div>
      </div>
      ...
      <div class="choose-card-wrapper w-full h-[212px] md:w-[409px] m-auto lg:m-0 z-10">
        <div class="choose-card shadow-[0_24px_34px_0_rgba(0,0,0,.078)]">
          ...
          <div
            ...
            <!-- SVG Icon -->
            <p class="text-sm">
              Our platforms run thousands of simulations in hours, enabling enterprises to accelerate design cycles and eliminate bottlenecks across distributed global product development teams.
            </p>
          </div>
        </div>
      </div>
      ...
      <div class="choose-card-wrapper w-full h-[212px] md:w-[409px] m-auto lg:m-0 z-10">
        <div class="choose-card shadow-[0_24px_34px_0_rgba(0,0,0,.078)]">
          ...
          <div class="choose-card-front bg-white p-6 flex flex-col gap-8 items-center justify-center">
            <!-- SVG Icon -->
            <h3 class="text-xl font-semibold text-center">Deep Manufacturing Expertise</h3>
          </div>
          <!-- Back Side -->
          <div
            class="choose-card-back bg-white p-6 flex flex-col gap-4 items-center justify-center text-center text-gray-800">
            <!-- SVG Icon -->
            <p class="text-sm">
              Solutions tailored to enterprise manufacturing workflows and compliance requirements ensure seamless adoption and superior results across complex operations worldwide.
            </p>
          </div>
        </div>
      </div>
      ...
      <div class="choose-card-wrapper w-full h-[212px] md:w-[409px] m-auto lg:m-0 z-10">
        <div class="choose-card shadow-[0_24px_34px_0_rgba(0,0,0,.078)]">
          ...
          <div
            ...
            <!-- SVG Icon -->
            <p class="text-sm">
              Our systems integrate easily with CAD, PLM, and ERP environments, ensuring straightforward enterprise adoption with no workflow disruption during implementation stages.
            </p>
          </div>
        </div>
      </div>
      ...
      <div class="choose-card-wrapper w-full h-[212px] md:w-[409px] m-auto lg:m-0 z-10">
        <div class="choose-card shadow-[0_24px_34px_0_rgba(0,0,0,.078)]">
          ...
          <div
            ...
            <!-- SVG Icon -->
            <p class="text-sm">
              Simulation reduces prototype requirements and errors, helping enterprises save millions in R&D while simultaneously accelerating design cycles and innovation velocity.
            </p>
          </div>
        </div>
      </div>
      ...
      <div class="choose-card-wrapper w-full h-[212px] md:w-[409px] m-auto lg:m-0 z-10">
        <div class="choose-card shadow-[0_24px_34px_0_rgba(0,0,0,.078)]">
          ...
          <div
            ...
            <!-- SVG Icon -->
            <p class="text-sm">
              We prioritize innovation by equipping enterprises with predictive analytics and simulation pipelines, driving continuous product breakthroughs and faster global launches.
            </p>
          </div>
        </div>
      </div>
    ...
    <div class="flex items-end justify-between mt-6 mb-3">
      ...
      <div class="flex flex-col gap-3 w-full">
        ...
        <h2 class="text-4xl md:gap-3 items-center font-bold text-black1 font-urbanist leading-snug tracking-[0.5px]">
          How We Build Enterprise-Grade Product Design and Simulation Systems
          <span class="text-gradient"> in 3 Steps </span>
        </h2>
        <p class="text-[#333333] w-full lg:w-3/4 text-base font-medium">
          Intellivon’s process helps enterprises replace inefficient workflows with advanced AI-powered simulations that improve accuracy, efficiency, and speed across design cycles.
        </p>
      </div>
    </div>
    <!-- Consulting Cards -->
        ...
        <div class="grid grid-cols-2 gap-1 mt-4">
          <div class="p-3 bg-[#F7F7F7] h-44">
            ...
            <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
              Assess existing design workflows, inefficiencies, and dependencies carefully.
            </p>
          </div>
          <div class="p-3 bg-[#F7F7F7] h-44">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
            ...
            <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
              Analyze reliance on physical prototypes and costly testing delays.
            </p>
          </div>
          <div class="p-3 bg-[#F7F7F7] h-44">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
            ...
            <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
              Review CAD and PLM readiness across enterprise teams.
            </p>
          </div>
          <div class="p-3 bg-[#F7F7F7] h-44">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
            ...
            <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
              Define measurable KPIs aligned with enterprise innovation goals.
            </p>
          </div>
        </div>
      </div>
      ...
      <div class="card w-full lg:w-1/3 p-6 border-2 border-transparent rounded-md"
        ...
        <div class="grid grid-cols-2 gap-1 mt-4">
          <div class="p-3 bg-[#F7F7F7] h-44">
            ...
            <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
              Prototype AI-driven simulation workflows tailored for enterprise needs.
            </p>
          </div>
          <div class="p-3 bg-[#F7F7F7] h-44">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
            ...
            <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
              Validate predictive models against historic performance and outcomes.
            </p>
          </div>
          <div class="p-3 bg-[#F7F7F7] h-44">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
            ...
            <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
              Test return on investment with real-world enterprise datasets.
            </p>
          </div>
          <div class="p-3 bg-[#F7F7F7] h-44">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
            ...
            <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
              Evaluate scalability options for global cross-team deployments.
            </p>
          </div>
        </div>
      </div>
      ...
      <div class="card w-full lg:w-1/3 p-6 border-2 border-transparent rounded-md"
        ...
        <div class="grid grid-cols-2 gap-1 mt-4">
          <div class="p-3 bg-[#F7F7F7] h-44">
            ...
            <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
              Deploy AI-driven simulation solutions across global teams enterprise-wide.
            </p>
          </div>
          <div class="p-3 bg-[#F7F7F7] h-44">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
            ...
            <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
              Integrate smoothly with CAD, PLM, and ERP systems instantly.
            </p>
          </div>
          <div class="p-3 bg-[#F7F7F7] h-44">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
            ...
            <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
              Train engineers for confident adoption of simulation workflows.
            </p>
          </div>
          <div class="p-3 bg-[#F7F7F7] h-44">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
            ...
            <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
              Continuously refine predictive models for enhanced performance accuracy.
            </p>
          </div>
        </div>
      </div>
    ...
    <a href="https://intellivon.com/ai-strategy-call-booking-confirmation/" target="_blank">
      <div class="w-full flex items-center justify-center mt-4">
        <button type="button"
          ...
          <span class="relative z-10 text-blue text-nowrap"> Talk to Our AI Manufacturing Experts</span>
      ...
      <div class="flex items-end justify-between mt-6 mb-3">
        <div class="w-full flex flex-col gap-5">
          ...
          <div class="flex flex-col gap-5 lg:gap-0 lg:flex-row justify-between w-full">
            <h2
              class="w-full lg:w-11/12 text-4xl gap-3 font-bold text-black1 font-urbanist leading-snug tracking-[0.5px]">
              What Manufacturing Leaders Say About Our 
              <span class="text-gradient">Product Design and Simulation Solutions</span>
            </h2>
        ...
        <div id="testimonial-slider" class="overflow-hidden relative w-full max-w-full order-1 lg:order-2 z-20">
          <div id="testimonial-track" class="flex transition-transform duration-500 ease-in-out w-full"
            ...
            <div
              ...
              <div class="pl-6 h-fit pt-4">
                <div class="flex flex-col gap-5 font-normal text-black1 mt-5">
                  Prototyping costs were consuming our resources and slowing R&D output. Intellivon’s AI-powered simulation cut costs, streamlined processes, and transformed innovation speed dramatically.
                  <div class="text-xl font-medium font-urbanist text-black1">
                    Director of R&D, Global Automotive Manufacturer
                  </div>
                </div>
              </div>
            </div>
            ...
            <div
              ...
              <div class="pl-6 h-fit pt-4">
                <div class="flex flex-col gap-5 font-normal text-black1 mt-5">
                  In our industry, reducing time-to-market is critical. Intellivon delivered a solution that helped us design faster, validate better, and launch reliably. It’s a powerful competitive advantage.
                  <div class="text-xl font-medium font-urbanist text-black1">
                    VP of Product Development, International Electronics Enterprise
                  </div>
                </div>
              </div>
            </div>
            ...
            <div
              ...
              <div class="pl-6 h-fit pt-4">
                <div class="flex flex-col gap-5 font-normal text-black1 mt-5">
                  Our engineers now simulate thousands of design scenarios daily without building physical prototypes. It has revolutionized decision-making, improved quality, and reduced late-stage product risks dramatically.
                  <div class="text-xl font-medium font-urbanist text-black1">
                    Head of Engineering, Global Industrial Firm
                  </div>
                </div>
              </div>
            </div>
            ...
            <div
              ...
              <div class="pl-6 h-fit pt-4">
                <div class="flex flex-col gap-5 font-normal text-black1 mt-5">
                  Sustainability became achievable with Intellivon’s AI simulations. We now design eco-friendly, compliance-ready products faster, positioning ourselves ahead of industry rivals and market expectations consistently.
                  <div class="text-xl font-medium font-urbanist text-black1">
                    Chief Sustainability Officer, Multinational Consumer Goods Enterprise
                  </div>
                </div>
              </div>
            </div>
            ...
            <div
              ...
              <div class="pl-6 h-fit pt-4">
                <div class="flex flex-col gap-5 font-normal text-black1 mt-5">
                  Previously, fragmented workflows delayed production readiness. Intellivon’s integrated solution unified design and manufacturing processes seamlessly, eliminating inefficiencies and boosting enterprise-wide collaboration efficiency.
                  <div class="text-xl font-medium font-urbanist text-black1">
                    COO, Leading Global Manufacturing Enterprise
                  </div>
                </div>
              </div>
            </div>
...
<section class="w-full relative bg-[#E4EAF2] py-20 px-5 lg:px-10">
  <div class="flex flex-col gap-8 container">
    ...
    <div class="text-4xl leading-[1.25] font-semibold mt-10 lg:mt-0">
      Connect with Our 
      <span class="text-gradient">AI Manufacturing Experts</span>
      Today
    </div>
