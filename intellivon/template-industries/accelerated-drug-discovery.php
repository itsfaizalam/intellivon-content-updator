<?php /* Template Name: Accelerated Drug Discovery */ ?>
<?php get_header(); ?>
  ...
  <div class="flex">
    <div class="lg:w-full flex flex-col gap-5 px-10 justify-center py-10 lg:p-[150px] lg:text-center">
      <h1 class="font-bold text-4xl lg:text-5xl text-white">
        AI Healthcare Solutions for
        <span class="text-gradient">Precision and Speed in Drug Discovery</span>
      </h1>
      <p class="text-white text-lg font-medium">Our AI-powered solutions are transforming drug discovery by automating
        critical stages, reducing time to market, and improving accuracy to help pharmaceutical companies stay
        competitive.</p>
    ...
    <div class="w-full lg:w-2/3 lg:pl-10 px-10 lg:px-0">
      <div class="flex flex-col gap-5 items-start">
        ...
        <h2 class="text-4xl items-center font-bold text-black1 font-urbanist leading-snug tracking-[0.5px] gap-1">
          Pharma Leaders Trust Our
          <span class="text-gradient">AI-Accelerated Drug Discovery Solutions</span>
        </h2>
        <p class="mb-4 md:mb-0 text-base font-medium text-grey1 mt-2 w-full tracking-[0.25px] pr-5 mb-12">
          We collaborate with leading pharmaceutical companies to accelerate drug discovery, leveraging AI-driven
          solutions that streamline workflows and enhance testing precision for faster and more accurate results.
        </p>
      </div>
    </div>
    <!-- Right column: Image -->
      ...
      <div class="w-full flex flex-col gap-5 items-start">
        ...
        <div class="flex flex-col gap-5 lg:gap-0 lg:flex-row justify-between w-full">
          <h2
            ...
            <span class="text-gradient">AI-Accelerated Drug Discovery</span>
          </h2>
        </div>
                ...
                <div class="w-full lg:w-1/2 flex flex-col gap-5 px-5 py-4">
                  <div class="flex flex-col w-full gap-2 pb-4 border-b border-b-[#99899d]">
                    ...
                    <div class="text-[#333] leading-7 tracking-wide">
                      <p class="hidden xl:block text-md">
                        We partnered with a leading pharmaceutical company, and through our tailored retail AI
                        solutions, we helped them overcome delays and high costs in drug discovery. By utilizing
                        predictive analytics and automated molecular screening, we analyzed large datasets to identify
                        promising drug candidates rapidly. This streamlined process reduced human error, improved
                        testing accuracy, and accelerated development, ultimately lowering costs and speeding up
                        time-to-market.
                      </p>
                  ...
                  <ul class="flex flex-col gap-2 list-disc pl-5">
                    ...
                    <li class="">
                      ...
                      improvement in compound screening accuracy
                    </li>
                    <li class="">
    ...
    <div class="w-full">
      ...
      <h2 class="w-full lg:w-11/12 text-4xl gap-3 font-bold text-black1 font-urbanist leading-snug tracking-[0.5px]">
        <span class="text-gradient">
          See How AI Accelerates Drug Discovery
        </span>
      </h2>
    </div>
    <p class="text-[#333333] w-full lg:w-4/4 text-base font-medium pb-12">
      Discover how AI accelerates drug discovery, optimizing every stage from screening to analytics with real-world use
      cases.
    </p>
        ...
        <div class="swiper-wrapper">
          ...
          <div class="swiper-slide h-full">
            <div
              ...
              <p class="text-center md:text-start">
                Our AI models analyze vast scientific datasets and literature using advanced techniques like graph
                neural networks (GNNs) and natural language processing (NLP) to identify actionable biological targets
                with high precision.
              </p>
            </div>
          </div>
          ...
          <div class="swiper-slide h-full">
            <div
              ...
              <p class="text-center md:text-start">
                Using generative AI and LLMs, we design new chemical entities or biological molecules tailored to
                specific pharmacological profiles, accelerating the creation of innovative drug candidates.
              </p>
            </div>
          </div>
          ...
          <div class="swiper-slide h-full">
            <div
              ...
              <div class="flex flex-col md:flex-row gap-5 items-center">
                <!-- SVG Icon -->
                <h3 class="font-bold text-lg text-center md:text-start">
                  Lead Optimization with AI
                </h3>
              </div>
              <p class="text-center md:text-start">
                Intellivon’s AI-driven lead optimization enhances the identification of promising compounds,
                accelerating drug development while ensuring efficiency and precision at every stage.
              </p>
            </div>
          </div>
          <!-- CARD 4 -->
          <div class="swiper-slide h-full">
            <div
              ...
              <div class="flex flex-col md:flex-row gap-5 items-center">
                <!-- SVG Icon -->
                <h3 class="font-bold text-lg text-center md:text-start">
                  AI-based ADMET Property Prediction
                </h3>
              </div>
              <p class="text-center md:text-start">
                Our AI models predict ADMET properties early in the drug discovery process, helping you assess compound
                viability and streamline development timelines.
              </p>
            </div>
          </div>
          ...
          <div class="swiper-slide h-full">
            <div
              ...
              <p class="text-center md:text-start">
                Using predictive toxicology, we analyze compound safety profiles, reducing risk and speeding up
                decision-making to deliver safer drugs faster.
              </p>
            </div>
          </div>
          ...
          <div class="swiper-slide h-full">
            <div
              ...
              <p class="text-center md:text-start">
                Intellivon’s AI-driven virtual screening helps prioritize the most promising compounds, optimizing your
                pipeline and accelerating the journey from discovery to delivery.
              </p>
            </div>
          </div>
          ...
          <div class="swiper-slide h-full">
            <div
              ...
              <p class="text-center md:text-start">
                We accelerate biomarker discovery through AI, helping identify critical targets faster and improving the
                efficiency of drug development and personalized therapies.
              </p>
            </div>
          </div>
        ...
        <div class="w-full flex flex-col gap-5 items-start">
          ...
          <div class="flex flex-col gap-5 lg:gap-0 lg:flex-row justify-between">
            <h2 class="w-full lg:w-7/12 text-4xl flex-wrap gap-3 flex items-center font-bold text-black1 font-urbanist">
              ...
              <span class="text-gradient">Next-Generation Drug Discovery</span>
            </h2>
            <a href="https://intellivon.com/ai-strategy-call-booking-confirmation/" target="_blank">
              <div>
                <button type="button"
          ...
          <p class="text-grey1 text-base font-medium">
            Global pharma leaders trust our AI solutions for faster, more accurate drug discovery, with customized
            results that reduce costs and accelerate time-to-market.
          </p>
        </div>
      </div>
    </div>
    <div class="mt-16 grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-5">
      ...
      <div class="choose-card-wrapper w-full h-[212px] md:w-[409px] m-auto lg:m-0 z-10">
        <div class="choose-card shadow-[0_24px_34px_0_rgba(0,0,0,.078)]">
          ...
          <div
            ...
            <!-- SVG Icon -->
            <p class="text-sm">
              Our AI solution automates critical stages, such as molecular screening and predictive analytics,
              streamlining the discovery process and enhancing overall efficiency, allowing you to focus on
              high-priority tasks.
            </p>
          </div>
        </div>
      ...
      <div class="choose-card-wrapper w-full h-[212px] md:w-[409px] m-auto lg:m-0 z-10">
        <div class="choose-card shadow-[0_24px_34px_0_rgba(0,0,0,.078)]">
          ...
          <div class="choose-card-front bg-white p-6 flex flex-col gap-8 items-center justify-center">
            <!-- SVG Icon -->
            <h3 class="text-xl font-semibold text-center">
              Optimize Candidate Identification
            </h3>
          </div>
          <!-- Back Side -->
          <div
            ...
            <!-- SVG Icon -->
            <p class="text-sm">
              We offer bespoke AI systems designed to match your unique workflows and challenges, optimizing drug
              candidate identification and enhancing testing accuracy for your organization.
            </p>
          </div>
        </div>
      </div>
      ...
      <div class="choose-card-wrapper w-full h-[212px] md:w-[409px] m-auto lg:m-0 z-10">
        <div class="choose-card shadow-[0_24px_34px_0_rgba(0,0,0,.078)]">
          ...
          <div class="choose-card-front bg-white p-6 flex flex-col gap-8 items-center justify-center">
            <!-- SVG Icon -->
            <h3 class="text-xl font-semibold text-center">Faster Time to Market</h3>
          </div>
          <!-- Back Side -->
          <div
            class="choose-card-back bg-white p-6 flex flex-col gap-4 items-center justify-center text-center text-gray-800">
            <!-- SVG Icon -->
            <p class="text-sm">
              Our solutions drastically reduce the time it takes to bring new drugs to market, helping you stay
              competitive and meet the growing demand for innovative treatments.
            </p>
          </div>
        </div>
      </div>
      ...
      <div class="choose-card-wrapper w-full h-[212px] md:w-[409px] m-auto lg:m-0 z-10">
        <div class="choose-card shadow-[0_24px_34px_0_rgba(0,0,0,.078)]">
          ...
          <div
            ...
            <!-- SVG Icon -->
            <p class="text-sm">
              By integrating AI into the drug discovery process, we enhance testing accuracy and the precision of drug
              efficacy predictions, leading to more reliable and consistent outcomes.
            </p>
          </div>
        </div>
      </div>
      ...
      <div class="choose-card-wrapper w-full h-[212px] md:w-[409px] m-auto lg:m-0 z-10">
        <div class="choose-card shadow-[0_24px_34px_0_rgba(0,0,0,.078)]">
          ...
          <div
            ...
            <!-- SVG Icon -->
            <p class="text-sm">
              Our AI-powered solutions reduce R&D expenses by optimizing processes and minimizing costly
              trial-and-error, making drug development more cost-effective.
            </p>
          </div>
        </div>
      </div>
      ...
      <div class="choose-card-wrapper w-full h-[212px] md:w-[409px] m-auto lg:m-0 z-10">
        <div class="choose-card shadow-[0_24px_34px_0_rgba(0,0,0,.078)]">
          ...
          <div
            ...
            <!-- SVG Icon -->
            <p class="text-sm">
              With faster, more efficient, and more accurate drug discovery, our solution provides you with a
              competitive edge, enabling you to lead the race to develop the next breakthrough treatment.
            </p>
          </div>
        </div>
      </div>
    ...
    <div class="flex items-end justify-between mt-6 mb-3">
      ...
      <div class="flex flex-col gap-3 w-full">
        ...
        <h2 class="text-4xl md:gap-3 items-center font-bold text-black1 font-urbanist leading-snug tracking-[0.5px]">
          Accelerating Every Step of AI-Powered Drug Discovery
          <span class="text-gradient"> in 3 Steps </span>
        </h2>
        <p class="text-[#333333] w-full lg:w-3/4 text-base font-medium">
          We guide you through every phase, from customized Proof of Concept to post-implementation support, ensuring
          faster, more efficient drug discovery.
        </p>
      </div>
    </div>
    <!-- Consulting Cards -->
        ...
        <div class="grid grid-cols-2 gap-1 mt-4">
          <div class="p-3 bg-[#F7F7F7] h-44">
            ...
            <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
              Assess current workflows, identify pain points, and define AI objectives.
            </p>
          </div>
          <div class="p-3 bg-[#F7F7F7] h-44">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
            ...
            <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
              Conduct gap analysis for data readiness and system compatibility.
            </p>
          </div>
          <div class="p-3 bg-[#F7F7F7] h-44">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
            ...
            <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
              Evaluate potential risks, benefits, and compliance with industry regulations.
            </p>
          </div>
          <div class="p-3 bg-[#F7F7F7] h-44">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
            ...
            <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
              Define key metrics for success and AI integration outcomes.
            </p>
          </div>
        </div>
      </div>
      ...
      <div class="card w-full lg:w-1/3 p-6 border-2 border-transparent rounded-md"
        ...
        <div class="grid grid-cols-2 gap-1 mt-4">
          <div class="p-3 bg-[#F7F7F7] h-44">
            ...
            <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
              Prepare high-quality, standardized data, ensuring accuracy and consistency.
            </p>
          </div>
          <div class="p-3 bg-[#F7F7F7] h-44">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
            ...
            <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
              Utilize real-world datasets to create unbiased, representative AI models.
            </p>
          </div>
          <div class="p-3 bg-[#F7F7F7] h-44">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
            ...
            <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
              Identify impactful AI use cases aligning with drug discovery objectives.
            </p>
          </div>
          <div class="p-3 bg-[#F7F7F7] h-44">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
            ...
            <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
              Ensure ethical AI practices, focusing on transparency and fairness.
            </p>
          </div>
        </div>
      </div>
      ...
      <div class="card w-full lg:w-1/3 p-6 border-2 border-transparent rounded-md"
        ...
        <div class="grid grid-cols-2 gap-1 mt-4">
          <div class="p-3 bg-[#F7F7F7] h-44">
            ...
            <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
              Develop and implement AI solution, optimizing discovery from molecule identification.
            </p>
          </div>
          <div class="p-3 bg-[#F7F7F7] h-44">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
            ...
            <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
              Integrate AI tools seamlessly with systems for improved workflow efficiency.
            </p>
          </div>
          <div class="p-3 bg-[#F7F7F7] h-44">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
            ...
            <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
              Deliver Proof of Concept (POC) to demonstrate AI effectiveness.
            </p>
          </div>
          <div class="p-3 bg-[#F7F7F7] h-44">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
            ...
            <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
              Monitor and optimize AI performance, ensuring long-term compliance.
            </p>
          </div>
        </div>
      </div>
        ...
        <div id="testimonial-slider" class="overflow-hidden relative w-full max-w-full order-1 lg:order-2 z-20">
          <div id="testimonial-track" class="flex transition-transform duration-500 ease-in-out w-full"
            ...
            <div
              ...
              <div class="pl-6 h-fit pt-4">
                <div class="flex flex-col gap-5 font-normal text-black1 mt-5">
                  Intellivon’s AI solution revolutionized our drug discovery process. By automating key stages, we were
                  able to reduce our research timelines by 40%, enabling us to bring new treatments to market faster.
                  Their tailored approach truly made a difference for our team.
                  <div class="text-xl font-medium font-urbanist text-black1">
                    Sarah L., Director of R&D, Global Pharmaceutical Company
                  </div>
                </div>
              </div>
            </div>
            ...
            <div
              ...
              <div class="pl-6 h-fit pt-4">
                <div class="flex flex-col gap-5 font-normal text-black1 mt-5">
                  Working with Intellivon has been a game-changer. Their AI-driven platform helped us optimize our drug
                  candidate screening with remarkable accuracy, cutting down our testing costs by 25%. Their team’s
                  ongoing support ensured seamless integration with our systems.
                  <div class="text-xl font-medium font-urbanist text-black1">
                    David M., Chief Scientific Officer, Biotech Startup
                  </div>
                </div>
              </div>
            </div>
            ...
            <div
              ...
              <div class="pl-6 h-fit pt-4">
                <div class="flex flex-col gap-5 font-normal text-black1 mt-5">
                  Thanks to Intellivon’s AI solutions, we were able to identify promising drug candidates from a massive
                  dataset quickly. The platform’s ability to predict ADMET properties early on saved us months of work
                  and minimized risk. We couldn’t be more satisfied with the results.
                  <div class="text-xl font-medium font-urbanist text-black1">
                    Emily W., VP of Drug Discovery, Leading Biopharma
                  </div>
                </div>
              </div>
            </div>
            ...
            <div
              ...
              <div class="pl-6 h-fit pt-4">
                <div class="flex flex-col gap-5 font-normal text-black1 mt-5">
                  Intellivon’s tailored AI technology accelerated our drug discovery pipeline, improving both speed and
                  precision. Their team guided us through every step, from the proof of concept to full integration,
                  making the whole process smooth and effective.
                  <div class="text-xl font-medium font-urbanist text-black1">
                    James R., Head of Research Operations, Pharma Innovator
                  </div>
                </div>
              </div>
            </div>
            ...
            <div
              ...
              <div class="pl-6 h-fit pt-4">
                <div class="flex flex-col gap-5 font-normal text-black1 mt-5">
                  We chose Intellivon because of their commitment to creating a solution that meets our unique needs.
                  Their AI platform didn’t just speed up our discovery process; it also improved the accuracy of our
                  predictions, allowing us to make more informed decisions earlier in the process.
                  <div class="text-xl font-medium font-urbanist text-black1">
                    Laura T., Chief Technology Officer, Pharmaceutical Research Firm
                  </div>
                </div>
              </div>
            </div>
