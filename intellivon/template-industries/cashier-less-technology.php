<?php /* Template Name: Cashier-less Technology */ ?>
<?php get_header(); ?>
  ...
  <div class="flex">
    <div class="lg:w-1/2 flex flex-col gap-5 px-10 justify-center py-10 lg:py-0">
      <h1 class="font-bold text-4xl lg:text-5xl text-white">
        AI-Powered Cashier-less Solutions to 
        <span class="text-gradient">Revolutionize Checkouts</span>
      </h1>
      <p class="text-white text-lg font-medium">Intellivon’s enterprise-grade cashier-less solutions use AI, sensors, and computer vision to eliminate queues, automate billing, and provide frictionless shopping experiences that redefine modern retail.</p>
    ...
    <div class="w-full lg:w-2/3 lg:pl-10 px-10 lg:px-0">
      <div class="flex flex-col gap-5 items-start">
        ...
        <h2 class="text-4xl items-center font-bold text-black1 font-urbanist leading-snug tracking-[0.5px] gap-1">
          Trusted by Global Retailers for 
          <span class="text-gradient">Next-Gen Shopping Experiences</span>
        </h2>
        <p class="mb-4 md:mb-0 text-base font-medium text-grey1 mt-2 w-full tracking-[0.25px] pr-5 mb-12">
          Retail leaders rely on Intellivon’s cashier-less solutions to improve efficiency, cut costs, and create seamless, modern shopping experiences that boost customer loyalty and satisfaction.
        </p>
      </div>
    </div>
    <!-- Right column: Image -->
      ...
      <div class="w-full flex flex-col gap-5 items-start">
        ...
        <div class="flex flex-col gap-5 lg:gap-0 lg:flex-row justify-between w-full">
          <h2
            ...
            <span class="text-gradient">Cashier-less Retail AI</span>
          </h2>
        </div>
                ...
                <div class="w-full lg:w-1/2 flex flex-col gap-5 px-5 py-4">
                  <div class="flex flex-col w-full gap-2 pb-4 border-b border-b-[#99899d]">
                    <h3 class="text-xl md:text-3xl font-semibold">
                      Cashier-less Checkout for a Leading Retail Chain
                    </h3>
                    <div class="text-[#333] leading-7 tracking-wide">
                      <p class="hidden xl:block text-md">
                        A global retail chain wanted to eliminate long queues and reduce the need for extensive cashier staffing while delivering a modern, seamless shopping journey. Intellivon implemented its AI-driven cashier-less solution powered by advanced computer vision, in-store sensors, and mobile payment integration. Customers could simply grab their items and leave the store, with purchases detected automatically and payments processed instantly via mobile apps.
                      </p>
                  ...
                  <ul class="flex flex-col gap-2 list-disc pl-5">
                    <li class="">
                      ...
                      reduction in store labor costs
                    </li>
                    <li class="">
                      <span class="xl:text-xl font-semibold">60%</span>
                      faster average shopping journey for customers
                    </li>
                    <li class="">
    ...
    <div class="w-full">
      ...
      <h2 class="w-full lg:w-11/12 text-4xl gap-3 font-bold text-black1 font-urbanist leading-snug tracking-[0.5px]">         
        <span class="text-gradient">
          Cashier-less AI Driving
        </span>
        Real Value Across Retail
      </h2>
    </div>
    <p class="text-[#333333] w-full lg:w-4/4 text-base font-medium pb-12">
      Intellivon’s cashier-less solutions create value for enterprises by automating checkout, reducing operational complexity, and delivering next-gen shopping experiences.
    </p>
        ...
        <div class="swiper-wrapper">
          ...
          <div class="swiper-slide h-full">
            <div
              ...
              <p class="text-center md:text-start">
                Eliminate queues and manual scanning with AI-driven systems that automatically detect products and process payments seamlessly as customers exit the store.
              </p>
            </div>
          </div>
          ...
          <div class="swiper-slide h-full">
            <div
              ...
              <p class="text-center md:text-start">
                Deploy computer vision and advanced sensors to track items in real time, ensuring accurate billing and inventory tracking.
              </p>
            </div>
          </div>
          ...
          <div class="swiper-slide h-full">
            <div
              ...
              <p class="text-center md:text-start">
                Enable fast, secure, and convenient checkout using mobile apps and digital wallets, giving customers flexible and easy payment options.
              </p>
            </div>
          </div>
          <!-- CARD 4 -->
          <div class="swiper-slide h-full">
            <div
              ...
              <p class="text-center md:text-start">
                Reduce staffing needs at checkout counters, allowing employees to focus on customer service, store management, and improving overall shopper experience.
              </p>
            </div>
          </div>
          ...
          <div class="swiper-slide h-full">
            <div
              ...
              <p class="text-center md:text-start">
                Keep inventory levels updated in real time, ensuring stock accuracy and reducing shrinkage while improving replenishment strategies.
              </p>
            </div>
          </div>
          ...
          <div class="swiper-slide h-full">
            <div
              ...
              <p class="text-center md:text-start">
                Capture data on shopping patterns, preferences, and behavior to drive personalized offers, smarter promotions, and more effective marketing campaigns.
              </p>
            </div>
          </div>
        ...
        <div class="w-full flex flex-col gap-5 items-start">
          ...
          <div class="flex flex-col gap-5 lg:gap-0 lg:flex-row justify-between">
            <h2 class="w-full lg:w-7/12 text-4xl flex-wrap gap-3 flex items-center font-bold text-black1 font-urbanist">
              ...
              <span class="text-gradient">Intellivon’s Cashier-less Retail AI</span>
            </h2>
            <a href="https://intellivon.com/ai-strategy-call-booking-confirmation/" target="_blank">
              <div>
                <button type="button"
          ...
          <p class="text-grey1 text-base font-medium">
            Intellivon’s AI-first cashier-less solutions help enterprises create smarter, more efficient retail experiences that scale with customer demand and future industry needs.
          </p>
        </div>
      </div>
    </div>
    <div class="mt-16 grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-5">
      ...
      <div class="choose-card-wrapper w-full h-[212px] md:w-[409px] m-auto lg:m-0 z-10">
        <div class="choose-card shadow-[0_24px_34px_0_rgba(0,0,0,.078)]">
          ...
          <div
            ...
            <!-- SVG Icon -->
            <p class="text-sm">
              Leverage AI, sensors, and computer vision to deliver real-time, accurate, and seamless cashier-less checkout experiences.
            </p>
          </div>
        </div>
      </div>
      ...
      <div class="choose-card-wrapper w-full h-[212px] md:w-[409px] m-auto lg:m-0 z-10">
        <div class="choose-card shadow-[0_24px_34px_0_rgba(0,0,0,.078)]">
          ...
          <div
            ...
            <!-- SVG Icon -->
            <p class="text-sm">
              We focus on improving the shopper journey, ensuring intuitive, convenient, and frictionless retail interactions at every step.
            </p>
          </div>
        </div>
      </div>
      ...
      <div class="choose-card-wrapper w-full h-[212px] md:w-[409px] m-auto lg:m-0 z-10">
        <div class="choose-card shadow-[0_24px_34px_0_rgba(0,0,0,.078)]">
          ...
          <div class="choose-card-front bg-white p-6 flex flex-col gap-8 items-center justify-center">
            <!-- SVG Icon -->
            <h3 class="text-xl font-semibold text-center">Seamless System Integration</h3>
          </div>
          <!-- Back Side -->
          <div
            class="choose-card-back bg-white p-6 flex flex-col gap-4 items-center justify-center text-center text-gray-800">
            <!-- SVG Icon -->
            <p class="text-sm">
              Our AI integrates with POS, ERP, and inventory systems to ensure minimal disruption and maximum efficiency.
            </p>
          </div>
        </div>
      </div>
      ...
      <div class="choose-card-wrapper w-full h-[212px] md:w-[409px] m-auto lg:m-0 z-10">
        <div class="choose-card shadow-[0_24px_34px_0_rgba(0,0,0,.078)]">
          ...
          <div
            ...
            <!-- SVG Icon -->
            <p class="text-sm">
              Built to scale across multiple stores and regions, supporting growing customer bases and expansion strategies.
            </p>
          </div>
        </div>
      </div>
      ...
      <div class="choose-card-wrapper w-full h-[212px] md:w-[409px] m-auto lg:m-0 z-10">
        <div class="choose-card shadow-[0_24px_34px_0_rgba(0,0,0,.078)]">
          ...
          <div
            ...
            <!-- SVG Icon -->
            <p class="text-sm">
              Gain actionable data on shopping behavior, store traffic, and product performance with advanced AI analytics dashboards.
            </p>
          </div>
        </div>
      </div>
      ...
      <div class="choose-card-wrapper w-full h-[212px] md:w-[409px] m-auto lg:m-0 z-10">
        <div class="choose-card shadow-[0_24px_34px_0_rgba(0,0,0,.078)]">
          ...
          <div
            ...
            <!-- SVG Icon -->
            <p class="text-sm">
              We ensure your retail experience evolves with AI advancements, keeping your enterprise competitive and future-ready.
            </p>
          </div>
        </div>
      </div>
    ...
    <div class="flex items-end justify-between mt-6 mb-3">
      ...
      <div class="flex flex-col gap-3 w-full">
        ...
        <h2 class="text-4xl md:gap-3 items-center font-bold text-black1 font-urbanist leading-snug tracking-[0.5px]">
          Our Proven Process for Deploying Cashier-less Retail Solutions
          <span class="text-gradient"> in 3 Steps </span>
        </h2>
        <p class="text-[#333333] w-full lg:w-3/4 text-base font-medium">
          Intellivon ensures seamless delivery of cashier-less technology by aligning AI systems with business goals and customer experience priorities.
        </p>
      </div>
    </div>
    <!-- Consulting Cards -->
        ...
        <div class="grid grid-cols-2 gap-1 mt-4">
          <div class="p-3 bg-[#F7F7F7] h-44">
            ...
            <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
              Assess current store operations and customer journey.
            </p>
          </div>
          <div class="p-3 bg-[#F7F7F7] h-44">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
            ...
            <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
              Define goals for automation, customer satisfaction, and efficiency.
            </p>
          </div>
          <div class="p-3 bg-[#F7F7F7] h-44">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
            ...
            <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
              Identify integration points with existing POS and inventory systems.
            </p>
          </div>
          <div class="p-3 bg-[#F7F7F7] h-44">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
      ...
      <div class="card w-full lg:w-1/3 p-6 border-2 border-transparent rounded-md"
        ...
        <div class="grid grid-cols-2 gap-1 mt-4">
          <div class="p-3 bg-[#F7F7F7] h-44">
            ...
            <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
              Analyze infrastructure readiness, including sensors, cameras, and data systems.
            </p>
          </div>
          <div class="p-3 bg-[#F7F7F7] h-44">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
            ...
            <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
              Address data accuracy, privacy, and compliance needs.
            </p>
          </div>
          <div class="p-3 bg-[#F7F7F7] h-44">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
            ...
            <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
              Prototype cashier-less flows in controlled environments.
            </p>
          </div>
          <div class="p-3 bg-[#F7F7F7] h-44">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
            ...
            <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
              Simulate customer scenarios for ROI validation.
            </p>
          </div>
        </div>
      </div>
      ...
      <div class="card w-full lg:w-1/3 p-6 border-2 border-transparent rounded-md"
        ...
        <div class="grid grid-cols-2 gap-1 mt-4">
          <div class="p-3 bg-[#F7F7F7] h-44">
            ...
            <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
              Deploy AI-driven cashier-less systems across store locations.
            </p>
          </div>
          <div class="p-3 bg-[#F7F7F7] h-44">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
            ...
            <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
              Integrate seamlessly with enterprise retail operations.
            </p>
          </div>
          <div class="p-3 bg-[#F7F7F7] h-44">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
            ...
            <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
              Train store teams on managing systems and customer engagement.
            </p>
          </div>
          <div class="p-3 bg-[#F7F7F7] h-44">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
            ...
            <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
              Monitor performance and continuously optimize experiences.
            </p>
          </div>
        </div>
      </div>
        ...
        <div class="w-full flex flex-col gap-5">
          ...
          <div class="flex flex-col gap-5 lg:gap-0 lg:flex-row justify-between w-full">
            <h2
              ...
              <span class="text-gradient"> Intellivon’s Cashier-less AI</span>
            </h2>
        ...
        <div id="testimonial-slider" class="overflow-hidden relative w-full max-w-full order-1 lg:order-2 z-20">
          <div id="testimonial-track" class="flex transition-transform duration-500 ease-in-out w-full"
            ...
            <div
              ...
              <div class="pl-6 h-fit pt-4">
                <div class="flex flex-col gap-5 font-normal text-black1 mt-5">
                  Long checkout queues frustrated both customers and staff. With Intellivon’s cashier-less solution, we eliminated the bottleneck entirely. Shoppers now breeze through checkout, and our team can focus on customer engagement.
                  <div class="text-xl font-medium font-urbanist text-black1">
                    Store Operations Director, Global Retail Chain
                  </div>
                </div>
              </div>
            </div>
            ...
            <div
              ...
              <div class="pl-6 h-fit pt-4">
                <div class="flex flex-col gap-5 font-normal text-black1 mt-5">
                  Integrating cashier-less checkout into our existing infrastructure seemed daunting. Intellivon made the process smooth, and within weeks, we saw more efficient operations and happier customers.
                  <div class="text-xl font-medium font-urbanist text-black1">
                    VP of Innovation, National Grocery Retailer
                  </div>
                </div>
              </div>
            </div>
            ...
            <div
              ...
              <div class="pl-6 h-fit pt-4">
                <div class="flex flex-col gap-5 font-normal text-black1 mt-5">
                  We were seeking a modern retail experience that set us apart from competitors. Intellivon delivered with AI-driven cashier-less systems that our customers love. Retention and loyalty are stronger than ever.
                  <div class="text-xl font-medium font-urbanist text-black1">
                    Head of Customer Experience, Fashion Retail Brand
                  </div>
                </div>
              </div>
            </div>
            ...
            <div
              ...
              <div class="pl-6 h-fit pt-4">
                <div class="flex flex-col gap-5 font-normal text-black1 mt-5">
                  Our staff was burdened by repetitive checkout tasks, leaving less time for customer support. Intellivon’s technology automated checkout seamlessly and freed up staff to deliver better service.
                  <div class="text-xl font-medium font-urbanist text-black1">
                    Retail Manager, Electronics Superstore
                  </div>
                </div>
              </div>
            </div>
            ...
            <div
              ...
              <div class="pl-6 h-fit pt-4">
                <div class="flex flex-col gap-5 font-normal text-black1 mt-5">
                  Accuracy and speed were our top priorities. Intellivon’s cashier-less system handles billing flawlessly and provides data that helps us manage inventory smarter.
                  <div class="text-xl font-medium font-urbanist text-black1">
                    COO, International Convenience Store Chain
                  </div>
                </div>
              </div>
            </div>
