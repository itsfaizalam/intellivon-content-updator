<?php /* Template Name: Retail AI Solutions */ ?>
<?php get_header(); ?>
<!-- Intellivon Menubar Start -->
<!-- Intellivon Menubar End -->
<!-- Content updated by - tusha -->
  ...
  <div class="flex">
    <div class="lg:w-full flex flex-col gap-5 px-10 justify-center py-10 lg:p-[150px] lg:text-center">
      <h1 class="font-bold text-4xl lg:text-5xl text-white">
        AI-Powered Retail Solutions for Rapidly Evolving Consumer Demands 
        <span class="text-gradient"></span>
      </h1>
      <p class="text-white text-lg font-medium">Optimize retail workflows, exceed customer expectations, and boost ROI with Intellivon’s targeted AI solutions, built to scale.</p>
    ...
    <div class="w-full lg:w-2/3 lg:pl-10 px-10 lg:px-0">
      <div class="flex flex-col gap-5 items-start">
        ...
        <h2 class="text-4xl items-center font-bold text-black1 font-urbanist leading-snug tracking-[0.5px] gap-1">
          Leading Retail Enterprises That Trust Our 
          <span class="text-gradient">AI Retail Solutions</span>
        </h2>
        <p class="mb-4 md:mb-0 text-base font-medium text-grey1 mt-2 w-full tracking-[0.25px] pr-5 mb-12">
          Intellivon’s AI solutions are empowering retail enterprises to stay ahead of the curve. Our technology helps top brands streamline workflows, improve customer experiences, and achieve sustainable growth.
        </p>
      </div>
    </div>
    <!-- Right column: Image -->
...
<section class="w-full px-5 lg:px-10 bg-cover relative">
  <div class="container">
    <div class="flex flex-col items-end justify-between mt-6 mb-3 w-full">
      <div class="w-full flex flex-col gap-5 items-start">
        ...
        <div class="flex flex-col gap-5 lg:gap-0 lg:flex-row justify-between w-full">
          <h2 class="w-full lg:w-11/12 text-4xl gap-3 font-bold text-black1 font-urbanist leading-snug tracking-[0.5px]">
            See How Leading Retail Enterprises Are Transforming with Our 
            ...
            <div class="swiper-wrapper bg-[#F2F7FF]">
                ...
                <div class="w-full lg:w-1/2 flex flex-col gap-5 px-5 py-4">
                  <div class="flex flex-col w-full gap-2 pb-4 border-b border-b-[#99899d]">
                    ...
                    <div class="text-[#333] leading-7 tracking-wide">
                      <p class="hidden xl:block text-md">
                        A major retail chain was facing inefficiencies in its ordering process, with customers struggling to place orders quickly and accurately, especially during peak hours. To address this, Intellivon implemented a voice ordering system powered by natural language processing (NLP) and machine learning. The AI solution enabled customers to place orders simply by speaking, improving both order accuracy and speed. It also integrated with the store’s inventory system, allowing real-time stock updates and personalized recommendations.
                      </p>
                      <p
                  ...
                  <ul class="flex flex-col gap-2 list-disc pl-5">
                    <li class="">
                      ...
                      <span
                        > improvement in order accuracy.</span
                      >
                    </li>
                    <li class="">
                      <span class="xl:text-xl font-semibold">50%</span>
                      <span>faster ordering process.</span>
                    </li>
                    <li class="">
                      <span class="xl:text-xl font-semibold">18%</span>
                      <span
                        >increase in operational efficiency</span
                      >
                    </li>
                  </ul>
                  <!-- Explore More button -->
                  <a
                    ...
                    target="_blank"
                  >
                    <div class="flex gap-5 py-2 px-5 items-center bg-[#28103B] text-white rounded-full w-fit" role="button">
                      Explore more
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="24"
              ...
              >
                <div class="w-full lg:w-1/2 flex flex-col gap-5 px-5 py-4">
                  <div class="flex flex-col w-full gap-2 pb-4 border-b border-b-[#99899d]">
                    <h3 class="text-xl md:text-3xl font-semibold">
                      AI-Driven Retail AI Agent
                    </h3>
                    <div class="text-[#333] leading-7 tracking-wide">
                      <p class="hidden xl:block text-md">
                        A leading e-commerce retailer sought to offer 24/7 customer support without incurring the high costs associated with staffing. Intellivon deployed an AI-powered retail agent, capable of handling customer queries, providing personalized recommendations, and assisting with troubleshooting. The AI agent integrated seamlessly with the retailer's existing CRM system, allowing it to provide tailored responses based on customer data. Over time, it learned from interactions, continually improving its ability to assist customers.
                      </p>
                  ...
                  <ul class="flex flex-col gap-2 list-disc pl-5">
                    <li class="">
                      ...
                      <span> reduction in customer service costs.</span>
                    </li>
                    <li class="">
                      <span class="xl:text-xl font-semibold">35%</span>
                      <span>increase in customer engagement</span>
                    </li>
                    <li class="">
                      <span class="xl:text-xl font-semibold">25%</span>
                      <span>reduction in employee workload.</span>
                    </li>
                  </ul>
                  <!-- Explore More button -->
                  <a
              ...
              <div class="swiper-slide w-full h-[500px] shrink-0 flex flex-col lg:flex-row rounded-xl shadow-purple bg-white case-study-slide">
                <div class="w-full lg:w-1/2 flex flex-col gap-5 px-5 py-4">
                  <div class="flex flex-col w-full gap-2 pb-4 border-b border-b-[#99899d]">
                    <h3 class="text-xl md:text-3xl font-semibold">
                      AI-Enabled Virtual Try-On Technology
                    </h3>
                    <div class="text-[#333] leading-7 tracking-wide">
                      <p class="hidden xl:block text-md">
                        A global fashion retailer faced challenges in online sales due to customers being hesitant to buy clothing without trying them on. Intellivon introduced a virtual try-on solution powered by augmented reality (AR) and AI, allowing customers to visualize how products would look on their bodies in real-time. This solution enabled customers to virtually "try on" clothing through their smartphone or desktop, boosting confidence in their purchase decisions.
                      </p>
                      <p class="xl:hidden leading-0 line-clamp-5 read-more-content text-sm">
                        A global fashion retailer faced challenges in online sales due to customers being hesitant to buy clothing without trying them on. Intellivon introduced a virtual try-on solution powered by augmented reality (AR) and AI, allowing customers to visualize how products would look on their bodies in real-time. This solution enabled customers to virtually "try on" clothing through their smartphone or desktop, boosting confidence in their purchase decisions.
                      </p>
                  ...
                  <ul class="flex flex-col gap-2 list-disc pl-5">
                    <li class="">
                      <span class="xl:text-xl font-semibold">25% </span>
                      <span>increase in online conversion rates.</span>
                    </li>
                    <li class="">
                      <span class="xl:text-xl font-semibold">40%</span>
                      <span>decrease in product return rates</span>
                    </li>
                    <li class="">
                      <span class="xl:text-xl font-semibold">35% </span>
                      <span>improvement in average order value.</span>
                    </li>
                  </ul>
                  <!-- Explore More button -->
                  <a
              ...
              <div class="swiper-slide w-full h-[500px] shrink-0 flex flex-col lg:flex-row rounded-xl shadow-purple bg-white case-study-slide">
                <div class="w-full lg:w-1/2 flex flex-col gap-5 px-5 py-4">
                  <div class="flex flex-col w-full gap-2 pb-4 border-b border-b-[#99899d]">
                    <h3 class="text-xl md:text-3xl font-semibold">
                      AI-Integrated Intelligent Inventory Management System
                    </h3>
                    <div class="text-[#333] leading-7 tracking-wide">
                      <p class="hidden xl:block text-md">
                        A national grocery retailer was experiencing frequent stockouts and overstocking, resulting in lost sales and excess inventory costs. Intellivon implemented an intelligent inventory management system powered by AI and predictive analytics. The system continuously analyzed sales data, weather patterns, and consumer behavior to forecast demand and optimize stock levels. This allowed the retailer to maintain optimal inventory across all locations, reducing waste and improving the availability of popular products.
                      </p>
                      <p class="xl:hidden leading-0 line-clamp-5 read-more-content text-sm">
                        A national grocery retailer was experiencing frequent stockouts and overstocking, resulting in lost sales and excess inventory costs. Intellivon implemented an intelligent inventory management system powered by AI and predictive analytics. The system continuously analyzed sales data, weather patterns, and consumer behavior to forecast demand and optimize stock levels. This allowed the retailer to maintain optimal inventory across all locations, reducing waste and improving the availability of popular products.
                      </p>
                  ...
                  <ul class="flex flex-col gap-2 list-disc pl-5">
                    <li class="">
                      ...
                      <span>reduction in inventory holding costs.</span>
                    </li>
                    <li class="">
                    ...
                    <li class="">
                      <span class="xl:text-xl font-semibold">25% </span>
                      <span>improvement in overall supply chain efficiency.</span>
                    </li>
                  </ul>
                  <!-- Explore More button -->
                  <a
              ...
              <div class="swiper-slide w-full h-[500px] shrink-0 flex flex-col lg:flex-row rounded-xl shadow-purple bg-white case-study-slide">
                <div class="w-full lg:w-1/2 flex flex-col gap-5 px-5 py-4">
                  <div class="flex flex-col w-full gap-2 pb-4 border-b border-b-[#99899d]">
                    ...
                    <div class="text-[#333] leading-7 tracking-wide">
                      <p class="hidden xl:block text-md">
                        A leading electronics retailer experienced costly equipment breakdowns in its distribution centers, which impacted operations and delivery timelines. Intellivon implemented a predictive maintenance solution using AI and IoT sensors to monitor the health of critical equipment. The system identified potential issues before they caused failures, allowing the retailer to schedule proactive maintenance and avoid costly repairs and downtime. This resulted in more efficient operations and fewer disruptions to the supply chain.
                      </p>
                      <p class="xl:hidden leading-0 line-clamp-5 read-more-content text-sm">
                        A leading electronics retailer experienced costly equipment breakdowns in its distribution centers, which impacted operations and delivery timelines. Intellivon implemented a predictive maintenance solution using AI and IoT sensors to monitor the health of critical equipment. The system identified potential issues before they caused failures, allowing the retailer to schedule proactive maintenance and avoid costly repairs and downtime. This resulted in more efficient operations and fewer disruptions to the supply chain.
                      </p>
                  ...
                  <ul class="flex flex-col gap-2 list-disc pl-5">
                    <li class="">
                      <span class="xl:text-xl font-semibold">40%</span>
                      <span> reduction in unplanned downtime.</span>
                    </li>
                    <li class="">
                      <span class="xl:text-xl font-semibold">30%</span>
                      <span> decrease in equipment maintenance costs.</span>
                    </li>
                    <li class="">
                      <span class="xl:text-xl font-semibold">22%</span>
                      <span>increase in overall equipment lifespan.</span>
                    </li>
                  </ul>
                  <!-- Explore More button -->
                  <a
      ...
      <!-- Button -->
      <a class="m-auto my-5 rounded-full bg-white flex gap-3 w-fit p-3 z-20 outline-gradient" href="https://intellivon.com/portfolio/" target="_blank">
    ...
    <div class="w-full">
      ...
      <h2 class="w-full lg:w-11/12 text-4xl gap-3 font-bold text-black1 font-urbanist leading-snug tracking-[0.5px]">
        <span class="text-gradient">
          Discover Real-World Applications of Our AI Retail Solutions
        </span>
      </h2>


    </div>
    <p class="text-[#333333] w-full lg:w-4/4 text-base font-medium pb-12">

      Explore how Intellivon’s AI-powered solutions are being implemented in top retail businesses to enhance efficiency, optimize workflows, and exceed consumer expectations.
      ...
      <div class="swiper swiper-usecases w-full">
        <div class="swiper-wrapper">
          ...
          <div class="swiper-slide h-full">
            <div class="flex flex-col gap-5 py-5 px-3 bg-white rounded-2xl border border-[#333333] h-[450px] md:h-[320px] lg:h-[240px]">
              ...
              <p class="text-center md:text-start">
                We help retailers offer a seamless, hands-free shopping experience by enabling customers to place orders using voice commands. This reduces wait times, simplifies the shopping process, and increases customer satisfaction.
              </p>
            </div>
          </div>
          ...
          <div class="swiper-slide h-full">
            <div class="flex flex-col gap-5 py-5 px-3 bg-white rounded-2xl border border-[#333333] h-[450px] md:h-[320px] lg:h-[240px]">
              ...
              <p class="text-center md:text-start">
                We create intelligent agents that provide personalized support by offering tailored product recommendations, answering questions in real-time, and assisting customers throughout their shopping journey, creating a more engaging experience.
              </p>
            </div>
          </div>
          ...
          <div class="swiper-slide h-full">
            <div class="flex flex-col gap-5 py-5 px-3 bg-white rounded-2xl border border-[#333333] h-[450px] md:h-[320px] lg:h-[240px]">
              ...
              <p class="text-center md:text-start">
                Our dynamic pricing solution adjusts product prices in real-time based on demand and customer behavior, ensuring you stay competitive. We also offer personalized experiences that suggest products and offers, fostering stronger customer loyalty.
              </p>
            </div>
          </div>
          <!-- CARD 4 -->
          <div class="swiper-slide h-full">
            <div class="flex flex-col gap-5 py-5 px-3 bg-white rounded-2xl border border-[#333333] h-[450px] md:h-[320px] lg:h-[240px]">
              ...
              <p class="text-center md:text-start">
                We integrate visual search technology that allows customers to find products using images. This intuitive method enhances product discovery, driving higher engagement and making it easier for shoppers to find what they’re looking for.
              </p>
            </div>
          </div>
          ...
          <div class="swiper-slide h-full">
            <div class="flex flex-col gap-5 py-5 px-3 bg-white rounded-2xl border border-[#333333] h-[450px] md:h-[320px] lg:h-[240px]">
              ...
              <p class="text-center md:text-start">
                Our virtual try-on technology allows customers to visualize products on themselves before purchasing, reducing return rates. Additionally, our cashierless systems simplify the checkout process, reducing wait times and enhancing the overall shopping experience.
              </p>
            </div>
          </div>
          ...
          <div class="swiper-slide h-full">
            <div class="flex flex-col gap-5 py-5 px-3 bg-white rounded-2xl border border-[#333333] h-[450px] md:h-[320px] lg:h-[240px]">
              ...
              <p class="text-center md:text-start">
                We use predictive analytics to optimize your supply chain, improving demand forecasting and product distribution. This ensures smoother operations, better product availability, and reduces the risk of stockouts and overstocking.
              </p>
            </div>
          </div>
          ...
          <div class="swiper-slide h-full">
            <div class="flex flex-col gap-5 py-5 px-3 bg-white rounded-2xl border border-[#333333] h-[450px] md:h-[320px] lg:h-[240px]">
              ...
              <p class="text-center md:text-start">
                Our intelligent inventory management system leverages data to optimize stock levels, reduce excess inventory, and ensure that products are always available when needed. This helps minimize waste, improve operational efficiency, and increase profitability.
              </p>
            </div>
          </div>
          ...
          <div class="swiper-slide h-full">
            <div class="flex flex-col gap-5 py-5 px-3 bg-white rounded-2xl border border-[#333333] h-[450px] md:h-[320px] lg:h-[240px]">
              ...
              <p class="text-center md:text-start">
                We implement AI solutions that analyze equipment data to predict maintenance needs, preventing unexpected failures. This reduces downtime, improves operational efficiency, and ensures that equipment stays in top working condition, avoiding costly repairs and delays.
              </p>
            </div>
          </div>
        </div>
      ...
      <div class="w-full">
        <div class="w-full flex flex-col gap-5 items-start">
          ...
          <div class="flex flex-col gap-5 lg:gap-0 lg:flex-row justify-between">
            ...
            >
            See What Makes Our AI Solutions the Choice of 
              <span class="text-gradient">Leading Retail Enterprises</span>
            </h2>
            <a
              href="https://intellivon.com/ai-strategy-call-booking-confirmation/"
              target="_blank"
          ...
          <p class="text-grey1 text-base font-medium">
            Leading retailers choose our AI solutions for their ability to streamline workflows, boost efficiency, and deliver personalized shopping experiences. See how our innovative technology accelerates growth and maximizes ROI.
          </p>
        </div>
      </div>
    </div>
    <div class="mt-16 grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-5">
      ...
      <div class="choose-card-wrapper w-full h-[212px] md:w-[409px] m-auto lg:m-0 z-10">
        <div class="choose-card shadow-[0_24px_34px_0_rgba(0,0,0,.078)]">
          ...
          <div class="choose-card-back bg-white p-6 flex flex-col gap-4 items-center justify-center text-center text-gray-800">
            <!-- SVG Icon -->
            <p class="text-sm">
              Our AI solutions smoothly integrate with existing POS and e-commerce platforms, ensuring minimal disruption to your operations while enhancing functionality.
            </p>
          </div>
        </div>
      </div>
      ...
      <div class="choose-card-wrapper w-full h-[212px] md:w-[409px] m-auto lg:m-0 z-10">
        <div class="choose-card shadow-[0_24px_34px_0_rgba(0,0,0,.078)]">
          ...
          <div class="choose-card-back bg-white p-6 flex flex-col gap-4 items-center justify-center text-center text-gray-800">
            <!-- SVG Icon -->
            <p class="text-sm">
              With deep expertise in deep learning, machine learning, computer vision, and NLP, we deliver tailored AI solutions that drive innovation and efficiency across retail operations.
            </p>
          </div>
        </div>
      </div>
      ...
      <div class="choose-card-wrapper w-full h-[212px] md:w-[409px] m-auto lg:m-0 z-10">
        <div class="choose-card shadow-[0_24px_34px_0_rgba(0,0,0,.078)]">
          ...
          <div class="choose-card-front bg-white p-6 flex flex-col gap-8 items-center justify-center">
            <!-- SVG Icon -->
            <h3 class="text-xl font-semibold text-center">Rapid Implementation</h3>
          </div>
          <!-- Back Side -->
          <div class="choose-card-back bg-white p-6 flex flex-col gap-4 items-center justify-center text-center text-gray-800">
            <!-- SVG Icon -->
            <p class="text-sm">
              We deliver proof of concept within weeks, ensuring faster deployment and quicker value realization for your retail business.
            </p>
          </div>
        </div>
      </div>
      ...
      <div class="choose-card-wrapper w-full h-[212px] md:w-[409px] m-auto lg:m-0 z-10">
        <div class="choose-card shadow-[0_24px_34px_0_rgba(0,0,0,.078)]">
          ...
          <div class="choose-card-back bg-white p-6 flex flex-col gap-4 items-center justify-center text-center text-gray-800">
            <!-- SVG Icon -->
            <p class="text-sm">
              Our AI solutions prioritize security, with advanced encryption and strict data protection measures to ensure compliance and safeguard your data.
            </p>
          </div>
        </div>
      </div>
        ...
        <div class="choose-card shadow-[0_24px_34px_0_rgba(0,0,0,.078)]">
          ...
          <div class="choose-card-back bg-white p-6 flex flex-col gap-4 items-center justify-center text-center text-gray-800">
            ...
            <p class="text-sm">
              ...
              We adhere to transparent, bias-free decision-making practices, ensuring ethical use of data and fostering trust with both consumers and stakeholders.
            </p>
          </div>
        </div>
      </div>
      ...
      <div class="choose-card-wrapper w-full h-[212px] md:w-[409px] m-auto lg:m-0 z-10">
        <div class="choose-card shadow-[0_24px_34px_0_rgba(0,0,0,.078)]">
          ...
          <div class="choose-card-back bg-white p-6 flex flex-col gap-4 items-center justify-center text-center text-gray-800">
            <!-- SVG Icon -->
            <p class="text-sm">
              Our solutions process vast amounts of data in real time, empowering you with actionable insights to make informed, strategic business decisions.
            </p>
          </div>
        </div>
      </div>
...
<div class="bg-gradient-to-l from-[#E61C42] to-[#61268F] lg:py-12 py-10 relative max-w-full overflow-hidden">
  ...
  <div class="absolute top-0 left-0 max-w-[288px] max-h-[187px] overflow-hidden pointer-events-none">
    <svg xmlns="http://www.w3.org/2000/svg" width="288" height="187" viewBox="0 0 288 187" fill="none">
      <path opacity="0.6" d="M-6.00009 77.3586C14.732 155.567 96.0211 201.874 175.564 180.788C255.107 159.702 302.783 79.2084 282.051 0.999952" stroke="#9A9A9A"></path>
    </svg>
  </div>
  <div class="absolute bottom-0 left-[50%] max-w-[315px] max-h-[137px] overflow-hidden pointer-events-none">
    <svg xmlns="http://www.w3.org/2000/svg" width="315" height="137" viewBox="0 0 315 137" fill="none">
      <path opacity="0.4" d="M313.975 150.186C313.975 67.7929 243.913 1 157.487 1C71.0618 1 1 67.7929 1 150.186" stroke="#9A9A9A"></path>
    </svg>
  </div>
  <div class="absolute top-0 right-0 max-w-[300px] max-h-[190px] overflow-hidden pointer-events-none">
    <svg xmlns="http://www.w3.org/2000/svg" width="300" height="190" viewBox="0 0 300 190" fill="none">
      <path opacity="0.5" d="M5.38462 0.521899C-15.527 80.374 33.3583 162.348 114.573 183.617C195.788 204.885 278.578 157.394 299.489 77.5419" stroke="#9A9A9A"></path>
    </svg>
  </div>
</div>
...
<section class="bg-landingGen py-16 lg:py-24 bg-cover px-5 lg:px-10">
  <div class="container">
    <div class="flex items-end justify-between mt-6 mb-3">
      ...
      <div class="flex flex-col gap-3 w-full">
        ...
        <h2 class="text-4xl md:gap-3 items-center font-bold text-black1 font-urbanist leading-snug tracking-[0.5px]">
          How We Deliver Impactful 
          <span class="text-gradient"> Retail AI Solutions </span>
        </h2>
        <p class="text-[#333333] w-full lg:w-3/4 text-base font-medium">
          Our process begins with understanding your goals, followed by the design and deployment of a custom solution. But we don’t stop there. We provide continuous monitoring and optimization to ensure long-term success even after deployment. 
        </p>
      </div>
    </div>
    <!-- Consulting Cards -->
    <div id="consulting-cards" class="flex flex-col lg:flex-row justify-center bg-white mt-8">
      <!-- Step 1 -->
      <div class="card w-full lg:w-1/3 p-6 border-2 border-transparent bg-zinc-50 rounded-md" style="border-radius: 12px; background: linear-gradient(142deg, #fff 0%, #e0faff 99.14%);">
        ...
        <div class="grid grid-cols-2 gap-1 mt-4">
          <div class="p-3 bg-[#F7F7F7] h-44">
            ...
            <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
              Define objectives and align retail AI solutions with business goals.
            </p>
          </div>
          <div class="p-3 bg-[#F7F7F7] h-44">
            <svg
            ...
            <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
              Assess available data sources for relevance and quality.
            </p>
          </div>
          <div class="p-3 bg-[#F7F7F7] h-44">
            <svg
...
Ensure compliance and security standards are met from the start.
      ...
      <!-- Step 2 -->
      <div class="card w-full lg:w-1/3 p-6 border-2 border-transparent rounded-md" style="background: linear-gradient(142deg, #fff 0%, #d4d6ff 99.14%)">
        <div class="flex items-center justify-between">
          <div>
        ...
        <div class="grid grid-cols-2 gap-1 mt-4">
          <div class="p-3 bg-[#F7F7F7] h-44">
            ...
            <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
              Collect relevant data from transactions and customer interactions.
            </p>
          </div>
          <div class="p-3 bg-[#F7F7F7] h-44">
            <svg
            ...
            <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
              Integrate both structured and unstructured data for a unified view.
            </p>
          </div>
          <div class="p-3 bg-[#F7F7F7] h-44">
            <svg
            ...
            <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
              Select appropriate algorithms based on business use cases.
            </p>
          </div>
          <div class="p-3 bg-[#F7F7F7] h-44">
            <svg
...
Develop intuitive interfaces and dashboards for easy user engagement.
      ...
      <!-- Step 3 -->
      <div class="card w-full lg:w-1/3 p-6 border-2 border-transparent rounded-md" style="background: linear-gradient(142deg, #fff 0%, #ffddfb 99.14%)">
        <div class="flex items-center justify-between">
          <div>
        ...
        <div class="grid grid-cols-2 gap-1 mt-4">
          <div class="p-3 bg-[#F7F7F7] h-44">
            ...
            <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
              Deploy AI models into existing retail systems smoothly.
            </p>
          </div>
          <div class="p-3 bg-[#F7F7F7] h-44">
            <svg
            ...
            <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
              Train staff to operate and leverage AI solutions effectively.
            </p>
          </div>
          <div class="p-3 bg-[#F7F7F7] h-44">
            <svg
            ...
            <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
              Continuously monitor AI performance and track real-time metrics.
            </p>
          </div>
          <div class="p-3 bg-[#F7F7F7] h-44">
            <svg
            ...
            <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
              Iterate and improve models based on user feedback and data.
            </p>
          </div>
        </div>
      </div>
    ...
    <div class="w-full flex items-center justify-center mt-4">
      ...
      >
        <span class="relative z-10 text-blue text-nowrap"> Talk To Our AI Experts </span>
        <div
        ...
        <div id="testimonial-slider" class="overflow-hidden relative w-full max-w-full order-1 lg:order-2 z-20">
          ...
          >
            ...
            <div class="slide min-w-full shrink-0 common-whitebox2 px-6 p-5 rounded-lg flex h-fit relative w-full shadow-lg md:shadow-none">
              ...
              <div class="pl-6 h-fit pt-4">
                <div class="flex flex-col gap-5 font-normal text-black1 mt-5">
                  Intellivon’s voice ordering system has revolutionized our customer experience. The seamless integration into our POS system enabled customers to place orders quickly, reducing wait times and enhancing satisfaction. It’s been a valuable tool for boosting sales during peak hours.
                  <div class="text-xl font-medium font-urbanist text-black1">
                    John Parker, Operations Manager
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="slide min-w-full shrink-0 common-whitebox2 px-6 p-5 rounded-lg flex h-fit relative w-full shadow-lg md:shadow-none">
              ...
              <div class="pl-6 h-fit pt-4">
                <div class="flex flex-col gap-5 font-normal text-black1 mt-5">
                  Working with Intellivon’s AI retail agents has completely transformed our approach to assisting customers. Their personalized recommendations and real-time responses have enhanced our support and boosted customer loyalty. The system's smooth integration with our existing platforms was a huge plus.
                  <div class="text-xl font-medium font-urbanist text-black1">
                    Emily Thomas, Customer Experience Director
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="slide min-w-full shrink-0 common-whitebox2 px-6 p-5 rounded-lg flex h-fit relative w-full shadow-lg md:shadow-none">
              ...
              <div class="pl-6 h-fit pt-4">
                <div class="flex flex-col gap-5 font-normal text-black1 mt-5">
                  Intellivon’s dynamic pricing solution has given us a competitive edge. It adjusts prices in real-time based on demand, resulting in higher sales and optimized profits. The results speak for themselves, and our pricing strategies have never been more effective.
                  <div class="text-xl font-medium font-urbanist text-black1">
                    David Clark, Pricing Strategy Manager
            ...
            <div class="slide min-w-full shrink-0 common-whitebox2 px-6 p-5 rounded-lg flex h-fit relative w-full shadow-lg md:shadow-none">
              ...
              <div class="pl-6 h-fit pt-4">
                <div class="flex flex-col gap-5 font-normal text-black1 mt-5">
                  Intellivon’s intelligent inventory system has streamlined our stock management. By accurately forecasting demand, we have helped reduce waste and stockouts. Our operations are more efficient, and we’ve seen a significant drop in excess inventory costs since implementation
                  <div class="text-xl font-medium font-urbanist text-black1">
                    Lindsey Roberts, Supply Chain Manager
                  </div>
                </div>
              </div>
            </div>
            ...
            >
              ...
              <div class="pl-6 h-fit pt-4">
                <div class="flex flex-col gap-5 font-normal text-black1 mt-5">
                  Since implementing Intellivon’s virtual try-on technology, our online sales have increased significantly. Customers are now able to see how products will look on them before purchasing, reducing returns and boosting conversions. It’s been an invaluable addition to our e-commerce strategy.
                  <div class="text-xl font-medium font-urbanist text-black1">
                    Chris Allen, E-commerce Director
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="lg:w-1/3">
              <a href="https://intellivon.com/blog/" target="_blank">
                ...
                >
                  ...
                  <div class="absolute inset-0 bg-gradient-to-l from-[#ab00ff] via-[#7000eb] to-[#00c8eb] rounded-full p-[1px]">
                    <div class="h-full w-full bg-white rounded-full"></div>
                  </div>
                </button>
              </a>
...
<section class="w-full relative bg-[#E4EAF2] py-20 px-5 lg:px-10">
  <div class="flex flex-col gap-8 container">
    ...
    <div class="text-4xl leading-[1.25] font-semibold mt-10 lg:mt-0">
      Connect with Our
      <span class="text-gradient"> AI Retail Experts Today </span>
      Today
    </div>
  ...
  <div class="container flex flex-col gap-5 items-center">
    ...
    <div class="flex flex-col w-5/6 mt-5">
      ...
      <div class="faq-item">
        <div class="border-t border-[#7C3BAF] flex justify-between py-5 cursor-pointer">
          <div class="font-medium text-xl">
            Q1. What are Retail AI Solutions for Large Enterprises?
          </div>
          <div class="faq-icon">
            <svg
              xmlns="http://www.w3.org/2000/svg"
        ...
        <div class="faq-answer overflow-hidden max-h-0 opacity-0 transition-all duration-300 ease-in-out px-4 pb-8">
          <p class="text-base text-[#333]">
            Retail AI solutions for large enterprises automate key processes like inventory management, customer service, and pricing. They enhance operational efficiency, provide personalized customer experiences, and drive strategic decision-making through data-driven insights.
          </p>
        </div>
      </div>
      <!-- FAQ Item 2 -->
      <div class="faq-item">
        <div class="border-t border-[#7C3BAF] flex justify-between py-5 cursor-pointer">
          <div class="font-medium text-xl">
            Q2. How can AI improve the efficiency of my retail operations?
          </div>
          <div class="faq-icon">
            <svg
              xmlns="http://www.w3.org/2000/svg"
        ...
        <div class="faq-answer overflow-hidden max-h-0 opacity-0 transition-all duration-300 ease-in-out px-4 pb-8">
          <p class="text-base text-[#333]">
            AI can streamline operations by optimizing inventory, reducing waste, automating customer support, and personalizing marketing efforts. It helps large enterprises cut costs, improve accuracy, and enhance scalability across multiple locations.
          </p>
        </div>
      </div>
      <!-- FAQ Item 3 -->
      <div class="faq-item">
        <div class="border-t border-[#7C3BAF] flex justify-between py-5 cursor-pointer">
          <div class="font-medium text-xl">
            Q3. What impact does AI have on inventory management in large retail businesses?
          </div>
          <div class="faq-icon">
            <svg
              xmlns="http://www.w3.org/2000/svg"
        ...
        <div class="faq-answer overflow-hidden max-h-0 opacity-0 transition-all duration-300 ease-in-out px-4 pb-8">
          <p class="text-base text-[#333]">
            AI-driven inventory management systems predict demand, optimize stock levels, and automate replenishment processes. This minimizes stockouts, reduces overstocking, and ensures better product availability, ultimately improving operational efficiency and customer satisfaction.
          </p>
        </div>
      </div>
      <!-- FAQ Item 4 -->
      <div class="faq-item">
        <div class="border-t border-[#7C3BAF] flex justify-between py-5 cursor-pointer">
          <div class="font-medium text-xl">
            Q4. How does Dynamic Pricing AI benefit large retail enterprises?
          </div>
          <div class="faq-icon">
            <svg
              xmlns="http://www.w3.org/2000/svg"
        ...
        <div class="faq-answer overflow-hidden max-h-0 opacity-0 transition-all duration-300 ease-in-out px-4 pb-8">
          <p class="text-base text-[#333]">
            AI-powered dynamic pricing enables large retailers to adjust prices in real-time based on demand, competitor activity, and customer behavior. This leads to optimized pricing strategies, increased profitability, and the ability to respond swiftly to market changes.
          </p>
        </div>
      </div>
      <!-- FAQ Item 5 -->
      <div class="faq-item">
        <div class="border-t border-[#7C3BAF] flex justify-between py-5 cursor-pointer">
          <div class="font-medium text-xl">
            Q5. How does AI help large retail enterprises segment and target customers?
          </div>
          <div class="faq-icon">
            <svg
              xmlns="http://www.w3.org/2000/svg"
        ...
        <div class="faq-answer overflow-hidden max-h-0 opacity-0 transition-all duration-300 ease-in-out px-4 pb-8">
          <p class="text-base text-[#333]">
            AI analyzes vast amounts of customer data to create precise segments based on purchasing behavior, demographics, and preferences. This allows large retailers to target specific customer groups with tailored offers, increasing ROI on marketing spend.
          </p>
        </div>
      </div>
      ...
      <div class="faq-item">
        <div class="border-t border-[#7C3BAF] flex justify-between py-5 cursor-pointer">
          <div class="font-medium text-xl">
            Q6. Can AI solutions help reduce returns for large retail businesses?
          </div>
          <div class="faq-icon">
            <svg
              xmlns="http://www.w3.org/2000/svg"
        ...
        <div class="faq-answer overflow-hidden max-h-0 opacity-0 transition-all duration-300 ease-in-out px-4 pb-8">
          <p class="text-base text-[#333]">
            Yes, AI reduces returns by offering solutions like virtual try-ons and personalized recommendations that help customers make more confident purchase decisions. Additionally, predictive analytics can anticipate customer preferences, leading to better product fit and fewer returns.
          </p>
        </div>
      </div>
      ...
      <div class="faq-item">
        <div class="border-t border-[#7C3BAF] flex justify-between py-5 cursor-pointer">
          <div class="font-medium text-xl">
            Q7. How do AI solutions integrate with existing systems in large retail operations?
          </div>
          <div class="faq-icon">
            <svg
              xmlns="http://www.w3.org/2000/svg"
        ...
        <div class="faq-answer overflow-hidden max-h-0 opacity-0 transition-all duration-300 ease-in-out px-4 pb-8">
          <p class="text-base text-[#333]">
            AI solutions are designed to integrate seamlessly with existing POS systems, e-commerce platforms, and enterprise resource planning (ERP) systems. This ensures minimal disruption while enhancing current workflows, providing valuable insights, and automating complex tasks.
          </p>
        </div>
      </div>
      ...
      <div class="faq-item">
        <div class="border-t border-[#7C3BAF] flex justify-between py-5 cursor-pointer">
          <div class="font-medium text-xl">
            Q8. How can predictive maintenance improve operations for large retail enterprises?
          </div>
          <div class="faq-icon">
            <svg
              xmlns="http://www.w3.org/2000/svg"
        ...
        <div class="faq-answer overflow-hidden max-h-0 opacity-0 transition-all duration-300 ease-in-out px-4 pb-8">
          <p class="text-base text-[#333]">
            Predictive maintenance uses AI to monitor equipment and infrastructure in real-time, predicting when repairs are needed before breakdowns occur. This reduces unplanned downtime, prevents costly repairs, and ensures smoother operations across large retail networks.
          </p>
        </div>
      </div>
    </div>
