<?php /* Template Name: 3D Construction Modeling */ ?>
<?php get_header(); ?>
  ...
  <div class="flex">
    <div class="lg:w-full flex flex-col gap-5 px-10 justify-center py-10 lg:p-[150px] lg:text-center">
      <h1 class="font-bold text-4xl lg:text-5xl text-white">
        3D Construction Modeling For 
        <span class="text-gradient">Enterprise-Scale Building</span>
      </h1>
      <p class="text-white text-lg font-medium">Our 3D Construction Modeling ensures enterprises move beyond static blueprints into actionable, dynamic 3D models for clearer decisions, reduced errors, and improved project efficiency.</p>
    ...
    <div class="w-full lg:w-2/3 lg:pl-10 px-10 lg:px-0">
      <div class="flex flex-col gap-5 items-start">
        ...
        <h2 class="text-4xl items-center font-bold text-black1 font-urbanist leading-snug tracking-[0.5px] gap-1">
          Leading Enterprises Trust Intellivon for 
          <span class="text-gradient">3D Construction Excellence</span>
        </h2>
        <p class="mb-4 md:mb-0 text-base font-medium text-grey1 mt-2 w-full tracking-[0.25px] pr-5 mb-12">
          Our clients lead the way in innovation, relying on our AI-driven 3D models to streamline processes and reduce errors in large-scale projects.
        </p>
      </div>
    </div>
    <!-- Right column: Image -->
      ...
      <div class="w-full flex flex-col gap-5 items-start">
        ...
        <div class="flex flex-col gap-5 lg:gap-0 lg:flex-row justify-between w-full">
          <h2
            ...
            How Global Enterprises Achieved Success With Us
            <span class="text-gradient">AI-Powered 3D Construction Modeling for a Global Infrastructure Enterprise</span>
          </h2>
        </div>
                ...
                <div class="w-full lg:w-1/2 flex flex-col gap-5 px-5 py-4">
                  <div class="flex flex-col w-full gap-2 pb-4 border-b border-b-[#99899d]">
                    <h3 class="text-xl md:text-3xl font-semibold">
                      AI-Powered Accelerated Drug Discovery
                    </h3>
                    <div class="text-[#333] leading-7 tracking-wide">
                      <p class="hidden xl:block text-md">
                        Intellivon deployed its AI-powered 3D Construction Modeling solution for a global infrastructure enterprise to transform traditional project planning into intelligent, interactive modeling. By converting complex 2D blueprints into dynamic 3D environments, the enterprise was able to identify design conflicts earlier, streamline collaboration across stakeholders, and manage projects with greater precision.
                      </p>
                  ...
                  <ul class="flex flex-col gap-2 list-disc pl-5">
                    <li class="">
                      ...
                      reduction in design-related errors
                    </li>
                    <li class="">
                      <span class="xl:text-xl font-semibold">32%</span>
                      decrease in project rework costs
                    </li>
                    <li class="">
...
<section class="w-full px-5 lg:px-10 py-14 lg:py-20 bg-[#F2F7FF] relative overflow-hidden">
  <div class="container flex flex-col gap-5 items-center">
    ...
    <p class="text-[#333333] w-full lg:w-4/4 text-base font-medium pb-12">
      AI-powered modeling supports enterprises in planning, compliance, safety, and logistics, ensuring each construction project is executed seamlessly across large, complex environments.
    </p>
        ...
        <div class="swiper-wrapper">
          ...
          <div class="swiper-slide h-full">
            <div
              ...
              <p class="text-center md:text-start">
                For enterprises handling highways, railways, or metro networks, 3D Construction Modeling provides a single source of truth, reducing coordination delays and ensuring compliance across contractors.
              </p>
            </div>
          </div>
          ...
          <div class="swiper-slide h-full">
            <div
              ...
              <p class="text-center md:text-start">
                Real estate giants use 3D modeling to visualize high-rise projects, detect design conflicts early, and streamline investor, architect, and contractor approvals before ground-breaking.
              </p>
            </div>
          </div>
          ...
          <div class="swiper-slide h-full">
            <div
              ...
              <p class="text-center md:text-start">
                Complex plants and refineries demand extreme precision. Enterprises rely on 3D Construction Modeling to simulate layouts, anticipate safety hazards, and avoid costly shutdowns.
              </p>
            </div>
          </div>
          <!-- CARD 4 -->
          <div class="swiper-slide h-full">
            <div
              ...
              <p class="text-center md:text-start">
                Government and enterprise consortiums use interactive 3D models to visualize utilities, road networks, and zoning in a connected environment, reducing planning errors and political bottlenecks.
              </p>
            </div>
          </div>
          ...
          <div class="swiper-slide h-full">
            <div
              ...
              <p class="text-center md:text-start">
                Enterprises building large-scale production sites use 3D modeling for layout optimization, equipment placement, and safety compliance, ensuring facilities run at peak operational efficiency.
              </p>
            </div>
          </div>
          ...
          <div class="swiper-slide h-full">
            <div
              ...
              <p class="text-center md:text-start">
                Hospital networks and healthcare enterprises adopt 3D Construction Modeling to design patient-centered layouts, integrate medical equipment seamlessly, and avoid functional errors in construction phases.
              </p>
            </div>
          </div>
          ...
          <div class="swiper-slide h-full">
            <div
              ...
              <div class="flex flex-col md:flex-row gap-5 items-center">
                <!-- SVG Icon -->
                <h3 class="font-bold text-lg text-center md:text-start">
                  Global Retail and Commercial Complexes
                </h3>
              </div>
              <p class="text-center md:text-start">
                Retail enterprises developing malls or logistics centers leverage 3D models for visualization, phasing, and early error detection, cutting rework and speeding up tenant onboarding.
              </p>
            </div>
          </div>
          ...
          <div class="swiper-slide h-full">
            <div
              ...
              <p class="text-center md:text-start">
                Defense enterprises and aerospace manufacturers adopt 3D Construction Modeling for highly sensitive projects, ensuring accuracy, compliance, and controlled collaboration across restricted-access teams.
              </p>
            </div>
          </div>
        ...
        <div class="w-full flex flex-col gap-5 items-start">
          ...
          <div class="flex flex-col gap-5 lg:gap-0 lg:flex-row justify-between">
            <h2 class="w-full lg:w-7/12 text-4xl flex-wrap gap-3 flex items-center font-bold text-black1 font-urbanist">
              Why Enterprises Rely On Our 
              <span class="text-gradient">3D Construction Modeling</span>
            </h2>
            <a href="https://intellivon.com/ai-strategy-call-booking-confirmation/" target="_blank">
              <div>
                <button type="button"
          ...
          <p class="text-grey1 text-base font-medium">
            We offer more than just 3D visualization. We deliver proactive risk detection, AI-enabled planning, and enterprise-ready collaboration tools that drive measurable construction success.
          </p>
        </div>
      </div>
    </div>
      ...
      <div class="choose-card-wrapper w-full h-[212px] md:w-[409px] m-auto lg:m-0 z-10">
        <div class="choose-card shadow-[0_24px_34px_0_rgba(0,0,0,.078)]">
          ...
          <div
            ...
            <!-- SVG Icon -->
            <p class="text-sm">
              Spot clashes before construction starts. Eliminate costly rework and delays with early error detection across complex enterprise projects.
            </p>
          </div>
        </div>
      </div>
      ...
      <div class="choose-card-wrapper w-full h-[212px] md:w-[409px] m-auto lg:m-0 z-10">
        <div class="choose-card shadow-[0_24px_34px_0_rgba(0,0,0,.078)]">
          ...
          <div
            ...
            <!-- SVG Icon -->
            <p class="text-sm">
              Simplify complex blueprints into clear 3D visuals. Get faster buy-ins and speed up project approval cycles.
            </p>
          </div>
        </div>
      </div>
      ...
      <div class="choose-card-wrapper w-full h-[212px] md:w-[409px] m-auto lg:m-0 z-10">
        <div class="choose-card shadow-[0_24px_34px_0_rgba(0,0,0,.078)]">
          ...
          <div
            ...
            <!-- SVG Icon -->
            <p class="text-sm">
              Plug directly into your BIM and project workflows. No disruption, just stronger visualization and smarter execution.
            </p>
          </div>
        </div>
      </div>
      ...
      <div class="choose-card-wrapper w-full h-[212px] md:w-[409px] m-auto lg:m-0 z-10">
        <div class="choose-card shadow-[0_24px_34px_0_rgba(0,0,0,.078)]">
          ...
          <div
            ...
            <!-- SVG Icon -->
            <p class="text-sm">
              Built for the largest infrastructure and real estate projects. Reliable performance, no matter how complex your construction environment.
            </p>
          </div>
        </div>
      </div>
      ...
      <div class="choose-card-wrapper w-full h-[212px] md:w-[409px] m-auto lg:m-0 z-10">
        <div class="choose-card shadow-[0_24px_34px_0_rgba(0,0,0,.078)]">
          ...
          <div
            ...
            <!-- SVG Icon -->
            <p class="text-sm">
              Keep every stakeholder aligned with live updates. Reduce miscommunication and avoid bottlenecks that derail enterprise timelines.
            </p>
          </div>
        </div>
      </div>
      ...
      <div class="choose-card-wrapper w-full h-[212px] md:w-[409px] m-auto lg:m-0 z-10">
        <div class="choose-card shadow-[0_24px_34px_0_rgba(0,0,0,.078)]">
          ...
          <div
            ...
            <!-- SVG Icon -->
            <p class="text-sm">
              Stay ahead of regulations. Our models account for zoning, safety, and legal requirements from the start.
            </p>
          </div>
        </div>
      </div>
    ...
    <div class="flex items-end justify-between mt-6 mb-3">
      ...
      <div class="flex flex-col gap-3 w-full">
        ...
        <h2 class="text-4xl md:gap-3 items-center font-bold text-black1 font-urbanist leading-snug tracking-[0.5px]">
          Your Construction Project, Perfected with Our 3D Modeling Process
          <span class="text-gradient"> in 3 Steps </span>
        </h2>
        <p class="text-[#333333] w-full lg:w-3/4 text-base font-medium">
          We follow a streamlined process, converting 2D plans into intelligent 3D models, integrating AI simulations, and delivering enterprise-ready construction insights.
        </p>
      </div>
    </div>
    <!-- Consulting Cards -->
        ...
        <div class="grid grid-cols-2 gap-1 mt-4">
          <div class="p-3 bg-[#F7F7F7] h-44">
            ...
            <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
              Assess existing 2D blueprints and project plans for conversion readiness.
            </p>
          </div>
          <div class="p-3 bg-[#F7F7F7] h-44">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
            ...
            <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
              Identify common design conflicts that delay enterprise-scale projects.
            </p>
          </div>
          <div class="p-3 bg-[#F7F7F7] h-44">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
            ...
            <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
              Review BIM and project management tool compatibility.
            </p>
          </div>
          <div class="p-3 bg-[#F7F7F7] h-44">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
            ...
            <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
              Pinpoint cost-heavy inefficiencies and planning challenges.
            </p>
          </div>
        </div>
      </div>
      ...
      <div class="card w-full lg:w-1/3 p-6 border-2 border-transparent rounded-md"
        ...
        <div class="grid grid-cols-2 gap-1 mt-4">
          <div class="p-3 bg-[#F7F7F7] h-44">
            ...
            <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
              Design a tailored 3D modeling approach aligned with enterprise needs.
            </p>
          </div>
          <div class="p-3 bg-[#F7F7F7] h-44">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
            ...
            <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
              Develop a prototype to demonstrate visualization, accuracy, and conflict detection.
            </p>
          </div>
          <div class="p-3 bg-[#F7F7F7] h-44">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
            ...
            <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
              Explore integration with enterprise collaboration and compliance frameworks.
            </p>
          </div>
          <div class="p-3 bg-[#F7F7F7] h-44">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
            ...
            <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
              Validate scalability for multi-site or large infrastructure projects.
            </p>
          </div>
        </div>
      </div>
      ...
      <div class="card w-full lg:w-1/3 p-6 border-2 border-transparent rounded-md"
        ...
        <div class="grid grid-cols-2 gap-1 mt-4">
          <div class="p-3 bg-[#F7F7F7] h-44">
            ...
            <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
              Convert 2D plans into detailed, interactive 3D models.
            </p>
          </div>
          <div class="p-3 bg-[#F7F7F7] h-44">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
            ...
            <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
              Enable real-time updates and collaboration across stakeholders.
            </p>
          </div>
          <div class="p-3 bg-[#F7F7F7] h-44">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
            ...
            <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
              Integrate seamlessly with enterprise project workflows and BIM systems.
            </p>
          </div>
          <div class="p-3 bg-[#F7F7F7] h-44">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
            ...
            <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
              Continuously refine models to improve accuracy and compliance
            </p>
          </div>
        </div>
      </div>
        ...
        <div id="testimonial-slider" class="overflow-hidden relative w-full max-w-full order-1 lg:order-2 z-20">
          <div id="testimonial-track" class="flex transition-transform duration-500 ease-in-out w-full"
            ...
            <div
              ...
              <div class="pl-6 h-fit pt-4">
                <div class="flex flex-col gap-5 font-normal text-black1 mt-5">
                  The complexity of managing multi-site infrastructure projects often leads to delays and costly rework. Intellivon’s 3D Construction Modeling transformed how we plan and visualize projects. By converting our blueprints into interactive models, we gained clarity across teams, identified risks early, and secured faster stakeholder approvals. 
                  <div class="text-xl font-medium font-urbanist text-black1">
                    Director of Project Delivery, Global Infrastructure Enterprise
                  </div>
                </div>
              </div>
            </div>
            ...
            <div
              ...
              <div class="pl-6 h-fit pt-4">
                <div class="flex flex-col gap-5 font-normal text-black1 mt-5">
                  Our large-scale real estate developments demanded precision and speed. Intellivon’s AI-powered modeling gave us both. It not only highlighted design conflicts before construction but also streamlined collaboration between architects, engineers, and investors. This level of efficiency was unmatched compared to our previous workflows.
                  <div class="text-xl font-medium font-urbanist text-black1">
                    VP of Operations, Enterprise Real Estate Developer
                  </div>
                </div>
              </div>
            </div>
            ...
            <div
              ...
              <div class="pl-6 h-fit pt-4">
                <div class="flex flex-col gap-5 font-normal text-black1 mt-5">
                  As a leader in energy facility construction, we faced challenges in coordinating safety compliance, design accuracy, and execution timelines. Intellivon’s modeling solution helped us simulate layouts, foresee hazards, and align multiple teams in real time. It fundamentally changed how we deliver complex projects.
                  <div class="text-xl font-medium font-urbanist text-black1">
                    Head of Engineering, Global Energy Provider
                  </div>
                </div>
              </div>
            </div>
            ...
            <div
              ...
              <div class="pl-6 h-fit pt-4">
                <div class="flex flex-col gap-5 font-normal text-black1 mt-5">
                  Urban development projects come with enormous political and stakeholder pressure. Intellivon’s 3D Construction Modeling gave us a powerful tool to communicate designs clearly and eliminate misunderstandings. It accelerated approvals and gave decision-makers the confidence to move forward without delays.
                  <div class="text-xl font-medium font-urbanist text-black1">
                    Chief Planning Officer, Smart City Consortium
                  </div>
                </div>
              </div>
            </div>
            ...
            <div
              ...
              <div class="pl-6 h-fit pt-4">
                <div class="flex flex-col gap-5 font-normal text-black1 mt-5">
                  Manufacturing facilities require absolute precision in layout and compliance. Intellivon’s 3D models ensured we avoided costly errors, optimized space for equipment, and stayed on schedule. The difference it made in reducing rework and aligning all contractors was remarkable.
                  <div class="text-xl font-medium font-urbanist text-black1">
                    Global Projects Director, Enterprise Manufacturing Firm
                  </div>
                </div>
              </div>
            </div>
