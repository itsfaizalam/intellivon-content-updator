<?php /* Template Name: Travel AI Agents  */ ?>
<?php get_header(); ?>
  ...
  <div class="flex">
    ...
    >
      <h1 class="font-bold text-4xl lg:text-5xl text-white">
        Enterprise-Grade AI Agents That Transform 
        <span class="text-gradient">Global Travel Experiences </span>
      </h1>
      <p class="text-white text-lg font-medium">
        Intellivon’s AI-powered travel agents provide real-time, personalized, multilingual support across channels, empowering travel enterprises to streamline operations, elevate customer experiences, and drive loyalty at scale.
      </p>
      <a
  ...
  <div class="flex flex-wrap items-center">
    ...
    <div class="w-full lg:w-2/3 lg:pl-10 px-10 lg:px-0">
      <div class="flex flex-col gap-5 items-start">
        ...
        >
        Trusted by Global Travel and Hospitality Leaders
        ...
        >
        Leading airlines, hotels, and booking platforms partner with Intellivon to integrate AI agents that redefine support, improve efficiency, and create seamless traveler journeys worldwide.
        </p>
      </div>
    </div>
    <!-- Right column: Image -->
    ...
    <div class="flex flex-col items-end justify-between mt-6 mb-3 w-full">
      <div class="w-full flex flex-col gap-5 items-start">
        ...
        >
          ...
          >
          Powering Customer Loyalty with Travel AI Agents
            <span class="text-gradient"></span>
          </h2>
        </div>
                ...
                <div class="w-full lg:w-1/2 flex flex-col gap-5 px-5 py-4">
                  ...
                  >
                    <h3 class="text-xl md:text-3xl font-semibold">
                        AI Agent Integration for a Global Airline Alliance
                    </h3>
                    <div class="text-[#333] leading-7 tracking-wide">
                      <p class="hidden xl:block text-md">
                        A leading global airline alliance struggled to keep pace with customer inquiries spanning multiple regions, time zones, and languages. Intellivon deployed multilingual AI agents across chat, voice, and mobile apps. These agents handled real-time flight updates, booking changes, and personalized travel recommendations. By automating high-volume requests and delivering empathetic, context-aware support, the airline alliance significantly improved responsiveness and customer satisfaction. Human agents were freed to manage complex cases requiring critical judgment. 
                      </p>
                      <p
                  ...
                  <ul class="flex flex-col gap-2 list-disc pl-5">
                    ...
                    <li class="">
                      ...
                      increase in traveler satisfaction scores
                    </li>
                  </ul>
                  <!-- Explore More button -->
                  <a
    ...
    <div class="w-full">
      ...
      >
        <span class="text-gradient">
            Enterprise-Grade AI Agents Redefining Travel Experiences
        </span>
      </h2>
    </div>
    <p class="text-[#333333] w-full lg:w-4/4 text-base font-medium pb-12">
        Intellivon’s AI agents support travel enterprises across every stage of the journey, enhancing customer experience, operational agility, and brand loyalty.
    </p>
        ...
        <div class="swiper-wrapper">
          ...
          <div class="swiper-slide h-full">
            ...
            >
              ...
              <p class="text-center md:text-start">
                AI agents provide multilingual support across voice, chat, and apps, ensuring global travelers receive real-time assistance regardless of language, geography, or cultural nuances.
              </p>
            </div>
          </div>
          ...
          <div class="swiper-slide h-full">
            ...
            >
              ...
              <p class="text-center md:text-start">
                Agents help travelers book, modify, or cancel reservations instantly, seamlessly integrating with backend travel systems to reduce errors and optimize booking workflows.
              </p>
            </div>
          </div>
          ...
          <div class="swiper-slide h-full">
            ...
            >
              ...
              <p class="text-center md:text-start">
                AI agents proactively inform travelers of delays, cancellations, or reschedules, offering alternative options and minimizing stress during unexpected disruptions.
              </p>
            </div>
          </div>
          <!-- CARD 4 -->
          <div class="swiper-slide h-full">
            ...
            >
              ...
              <p class="text-center md:text-start">
                AI analyzes traveler preferences, historical data, and patterns to deliver personalized itineraries, upgrades, and offers that increase loyalty and revenue opportunities.
              </p>
            </div>
          </div>
          ...
          <div class="swiper-slide h-full">
            ...
            >
              ...
              <p class="text-center md:text-start">
                Agents help travelers manage reward balances, redemption, and upgrades, strengthening retention while encouraging repeat bookings across multiple platforms.
              </p>
            </div>
          </div>
          ...
          <div class="swiper-slide h-full">
            ...
            >
              ...
              <p class="text-center md:text-start">
                AI agents gather post-trip sentiment, provide personalized offers, and generate insights to drive continuous service improvement and repeat travel bookings.
              </p>
            </div>
          </div>
          ...
          <div class="swiper-slide h-full">
            ...
            >
              <div class="flex flex-col md:flex-row gap-5 items-center">
                <!-- SVG Icon -->
                <h3 class="font-bold text-lg text-center md:text-start">
                    Ancillary Service Upselling
                </h3>
              </div>
              <p class="text-center md:text-start">
                Agents recommend upgrades like premium seating, add-on experiences, and travel insurance, increasing ancillary revenue while enhancing traveler satisfaction.
              </p>
            </div>
          </div>
          <!-- CARD 8-->
          <div class="swiper-slide h-full">
            ...
            >
              <div class="flex flex-col md:flex-row gap-5 items-center">
                <!-- SVG Icon -->
                <h3 class="font-bold text-lg text-center md:text-start">
                    Customer Support Performance Optimization
                </h3>
              </div>
              <p class="text-center md:text-start">
                Insights from AI-driven conversations help enterprises identify service gaps, optimize staffing, and improve overall traveler support experiences globally.
              </p>
            </div>
          </div>
        </div>
      ...
      <div class="w-full">
        <div class="w-full flex flex-col gap-5 items-start">
          ...
          <p class="text-grey1 text-base font-medium">
            Intellivon empowers enterprises with AI agents designed for scalability, empathy, and precision, enhancing operations, reducing costs, and transforming traveler interactions into business growth opportunities worldwide.
          </p>
        </div>
      </div>
    </div>
    <div class="mt-16 grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-5">
      ...
      >
        <div class="choose-card shadow-[0_24px_34px_0_rgba(0,0,0,.078)]">
          ...
          >
            <!-- SVG Icon -->
            <p class="text-sm">
                AI agents connect seamlessly across apps, social, and chat, delivering consistent, personalized service experiences across every customer-facing platform in real time.
            </p>
          </div>
        </div>
      </div>
      ...
      >
        <div class="choose-card shadow-[0_24px_34px_0_rgba(0,0,0,.078)]">
          ...
          >
            <!-- SVG Icon -->
            <h3 class="text-xl font-semibold text-center">Human-Centric Design</h3>
          </div>
          <!-- Back Side -->
          <div
            class="choose-card-back bg-white p-6 flex flex-col gap-4 items-center justify-center text-center text-gray-800"
          >
            <!-- SVG Icon -->
            <p class="text-sm">
                Our AI interprets sentiment and intent, delivering support that feels empathetic, relevant, and tailored, creating stronger loyalty and lasting customer trust.
            </p>
          </div>
        </div>
      </div>
      ...
      >
        <div class="choose-card shadow-[0_24px_34px_0_rgba(0,0,0,.078)]">
          ...
          >
            <!-- SVG Icon -->
            <p class="text-sm">
                Built for global scale, Intellivon’s AI agents adapt to multi-language, multi-region deployments, ensuring consistent quality in highly complex enterprise environments.
            </p>
          </div>
        </div>
      </div>
      ...
      >
        <div class="choose-card shadow-[0_24px_34px_0_rgba(0,0,0,.078)]">
          ...
          >
            <!-- SVG Icon -->
            <p class="text-sm">
                Solutions are tailored to the workflows of airlines, hotels, and aggregators, ensuring travel-specific accuracy in every AI-driven customer interaction.
            </p>
          </div>
        </div>
      </div>
      ...
      >
        <div class="choose-card shadow-[0_24px_34px_0_rgba(0,0,0,.078)]">
          ...
          >
            <!-- SVG Icon -->
            <p class="text-sm">
                Our systems create tangible ROI by improving loyalty, reducing operational costs, and enhancing global traveler experiences across millions of touchpoints.
            </p>
          </div>
        </div>
      </div>
      ...
      >
        <div class="choose-card shadow-[0_24px_34px_0_rgba(0,0,0,.078)]">
          ...
          >
            <!-- SVG Icon -->
            <p class="text-sm">
                We continuously evolve AI models, ensuring enterprises remain competitive by anticipating traveler expectations and market dynamics effectively.
            </p>
          </div>
        </div>
      </div>
  ...
  <div class="container">
    <div class="flex items-end justify-between mt-6 mb-3">
      ...
      <div class="flex flex-col gap-3 w-full">
        ...
        >
        Our Proven Process for Deploying AI Agents in 
          <span class="text-gradient">Travel</span>
        </h2>
        <p class="text-[#333333] w-full lg:w-3/4 text-base font-medium">
            We design, test, and implement AI agents that align with enterprise travel goals, ensuring seamless integration and measurable results.
        </p>
      </div>
    </div>
    <!-- Consulting Cards -->
        ...
        <div class="grid grid-cols-2 gap-1 mt-4">
          <div class="p-3 bg-[#F7F7F7] h-44">
            ...
            <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
                Assess traveler pain points and service gaps.
            </p>
          </div>
          <div class="p-3 bg-[#F7F7F7] h-44">
            <svg
            ...
            <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
                Review enterprise readiness for AI adoption.
            </p>
          </div>
          <div class="p-3 bg-[#F7F7F7] h-44">
            <svg
            ...
            <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
                Define goals and KPIs for support efficiency.
            </p>
          </div>
          <div class="p-3 bg-[#F7F7F7] h-44">
            <svg
            ...
            <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
                Identify multilingual and multi-channel requirements.
            </p>
          </div>
        </div>
      </div>
      ...
      >
        ...
        <div class="grid grid-cols-2 gap-1 mt-4">
          <div class="p-3 bg-[#F7F7F7] h-44">
            ...
            <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
                Design tailored AI agent workflows for travel scenarios.
            </p>
          </div>
          <div class="p-3 bg-[#F7F7F7] h-44">
            <svg
            ...
            <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
                Prototype multilingual conversational flows for accuracy.
            </p>
          </div>
          <div class="p-3 bg-[#F7F7F7] h-44">
            <svg
            ...
            <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
                Test integrations with booking and CRM systems.
            </p>
          </div>
          <div class="p-3 bg-[#F7F7F7] h-44">
            <svg
            ...
            <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
                Validate business impact with pilot deployments.
            </p>
          </div>
        </div>
      </div>
...
Deploy AI agents across selected channels.
          ...
          <div class="p-3 bg-[#F7F7F7] h-44">
            ...
            <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
                Train enterprise teams for adoption.
            </p>
          </div>
          <div class="p-3 bg-[#F7F7F7] h-44">
            <svg
            ...
            <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
                Integrate with travel platforms and backend systems.
            </p>
          </div>
          <div class="p-3 bg-[#F7F7F7] h-44">
            <svg
      ...
      <div class="flex items-end justify-between mt-6 mb-3">
        <div class="w-full flex flex-col gap-5">
          ...
          >
            ...
            >
              <span class="text-gradient"
                >What Travel Leaders Say About Our AI Agents</span
              >
            </h2>
        ...
        >
          ...
          >
            ...
            >
              ...
              <div class="pl-6 h-fit pt-4">
                <div class="flex flex-col gap-5 font-normal text-black1 mt-5">
                    Our customer service operations were collapsing under inquiry surges during seasonal peaks. Intellivon’s AI agents absorbed high-volume requests, freeing staff for critical situations while improving traveler experience.
                  <div class="text-xl font-medium font-urbanist text-black1">
                    VP of Customer Experience, Global Airline
            ...
            >
              ...
              <div class="pl-6 h-fit pt-4">
                <div class="flex flex-col gap-5 font-normal text-black1 mt-5">
                    Language diversity across markets made support challenging. Intellivon’s multilingual agents gave us consistent global coverage, improving trust and loyalty among international customers instantly.
                  <div class="text-xl font-medium font-urbanist text-black1">
                    Director of Digital Operations, International Hotel Chain
            ...
            >
              ...
              <div class="pl-6 h-fit pt-4">
                <div class="flex flex-col gap-5 font-normal text-black1 mt-5">
                    With Intellivon’s AI, booking modifications and cancellations became seamless. Our customer support satisfaction rose sharply, and productivity among our internal teams improved significantly. 

                  <div class="text-xl font-medium font-urbanist text-black1">
                    COO, Travel Aggregator Platform
            ...
            >
              ...
              <div class="pl-6 h-fit pt-4">
                <div class="flex flex-col gap-5 font-normal text-black1 mt-5">
                    Flight delays often cause chaos in communication. Intellivon’s proactive agents reduced panic by delivering updates instantly, helping us manage our reputation better.
                  <div class="text-xl font-medium font-urbanist text-black1">
                    Chief Operations Officer, Airline Alliance
            ...
            >
              ...
              <div class="pl-6 h-fit pt-4">
                <div class="flex flex-col gap-5 font-normal text-black1 mt-5">
                    Personalized upselling has become effortless. Our AI agents suggest upgrades and travel add-ons tailored to each traveler, driving ancillary revenue growth steadily.
                  <div class="text-xl font-medium font-urbanist text-black1">
                    VP of Commercial Strategy, Luxury Travel Group
