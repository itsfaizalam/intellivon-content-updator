<?php /* Template Name: Document & Plan Digitization */ ?>
<?php get_header(); ?>
  ...
  <div class="flex">
    <div class="lg:w-full flex flex-col gap-5 px-10 justify-center py-10 lg:p-[150px] lg:text-center">
      <h1 class="font-bold text-4xl lg:text-5xl text-white">
        Document and Plan Digitization for 
        <span class="text-gradient">Enterprise-Grade Construction Efficiency</span>
      </h1>
      <p class="text-white text-lg font-medium">Our AI-powered solutions are transforming drug discovery by automating
        Our document and plan digitization systems transform enterprise construction by turning paper-heavy processes into AI-powered digital systems, enhancing speed, compliance, and operational accuracy every step.</p>
    ...
    <div class="w-full lg:w-2/3 lg:pl-10 px-10 lg:px-0">
      <div class="flex flex-col gap-5 items-start">
        ...
        <h2 class="text-4xl items-center font-bold text-black1 font-urbanist leading-snug tracking-[0.5px] gap-1">
          Trusted by Construction Leaders Who 
          <span class="text-gradient">Demand Precision</span>
        </h2>
        <p class="mb-4 md:mb-0 text-base font-medium text-grey1 mt-2 w-full tracking-[0.25px] pr-5 mb-12">
          We empower leading enterprises to replace paperwork inefficiencies with automated AI-driven document workflows, setting new standards for construction excellence.
        </p>
      </div>
    </div>
    <!-- Right column: Image -->
      ...
      <div class="w-full flex flex-col gap-5 items-start">
        ...
        <div class="flex flex-col gap-5 lg:gap-0 lg:flex-row justify-between w-full">
          <h2
            ...
            Real Results From 
            <span class="text-gradient">Large-Scale Construction Document Digitization</span>
          </h2>
        </div>
                ...
                <div class="w-full lg:w-1/2 flex flex-col gap-5 px-5 py-4">
                  <div class="flex flex-col w-full gap-2 pb-4 border-b border-b-[#99899d]">
                    <h3 class="text-xl md:text-3xl font-semibold">
                      AI-Powered Document and Plan Digitization for a Global Construction Enterprise
                    </h3>
                    <div class="text-[#333] leading-7 tracking-wide">
                      <p class="hidden xl:block text-md">
                        Intellivon partnered with a leading global construction enterprise to digitize and automate the management of project documents, contracts, and permits across multiple large-scale infrastructure projects. By deploying our AI-powered document and plan digitization solution, the enterprise was able to eliminate paper-heavy workflows, streamline collaboration between distributed teams, and ensure compliance with stringent regulatory requirements.
                      </p>
                  ...
                  <ul class="flex flex-col gap-2 list-disc pl-5">
                    <li class="">
                      ...
                      faster project documentation workflows
                    </li>
                    <li class="">
                    ...
                    <li class="">
                      ...
                      lower documentation management operational costs
                    </li>
                  </ul>
                  <!-- Explore More button -->
                  <a href="https://intellivon.com/ai-strategy-call-booking-confirmation/" target="_blank">
    ...
    <div class="w-full">
      ...
      <h2 class="w-full lg:w-11/12 text-4xl gap-3 font-bold text-black1 font-urbanist leading-snug tracking-[0.5px]">
        <span class="text-gradient">
          Real-World Applications Across Construction Enterprises
        </span>
      </h2>
    </div>
    <p class="text-[#333333] w-full lg:w-4/4 text-base font-medium pb-12">
      Document and Plan Digitization accelerates workflows across contracts, permits, and reports, ensuring accuracy, compliance, and efficiency in every construction stage.
    </p>
        ...
        <div class="swiper-wrapper">
          ...
          <div class="swiper-slide h-full">
            <div
              ...
              <p class="text-center md:text-start">
                Managing thousands of engineering drawings, contracts, and permits for billion-dollar infrastructure projects becomes seamless when all documentation is digitized, searchable, and instantly accessible to global project teams.
              </p>
            </div>
          </div>
          ...
          <div class="swiper-slide h-full">
            <div
              ...
              <p class="text-center md:text-start">
                Enterprises working in highly regulated regions can avoid penalties and delays by digitizing permits, environmental approvals, and inspection reports, ensuring compliance is tracked, auditable, and always up to date.
              </p>
            </div>
          </div>
          ...
          <div class="swiper-slide h-full">
            <div
              ...
              <div class="flex flex-col md:flex-row gap-5 items-center">
                <!-- SVG Icon -->
                <h3 class="font-bold text-lg text-center md:text-start">
                  Mergers and Acquisitions in Real Estate
                </h3>
              </div>
              <p class="text-center md:text-start">
                During acquisitions or joint ventures, digitized project documents and contracts provide a single source of truth, reducing due diligence timelines and preventing costly misinterpretations.
              </p>
            </div>
          </div>
          <!-- CARD 4 -->
          <div class="swiper-slide h-full">
            <div
              ...
              <p class="text-center md:text-start">
                Enterprises can quickly access and validate historical contracts, permits, and correspondence, reducing legal disputes and accelerating resolution in multi-million-dollar claims.
              </p>
            </div>
          </div>
          ...
          <div class="swiper-slide h-full">
            <div
              ...
              <p class="text-center md:text-start">
                Global enterprises working across multiple countries can digitize documents in different formats and languages, ensuring consistency and accessibility for distributed project managers, regulators, and contractors.
              </p>
            </div>
          </div>
          ...
          <div class="swiper-slide h-full">
            <div
              ...
              <p class="text-center md:text-start">
                By digitizing safety manuals, inspection logs, and compliance reports, enterprises reduce the risk of project shutdowns caused by missing or misfiled documentation.
              </p>
            </div>
          </div>
          ...
          <div class="swiper-slide h-full">
            <div
              ...
              <p class="text-center md:text-start">
                Digitized project data can be integrated with ERP and project management platforms, allowing leaders to make faster, data-driven resource allocation and budgeting decisions.
              </p>
            </div>
          </div>
          ...
          <div class="swiper-slide h-full">
            <div
              ...
              <p class="text-center md:text-start">
                For enterprises managing projects with lifecycles spanning decades, digitization ensures contracts, reports, and blueprints remain secure, accessible, and usable long after paper records deteriorate.
              </p>
            </div>
          </div>
        ...
        <div class="w-full flex flex-col gap-5 items-start">
          ...
          <div class="flex flex-col gap-5 lg:gap-0 lg:flex-row justify-between">
            <h2 class="w-full lg:w-7/12 text-4xl flex-wrap gap-3 flex items-center font-bold text-black1 font-urbanist">
              ...
              <span class="text-gradient">Document and Plan Digitization</span>
            </h2>
            <a href="https://intellivon.com/ai-strategy-call-booking-confirmation/" target="_blank">
              <div>
                <button type="button"
          ...
          <p class="text-grey1 text-base font-medium">
            We go beyond digitization, delivering AI-powered accuracy, compliance, and real-time collaboration that competitors simply don’t prioritize at enterprise scale.
          </p>
        </div>
      </div>
    </div>
    <div class="mt-16 grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-5">
      ...
      <div class="choose-card-wrapper w-full h-[212px] md:w-[409px] m-auto lg:m-0 z-10">
        <div class="choose-card shadow-[0_24px_34px_0_rgba(0,0,0,.078)]">
          ...
          <div
            ...
            <!-- SVG Icon -->
            <p class="text-sm">
              Never miss regulatory deadlines. Our system digitizes and tracks permits, safety documents, and approvals, giving you audit-ready records without manual chasing.
            </p>
          </div>
        </div>
      </div>
      ...
      <div class="choose-card-wrapper w-full h-[212px] md:w-[409px] m-auto lg:m-0 z-10">
        <div class="choose-card shadow-[0_24px_34px_0_rgba(0,0,0,.078)]">
          ...
          <div
            ...
            <!-- SVG Icon -->
            <p class="text-sm">
              Cut critical mistakes out of construction workflows by automating document capture and categorization, ensuring contracts, plans, and approvals are always accurate and consistent.
            </p>
          </div>
        </div>
      </div>
      ...
      <div class="choose-card-wrapper w-full h-[212px] md:w-[409px] m-auto lg:m-0 z-10">
        <div class="choose-card shadow-[0_24px_34px_0_rgba(0,0,0,.078)]">
          ...
          <div class="choose-card-front bg-white p-6 flex flex-col gap-8 items-center justify-center">
            <!-- SVG Icon -->
            <h3 class="text-xl font-semibold text-center">Built for Scale</h3>
          </div>
          <!-- Back Side -->
          <div
            class="choose-card-back bg-white p-6 flex flex-col gap-4 items-center justify-center text-center text-gray-800">
            <!-- SVG Icon -->
            <p class="text-sm">
              Whether managing one megaproject or hundreds across regions, our solution handles vast document volumes without slowing down collaboration or compliance.
            </p>
          </div>
        </div>
      </div>
      ...
      <div class="choose-card-wrapper w-full h-[212px] md:w-[409px] m-auto lg:m-0 z-10">
        <div class="choose-card shadow-[0_24px_34px_0_rgba(0,0,0,.078)]">
          ...
          <div
            ...
            <!-- SVG Icon -->
            <p class="text-sm">
              We plug directly into your project management and ERP tools, so digitization works within existing workflows instead of creating new silos.
            </p>
          </div>
        </div>
      </div>
      ...
      <div class="choose-card-wrapper w-full h-[212px] md:w-[409px] m-auto lg:m-0 z-10">
        <div class="choose-card shadow-[0_24px_34px_0_rgba(0,0,0,.078)]">
          ...
          <div
            ...
            <!-- SVG Icon -->
            <p class="text-sm">
              Resolve claims and conflicts quickly with digitized, searchable records. No more digging through paperwork when millions are on the line.
            </p>
          </div>
        </div>
      </div>
      ...
      <div class="choose-card-wrapper w-full h-[212px] md:w-[409px] m-auto lg:m-0 z-10">
        <div class="choose-card shadow-[0_24px_34px_0_rgba(0,0,0,.078)]">
          ...
          <div
            ...
            <!-- SVG Icon -->
            <p class="text-sm">
              Keep decades of project documents secure, accessible, and usable for long-term compliance, maintenance, and expansions, long after paper records fail.
            </p>
          </div>
        </div>
      </div>
    ...
    <div class="flex items-end justify-between mt-6 mb-3">
      ...
      <div class="flex flex-col gap-3 w-full">
        ...
        <h2 class="text-4xl md:gap-3 items-center font-bold text-black1 font-urbanist leading-snug tracking-[0.5px]">
          How We Transform Paper Into Enterprise-Grade Digital Workflows
          <span class="text-gradient"> in 3 Steps </span>
        </h2>
        <p class="text-[#333333] w-full lg:w-3/4 text-base font-medium">
          Our proven process converts manual paperwork into enterprise-ready digital systems, aligning construction operations with speed, compliance, and efficiency.
        </p>
      </div>
    </div>
    <!-- Consulting Cards -->
        ...
        <div class="grid grid-cols-2 gap-1 mt-4">
          <div class="p-3 bg-[#F7F7F7] h-44">
            ...
            <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
              Assess current documentation and plan management workflows.
            </p>
          </div>
          <div class="p-3 bg-[#F7F7F7] h-44">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
            ...
            <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
              Identify inefficiencies in manual and disconnected processes.
            </p>
          </div>
          <div class="p-3 bg-[#F7F7F7] h-44">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
            ...
            <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
              Analyze data readiness for enterprise-wide digitization.
            </p>
          </div>
          <div class="p-3 bg-[#F7F7F7] h-44">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
            ...
            <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
              Review integration with project management and ERP systems.
            </p>
          </div>
          <div class="p-3 bg-[#F7F7F7] h-44">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
            ...
            <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
              Pinpoint compliance gaps and documentation risks.
            </p>
          </div>
        </div>
      </div>
      ...
      <div class="card w-full lg:w-1/3 p-6 border-2 border-transparent rounded-md"
        ...
        <div class="grid grid-cols-2 gap-1 mt-4">
          <div class="p-3 bg-[#F7F7F7] h-44">
            ...
            <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
              Design a tailored digitization framework for enterprise needs.
            </p>
          </div>
          <div class="p-3 bg-[#F7F7F7] h-44">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
            ...
            <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
              Build a prototype to demonstrate efficiency improvements.
            </p>
          </div>
          <div class="p-3 bg-[#F7F7F7] h-44">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
            ...
            <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
              Explore scalability for multi-project and multi-region operations.
            </p>
          </div>
          <div class="p-3 bg-[#F7F7F7] h-44">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
            ...
            <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
              Ensure compliance with regulatory and governance standards.
            </p>
          </div>
        </div>
      </div>
      ...
      <div class="card w-full lg:w-1/3 p-6 border-2 border-transparent rounded-md"
        ...
        <div class="grid grid-cols-2 gap-1 mt-4">
          <div class="p-3 bg-[#F7F7F7] h-44">
            ...
            <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
              Deploy digitization with minimal disruption to operations.
            </p>
          </div>
          <div class="p-3 bg-[#F7F7F7] h-44">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
            ...
            <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
              Provide training for smooth team adoption.
            </p>
          </div>
          <div class="p-3 bg-[#F7F7F7] h-44">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
          ...
          <div class="p-3 bg-[#F7F7F7] h-44">
            ...
            <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
              Continuously optimize workflows for accuracy and compliance.
            </p>
          </div>
        </div>
      </div>
        ...
        <div id="testimonial-slider" class="overflow-hidden relative w-full max-w-full order-1 lg:order-2 z-20">
          <div id="testimonial-track" class="flex transition-transform duration-500 ease-in-out w-full"
            ...
            <div
              ...
              <div class="pl-6 h-fit pt-4">
                <div class="flex flex-col gap-5 font-normal text-black1 mt-5">
                  The volume of project documents across our global infrastructure builds was overwhelming. Intellivon’s document digitization framework allowed us to centralize records, automate compliance checks, and cut delays significantly. It has transformed how our teams handle plans, contracts, and approvals.
                  <div class="text-xl font-medium font-urbanist text-black1">
                    Director of Project Controls, Global Infrastructure Enterprise
                  </div>
                </div>
              </div>
            </div>
            ...
            <div
              ...
              <div class="pl-6 h-fit pt-4">
                <div class="flex flex-col gap-5 font-normal text-black1 mt-5">
                  Our multi-region construction projects required precise documentation management to stay compliant. Intellivon’s AI-driven solution gave us instant access to critical records, reduced manual errors, and improved collaboration across dispersed teams. It has set a new benchmark for efficiency.
                  <div class="text-xl font-medium font-urbanist text-black1">
                    VP of Operations, International Construction Group
                  </div>
                </div>
              </div>
            </div>
            ...
            <div
              ...
              <div class="pl-6 h-fit pt-4">
                <div class="flex flex-col gap-5 font-normal text-black1 mt-5">
                  Managing decades of paper-based contracts, permits, and reports was a constant challenge. Intellivon digitized everything into secure, searchable archives while integrating with our ERP systems. This not only improved accuracy but also sped up dispute resolution dramatically.
                  <div class="text-xl font-medium font-urbanist text-black1">
                    Head of Compliance, Global Real Estate Developer
                  </div>
                </div>
              </div>
            </div>
            ...
            <div
              ...
              <div class="pl-6 h-fit pt-4">
                <div class="flex flex-col gap-5 font-normal text-black1 mt-5">
                  Large-scale projects often stall due to documentation errors and missing approvals. With Intellivon, we digitized our entire process, achieving real-time collaboration, fewer errors, and guaranteed compliance. What used to take weeks now happens in hours.
                  <div class="text-xl font-medium font-urbanist text-black1">
                    Chief Project Officer, Multinational Construction Enterprise
                  </div>
                </div>
              </div>
            </div>
            ...
            <div
              ...
              <div class="pl-6 h-fit pt-4">
                <div class="flex flex-col gap-5 font-normal text-black1 mt-5">
                  During a major acquisition, having digitized and organized project documentation was a game-changer. Intellivon’s platform gave us transparency, eliminated redundancies, and accelerated due diligence. It’s clear this solution is designed for enterprises operating at scale.
                  <div class="text-xl font-medium font-urbanist text-black1">
                    SVP of Strategy, Global Engineering and Construction Firm
                  </div>
                </div>
              </div>
            </div>
...
<section class="w-full relative bg-[#E4EAF2] py-20 px-5 lg:px-10">
  <div class="flex flex-col gap-8 container">
    ...
    <div class="text-4xl leading-[1.25] font-semibold mt-10 lg:mt-0">
       Connect with Our 
      <span class="text-gradient"> AI Construction Experts </span>
      Today
    </div>
