<?php /* Template Name: MLOps & ML Lifecycle Management */ ?>
<?php get_header(); ?>
  ...
  <div class="flex">
    <div class="lg:w-full flex flex-col gap-5 px-10 justify-center py-10 lg:p-[150px] lg:text-center">
      <h1 class="font-bold text-4xl lg:text-5xl text-white">
        Accelerate ML Model Deployment With Our 
         <span class="text-gradient">MLOps Services </span> 
      </h1>
      ...
      <a href="https://intellivon.com/ai-strategy-call-booking-confirmation/" target="_blank">
        <button
          ...
          Get Your Customized MLOps Strategy 
    ...
    <div class="w-full lg:w-2/3 lg:pl-10 px-10 lg:px-0">
      <div class="flex flex-col gap-5 items-start">
        ...
        <h2 class="text-4xl items-center font-bold text-black1 font-urbanist leading-snug tracking-[0.5px] gap-1">
          Trusted Partners Across the Entire ML Lifecycle 
...
<section>
  ...
  <script>
    const services = [
      {
        title: "Business Alignment & ML Strategy",
        description:
          "We help align your ML initiatives with business goals, defining use cases, success metrics, and ROI frameworks, ensuring scalable ML adoption.",
        points: [
"ML Use Case Identification",
"Success Metrics Definition",
"ML Adoption Roadmap",
"ROI and Value Framework",
...
"Governance and Compliance Planning",
        ...
        description:
          "We handle data sourcing, cleansing, transformation, and automated validation to ensure high-quality, reproducible datasets for successful model development and deployment.",
        points: [
...
"Real-Time Data Streaming",
      ...
      },
      {
        ...
        description:
          "Our collaborative model development process includes automated experiment tracking, hyperparameter optimization, and model selection to create robust, high-performance models.",
        points: [
...
"Custom Model Architecture Design",
      ...
      },
      {
        ...
        description:
          "We design API-based, containerized deployment pipelines with automated CI/CD workflows, supporting multi-cloud and on-premise deployment options for flexibility and scalability.",
        points: [
...
"Real-Time Monitoring and Alerts",
...

      {
        ...
        description:
          "We provide real-time model monitoring, drift detection, and automatic retraining to ensure models perform optimally and remain aligned with changing data.",
        points: [
...
"Model Versioning and Rollback",
      ...
      {
        title: "Lifecycle Automation & Orchestration",
        description:
          "We automate end-to-end workflows using tools like Kubeflow and MLflow, integrating seamlessly with your existing IT infrastructure for streamlined operations.",
        points: [
"End-to-End Workflow Automation",
"Pipeline Orchestration for Data and Training",
...
"Scalable Infrastructure Management",
...

      {
        ...
        description:
          "We ensure secure data handling, compliance with industry standards like GDPR and HIPAA, and risk mitigation for safe deployment of ML models.",
        points: [
...
"Compliance-Driven Model Monitoring",
        ],
      },
    ...
    <div class="flex items-end justify-between mt-6 mb-3">
      ...
      <div class="flex flex-col gap-3 w-full">
        ...
        <h2 class="text-4xl md:gap-3 items-center font-bold text-black1 font-urbanist leading-snug tracking-[0.5px]">
          Turning ML Ambitions into Production-Ready Solutions
  ...
  <div class="container flex flex-col gap-5 items-center">
    ...
    <div class="w-full">
      ...
      <h2 class="w-full lg:w-11/12 text-4xl gap-3 font-bold text-black1 font-urbanist leading-snug tracking-[0.5px]">
        Real-World Impact of MLOps and   
        <span class="text-gradient">ML Lifecycle Management </span>
      </h2>
    </div>
        ...
        <div class="w-full flex flex-col gap-5 items-start">
          ...
          <div class="flex flex-col gap-5 lg:gap-0 lg:flex-row justify-between">
            <h2 class="w-full lg:w-7/12 text-4xl flex-wrap gap-3 flex items-center font-bold text-black1 font-urbanist">
              ...
              <span class="text-gradient">MLOps Excellence</span>
            </h2>
            <a href="https://intellivon.com/ai-strategy-call-booking-confirmation/" target="_blank">
              <div>
                <button type="button"
      ...
      <div class="choose-card-wrapper w-full h-[212px] md:w-[409px] m-auto lg:m-0 z-10">
        <div class="choose-card shadow-[0_24px_34px_0_rgba(0,0,0,.078)]">
          ...
          <div class="choose-card-front bg-white p-6 flex flex-col gap-8 items-center justify-center">
            ...
            <h3 class="text-xl font-semibold text-center">Rapid, Reliable Results</h3>
          </div>
          <!-- Back Side -->
          <div
            class="choose-card-back bg-white p-6 flex flex-col gap-4 items-center justify-center text-center text-gray-800">
  ...
  <div class="container">
    ...
    <div class="w-full flex flex-col gap-3 items-start">
      ...
      <h2 class="text-4xl font-bold text-black1 font-urbanist leading-snug tracking-[0.5px] w-full md:gap-3">
        Future-Ready Tools for Every Stage of the 
        <span class="text-gradient"> ML Journey</span>
      </h2>
    ...
    <div class="mt-10">
      ...
      <div class="swiper techSwiper">
        <div class="swiper-wrapper min-h-auto">
          ...
          <div class="swiper-slide border-2 border-[#99899d] rounded-[30px]">
            <div class="flex flex-col w-full items-center gap-5 py-10 lg:py-20">
              <h3 class="font-bold text-3xl text-center">Model Deployment & Integration</h3>
              <div class="flex flex-wrap justify-center gap-6 mt-5 max-w-[1200px] mx-auto">
                <!-- Use same layout -->
                <div
                  class="technology-edge w-[260px] lg:w-[280px] rounded-full flex items-center gap-3 px-6 py-3 bg-white shadow-sm">
          ...
          <div class="swiper-slide border-2 border-[#99899d] rounded-[30px]">
            <div class="flex flex-col w-full items-center gap-5 py-10 lg:py-20">
              <h3 class="font-bold text-3xl text-center">Monitoring & Model Management</h3>
              <div class="flex flex-wrap justify-center gap-6 mt-5 max-w-[1200px] mx-auto">
                <!-- Use same layout -->
                <div
                  class="technology-edge w-[260px] lg:w-[280px] rounded-full flex items-center gap-3 px-6 py-3 bg-white shadow-sm">
          ...
          <div class="swiper-slide border-2 border-[#99899d] rounded-[30px]">
            <div class="flex flex-col w-full items-center gap-5 py-10 lg:py-20">
              <h3 class="font-bold text-3xl text-center">CI/CD & Automation</h3>
              <div class="flex flex-wrap justify-center gap-6 mt-5 max-w-[1200px] mx-auto">
                <!-- Use same layout -->
                <div
                  class="technology-edge w-[260px] lg:w-[280px] rounded-full flex items-center gap-3 px-6 py-3 bg-white shadow-sm">
