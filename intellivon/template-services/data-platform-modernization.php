<?php /* Template Name: Data Platform Modernization Services
  */ ?>
<?php get_header(); ?>
<!-- Intellivon Menubar Start -->
<!-- developed by - Sachin Gangwar 21-08-2025 -->
    ...
    <div class="flex">
        <div class="lg:w-full flex flex-col gap-5 px-10 justify-center py-10 lg:p-[150px] lg:text-center">
            <h1 class="font-bold text-4xl lg:text-5xl text-white">
                Unlock
                <span class="text-gradient">Data Platform Modernization Services for Future-Ready Enterprise Data</span>
            </h1>
            <p class="text-white text-lg font-medium">
                Unlock enterprise growth with Intellivon’s data platform modernization - transforming legacy systems
                into agile, intelligent, and AI-ready platforms.
            </p>
        ...
        <div class="w-full lg:w-2/3 lg:pl-10 px-10 lg:px-0">
            <div class="flex flex-col gap-5 items-start">
                ...
                <h2
                    ...
                    <span class="text-gradient"> Data-Driven Enterprises</span>
                </h2>
                <p class="mb-4 md:mb-0 text-base font-medium text-grey1 mt-2 w-full tracking-[0.25px] pr-5 mb-12">
                    We partner with the world’s largest enterprises, modernizing data platforms with AI precision that
                    competitors struggle to match, delivering speed, scale, and measurable impact.
...
<section>
            ...
            <div class="w-full pr-5">
                <div class="w-full flex flex-col gap-5 items-start">
                    ...
                    <p class="mb-4 md:mb-0 text-base font-medium text-grey1 mt-2 w-full tracking-[0.25px] pr-5 mb-12">
                        ...
                        We transform your legacy systems into AI-ready platforms, seamlessly integrating data sources
                        for insights and innovation that competitors struggle to replicate.
                ...
                <div class="flex flex-col gap-5 lg:w-1/3 h-[70vh] overflow-y-scroll pt-5 px-5" id="serviceButtons">
                    ...
                    <div class="rounded-xl">
                        <div
                            ...
                            Enterprise Data Architecture Redesign
                    ...
                    <div
                        class="rounded-xl flex items-center justify-center font-bold text-lg p-5 w-full shadow-[0px_4px_24px_-1px_rgba(124,59,175,0.6)]">
                        Real-Time Data Integration Hubs
                    ...
                    <div
                        class="rounded-xl flex items-center justify-center font-bold text-lg p-5 w-full shadow-[0px_4px_24px_-1px_rgba(124,59,175,0.6)]">
                        Cloud-Ready Platform Modernization
    ...
    <script>
        const services = [
            {
                title: "Enterprise Data Architecture Redesign",
                description:
                    "We overhaul outdated data systems into flexible, high-performance platforms that grow with your business, improving speed, reliability, and integration across all departments.",
                points: [
            ...
            },
            {
                ...
                description:
                    "We handle complex migrations without downtime, ensuring data is mapped, cleaned, and transferred with complete accuracy, keeping business operations running smoothly.",
                points: [
            ...
            {
                title: " Real-Time Data Integration Hubs",
                description:
                    "We bring together all your data sources into a single, secure hub, giving teams instant access to accurate information for faster, better decisions.",
                points: [
                    "Unified Data Access",
                    "Live Data Feeds",
            ...
            },
            {
                ...
                description:
                    "We set clear rules and safeguards for how your data is stored, accessed, and used, ensuring consistency, compliance, and trust at every level.",
                points: [
            ...
            {
                title: "Cloud-Ready Platform Modernization",
                description:
                    "We rebuild your data platform for secure, efficient use in cloud environments, giving you flexibility to scale and adapt without costly overhauls.",
                points: [
                    "Multi-Cloud Options",
            ...
            {
                title: "Continuous Data Quality Management",
                description:
                    "We put systems in place that constantly check, clean, and improve your data, so you can trust every report, forecast, and decision.",
                points: [
        ...
        <div class="flex items-end justify-between mt-6 mb-3">
            ...
            <div class="flex flex-col gap-3 w-full">
                ...
                <h2
                    ...
                    Our Proven Enterprise Modernization Framework
                ...
                <p class="text-[#333333] w-full lg:w-3/4 text-base font-medium">
                    From deep audits to intelligent deployment, our process delivers scalable results, avoiding the
                    costly rework common in rushed modernization projects
                ...
                <div class="grid grid-cols-2 gap-1 mt-4">
                    <div class="p-3 bg-[#F7F7F7] h-44">
                        ...
                        <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
                            ...
                            Analyze current data architecture, infrastructure, and governance frameworks.
                    ...
                    <div class="p-3 bg-[#F7F7F7] h-44">
                        ...
                        <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
                            ...
                            Identify high-impact modernization opportunities and ROI potential
                    ...
                    <div class="p-3 bg-[#F7F7F7] h-44">
                        ...
                        <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
                            Conduct stakeholder interviews and technical audits
                    ...
                    <div class="p-3 bg-[#F7F7F7] h-44">
                        ...
                        <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
                            Set clear success metrics and project milestones
            ...
            <div class="card w-full lg:w-1/3 p-6 border-2 border-transparent rounded-md"
                ...
                <div class="grid grid-cols-2 gap-1 mt-4">
                    <div class="p-3 bg-[#F7F7F7] h-44">
                        ...
                        <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
                            Design a future-ready data platform architecture and migration roadmap
                    ...
                    <div class="p-3 bg-[#F7F7F7] h-44">
                        ...
                        <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
                            Select optimal cloud, integration, and security technologies
                    ...
                    <div class="p-3 bg-[#F7F7F7] h-44">
                        ...
                        <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
                            Develop proof-of-concept for key modernization components
                    ...
                    <div class="p-3 bg-[#F7F7F7] h-44">
                        ...
                        <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
                            Validate designs against enterprise performance and compliance goals
            ...
            <div class="card w-full lg:w-1/3 p-6 border-2 border-transparent rounded-md"
                ...
                <div class="grid grid-cols-2 gap-1 mt-4">
                    <div class="p-3 bg-[#F7F7F7] h-44">
                        ...
                        <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
                            Migrate and validate enterprise data with zero downtime
                    ...
                    <div class="p-3 bg-[#F7F7F7] h-44">
                        ...
                        <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
                            Deploy scalable, high-performance platform infrastructure
                    ...
                    <div class="p-3 bg-[#F7F7F7] h-44">
                        ...
                        <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
                            Integrate systems for unified, real-time data access
                    ...
                    <div class="p-3 bg-[#F7F7F7] h-44">
                        ...
                        <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
                            Continuously monitor KPIs and optimize post-launch performance
            ...
            <div class="w-full flex flex-col gap-5 items-start">
                ...
                <div class="flex flex-col gap-5 lg:gap-0 lg:flex-row justify-between w-full">
                    <h2
                        ...
                        <span class="text-gradient"> Case Studies </span>
                    </h2>
                        ...
                        <div class="swiper-wrapper bg-[#F2F7FF]">
                                ...
                                <div class="w-full lg:w-1/2 flex flex-col gap-5 px-5 py-4">
                                    <div class="flex flex-col w-full gap-2 pb-4 border-b border-b-[#99899d]">
                                        <h3 class="text-xl md:text-3xl font-semibold">
                                            Global Bank Data Platform Modernization
                                        ...
                                        <div class="text-[#333] leading-7 tracking-wide">
                                            <p class="hidden xl:block text-md">
                                                We partnered with a leading private sector bank to overhaul its legacy
                                                data infrastructure, which suffered from slow performance, fragmented
                                                silos, and compliance risks. By implementing a modern, cloud-based
                                                platform with scalable storage, real-time analytics, and automated
                                                compliance workflows, the bank eliminated bottlenecks, reduced
                                                operational risk, and improved decision-making capabilities
                                                enterprise-wide.
                                    ...
                                    <ul class="flex flex-col gap-2 list-disc pl-5">
                                        <li class="">
                                            ...
                                            <span> faster query processing</span>
                                        </li>
                                        <li class="">
                            ...
                            <div
                                ...
                                <div class="w-full lg:w-1/2 flex flex-col gap-5 px-5 py-4">
                                    <div class="flex flex-col w-full gap-2 pb-4 border-b border-b-[#99899d]">
                                        <h3 class="text-xl md:text-3xl font-semibold">
                                            Travel Management Real-Time Data Integration
                                        ...
                                        <div class="text-[#333] leading-7 tracking-wide">
                                            <p class="hidden xl:block text-md">
                                                We helped a global corporate travel leader replace outdated, fragmented
                                                reporting systems with a unified, cloud-native platform. The new
                                                architecture integrated multiple data sources, enabling real-time
                                                intelligence for logistics, bookings, and operational planning. This
                                                transformation allowed for faster internal decision-making, streamlined
                                                operations, and significant cost reductions across the organization.
                            ...
                            <div
                                ...
                                <div class="w-full lg:w-1/2 flex flex-col gap-5 px-5 py-4">
                                    <div class="flex flex-col w-full gap-2 pb-4 border-b border-b-[#99899d]">
                                        <h3 class="text-xl md:text-3xl font-semibold">
                                            Retail Real-Time Streaming Migration
                                        ...
                                        <div class="text-[#333] leading-7 tracking-wide">
                                            <p class="hidden xl:block text-md">
                                                We migrated 15TB of retail data from slow, batch-based systems to a
                                                scalable, event-driven cloud platform. The upgrade provided immediate
                                                access to operational data, improved compliance reporting, and enabled
                                                rapid adjustments to pricing and inventory strategies, resulting in
                                                measurable efficiency gains across all retail channels.
                                    ...
                                    <ul class="flex flex-col gap-2 list-disc pl-5">
                                        ...
                                        <li class="">
                                            <span class="xl:text-xl font-semibold">70% </span>
                                            <span> faster compliance reporting</span>
                                        </li>
                                    </ul>
                                    <!-- Explore More button -->
                                    <a href="https://intellivon.com/ai-strategy-call-booking-confirmation/"
                            ...
                            <div
                                ...
                                <div class="w-full lg:w-1/2 flex flex-col gap-5 px-5 py-4">
                                    <div class="flex flex-col w-full gap-2 pb-4 border-b border-b-[#99899d]">
                                        <h3 class="text-xl md:text-3xl font-semibold">
                                            Telecom Provisioning System Overhaul
                                        ...
                                        <div class="text-[#333] leading-7 tracking-wide">
                                            <p class="hidden xl:block text-md">
                                                We replaced a major telecom operator’s legacy provisioning system with a
                                                modern, scalable digital platform. This eliminated long lead times for
                                                service activation, improved network resource allocation, and
                                                significantly reduced operating costs, all while preparing the
                                                infrastructure for large-scale 5G and IoT deployment.
                                    ...
                                    <ul class="flex flex-col gap-2 list-disc pl-5">
                                        <li class="">
                                            ...
                                            <span> faster service rollout

                                            </span>
                                        </li>
                                        <li class="">
                                            <span class="xl:text-xl font-semibold">40%</span>
                                            <span> lower provisioning costs
                                        ...
                                        <li class="">
                                            ...
                                            <span> scalability for many accounts
                                    ...
                                    <!-- Explore More button -->
                                    <a href="https://intellivon.com/ai-strategy-call-booking-confirmation/" 8
                                        target="_blank">
                                        <div class="flex gap-5 py-2 px-5 items-center bg-[#28103B] text-white rounded-full w-fit"
                                            role="button">
                                            Explore more
                            ...
                            <div
                                ...
                                <div class="w-full lg:w-1/2 flex flex-col gap-5 px-5 py-4">
                                    <div class="flex flex-col w-full gap-2 pb-4 border-b border-b-[#99899d]">
                                        <h3 class="text-xl md:text-3xl font-semibold">
                                            Quick Service Restaurant Real-Time Insights Platform
                                        ...
                                        <div class="text-[#333] leading-7 tracking-wide">
                                            <p class="hidden xl:block text-md">
                                                We modernized a leading North American fast-food chain’s on-premises
                                                data warehouses into a real-time, cloud-based analytics platform serving
                                                4,000 locations. The system delivered instant visibility into sales,
                                                inventory, labor, and loyalty metrics, improving operational efficiency
                                                and enabling faster enterprise-level decisions.
                                    ...
                                    <ul class="flex flex-col gap-2 list-disc pl-5">
                                        ...
                                        <li class="">
                                            <span class="xl:text-xl font-semibold">80%</span>
                                            <span> store performance visibility
...
<section class="w-full px-5 lg:px-10 py-14 lg:py-20 bg-[#F2F7FF] relative overflow-hidden">
    <div class="container flex flex-col gap-5 items-center">
        ...
        <div class="w-full">
            ...
            <h2
                class="w-full lg:w-11/12 text-4xl gap-3 font-bold text-black1 font-urbanist leading-snug tracking-[0.5px]">
                Real-World AI-Driven
                <span class="text-gradient">Data Modernization in Action
                ...
                <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide h-full">
                        <div
                            ...
                            <p class="text-center md:text-start">
                                Modernizing to enable instant data access and analytics, supporting time-sensitive
                                decisions in operations, strategy, and risk management.
                    ...
                    <div class="swiper-slide h-full">
                        <div
                            ...
                            <p class="text-center md:text-start">
                                Consolidating fragmented systems into a single source of truth, eliminating silos, and
                                enabling enterprise-wide data consistency.
                    ...
                    <div class="swiper-slide h-full">
                        <div
                            ...
                            <p class="text-center md:text-start">
                                Leveraging modernized platforms to run predictive models for supply chains, workforce
                    ...
                    <div class="swiper-slide h-full">
                        <div
                            ...
                            <p class="text-center md:text-start">
                                Embedding automated data capture, validation, and reporting to meet evolving regulations
                    ...
                    <div class="swiper-slide h-full">
                        <div
                            ...
                            <p class="text-center md:text-start">
                                ...
                                Upgrading to handle streaming, batch, and API-based data at scale without performance
                                degradation.
                    ...
                    <div class="swiper-slide h-full">
                        <div
                            ...
                            <p class="text-center md:text-start">
                                Continuous monitoring, cleansing, and enrichment to ensure all enterprise analytics are
                                based on accurate, complete, and reliable data.
                    ...
                    <div class="swiper-slide h-full">
                        <div
                            ...
                            <p class="text-center md:text-start">
                                Equipping business units with governed, secure self-service tools for creating
                                dashboards, reports, and insights without IT bottlenecks.
                    ...
                    <div class="swiper-slide h-full">
                        <div
                            ...
                            <div class="flex flex-col md:flex-row gap-5 items-center">
                                ...
                                <h3 class="font-bold text-lg text-center md:text-start">
                                    Multi-Cloud Data Architecture Enablement
                            ...
                            <p class="text-center md:text-start">
                                Re-architecting platforms for seamless operation across multiple cloud providers,
                                ensuring redundancy, cost optimization, and vendor flexibility.
                ...
                <div class="w-full flex flex-col gap-5 items-start">
                    ...
                    <div class="flex flex-col gap-5 lg:gap-0 lg:flex-row justify-between">
                        <h2
                            ...
                            See How Our Data Platform

                            <span class="text-gradient">Modernization Services Stand Out</span>
                        </h2>
                        <a href="https://intellivon.com/ai-strategy-call-booking-confirmation/" target="_blank">
                            <div>
                                <button type="button"
                    ...
                    <p class="text-grey1 text-base font-medium">
                        We deliver modernization at a scale with unmatched precision, reducing risk, increasing
                        performance, and enabling AI-driven advantage.
            ...
            <div class="choose-card-wrapper w-full h-[212px] md:w-[409px] m-auto lg:m-0 z-10">
                <div class="choose-card shadow-[0_24px_34px_0_rgba(0,0,0,.078)]">
                    ...
                    <div
                        ...
                        <p class="text-sm">
                            We modernize petabyte-scale platforms for global enterprises, ensuring zero downtime, no
                            data loss, and on-time delivery for mission-critical systems.
            ...
            <div class="choose-card-wrapper w-full h-[212px] md:w-[409px] m-auto lg:m-0 z-10">
                <div class="choose-card shadow-[0_24px_34px_0_rgba(0,0,0,.078)]">
                    ...
                    <div
                        ...
                        <p class="text-sm">
                            Our architectures anticipate growth, evolving regulations, and technology shifts, preventing
                            costly rebuilds and keeping your platform relevant for years ahead.
            ...
            <div class="choose-card-wrapper w-full h-[212px] md:w-[409px] m-auto lg:m-0 z-10">
                <div class="choose-card shadow-[0_24px_34px_0_rgba(0,0,0,.078)]">
                    ...
                    <div class="choose-card-front bg-white p-6 flex flex-col gap-8 items-center justify-center">
                        ...
                        <h3 class="text-xl font-semibold text-center"> Zero-Risk Migration Execution
                    ...
                    <div
                        ...
                        <p class="text-sm">
                            We deliver modernization projects without operational disruption, safeguarding core business
                            functions while meeting deadlines and exceeding enterprise-grade performance expectations.
            ...
            <div class="choose-card-wrapper w-full h-[212px] md:w-[409px] m-auto lg:m-0 z-10">
                <div class="choose-card shadow-[0_24px_34px_0_rgba(0,0,0,.078)]">
                    ...
                    <div
                        ...
                        <p class="text-sm">
                            Governance, auditability, and regulatory compliance are embedded from day one, ensuring you
                            stay ahead of evolving standards without last-minute fixes.
            ...
            <div class="choose-card-wrapper w-full h-[212px] md:w-[409px] m-auto lg:m-0 z-10">
                <div class="choose-card shadow-[0_24px_34px_0_rgba(0,0,0,.078)]">
                    ...
                    <div
                        ...
                        <p class="text-sm">
                            We select technologies for scalability, interoperability, and reliability, delivering
                            sustained performance gains instead of short-lived solutions driven by hype.
            ...
            <div class="choose-card-wrapper w-full h-[212px] md:w-[409px] m-auto lg:m-0 z-10">
                <div class="choose-card shadow-[0_24px_34px_0_rgba(0,0,0,.078)]">
                    ...
                    <div
                        ...
                        <p class="text-sm">
                            Every project includes clear milestones and transparent reporting, ensuring measurable
                            improvements in cost, speed, and data-driven decision-making across the enterprise.
    ...
    <div class="container">
        ...
        <div class="w-full flex flex-col gap-3 items-start">
            ...
            <h2 class="text-4xl font-bold text-black1 font-urbanist leading-snug tracking-[0.5px] w-full md:gap-3">
              Cutting-Edge Technology That Powers Are




                <span class="text-gradient"> Platform Modernization Services </span>
            </h2>
            <div class="w-full flex flex-col lg:flex-row justify-between">
                <p
                  ...
                  From AI frameworks to multi-cloud architectures, our stack is engineered for resilience and scale that competitors can’t deliver consistently. 
        ...
        <div class="mt-10">
            ...
            <div class="swiper techSwiper">
                <div class="swiper-wrapper min-h-auto">
                    ...
                    <div class="swiper-slide border-2 border-[#99899d] rounded-[30px]">
                        <div class="flex flex-col w-full items-center gap-5 py-10 lg:py-20">
                            <h3 class="font-bold text-3xl text-center"> Data Integration & ETL
                        ...
                        <div class="flex flex-col w-full items-center gap-5 py-10 lg:py-20">
                            ...
                            <div class="flex flex-wrap justify-center gap-6 mt-5 max-w-[1200px] mx-auto">
                                ...
                                <div
                                    ...
                                    <h4 class="text-base md:text-xl font-medium text-black2"> PostgreSQL
                                ...
                                <div
                                    ...
                                    <h4 class="text-base md:text-xl font-medium text-black2">Cassandra
                                ...
                                <div
                                    ...
                                    <h4 class="text-base md:text-xl font-medium text-black2">Oracle Database
                    ...
                    <div class="swiper-slide border-2 border-[#99899d] rounded-[30px]">
                        <div class="flex flex-col w-full items-center gap-5 py-10 lg:py-20">
                            <h3 class="font-bold text-3xl text-center">Data Governance & Cataloging
                    ...
                    <div class="swiper-slide border-2 border-[#99899d] rounded-[30px]">
                        <div class="flex flex-col w-full items-center gap-5 py-10 lg:py-20">
                            <h3 class="font-bold text-3xl text-center">Analytics & BI Tools
                    ...
                    <div class="swiper-slide border-2 border-[#99899d] rounded-[30px]">
                        <div class="flex flex-col w-full items-center gap-5 py-10 lg:py-20">
                            <h3 class="font-bold text-3xl text-center">Containerization & Orchestration
                            ...
                            <div class="flex flex-wrap justify-center gap-6 mt-5 max-w-[1200px] mx-auto">
                                ...
                                <div class="swiper-slide border-2 border-[#99899d] rounded-[30px]">
                                    <div class="flex flex-col w-full items-center gap-5 py-10 lg:py-20">
                                        <h3 class="font-bold text-3xl text-center">Machine Learning & AI Frameworks
                                        ...
                                        <div class="flex flex-wrap justify-center gap-6 mt-5 max-w-[1200px] mx-auto">
                                            ...
                                            <div class="swiper-slide border-2 border-[#99899d] rounded-[30px]">
                                                <div class="flex flex-col w-full items-center gap-5 py-10 lg:py-20">
                                                    <h3 class="font-bold text-3xl text-center">Security & Compliance
                                                        Tools
                ...
                <div id="testimonial-slider" class="overflow-hidden relative w-full max-w-full order-1 lg:order-2 z-20">
                    <div id="testimonial-track" class="flex transition-transform duration-500 ease-in-out w-full"
                        ...
                        <div
                            ...
                            <div class="pl-6 h-fit pt-4">
                                <div class="flex flex-col gap-5 font-normal text-black1 mt-5">
                                    Our reporting cycle used to take over a week, pulling data from multiple outdated
                                    systems. Intellivon consolidated everything into a single, real-time platform. Now,
                                    executives have instant access to performance metrics, and decisions that took days
                                    happen in hours. It’s transformed the way we operate.
                                    ...
                                    <div class="text-xl font-medium font-urbanist text-black1">
                                        Laura Mitchell, Chief Data Officer
                        ...
                        <div
                            ...
                            <div class="pl-6 h-fit pt-4">
                                <div class="flex flex-col gap-5 font-normal text-black1 mt-5">
                                    Before working with Intellivon, our compliance reporting was manual, slow, and
                                    error-prone. Their modernization process automated the entire pipeline, giving us
                                    accurate, audit-ready reports instantly. It’s eliminated countless late nights for
                                    our compliance team and drastically reduced regulatory risk.
                                    ...
                                    <div class="text-xl font-medium font-urbanist text-black1">
                                        David Chen, Director of Compliance
                        ...
                        <div
                            ...
                            <div class="pl-6 h-fit pt-4">
                                <div class="flex flex-col gap-5 font-normal text-black1 mt-5">
                                    Our legacy data warehouse couldn’t handle the volume we needed for analytics.
                                    Intellivon migrated us to a scalable cloud platform without any downtime.
                                    Performance improved tenfold, and our analysts can finally run advanced models
                                    ...
                                    <div class="text-xl font-medium font-urbanist text-black1">
                                        Priya Kapoor, Head of Business Intelligence
                        ...
                        <div
                            ...
                            <div class="pl-6 h-fit pt-4">
                                <div class="flex flex-col gap-5 font-normal text-black1 mt-5">
                                    We were drowning in fragmented customer data across departments. Intellivon built a
                                    unified data hub that integrates seamlessly with our systems. For the first time, we
                                    have a single source of truth. It’s improved collaboration and decision-making
                                    company-wide.
                        ...
                        <div
                            ...
                            <div class="pl-6 h-fit pt-4">
                                <div class="flex flex-col gap-5 font-normal text-black1 mt-5">
                                    Managing global inventory used to involve guesswork because of delayed data updates.
                                    Intellivon’s real-time data streaming platform means our operations team can respond
                                    instantly to supply chain changes. We’ve seen measurable savings and far fewer stock
                                    issues.
                                    ...
                                    <div class="text-xl font-medium font-urbanist text-black1">
                                        Sarah Thompson, VP of Supply Chain
    ...
    <div class="container flex flex-col gap-5 items-center">
        ...
        <div class="flex flex-col w-5/6 mt-5">
            ...
            <div class="faq-item">
                <div class="border-t border-[#7C3BAF] flex justify-between py-5 cursor-pointer">
                    <div class="font-medium text-xl">
                        Q1. What is data platform modernization?
                ...
                <div
                    ...
                    <p class="text-base text-[#333]">
                        Data platform modernization is the process of upgrading legacy data systems with scalable,
                        secure, and high-performance technologies to support real-time analytics and enterprise growth.
            ...
            <div class="faq-item">
                <div class="border-t border-[#7C3BAF] flex justify-between py-5 cursor-pointer">
                    <div class="font-medium text-xl">
                        Q2. Why do enterprises need data platform modernization?
                ...
                <div
                    class="faq-answer overflow-hidden max-h-0 opacity-0 transition-all duration-300 ease-in-out px-4 pb-8">
                    <p class="text-base text-[#333]">
                        Enterprises need modernization to eliminate data silos, improve performance, enable real-time
                        insights, and meet evolving compliance and scalability demands.
            ...
            <div class="faq-item">
                <div class="border-t border-[#7C3BAF] flex justify-between py-5 cursor-pointer">
                    <div class="font-medium text-xl">
                        Q3. How does Intellivon approach data platform modernization?
                ...
                <div
                    class="faq-answer overflow-hidden max-h-0 opacity-0 transition-all duration-300 ease-in-out px-4 pb-8">
                    <p class="text-base text-[#333]">
                        Intellivon follows a structured, low-risk process: Evaluate, Explore, Execute, ensuring minimal
                        disruption, measurable ROI, and solutions built for long-term adaptability.
            ...
            <div class="faq-item">
                <div class="border-t border-[#7C3BAF] flex justify-between py-5 cursor-pointer">
                    <div class="font-medium text-xl">
                        Q4. What technologies are used in data platform modernization?
                ...
                <div
                    class="faq-answer overflow-hidden max-h-0 opacity-0 transition-all duration-300 ease-in-out px-4 pb-8">
                    <p class="text-base text-[#333]">
                        Technologies include cloud platforms (AWS, Azure, GCP), data warehouses (Snowflake, BigQuery),
                        integration tools, governance frameworks, and real-time streaming solutions.
            ...
            <div class="faq-item">
                <div class="border-t border-[#7C3BAF] flex justify-between py-5 cursor-pointer">
                    <div class="font-medium text-xl">
                        Q5. How long does a data platform modernization project take?
                ...
                <div
                    ...
                    <p class="text-base text-[#333]">
                        ...
                        Timelines vary based on complexity and scope but typically range from 3 to 12 months for
            ...
            <div class="faq-item">
                <div class="border-t border-[#7C3BAF] flex justify-between py-5 cursor-pointer">
                    <div class="font-medium text-xl">
                        Q6. Can data platform modernization improve compliance?
                ...
                <div
                    class="faq-answer overflow-hidden max-h-0 opacity-0 transition-all duration-300 ease-in-out px-4 pb-8">
                    <p class="text-base text-[#333]">
                        Yes. Modernization embeds governance, security, and automated reporting to ensure compliance
            ...
            <div class="faq-item">
                <div class="border-t border-[#7C3BAF] flex justify-between py-5 cursor-pointer">
                    <div class="font-medium text-xl">
                        Q7. What are the business benefits of data platform modernization?
                ...
                <div
                    class="faq-answer overflow-hidden max-h-0 opacity-0 transition-all duration-300 ease-in-out px-4 pb-8">
                    <p class="text-base text-[#333]">
                        Benefits include faster decision-making, reduced operational costs, improved data quality,
                        better scalability, and greater agility in responding to market changes.
            ...
            <div class="faq-item">
                <div class="border-t border-[#7C3BAF] flex justify-between py-5 cursor-pointer">
                    <div class="font-medium text-xl">
                        Q8. How much does enterprise data platform modernization cost?
                ...
                <div
                    ...
                    <p class="text-base text-[#333]">
                        ...
                        Costs depend on scope, data volume, and technology stack. Intellivon provides custom estimates
                        based on each enterprise’s unique requirements.
