<?php /* Template Name: Managed Sustenance */ ?>
<?php get_header(); ?>
<!-- Intellivon Menubar Start -->
<!-- developed by - Sachin Gangwar 14-08-2025 -->
    ...
    <div class="flex">
        <div class="lg:w-full flex flex-col gap-5 px-10 justify-center py-10 lg:p-[150px] lg:text-center">
            <h1 class="font-bold text-4xl lg:text-5xl text-white">
                Unlock
                <span class="text-gradient">Future-Proof Your Mature Products With Our Product Sustenance Management
                    Services
                </span>
            </h1>
            <p class="text-white text-lg font-medium">
                Maximize the value of your mature products with our AI-driven product sustenance services, ensuring
                longevity, optimizing ROI, and driving continuous innovation for your enterprise.
        ...
        <div class="w-full lg:w-2/3 lg:pl-10 px-10 lg:px-0">
            <div class="flex flex-col gap-5 items-start">
                ...
                <h2
                    ...
                    Empowering Clients to Thrive with 


                    <span class="text-gradient">Advanced Product Sustenance</span>
                </h2>
                <p class="mb-4 md:mb-0 text-base font-medium text-grey1 mt-2 w-full tracking-[0.25px] pr-5 mb-12">
                    We've helped enterprises lower operational costs, mitigate risks with mature products, and enhance
                    lifecycle management, allowing innovation teams to focus on future products.
            ...
            <div class="w-full pr-5">
                <div class="w-full flex flex-col gap-5 items-start">
                    ...
                    <h2 class="text-4xl font-bold text-black1 font-urbanist leading-snug tracking-[0.5px] w-full">
                        Precision-Crafted Maintenance Services to
                    ...
                    <p class="mb-4 md:mb-0 text-base font-medium text-grey1 mt-2 w-full tracking-[0.25px] pr-5 mb-12">
                        Our personalized product sustenance services provide agile maintenance solutions, extending the
                        lifecycle of your industry-specific products with cutting-edge AI and precision.
        ...
        const services = [
            {
                ...
                description:
                    "We offer comprehensive, end-to-end support for managing product lifecycles from inception to end-of-life. This includes detailed strategies for continuous product optimization and proactive end-of-life management, ensuring that every stage of the product's life is maximized for value and performance.",
                points: [
                    "End-to-End Lifecycle Support",
                    "Continuous Optimization Strategies",
                    "Proactive Risk Management Throughout Product Stages",
                    "Tailored Roadmaps for Each Product’s Life",
                    "Seamless Integration of Updates and Enhancements",
                    "Maximized ROI Through Lifecycle Extensions",
                ],
            ...
            {
                title: "Sunset & End-of-Life (EOL) Management",
                description:
                    "Our Sunset & EOL Management ensures a smooth transition as products reach the end of their lifecycle. We help phase out legacy systems without disrupting operations, offering strategies such as software deprecation and ensuring legacy system maintenance.",
                points: [
                    "Seamless Product Phase-Outs",
                    "Smooth Transition Plans for Legacy Systems",
                    "Timely Software Deprecation",
                    "Minimized Downtime During Sunset Transitions",
            ...
            },
            {
                ...
                description:
                    "We prioritize risk mitigation and compliance throughout the product’s lifecycle. By implementing proactive risk assessments and ensuring compliance with industry regulations, we safeguard your product’s integrity and reduce vulnerabilities.",
                points: [
                    "Proactive Risk Identification and Management",
                    "Compliance with Industry Regulations",
                    "Ongoing Security Assessments and Updates",
                    "Early Warning Systems for Potential Product Failures",
                    "Integration of Risk Mitigation into Product Design",
                    "Regulatory Change Adaptation and Compliance",
                ],
            ...
            {
                title: "Software & Hardware Integration Support",
                description:
                    "We ensure seamless integration between legacy systems and emerging technologies, optimizing the product’s operational utility and extending its lifecycle. Our solutions bridge the gap between older products and new innovations, enhancing performance and scalability.",
                points: [
                    "Seamless Integration with Legacy Systems",
                    "Smooth Transition to New Technologies",
                    "Optimized Product Performance with Integrated Solutions",
                    "Industry-Specific Integration Expertise",
                    "Scalable Solutions for Growing Enterprises",
                    "End-to-End Integration Planning and Support",
                ],
...

            {
                ...
                description:
                    "We continuously monitor and optimize your product’s performance to maintain high operational standards. Our proactive approach identifies potential performance issues early, ensuring that your product remains reliable and efficient throughout its lifecycle.",
                points: [
                    "Continuous Monitoring and Performance Analytics",
                    "Proactive Optimization for Sustained Efficiency",
                    "Real-Time Performance Tracking",
                    "Timely Updates and Tweaks for Maximum Output",
                    "Performance-Driven Product Improvements",
                    "Reduced Operational Downtime Through Continuous Optimization",
                ],
...

            {
                ...
                description:
                    "Leveraging AI and machine learning, we predict product failures before they occur, allowing for timely intervention. This minimizes downtime and ensures that products maintain their optimal operational standards, enhancing ROI by preventing costly unplanned outages.",
                points: [
                    "AI-Powered Predictive Algorithms",
                    "Real-Time Failure Prediction and Diagnosis",
                    "Reduced Unplanned Downtime",
                    "Maximized ROI by Minimizing Maintenance Costs",
        ...
        <div class="flex items-end justify-between mt-6 mb-3">
            ...
            <div class="flex flex-col gap-3 w-full">
                ...
                <h2
                    ...
                    How We Extend the Lifecycle of Your Products and Maximize ROI

                    <span class="text-gradient"> in 3 Steps </span>
                </h2>
                <p class="text-[#333333] w-full lg:w-3/4 text-base font-medium">
                    Our process ensures product longevity, mitigating risks, reducing depreciation costs, and enabling
                    innovation by extending product lifecycles and optimizing ROI.
                ...
                <div class="grid grid-cols-2 gap-1 mt-4">
                    <div class="p-3 bg-[#F7F7F7] h-44">
                        ...
                        <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
                            Conduct a thorough product health and risk evaluation.
                    ...
                    <div class="p-3 bg-[#F7F7F7] h-44">
                        ...
                        <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
                            Identify risks that could affect the product's sustainability.
                    ...
                    <div class="p-3 bg-[#F7F7F7] h-44">
                        ...
                        <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
                            Leverage AI to forecast potential issues before they arise.
                    ...
                    <div class="p-3 bg-[#F7F7F7] h-44">
                        ...
                        <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
                            Gather performance data to ensure proactive sustenance decision-making.
            ...
            <div class="card w-full lg:w-1/3 p-6 border-2 border-transparent rounded-md"
                ...
                <div class="grid grid-cols-2 gap-1 mt-4">
                    <div class="p-3 bg-[#F7F7F7] h-44">
                        ...
                        <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
                            Craft personalized product sustenance roadmaps for maximum efficiency.
                    ...
                    <div class="p-3 bg-[#F7F7F7] h-44">
                        ...
                        <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
                            Regular product checks and improvements to maintain peak performance.
                    ...
                    <div class="p-3 bg-[#F7F7F7] h-44">
                        ...
                        <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
                            Seamless transition strategies for legacy systems and product phase-out.
                    ...
                    <div class="p-3 bg-[#F7F7F7] h-44">
                        ...
                        <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
                            Constant optimization efforts to ensure products perform at peak levels.
            ...
            <div class="card w-full lg:w-1/3 p-6 border-2 border-transparent rounded-md"
                ...
                <div class="grid grid-cols-2 gap-1 mt-4">
                    <div class="p-3 bg-[#F7F7F7] h-44">
                        ...
                        <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
                            Execute timely maintenance schedules to prevent unplanned downtime.
                    ...
                    <div class="p-3 bg-[#F7F7F7] h-44">
                        ...
                        <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
                            Address and mitigate risks to ensure product longevity.
                    ...
                    <div class="p-3 bg-[#F7F7F7] h-44">
                        ...
                        <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
                            Manage the phase-out process with minimal disruptions to operations.
                    ...
                    <div class="p-3 bg-[#F7F7F7] h-44">
                        ...
                        <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
                            Implement AI solutions to predict and prevent product failures before they happen.
            ...
            <div class="w-full flex flex-col gap-5 items-start">
                ...
                <div class="flex flex-col gap-5 lg:gap-0 lg:flex-row justify-between w-full">
                    <h2
                        ...
                        <span class="text-gradient">Product Sustenance Management Services</span>
                    </h2>
                        ...
                        <div class="swiper-wrapper bg-[#F2F7FF]">
                                ...
                                <div class="w-full lg:w-1/2 flex flex-col gap-5 px-5 py-4">
                                    <div class="flex flex-col w-full gap-2 pb-4 border-b border-b-[#99899d]">
                                        <h3 class="text-xl md:text-3xl font-semibold">
                                            Enterprise Workflow Automation & Mobility


                                        </h3>
                                        <div class="text-[#333] leading-7 tracking-wide">
                                            <p class="hidden xl:block text-md">
                                                A global Oil & Gas conglomerate faced productivity bottlenecks due to
                                                manual data management, fragmented communications, and antiquated
                                                service reporting. Intellivon's Productive Sustenance Management
                                                automated document tracking, enabled mobile-based data capture, and
                                                integrated workflow monitoring, enhancing traceability and enabling
                                    ...
                                    <ul class="flex flex-col gap-2 list-disc pl-5">
                                        <li class="">
                                            ...
                                            <span>reduction in processing delays</span>
                                        </li>
                                        <li class="">
                                            <span class="xl:text-xl font-semibold">30%</span>
                                            <span> improvement in real-time SLA management</span>
                                        </li>
                                        <li class="">
                                            <span class="xl:text-xl font-semibold">95%</span>
                                            <span> increase in productivity in key business units</span>
                                        </li>
                                    </ul>
                                    <!-- Explore More button -->
                            ...
                            <div
                                ...
                                <div class="w-full lg:w-1/2 flex flex-col gap-5 px-5 py-4">
                                    <div class="flex flex-col w-full gap-2 pb-4 border-b border-b-[#99899d]">
                                        ...
                                        <div class="text-[#333] leading-7 tracking-wide">
                                            <p class="hidden xl:block text-md">
                                                A leading bank struggled to secure, process, and integrate large volumes
                                                of paper and electronic documents across regional and head offices. By
                                                adopting Intellivon's intelligent capture and workflow automation, the
                                                bank achieved digitization of legacy files, better document compliance,
                                                automated approvals, and complete audit trails.
                                    ...
                                    <ul class="flex flex-col gap-2 list-disc pl-5">
                                        ...
                                        <li class="">
                                            ...
                                            <span> reduction in manual errors
                            ...
                            <div
                                ...
                                <div class="w-full lg:w-1/2 flex flex-col gap-5 px-5 py-4">
                                    <div class="flex flex-col w-full gap-2 pb-4 border-b border-b-[#99899d]">
                                        <h3 class="text-xl md:text-3xl font-semibold">
                                            Business Process Automation & Workforce Engagement

                                        </h3>
                                        <div class="text-[#333] leading-7 tracking-wide">
                                            <p class="hidden xl:block text-md">
                                                A multinational manufacturer wanted to boost plant productivity,
                                                minimize production downtime, and enable predictive asset maintenance.
                                                Intellivon implemented automated workflow, mobility-driven shopfloor
                                                reporting, and unified workforce engagement tools. This led to maximized
                                                machine utilization, and streamlined service requests.
                                    ...
                                    <ul class="flex flex-col gap-2 list-disc pl-5">
                                        <li class="">
                                            ...
                                            <span>increase in machine utilization
                                            </span>
                                        </li>
                                        <li class="">
                                        ...
                                        <li class="">
                                            <span class="xl:text-xl font-semibold">40% </span>
                                            <span>boost in workforce engagement</span>
                                        </li>
                                    </ul>
                                    <!-- Explore More button -->
                                    <a href="https://intellivon.com/ai-strategy-call-booking-confirmation/"
                            ...
                            <div
                                ...
                                <div class="w-full lg:w-1/2 flex flex-col gap-5 px-5 py-4">
                                    <div class="flex flex-col w-full gap-2 pb-4 border-b border-b-[#99899d]">
                                        ...
                                        <div class="text-[#333] leading-7 tracking-wide">
                                            <p class="hidden xl:block text-md">
                                                An integrated healthcare provider was challenged with confidential
                                                records management and audit traceability. Intellivon's Productive
                                                Sustenance Management enabled secure digitization, rules-driven workflow
                                                automation for patient documents, and compliance dashboards.
                                    ...
                                    <ul class="flex flex-col gap-2 list-disc pl-5">
                                        <li class="">
                                            <span class="xl:text-xl font-semibold">30% </span>
                                            <span> reduction in document processing time</span>
                                        </li>
                                        <li class="">
                                            <span class="xl:text-xl font-semibold">95% </span>
                                            <span> improvement in regulatory compliance

                                            </span>
                                        </li>
                                        <li class="">
                                            <span class="xl:text-xl font-semibold">25%</span>
                                            <span> reduction in compliance-related risks
                            ...
                            <div
                                ...
                                <div class="w-full lg:w-1/2 flex flex-col gap-5 px-5 py-4">
                                    <div class="flex flex-col w-full gap-2 pb-4 border-b border-b-[#99899d]">
                                        <h3 class="text-xl md:text-3xl font-semibold">
                                            Contact Center Automation and Enterprise Communication

                                        </h3>
                                        <div class="text-[#333] leading-7 tracking-wide">
                                            <p class="hidden xl:block text-md">
                                                A top telecom enterprise seeking future-proof customer service and rapid
                                                scale turned to Intellivon's solutions for virtualized contact centers,
                                                digital document capture, and unified communications. By integrating
                                                these capabilities, the company enhanced agent productivity, reduced
                                                case resolution times, and achieved seamless escalation management
                                                across large, distributed teams, critical for continuity and customer
                                                experience as operations expanded
                                    ...
                                    <ul class="flex flex-col gap-2 list-disc pl-5">
                                        <li class="">
                                            <span class="xl:text-xl font-semibold">40%</span>
                                            <span> reduction in case resolution times</span>
                                        </li>
                                        <li class="">
                                            <span class="xl:text-xl font-semibold">30%</span>
                                            <span>
                                        ...
                                        <li class="">
                                            <span class="xl:text-xl font-semibold">95%</span>
                                            <span> increase in operational scalability
...
<section class="w-full px-5 lg:px-10 py-14 lg:py-20 bg-[#F2F7FF] relative overflow-hidden">
    <div class="container flex flex-col gap-5 items-center">
        ...
        <div class="w-full">
            ...
            <h2
                class="w-full lg:w-11/12 text-4xl gap-3 font-bold text-black1 font-urbanist leading-snug tracking-[0.5px]">
                <span class="text-gradient">How We Apply Our Product Sustenance Expertise Across Industries</span>
            </h2>
        </div>
                ...
                <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide h-full">
                        <div
                            ...
                            <p class="text-center md:text-start">
                                Large enterprises with complex equipment, such as heavy machinery or factory assets,
                                require continuous monitoring to prevent downtime. AI-driven predictive maintenance
                                services analyze data from these machines, predict failures before they occur, and
                                schedule maintenance interventions to minimize disruptions.
                    ...
                    <div class="swiper-slide h-full">
                        <div
                            ...
                            <p class="text-center md:text-start">
                                Enterprises with legacy systems need to extend the product lifecycle without performing
                                costly full replacements. By providing ongoing support, patch management, and
                                performance optimization, legacy products are sustained for longer periods, allowing
                                companies to maximize their return on investment.
                    ...
                    <div class="swiper-slide h-full">
                        <div
                            ...
                            <p class="text-center md:text-start">
                                Products in regulated industries (e.g., pharmaceuticals, medical devices) need to remain
                                compliant with evolving regulations. Product sustenance services include regular updates
                                to ensure ongoing compliance with changing standards, helping enterprises avoid
                                penalties and ensure product safety.
                    ...
                    <div class="swiper-slide h-full">
                        <div
                            ...
                            <div class="flex flex-col md:flex-row gap-5 items-center">
                                ...
                                <h3 class="font-bold text-lg text-center md:text-start">
                                    Sunset & End-of-Life (EOL) Planning
                            ...
                            <p class="text-center md:text-start">
                                Enterprises with older product lines that need to phase out certain versions require a
                                structured EOL management plan. Product sustenance services manage the transition,
                                ensuring that customers continue to receive support while newer products are introduced.
                    ...
                    <div class="swiper-slide h-full">
                        <div
                            ...
                            <p class="text-center md:text-start">
                                Complex products, such as software suites or integrated systems, require continuous
                                performance optimization to stay competitive. Ongoing updates, performance monitoring,
                                and iterative improvements ensure these products meet evolving user needs and
                    ...
                    <div class="swiper-slide h-full">
                        <div
                            ...
                            <div class="flex flex-col md:flex-row gap-5 items-center">
                                ...
                                <h3 class="font-bold text-lg text-center md:text-start">
                                    Seamless Integration of Legacy Products


                                </h3>
                            </div>
                            <p class="text-center md:text-start">
                                Enterprises seeking to incorporate new technologies into their existing product lines
                                require integration services to maintain compatibility and optimize system performance.
                                Product sustenance maintenance bridges the gap, allowing legacy products to coexist with
                                modern technologies.
                    ...
                    <div class="swiper-slide h-full">
                        <div
                            ...
                            <div class="flex flex-col md:flex-row gap-5 items-center">
                                ...
                                <h3 class="font-bold text-lg text-center md:text-start">
                                    Risk Management and Product Security

                                </h3>
                            </div>
                            <p class="text-center md:text-start">
                                Products in critical industries (e.g., healthcare, financial services) require robust
                                security features and risk management. Sustenance services include proactive monitoring,
                                security patches, and risk mitigation strategies to safeguard products against evolving
                    ...
                    <div class="swiper-slide h-full">
                        <div
                            ...
                            <p class="text-center md:text-start">
                                Use Case: Enterprises in niche industries require highly tailored maintenance services
                                for their unique products (e.g., specialized manufacturing equipment, custom-built
                                software). Product sustenance services offer bespoke support, ensuring that the specific
                                needs of these products are met over time.
                ...
                <div class="w-full flex flex-col gap-5 items-start">
                    ...
                    <div class="flex flex-col gap-5 lg:gap-0 lg:flex-row justify-between">
                        <h2
                            ...
                            Your Partner in AI-Driven,

                            <span class="text-gradient"> Agile Product Sustenance </span>
                        </h2>
                        <a href="https://intellivon.com/ai-strategy-call-booking-confirmation/" target="_blank">
                            <div>
                                <button type="button"
                    ...
                    <p class="text-grey1 text-base font-medium">
                        With tailored, cutting-edge solutions, we optimize your product’s lifecycle, mitigate risks, and
                        drive ROI, ensuring long-term value for your enterprise.
            ...
            <div class="choose-card-wrapper w-full h-[212px] md:w-[409px] m-auto lg:m-0 z-10">
                <div class="choose-card shadow-[0_24px_34px_0_rgba(0,0,0,.078)]">
                    ...
                    <div
                        ...
                        <p class="text-sm">
                            We utilize advanced AI to monitor your products proactively, identifying potential issues
                            before they occur, ensuring reliability and maximizing product lifespan across operations.
            ...
            <div class="choose-card-wrapper w-full h-[212px] md:w-[409px] m-auto lg:m-0 z-10">
                <div class="choose-card shadow-[0_24px_34px_0_rgba(0,0,0,.078)]">
                    ...
                    <div
                        ...
                        <p class="text-sm">
                            Our product sustenance services are precisely designed for each industry, ensuring that your
                            unique needs are met with specialized strategies and solutions.
            ...
            <div class="choose-card-wrapper w-full h-[212px] md:w-[409px] m-auto lg:m-0 z-10">
                <div class="choose-card shadow-[0_24px_34px_0_rgba(0,0,0,.078)]">
                    ...
                    <div class="choose-card-front bg-white p-6 flex flex-col gap-8 items-center justify-center">
                        ...
                        <h3 class="text-xl font-semibold text-center"> Comprehensive Risk Mitigation</h3>
                    </div>
                    <!-- Back Side -->
                    <div
                        class="choose-card-back bg-white p-6 flex flex-col gap-4 items-center justify-center text-center text-gray-800">
                        ...
                        <p class="text-sm">
                            We focus on risk management to ensure your products remain compliant and protected,
                            minimizing risks and extending their lifecycle while meeting industry standards.
            ...
            <div class="choose-card-wrapper w-full h-[212px] md:w-[409px] m-auto lg:m-0 z-10">
                <div class="choose-card shadow-[0_24px_34px_0_rgba(0,0,0,.078)]">
                    ...
                    <div
                        ...
                        <p class="text-sm">
                            We bridge the gap between legacy and modern systems, ensuring smooth integration of new
                            technologies into existing infrastructures, optimizing performance, and minimizing
                            disruptions
            ...
            <div class="choose-card-wrapper w-full h-[212px] md:w-[409px] m-auto lg:m-0 z-10">
                <div class="choose-card shadow-[0_24px_34px_0_rgba(0,0,0,.078)]">
                    ...
                    <div
                        ...
                        <p class="text-sm">
                            Our agile and scalable sustenance services adapt to your evolving business needs, ensuring
                            that your products remain competitive as your enterprise grows.
            ...
            <div class="choose-card-wrapper w-full h-[212px] md:w-[409px] m-auto lg:m-0 z-10">
                <div class="choose-card shadow-[0_24px_34px_0_rgba(0,0,0,.078)]">
                    ...
                    <div
                        ...
                        <p class="text-sm">
                            We provide expert end-of-life and sunset management strategies, ensuring a smooth transition
                            and continued support while minimizing disruptions and protecting your investments.
    ...
    <div class="container">
        ...
        <div class="w-full flex flex-col gap-3 items-start">
            ...
            <h2 class="text-4xl font-bold text-black1 font-urbanist leading-snug tracking-[0.5px] w-full md:gap-3">
                ...
                <span class="text-gradient">Effective Product Sustenance</span>
            </h2>
            <div class="w-full flex flex-col lg:flex-row justify-between">
                <p
                    ...
                    We employ cutting-edge AI and data-driven technologies to predict product issues and ensure your
                    products stay operational, driving long-term success.
        ...
        <div class="mt-10">
            ...
            <div class="swiper techSwiper">
                <div class="swiper-wrapper min-h-auto">
                    ...
                    <div class="swiper-slide border-2 border-[#99899d] rounded-[30px]">
                        <div class="flex flex-col w-full items-center gap-5 py-10 lg:py-20">
                            <h3 class="font-bold text-3xl text-center"> Cloud Platforms</h3>
                            <div class="flex flex-wrap justify-center gap-6 mt-5 max-w-[1200px] mx-auto">
                                <!-- Use same layout -->
                                <div
                                    class="technology-edge w-[260px] lg:w-[280px] rounded-full flex items-center gap-3 px-6 py-3 bg-white shadow-sm">
                    ...
                    <div class="swiper-slide border-2 border-[#99899d] rounded-[30px]">
                        <div class="flex flex-col w-full items-center gap-5 py-10 lg:py-20">
                            <h3 class="font-bold text-3xl text-center"> Database Management</h3>
                            <div class="flex flex-wrap justify-center gap-6 mt-5 max-w-[1200px] mx-auto">
                                <!-- Use same layout -->
                                <div
                                    class="technology-edge w-[260px] lg:w-[280px] rounded-full flex items-center gap-3 px-6 py-3 bg-white shadow-sm">
                    ...
                    <div class="swiper-slide border-2 border-[#99899d] rounded-[30px]">
                        <div class="flex flex-col w-full items-center gap-5 py-10 lg:py-20">
                            <h3 class="font-bold text-3xl text-center">Automation & Orchestration</h3>
                            <div class="flex flex-wrap justify-center gap-6 mt-5 max-w-[1200px] mx-auto">
                                <!-- Use same layout -->
                                <div
                                    class="technology-edge w-[260px] lg:w-[280px] rounded-full flex items-center gap-3 px-6 py-3 bg-white shadow-sm">
                    ...
                    <div class="swiper-slide border-2 border-[#99899d] rounded-[30px]">
                        <div class="flex flex-col w-full items-center gap-5 py-10 lg:py-20">
                            <h3 class="font-bold text-3xl text-center">Security</h3>
                            <div class="flex flex-wrap justify-center gap-6 mt-5 max-w-[1200px] mx-auto">
                                <!-- Use same layout -->
                                <div
                                    class="technology-edge w-[260px] lg:w-[280px] rounded-full flex items-center gap-3 px-6 py-3 bg-white shadow-sm">
                    ...
                    <div class="swiper-slide border-2 border-[#99899d] rounded-[30px]">
                        <div class="flex flex-col w-full items-center gap-5 py-10 lg:py-20">
                            <h3 class="font-bold text-3xl text-center">Integration & API Management</h3>
                            <div class="flex flex-wrap justify-center gap-6 mt-5 max-w-[1200px] mx-auto">
                                <!-- Use same layout -->
                                <div
                                    class="technology-edge w-[260px] lg:w-[280px] rounded-full flex items-center gap-3 px-6 py-3 bg-white shadow-sm">
                    ...
                    <div class="swiper-slide border-2 border-[#99899d] rounded-[30px]">
                        <div class="flex flex-col w-full items-center gap-5 py-10 lg:py-20">
                            <h3 class="font-bold text-3xl text-center">Version Control
                            </h3>
                            <div class="flex flex-wrap justify-center gap-6 mt-5 max-w-[1200px] mx-auto">
                                <!-- Use same layout -->
                                <div
                    ...
                    <div class="swiper-slide border-2 border-[#99899d] rounded-[30px]">
                        <div class="flex flex-col w-full items-center gap-5 py-10 lg:py-20">
                            <h3 class="font-bold text-3xl text-center">Data Storage
                            </h3>
                            <div class="flex flex-wrap justify-center gap-6 mt-5 max-w-[1200px] mx-auto">
                                <!-- Use same layout -->
                                <div
                    ...
                    <div class="swiper-slide border-2 border-[#99899d] rounded-[30px]">
                        <div class="flex flex-col w-full items-center gap-5 py-10 lg:py-20">
                            <h3 class="font-bold text-3xl text-center">CI/CD
                            </h3>
                            <div class="flex flex-wrap justify-center gap-6 mt-5 max-w-[1200px] mx-auto">
                                <!-- Use same layout -->
                                <div
                    ...
                    <div class="swiper-slide border-2 border-[#99899d] rounded-[30px]">
                        <div class="flex flex-col w-full items-center gap-5 py-10 lg:py-20">
                            <h3 class="font-bold text-3xl text-center">Business Intelligence & Reporting
                    ...
                    <div class="swiper-slide border-2 border-[#99899d] rounded-[30px]">
                        <div class="flex flex-col w-full items-center gap-5 py-10 lg:py-20">
                            <h3 class="font-bold text-3xl text-center"> Containerizatio
                            </h3>
                            <div class="flex flex-wrap justify-center gap-6 mt-5 max-w-[1200px] mx-auto">
                                <!-- Use same layout -->
                                <div
                    ...
                    <div class="swiper-slide border-2 border-[#99899d] rounded-[30px]">
                        <div class="flex flex-col w-full items-center gap-5 py-10 lg:py-20">
                            <h3 class="font-bold text-3xl text-center">Incident Management
                ...
                <div id="testimonial-slider" class="overflow-hidden relative w-full max-w-full order-1 lg:order-2 z-20">
                    <div id="testimonial-track" class="flex transition-transform duration-500 ease-in-out w-full"
                        ...
                        <div
                            ...
                            <div class="pl-6 h-fit pt-4">
                                <div class="flex flex-col gap-5 font-normal text-black1 mt-5">
                                    Intellivon’s AI-powered predictive maintenance transformed how we handle our legacy
                                    systems. Their proactive approach has minimized unplanned downtime, helping us
                                    maintain operational continuity across global operations.



                                    <div class="text-xl font-medium font-urbanist text-black1">
                                        Chief Operations Officer, Global Manufacturing Enterprise
                        ...
                        <div
                            ...
                            <div class="pl-6 h-fit pt-4">
                                <div class="flex flex-col gap-5 font-normal text-black1 mt-5">
                                    As a leader in fintech, ensuring compliance and performance is critical.
                                    Intellivon’s tailored sustenance strategies have extended the life of our product
                                    suite, enabling us to focus on innovation while reducing operational risks.

                                    <div class="text-xl font-medium font-urbanist text-black1">
                                        Senior Product Manager, Leading Financial Institution
                        ...
                        <div
                            ...
                            <div class="pl-6 h-fit pt-4">
                                <div class="flex flex-col gap-5 font-normal text-black1 mt-5">
                                    With Intellivon’s support, we’ve been able to seamlessly integrate new technologies
                                    with our existing infrastructure. Their expertise in legacy system management has
                                    significantly reduced costs and streamlined our processes.




                                    <div class="text-xl font-medium font-urbanist text-black1">
                                        IT Director, Large Telecommunications Provider
                        ...
                        <div
                            ...
                            <div class="pl-6 h-fit pt-4">
                                <div class="flex flex-col gap-5 font-normal text-black1 mt-5">
                                    As a healthcare tech startup, data integrity and functionality are non-negotiable.
                                    Intellivon’s meticulous product sustenance process gave us confidence in our
                                    product's security and usability. Their insights were instrumental in helping us
                                    meet compliance standards while delivering a high-quality solution to our users.



                                    <div class="text-xl font-medium font-urbanist text-black1">
                                        Product Manager, Renowned Healthcare Enterprise
                        ...
                        <div
                            ...
                            <div class="pl-6 h-fit pt-4">
                                <div class="flex flex-col gap-5 font-normal text-black1 mt-5">
                                    Intellivon’s proactive risk mitigation and compliance management helped us stay
                                    ahead of industry regulations, ensuring our product remains secure and operational.
                                    Their expertise has been invaluable in reducing risk and optimizing product
                                    performance.



                                    <div class="text-xl font-medium font-urbanist text-black1">
                                        Head of Product, Global Pharmaceuticals Company  
    ...
    <div class="container flex flex-col gap-5 items-center">
        ...
        <div class="flex flex-col w-5/6 mt-5">
            ...
            <div class="faq-item">
                <div class="border-t border-[#7C3BAF] flex justify-between py-5 cursor-pointer">
                    <div class="font-medium text-xl">
                        Q1. What is Product Sustenance Management?
                ...
                <div
                    ...
                    <p class="text-base text-[#333]">
                        Product Sustenance Management is the ongoing process of ensuring that mature products remain
                        operational, efficient, and up-to-date over their lifecycle. It involves continuous support,
                        risk mitigation, and optimization to extend the product’s value, ensuring it continues to meet
                        the enterprise's needs while minimizing downtime and costs.
            ...
            <div class="faq-item">
                <div class="border-t border-[#7C3BAF] flex justify-between py-5 cursor-pointer">
                    <div class="font-medium text-xl">
                        Q2. How does Product Sustenance Management impact my enterprise?
                ...
                <div
                    class="faq-answer overflow-hidden max-h-0 opacity-0 transition-all duration-300 ease-in-out px-4 pb-8">
                    <p class="text-base text-[#333]">
                        Product Sustenance Management helps your enterprise by extending the life of existing products,
                        reducing operational risks, and ensuring ongoing performance optimization. This enables your
                        teams to focus on innovation and growth rather than dealing with the challenges of outdated or
                        underperforming products, ultimately improving ROI.
            ...
            <div class="faq-item">
                <div class="border-t border-[#7C3BAF] flex justify-between py-5 cursor-pointer">
                    <div class="font-medium text-xl">
                        Q3. How does Intellivon ensure the longevity of mature products?
                ...
                <div
                    class="faq-answer overflow-hidden max-h-0 opacity-0 transition-all duration-300 ease-in-out px-4 pb-8">
                    <p class="text-base text-[#333]">
                        Intellivon uses AI-driven predictive maintenance to anticipate potential failures, while
                        providing proactive updates, bug fixes, and continuous monitoring to keep products running at
                        peak performance. Our tailored lifecycle strategies ensure that mature products stay relevant
                        and functional, preventing unnecessary downtime and maximizing their value over time.
            ...
            <div class="faq-item">
                <div class="border-t border-[#7C3BAF] flex justify-between py-5 cursor-pointer">
                    <div class="font-medium text-xl">
                        Q4. How do I benefit from AI-driven product sustenance services?
                ...
                <div
                    class="faq-answer overflow-hidden max-h-0 opacity-0 transition-all duration-300 ease-in-out px-4 pb-8">
                    <p class="text-base text-[#333]">
                        AI-driven product sustenance services leverage advanced analytics and machine learning to
                        predict and address issues before they occur. This proactive approach reduces downtime, lowers
                        operational costs, and enhances product reliability, ensuring that your products continue to
                        meet your enterprise’s evolving needs while maximizing ROI.
            ...
            <div class="faq-item">
                <div class="border-t border-[#7C3BAF] flex justify-between py-5 cursor-pointer">
                    <div class="font-medium text-xl">
                        Q5. How can product sustenance services reduce risks for my enterprise?
                ...
                <div
                    ...
                    <p class="text-base text-[#333]">
                        ...
                        Product sustenance services identify and address potential risks before they impact your
                        operations. By providing regular updates, compliance management, and risk mitigation strategies,
                        these services ensure that your products remain secure, efficient, and compliant with industry
                        standards, minimizing the chance of disruptions or costly failures.
            ...
            <div class="faq-item">
                <div class="border-t border-[#7C3BAF] flex justify-between py-5 cursor-pointer">
                    <div class="font-medium text-xl">
                        Q6. Can product sustenance help me maximize ROI on mature products?
                ...
                <div
                    class="faq-answer overflow-hidden max-h-0 opacity-0 transition-all duration-300 ease-in-out px-4 pb-8">
                    <p class="text-base text-[#333]">
                        Yes, by extending the lifecycle of mature products, product sustenance services help you
                        optimize their performance and reduce unnecessary costs. This allows your enterprise to continue
                        leveraging existing products for a longer period, lowering maintenance costs and maximizing the
                        return on your investment while freeing up resources for innovation.
            ...
            <div class="faq-item">
                <div class="border-t border-[#7C3BAF] flex justify-between py-5 cursor-pointer">
                    <div class="font-medium text-xl">
                        Q7. What makes Intellivon’s approach to product sustenance unique?
                ...
                <div
                    class="faq-answer overflow-hidden max-h-0 opacity-0 transition-all duration-300 ease-in-out px-4 pb-8">
                    <p class="text-base text-[#333]">
                        Intellivon combines cutting-edge AI technology with industry-specific expertise to provide
                        highly personalized and agile product sustenance services. Our approach is tailored to each
                        enterprise’s unique needs, ensuring long-term product performance while mitigating risks and
                        maximizing ROI, setting us apart from traditional product maintenance providers.
            ...
            <div class="faq-item">
                <div class="border-t border-[#7C3BAF] flex justify-between py-5 cursor-pointer">
                    <div class="font-medium text-xl">
                        Q8. Why should I choose Intellivon for product sustenance management?
                ...
                <div
                    ...
                    <p class="text-base text-[#333]">
                        ...
                        Intellivon offers a unique combination of AI-powered predictive maintenance, tailored lifecycle
                        management strategies, and deep industry expertise. Unlike other providers, we focus on
                        extending the lifespan of your mature products, optimizing performance, and reducing risks, so
                        you can invest your savings into future innovation and remain ahead of the competition.
