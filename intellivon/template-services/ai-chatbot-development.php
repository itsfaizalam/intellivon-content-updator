<?php /* Template Name: AI Chatbot Development */ ?>
<?php get_header(); ?>
  ...
  <div class="flex">
    <div class="lg:w-full flex flex-col gap-5 px-10 justify-center py-10 lg:p-[150px] lg:text-center">
      <h1 class="font-bold text-4xl lg:text-5xl text-white">
        <span class="text-gradient"> Enterprise-Ready AI Chatbots</span>
        That Power Your Business Operations
      </h1>
      <p class="text-white text-lg font-medium">
        We transform your customer interactions with AI-driven chatbots that understand your users, speak their
        language, and deliver personalized, real-time solutions, empowering your business to solve key challenges.
      </p>
    ...
    <div class="w-full lg:w-2/3 lg:pl-10 px-10 lg:px-0">
      <div class="flex flex-col gap-5 items-start">
        ...
        <h2 class="text-4xl items-center font-bold text-black1 font-urbanist leading-snug tracking-[0.5px] gap-1">
          Delivering Custom AI Chatbots for
          <span class="text-gradient"> Leading Brands </span>
        </h2>
        <p class="mb-4 md:mb-0 text-base font-medium text-grey1 mt-2 w-full tracking-[0.25px] pr-5 mb-12">
          We build enterprise-grade AI chatbots for leading brands, solving their business challenges and unlocking
          multiple streams of ROI.
        </p>
      </div>
    </div>
    <!-- Right column: Image -->
...
<section>
        ...
        <div class="w-full flex flex-col gap-5 items-start">
          ...
          <h2 class="text-4xl font-bold text-black1 font-urbanist leading-snug tracking-[0.5px] w-full">
            <span class="text-gradient">
              Elevate Your Business with Our AI Chatbot Solutions
            </span>
          </h2>
          <p class="mb-4 md:mb-0 text-base font-medium text-grey1 mt-2 w-full tracking-[0.25px] pr-5 mb-12">
            Our skilled team of AI engineers blends cutting-edge AI technology with deep business understanding to
            create chatbots that deliver personalized experiences. This approach helps you engage customers meaningfully
  ...
  <script>
    const services = [
      {
        title: "Custom AI Chatbot Design",
        description:
          "We design personalized chatbot personas and conversation flows specific to your audience and business goals. Our approach ensures that your chatbot interacts naturally, answering specific challenges and enhancing user engagement.",
        points: [
          "Tailored chatbot personas",
          "Intuitive conversation flow",
          "Natural interaction addressing specific challenges",
          "Voice Integration for Seamless Interaction",
      ...
      },
      {
        ...
        description:
          "We integrate advanced NLP models that help your chatbot understand complex queries and respond in a natural, human-like manner.",
        points: [
          "Advanced NLP models",
          "Intent recognition and accurate responses",
          "Human-like interaction through NLP integration",
      ...
      },
      {
        ...
        description:
          "We deliver rule-based chatbots that efficiently handle common questions and routine interactions. They streamline customer support with straightforward and reliable responses.",
        points: [
          "Efficient handling of common questions",
          "Streamlined customer support for routine interactions",
          "Reliable, straightforward responses for businesses",
          "Automated Order Status and Tracking",
          "FAQ Automation and Knowledge Base Integration",
          "Rule-Based Chatbots For Personalization",
...

      {
        ...
        description:
          "Our transactional chatbots enable smooth, automated transactions across your digital platforms. Whether it's booking appointments or managing orders, our bots simplify user journeys by delivering reliable service during interactions.",
        points: [
          "Automated transactions within digital platforms",
          "Simplifying user journeys for bookings and orders",
          "Delivering reliable service for seamless transactions",
...

      {
        ...
        description:
          "Our conversational AI chatbots engage users naturally, mimicking human conversation. They provide sophisticated support, enhance customer engagement, and help cultivate stronger, more lasting relationships.",
        points: [
          "Context-Aware Conversations",
          "Multimodal Interaction Support",
          "Proactive Engagement and Upselling",
          "Real-Time Issue Resolution",
          "Integration with Backend Systems for Real-Time Data",
...

      {
        ...
        description:
          "Our voice-enabled chatbots provide intuitive, hands-free interaction through voice commands, enhancing user accessibility and convenience. They can be integrated across devices and applications.",
        points: [
...

      {
        ...
        description:
          "Our chatbots are tailored to support employees across various departments, including IT, HR, and operations. These bots harmonize internal communications and empower your teams with instant answers to common questions.",
        points: [
          ...
          "Employee Feedback and Survey Collection",
        ],
      },

      {
        title: "MCP in Chatbots",
        description:
          "Our MCP ensures that chatbots can handle complex, context-driven conversations by maintaining continuity and relevance across interactions. This allows for deeper, more meaningful engagements with users.",
        points: [
          "Context-Aware Conversations",
          ...
          "Improve Responses with Contextual Data",
        ],
      },
    ];
    ...
    <div class="flex items-end justify-between mt-6 mb-3">
      ...
      <div class="flex flex-col gap-3 w-full">
        ...
        <p class="text-[#333333] w-full lg:w-3/4 text-base font-medium">
          We follow a structured approach to ensure your AI chatbot aligns perfectly with your business goals and
          exceeds user expectations. Every phase is carefully planned to deliver solutions that are both impactful and
          scalable.
        </p>
      </div>
    </div>
        ...
        <div class="grid grid-cols-2 gap-1 mt-4">
          <div class="p-3 bg-[#F7F7F7] h-44">
            ...
            <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
              Analyze business needs to identify primary challenges and objectives.
            </p>
          </div>
          <div class="p-3 bg-[#F7F7F7] h-44">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
            ...
            <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
              Map detailed user personas and customer journeys.
            </p>
          </div>
          <div class="p-3 bg-[#F7F7F7] h-44">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
            ...
            <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
              Assess the most suitable technologies and platforms.
            </p>
          </div>
          <div class="p-3 bg-[#F7F7F7] h-44">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
            ...
            <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
              Comprehensive feasibility study and risk analysis conducted.
            </p>
          </div>
        </div>
      </div>
      ...
      <div class="card w-full lg:w-1/3 p-6 border-2 border-transparent rounded-md"
        ...
        <div class="grid grid-cols-2 gap-1 mt-4">
          <div class="p-3 bg-[#F7F7F7] h-44">
            ...
            <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
              Design detailed prototypes and flowcharts for visualization.
            </p>
          </div>
          <div class="p-3 bg-[#F7F7F7] h-44">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
            ...
            <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
              We select and train natural language processing (NLP) models.
            </p>
          </div>
          <div class="p-3 bg-[#F7F7F7] h-44">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
            ...
            <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
              Integration planning for chatbots’ seamless integration.
            </p>
          </div>
          <div class="p-3 bg-[#F7F7F7] h-44">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
            ...
            <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
              User testing sessions and iterative feedback loops.
            </p>
          </div>
        </div>
      </div>
      ...
      <div class="card w-full lg:w-1/3 p-6 border-2 border-transparent rounded-md"
        ...
        <div class="grid grid-cols-2 gap-1 mt-4">
          <div class="p-3 bg-[#F7F7F7] h-44">
            ...
            <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
              Undertake full-scale coding and construction of the chatbot.
            </p>
          </div>
          <div class="p-3 bg-[#F7F7F7] h-44">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
            ...
            <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
              Deploy the chatbot across multiple platforms.
            </p>
          </div>
          <div class="p-3 bg-[#F7F7F7] h-44">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
            ...
            <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
              Continuous monitoring of the chatbot’s performance.
            </p>
          </div>
          <div class="p-3 bg-[#F7F7F7] h-44">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
            ...
            <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
              Ongoing support and timely updates to keep the chatbot adaptive.
            </p>
          </div>
        </div>
      </div>
  ...
  <div class="container flex flex-col gap-5 items-center">
    ...
    <div class="w-full">
      ...
      <h2 class="w-full lg:w-11/12 text-4xl gap-3 font-bold text-black1 font-urbanist leading-snug tracking-[0.5px]">
        ...
        <span class="text-gradient">AI Chatbots </span>
      </h2>
    </div>
        ...
        <div class="swiper-wrapper">
          ...
          <div class="swiper-slide h-full">
            <div
              ...
              <p class="text-center md:text-start">
                Our chatbots handle common customer queries, like order status, returns, and shipping details, instantly
                and around the clock, reducing support workload and improving response times.
              </p>
            </div>
          </div>
          ...
          <div class="swiper-slide h-full">
            <div
              ...
              <p class="text-center md:text-start">
                Chatbots engage visitors, ask qualifying questions, recommend products, and guide users through the
                purchase process, boosting conversion rates and reducing cart abandonment.
              </p>
            </div>
          </div>
          ...
          <div class="swiper-slide h-full">
            <div
              ...
              <p class="text-center md:text-start">
                AI assistants manage calendars, book appointments, send reminders, and reschedule meetings
                automatically, simplifying scheduling for both customers and employees.
              </p>
            </div>
          </div>
          <!-- CARD 4 -->
          <div class="swiper-slide h-full">
            <div
              ...
              <p class="text-center md:text-start">
                Chatbots resolve routine IT issues, assist with password resets, and answer HR-related questions,
          ...
          <div class="swiper-slide h-full">
            <div
              ...
              <p class="text-center md:text-start">
                Our bots analyze user preferences and behavior to suggest relevant products, content, or services,
                creating a tailored and engaging user experience.
              </p>
            </div>
          </div>
          ...
          <div class="swiper-slide h-full">
            <div
              ...
              <p class="text-center md:text-start">
                Chatbots process order tracking requests, initiate returns, and handle refund queries, streamlining
                post-purchase support and ensuring customer satisfaction.
              </p>
            </div>
          </div>
          <!-- CARD 7 -->
          <div class="swiper-slide h-full">
            <div
              ...
              <p class="text-center md:text-start">
                Bots gather customer feedback, conduct surveys, and collect insights, providing valuable data for
          ...
          <div class="swiper-slide h-full">
            <div
              ...
              <p class="text-center md:text-start">
                AI chatbots act as a central hub for company information, policies, and procedures, empowering users to
                find answers quickly without human assistance.
              </p>
            </div>
          </div>
          <!-- CARD 9 -->
          <div class="swiper-slide h-full">
            <div
              ...
              <div class="flex flex-col md:flex-row gap-5 items-center">
                ...
                <h3 class="font-bold text-lg text-center md:text-start">
                  Healthcare and Wellness Assistance
                </h3>
              </div>
              <p class="text-center md:text-start">
                Chatbots help users assess symptoms, provide health advice, schedule appointments, and send medication
                reminders, improving patient engagement and care.
              </p>
            </div>
          </div>
          <!-- CARD 10 -->
          <div class="swiper-slide h-full">
            <div
              ...
              <p class="text-center md:text-start">
                Our chatbots communicate in multiple languages and integrate across web, mobile, and messaging
                platforms, ensuring consistent service for a global audience.
              </p>
            </div>
          </div>
        </div>
        ...
        <div class="w-full flex flex-col gap-5 items-start">
          ...
          <div class="flex flex-col gap-5 lg:gap-0 lg:flex-row justify-between">
            <h2 class="w-full lg:w-7/12 text-4xl flex-wrap gap-3 flex items-center font-bold text-black1 font-urbanist">
              Your Trusted
              <span class="text-gradient">AI Chatbot Partner</span>
            </h2>
            <a href="https://intellivon.com/ai-strategy-call-booking-confirmation/" target="_blank">
              <div>
                <button type="button"
          ...
          <p class="text-grey1 text-base font-medium">
            Intellivon blends deep AI expertise with hands-on business experience to deliver enterprise-grade AI chatbot
      ...
      <div class="choose-card-wrapper w-full h-[212px] md:w-[409px] m-auto lg:m-0 z-10">
        <div class="choose-card shadow-[0_24px_34px_0_rgba(0,0,0,.078)]">
          ...
          <div
            ...
            <p class="text-sm">
              Our AI chatbots use advanced NLP to grasp conversation context and user intent across multiple languages,
              ensuring clear and relevant responses every time.
            </p>
          </div>
        </div>
      </div>
      ...
      <div class="choose-card-wrapper w-full h-[212px] md:w-[409px] m-auto lg:m-0 z-10">
        <div class="choose-card shadow-[0_24px_34px_0_rgba(0,0,0,.078)]">
          ...
          <div
            ...
            <p class="text-sm">
              Engage your audience wherever they are, whether on mobile apps, websites, or popular social media
              platforms, with seamless AI chatbot integration across all channels.
            </p>
          </div>
        </div>
      </div>
      ...
      <div class="choose-card-wrapper w-full h-[212px] md:w-[409px] m-auto lg:m-0 z-10">
        <div class="choose-card shadow-[0_24px_34px_0_rgba(0,0,0,.078)]">
          ...
          <div class="choose-card-front bg-white p-6 flex flex-col gap-8 items-center justify-center">
            ...
            <h3 class="text-xl font-semibold text-center">Multilingual Communication</h3>
          </div>
          <!-- Back Side -->
          <div
            class="choose-card-back bg-white p-6 flex flex-col gap-4 items-center justify-center text-center text-gray-800">
            ...
            <p class="text-sm">
              Break language barriers and expand your global reach with our AI chatbots, which are capable of fluent,
      ...
      <div class="choose-card-wrapper w-full h-[212px] md:w-[409px] m-auto lg:m-0 z-10">
        <div class="choose-card shadow-[0_24px_34px_0_rgba(0,0,0,.078)]">
          ...
          <div
            ...
            <p class="text-sm">
              Powered by state-of-the-art machine learning, our AI chatbots handle everything from simple greetings to
              complex inquiries with ease and accuracy.
            </p>
          </div>
        </div>
      </div>
      ...
      <div class="choose-card-wrapper w-full h-[212px] md:w-[409px] m-auto lg:m-0 z-10">
        <div class="choose-card shadow-[0_24px_34px_0_rgba(0,0,0,.078)]">
          ...
          <div
            ...
            <p class="text-sm">
              Equipped with sentiment analysis, our AI chatbots detect user emotions and respond empathetically,
      ...
      <div class="choose-card-wrapper w-full h-[212px] md:w-[409px] m-auto lg:m-0 z-10">
        <div class="choose-card shadow-[0_24px_34px_0_rgba(0,0,0,.078)]">
          ...
          <div
            ...
            <p class="text-sm">
              We ensure your customer data is safe with strict privacy protocols and compliance standards, making our AI
              chatbots an ideal choice for industries such as finance and retail.
            </p>
          </div>
        </div>
      </div>
    ...
    <div class="w-full flex flex-col gap-3 items-start">
      ...
      <div class="w-full flex flex-col lg:flex-row justify-between">
        <p class="capitalize mb-4 md:mb-0 text-base font-medium text-grey1 mt-2 md:w-8/12 tracking-[0.25px] pr-5">
          <!-- Enter sub heading here for "Tech Stack" -->
        </p>
        <!-- Buttons -->
    ...
    <div class="mt-10">
      ...
      <div class="swiper techSwiper">
        <div class="swiper-wrapper min-h-auto">
          ...
          <div class="swiper-slide border-2 border-[#99899d] rounded-[30px]">
            <div class="flex flex-col w-full items-center gap-5 py-10 lg:py-20">
              <h3 class="font-bold text-3xl text-center">Platforms & Frameworks</h3>
              <div class="flex flex-wrap justify-center gap-6 mt-5 max-w-[1200px] mx-auto">
                <!-- Use same layout -->
                <div
                  class="technology-edge w-[260px] lg:w-[280px] rounded-full flex items-center gap-3 px-6 py-3 bg-white shadow-sm">
        ...
        <div id="testimonial-slider" class="overflow-hidden relative w-full max-w-full order-1 lg:order-2 z-20">
          <div id="testimonial-track" class="flex transition-transform duration-500 ease-in-out w-full"
            ...
            <div
              ...
              <div class="pl-6 h-fit pt-4">
                <div class="flex flex-col gap-5 font-normal text-black1 mt-5">
                  Our healthcare startup struggled to manage 24/7 patient inquiries. Intellivon built an AI chatbot for
                  us that now handles triage and appointment booking flawlessly, significantly reducing staff workload.
            ...
            <div
              ...
              <div class="pl-6 h-fit pt-4">
                <div class="flex flex-col gap-5 font-normal text-black1 mt-5">
                  As a fintech company, we required instant fraud alerts and automated customer support. Stratym’s
                  chatbot solution improved our support efficiency and enhanced user trust.
                  <div class="text-xl font-medium font-urbanist text-black1">
                    CTO, Fintech
                  </div>
                </div>
            ...
            <div
              ...
              <div class="pl-6 h-fit pt-4">
                <div class="flex flex-col gap-5 font-normal text-black1 mt-5">
                  Our fitness app users loved the personalized coaching avatars created by Intellivon. It boosted
                  engagement and retention beyond expectations. Now, our fitness community continues to grow, thanks to
                  Intellivon
                  <div class="text-xl font-medium font-urbanist text-black1">
                    CEO, Digital Fitness
                  </div>
            ...
            <div
              ...
              <div class="pl-6 h-fit pt-4">
                <div class="flex flex-col gap-5 font-normal text-black1 mt-5">
                  Intellivon’s AI agents helped us automate lead qualification and onboarding, shortening our sales
                  cycle and freeing our team to focus on closing deals. Our customer onboarding and retention rate it
                  growing at a fast scale.
                  <div class="text-xl font-medium font-urbanist text-black1">
                    Sales Director, SaaS Startup
                  </div>
                </div>
              </div>
            </div>
            ...
            <div
              ...
              <div class="pl-6 h-fit pt-4">
                <div class="flex flex-col gap-5 font-normal text-black1 mt-5">
                  We needed a secure chatbot for transaction tracking. Stratym delivered a reliable bot that our users
                  find incredibly helpful and easy to use.
                  <div class="text-xl font-medium font-urbanist text-black1">
  ...
  <div class="container flex flex-col gap-5 items-center">
    ...
    <div class="flex flex-col w-5/6 mt-5">
      ...
      <div class="faq-item">
        <div class="border-t border-[#7C3BAF] flex justify-between py-5 cursor-pointer">
          <div class="font-medium text-xl">
            Q1. What is an AI chatbot, and how can it benefit my business?
          </div>
          <div class="faq-icon">
        ...
        <div class="faq-answer overflow-hidden max-h-0 opacity-0 transition-all duration-300 ease-in-out px-4 pb-8">
          <p class="text-base text-[#333]">
            An AI chatbot is an intelligent software that simulates human conversation to automate customer
            interactions. It benefits businesses by providing 24/7 support, reducing response times, increasing customer
            engagement, and lowering operational costs.
          </p>
        </div>
      </div>
      <!-- FAQ Item 2 -->
      <div class="faq-item">
        <div class="border-t border-[#7C3BAF] flex justify-between py-5 cursor-pointer">
          <div class="font-medium text-xl">
            Q2. How long does it take to develop a custom AI chatbot?
          </div>
          <div class="faq-icon">
            <svg xmlns="http://www.w3.org/2000/svg" width="27" height="27" viewBox="0 0 27 27" fill="none">
              <path class="vertical-path" d="M13.2227 2.61133V23.7671" stroke="black" stroke-width="4.6301"
        ...
        <div class="faq-answer overflow-hidden max-h-0 opacity-0 transition-all duration-300 ease-in-out px-4 pb-8">
          <p class="text-base text-[#333]">
            Developing a custom AI chatbot typically takes 8 to 20 weeks, depending on complexity, features, and
      ...
      <div class="faq-item">
        <div class="border-t border-[#7C3BAF] flex justify-between py-5 cursor-pointer">
          <div class="font-medium text-xl">
            Q3. Can AI chatbots integrate with my existing CRM or backend systems?
          </div>
          <div class="faq-icon">
            <svg xmlns="http://www.w3.org/2000/svg" width="27" height="27" viewBox="0 0 27 27" fill="none">
              <path class="vertical-path" d="M13.2227 2.61133V23.7671" stroke="black" stroke-width="4.6301"
        ...
        <div class="faq-answer overflow-hidden max-h-0 opacity-0 transition-all duration-300 ease-in-out px-4 pb-8">
          <p class="text-base text-[#333]">
            Yes, AI chatbots can seamlessly integrate with most CRM platforms and backend systems to provide
            personalized, context-aware customer interactions.
          </p>
        </div>
      </div>
      <!-- FAQ Item 4 -->
      <div class="faq-item">
        <div class="border-t border-[#7C3BAF] flex justify-between py-5 cursor-pointer">
          <div class="font-medium text-xl">
            Q4. How does Intellivon ensure data privacy and security in chatbot development?
          </div>
          <div class="faq-icon">
            <svg xmlns="http://www.w3.org/2000/svg" width="27" height="27" viewBox="0 0 27 27" fill="none">
              <path class="vertical-path" d="M13.2227 2.61133V23.7671" stroke="black" stroke-width="4.6301"
        ...
        <div class="faq-answer overflow-hidden max-h-0 opacity-0 transition-all duration-300 ease-in-out px-4 pb-8">
          <p class="text-base text-[#333]">
            Intellivon employs industry-standard encryption and secure authentication and complies with regulations like
            GDPR and HIPAA to safeguard user data and ensure privacy.
          </p>
        </div>
      </div>
      <!-- FAQ Item 5 -->
      <div class="faq-item">
        <div class="border-t border-[#7C3BAF] flex justify-between py-5 cursor-pointer">
          <div class="font-medium text-xl">
            Q5. What industries do we specialize in for AI chatbot solutions?
          </div>
          <div class="faq-icon">
            <svg xmlns="http://www.w3.org/2000/svg" width="27" height="27" viewBox="0 0 27 27" fill="none">
              <path class="vertical-path" d="M13.2227 2.61133V23.7671" stroke="black" stroke-width="4.6301"
        ...
        <div class="faq-answer overflow-hidden max-h-0 opacity-0 transition-all duration-300 ease-in-out px-4 pb-8">
          <p class="text-base text-[#333]">
            Intellivon specializes in healthcare, fintech, digital fitness, blockchain, real estate, insurance, retail,
      ...
      <div class="faq-item">
        <div class="border-t border-[#7C3BAF] flex justify-between py-5 cursor-pointer">
          <div class="font-medium text-xl">
            Q6. How do AI chatbots improve customer engagement and satisfaction?
          </div>
          <div class="faq-icon">
            <svg xmlns="http://www.w3.org/2000/svg" width="27" height="27" viewBox="0 0 27 27" fill="none">
              <path class="vertical-path" d="M13.2227 2.61133V23.7671" stroke="black" stroke-width="4.6301"
        ...
        <div class="faq-answer overflow-hidden max-h-0 opacity-0 transition-all duration-300 ease-in-out px-4 pb-8">
          <p class="text-base text-[#333]">
            AI chatbots offer instant responses, personalized interactions, and 24/7 availability, which increase
            customer satisfaction and foster stronger engagement.
          </p>
        </div>
      </div>
      <!-- FAQ Item 7 -->
      <div class="faq-item">
        <div class="border-t border-[#7C3BAF] flex justify-between py-5 cursor-pointer">
          <div class="font-medium text-xl">
            Q7. Can our chatbots handle multi-language conversations?
          </div>
          <div class="faq-icon">
            <svg xmlns="http://www.w3.org/2000/svg" width="27" height="27" viewBox="0 0 27 27" fill="none">
              <path class="vertical-path" d="M13.2227 2.61133V23.7671" stroke="black" stroke-width="4.6301"
        ...
        <div class="faq-answer overflow-hidden max-h-0 opacity-0 transition-all duration-300 ease-in-out px-4 pb-8">
          <p class="text-base text-[#333]">
            Yes, our chatbots support multiple languages to serve diverse customer bases and expand global reach.
          </p>
        </div>
      </div>
      <!-- FAQ Item 8 -->
      <div class="faq-item">
        <div class="border-t border-[#7C3BAF] flex justify-between py-5 cursor-pointer">
          <div class="font-medium text-xl">
            Q8. What ongoing support and maintenance do we provide after deployment?
          </div>
          <div class="faq-icon">
            <svg xmlns="http://www.w3.org/2000/svg" width="27" height="27" viewBox="0 0 27 27" fill="none">
              <path class="vertical-path" d="M13.2227 2.61133V23.7671" stroke="black" stroke-width="4.6301"
        ...
        <div class="faq-answer overflow-hidden max-h-0 opacity-0 transition-all duration-300 ease-in-out px-4 pb-8">
          <p class="text-base text-[#333]">
            We provide continuous monitoring, performance optimization, regular updates, and retraining to keep your chatbot effective and aligned with business needs.
          </p>
        </div>
      </div>
    </div>
