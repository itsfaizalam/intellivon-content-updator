<?php /* Template Name: Modernization*/ ?>
<?php get_header(); ?>
<!-- Intellivon Menubar Start -->
<!-- developed by - Sachin Gangwar 13-08-2025 -->
    ...
    <div class="flex">
        <div class="lg:w-full flex flex-col gap-5 px-10 justify-center py-10 lg:p-[150px] lg:text-center">
            <h1 class="font-bold text-4xl lg:text-5xl text-white">
                Unlock
                <span class="text-gradient">Product and Platform Modernization for Future-Ready Enterprises
                </span>
            </h1>
            <p class="text-white text-lg font-medium">
                We help enterprises modernize their legacy platforms and products, leveraging cutting-edge technologies
                to enhance agility, scalability, and performance, thereby supporting future business growth.
        ...
        <div class="w-full lg:w-2/3 lg:pl-10 px-10 lg:px-0">
            <div class="flex flex-col gap-5 items-start">
                ...
                <h2
                    ...
                    Empowering Clients to Lead in

                    <span class="text-gradient"> Digital Transformation</span>
                </h2>
                <p class="mb-4 md:mb-0 text-base font-medium text-grey1 mt-2 w-full tracking-[0.25px] pr-5 mb-12">
                    We’ve partnered with industry leaders, helping them navigate complex product and platform
                    modernization projects, resulting in accelerated time-to-market and enhanced customer experiences.
                ...
                <div class="w-full flex flex-col gap-5 items-start">
                    ...
                    <h2 class="text-4xl font-bold text-black1 font-urbanist leading-snug tracking-[0.5px] w-full">
                        ...
                        <span class="text-gradient">
                            Product and Platform Modernization Services
                        </span>
                    </h2>
                    <p class="mb-4 md:mb-0 text-base font-medium text-grey1 mt-2 w-full tracking-[0.25px] pr-5 mb-12">
                        Our services are designed to revamp your product architecture, streamline platform integration,
                        and accelerate innovation, enabling you to build agile, scalable solutions that meet your
                        business needs.
        ...
        const services = [
            {
                ...
                description:
                    "We begin by conducting a thorough assessment of your current systems, identifying key gaps, and crafting a strategic modernization roadmap that aligns with your business goals.",
                points: [
                    "Current State Analysis & Technology Audit",
                    "Business Value & ROI Modeling",
                    "Target State Definition & Future-Ready Architecture",
                    "Modernization Roadmap & Prioritization",
                    "Resource and Technology Requirement Assessment",
                    "Clear Success Metrics and KPIs Definition",
                ],
            ...
            },
            {
                ...
                description:
                    "Our team helps safely decommission outdated systems and migrate critical data and functionalities to modern platforms, ensuring minimal disruption to your operations.",
                points: [
                    "Legacy System Decommissioning Strategy",
                    "Cloud Platform Integration & Migration",
                    "Data Migration & Integrity Assurance",
                    "Application Migration to Cloud-Native Environments",
                    "Seamless Transition for Business Continuity",
            ...
            },
            {
                ...
                description:
                    "We break down monolithic applications into independent microservices, enabling scalable, flexible, and faster product development cycles while maintaining system integrity.",
                points: [
                    "Monolithic System Decomposition & Microservices Design",
                    "API-First Development Strategy",
                    "Scalable Architecture for Future Growth",
                    "Reduced Time-to-Market for New Features",
                    "Accelerated Product Iteration with Microservices",
            ...
            },
            {
                ...
                description:
                    "We re-architect your applications for optimal performance in public, private, or hybrid cloud environments, utilizing serverless computing for cost efficiency and scalability.",
                points: [
                    "Cloud-Native Architecture Design & Migration",
                    "Serverless Computing for Scalability & Flexibility",
                    "Cost Optimization for Cloud Environments",
                    "Cloud Infrastructure Setup & Integration",
                    "Automated Scaling & Load Balancing",
                    "Increased Application Performance & Availability",
                ],
...

            {
                ...
                description:
                    "We help design and implement API-driven architectures to enable seamless integration with internal and external systems, fostering new business opportunities and innovation.",
                points: [
                    ...
                    "Enabling New Business Models via APIs",
                ],
...

            {
                ...
                description:
                    "We assist in migrating legacy databases to modern data platforms, implementing AI, machine learning, and advanced analytics to unlock new insights and drive business value.",
                points: [
                    "Cloud Data Warehouse & Data Lake Solutions",
                    "NoSQL & Relational Database Modernization",
                    "Data Migration Strategy & Execution",
                    "AI and Machine Learning for Data Insights",
        ...
        <div class="flex items-end justify-between mt-6 mb-3">
            ...
            <div class="flex flex-col gap-3 w-full">
                ...
                <h2
                    ...
                    Our Step-by-Step Approach to Modernizing Products and Platforms

                    <span class="text-gradient"> in 3 Steps </span>
                </h2>
                <p class="text-[#333333] w-full lg:w-3/4 text-base font-medium">
                    We follow a structured, results-driven process, from initial assessment and strategy to full
                    implementation and optimization, ensuring a smooth and successful modernization of products and
                    platforms.
                ...
                <div class="grid grid-cols-2 gap-1 mt-4">
                    <div class="p-3 bg-[#F7F7F7] h-44">
                        ...
                        <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
                            Conduct market research to identify gaps and validate product ideas.
                    ...
                    <div class="p-3 bg-[#F7F7F7] h-44">
                        ...
                        <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
                            Assess customer needs through interviews, surveys, and competitor analysis.
                    ...
                    <div class="p-3 bg-[#F7F7F7] h-44">
                        ...
                        <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
                            Define the product’s value proposition and market fit.
                    ...
                    <div class="p-3 bg-[#F7F7F7] h-44">
                        ...
                        <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
                            Analyze feasibility and resource requirements for successful execution.
            ...
            <div class="card w-full lg:w-1/3 p-6 border-2 border-transparent rounded-md"
                ...
                <div class="grid grid-cols-2 gap-1 mt-4">
                    <div class="p-3 bg-[#F7F7F7] h-44">
                        ...
                        <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
                            Outline the product roadmap, taking into account key features and development processes.
                    ...
                    <div class="p-3 bg-[#F7F7F7] h-44">
                        ...
                        <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
                            Plan for scalability, security, target audience, and cost considerations.
                    ...
                    <div class="p-3 bg-[#F7F7F7] h-44">
                        ...
                        <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
                            Define the tools, infrastructure, and design requirements for the development process.
                    ...
                    <div class="p-3 bg-[#F7F7F7] h-44">
                        ...
                        <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
                            Gather insights from product discovery to design solutions that fit user needs.
            ...
            <div class="card w-full lg:w-1/3 p-6 border-2 border-transparent rounded-md"
                ...
                <div class="grid grid-cols-2 gap-1 mt-4">
                    <div class="p-3 bg-[#F7F7F7] h-44">
                        ...
                        <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
                            Develop the MVP using DevOps practices and CI/CD pipelines.
                    ...
                    <div class="p-3 bg-[#F7F7F7] h-44">
                        ...
                        <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
                            Ensure scalability with microservices, modular design, and MACH principles.
                    ...
                    <div class="p-3 bg-[#F7F7F7] h-44">
                        ...
                        <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
                            Implement comprehensive testing strategies for automated and manual testing.
                    ...
                    <div class="p-3 bg-[#F7F7F7] h-44">
                        ...
                        <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
                            Deploy the product with cloud-native, serverless architectures.
            ...
            <div class="w-full flex flex-col gap-5 items-start">
                ...
                <div class="flex flex-col gap-5 lg:gap-0 lg:flex-row justify-between w-full">
                    <h2
                        ...
                        Proven Impact From Our


                        <span class="text-gradient">Product and Platform Modernization Services</span>
                    </h2>
                        ...
                        <div class="swiper-wrapper bg-[#F2F7FF]">
                                ...
                                <div class="w-full lg:w-1/2 flex flex-col gap-5 px-5 py-4">
                                    <div class="flex flex-col w-full gap-2 pb-4 border-b border-b-[#99899d]">
                                        <h3 class="text-xl md:text-3xl font-semibold">
                                            Transforming Learning Platforms for Scalability

                                        </h3>
                                        <div class="text-[#333] leading-7 tracking-wide">
                                            <p class="hidden xl:block text-md">
                                                A leading EdTech company faced limitations with outdated infrastructure.
                                                We modernized their learning management system with cloud-native
                                                architecture, microservices, and API-first integration, enhancing
                                    ...
                                    <ul class="flex flex-col gap-2 list-disc pl-5">
                                        <li class="">
                                            ...
                                            <span> improvement in platform performance during peak usage</span>
                                        </li>
                                        <li class="">
                                            <span class="xl:text-xl font-semibold">25%</span>
                                            <span> reduction in operational costs through cloud-native
                                                architecture</span>
                                        </li>
                                        <li class="">
                                            <span class="xl:text-xl font-semibold">50%</span>
                                            <span> faster course load times, improving user experience</span>
                                        </li>
                                    </ul>
                                    <!-- Explore More button -->
                            ...
                            <div
                                ...
                                <div class="w-full lg:w-1/2 flex flex-col gap-5 px-5 py-4">
                                    <div class="flex flex-col w-full gap-2 pb-4 border-b border-b-[#99899d]">
                                        <h3 class="text-xl md:text-3xl font-semibold">
                                            Cloud-Based Platform Transformation for Seamless Operations


                                        </h3>
                                        <div class="text-[#333] leading-7 tracking-wide">
                                            <p class="hidden xl:block text-md">
                                                An InsureTech firm struggled with legacy systems that impacted claim
                                                processing and policy offerings. We modernized their platform by
                                                migrating to the cloud, implementing microservices, and integrating AI
                                    ...
                                    <ul class="flex flex-col gap-2 list-disc pl-5">
                                        ...
                                        <li class="">
                                            ...
                                            <span>
                                                increase in operational efficiency through real-time integrations
                                        ...
                                        <li class="">
                                            ...
                                            <span> faster policy issuance and updates due to modular architecture
                                            </span>
                                        </li>
                                    </ul>
                                    <!-- Explore More button -->
                            ...
                            <div
                                ...
                                <div class="w-full lg:w-1/2 flex flex-col gap-5 px-5 py-4">
                                    <div class="flex flex-col w-full gap-2 pb-4 border-b border-b-[#99899d]">
                                        <h3 class="text-xl md:text-3xl font-semibold">
                                            Modernizing Smart Factory Systems for Operational Efficiency
                                        </h3>
                                        <div class="text-[#333] leading-7 tracking-wide">
                                            <p class="hidden xl:block text-md">
                                                A manufacturing firm experienced inefficiencies due to siloed data and
                                                outdated systems. We modernized their platform by implementing IoT
                                                devices, AI, and cloud-native technologies for predictive maintenance
                                    ...
                                    <ul class="flex flex-col gap-2 list-disc pl-5">
                                        <li class="">
                                            <span class="xl:text-xl font-semibold">40% </span>
                                            <span> reduction in unplanned downtimes, improving production efficiency
                                            </span>
                                        </li>
                                        <li class="">
                                            <span class="xl:text-xl font-semibold">30%</span>
                                            <span>
                                                improvement in supply chain decisions through real-time data
                                        ...
                                        <li class="">
                                            ...
                                            <span>system availability with cloud-native infrastructure</span>
                                        </li>
                                    </ul>
                                    <!-- Explore More button -->
                                    <a href="https://intellivon.com/ai-strategy-call-booking-confirmation/"
                            ...
                            <div
                                ...
                                <div class="w-full lg:w-1/2 flex flex-col gap-5 px-5 py-4">
                                    <div class="flex flex-col w-full gap-2 pb-4 border-b border-b-[#99899d]">
                                        <h3 class="text-xl md:text-3xl font-semibold">
                                            Scaling a Cloud Platform for Global Expansion

                                        </h3>
                                        <div class="text-[#333] leading-7 tracking-wide">
                                            <p class="hidden xl:block text-md">
                                                A large SaaS enterprise struggled with a monolithic architecture that
                                                limited scalability and feature deployment. We implemented microservices
                                                and serverless computing to scale their platform for global expansion.
                                            </p>
                                            <p class="xl:hidden leading-0 line-clamp-5 read-more-content text-sm">
                                                A large SaaS enterprise struggled with a monolithic architecture that
                                                limited scalability and feature deployment. We implemented microservices
                                    ...
                                    <ul class="flex flex-col gap-2 list-disc pl-5">
                                        <li class="">
                                            ...
                                            <span> faster deployment of new features</span>
                                        </li>
                                        <li class="">
                                            <span class="xl:text-xl font-semibold">50% </span>
                                            <span> reduction in downtime during traffic surges
                                            </span>
                                        </li>
                                        <li class="">
                                            <span class="xl:text-xl font-semibold">60%</span>
                                            <span> improvement in system performance and responsiveness
                                            </span>
                                        </li>
                                    </ul>
                                    <!-- Explore More button -->
                            ...
                            <div
                                ...
                                <div class="w-full lg:w-1/2 flex flex-col gap-5 px-5 py-4">
                                    <div class="flex flex-col w-full gap-2 pb-4 border-b border-b-[#99899d]">
                                        <h3 class="text-xl md:text-3xl font-semibold">
                                            Modernizing Farm Management Systems for Data-Driven Agriculture

                                        </h3>
                                        <div class="text-[#333] leading-7 tracking-wide">
                                            <p class="hidden xl:block text-md">
                                                An Agritech company faced challenges with outdated farm management
                                                software that didn’t support IoT and AI. We migrated their platform to
                                                the cloud, integrating IoT and AI for better crop and resource
                                                management.
                                    ...
                                    <ul class="flex flex-col gap-2 list-disc pl-5">
                                        <li class="">
                                            ...
                                            <span> increase in crop yield due to data-driven decisions</span>
                                        </li>
                                        <li class="">
                                            <span class="xl:text-xl font-semibold">15%</span>
                                            <span>
                                                reduction in water usage and fertilizer costs through optimized resource
                                                allocation
                                        ...
                                        <li class="">
                                            ...
                                            <span> increase in data accuracy with IoT and machine learning integration
                                            </span>
                                        </li>
                                    </ul>
                                    <!-- Explore More button -->
...
<section class="w-full px-5 lg:px-10 py-14 lg:py-20 bg-[#F2F7FF] relative overflow-hidden">
    <div class="container flex flex-col gap-5 items-center">
        ...
        <div class="w-full">
            ...
            <h2
                class="w-full lg:w-11/12 text-4xl gap-3 font-bold text-black1 font-urbanist leading-snug tracking-[0.5px]">
                <span class="text-gradient">Use Cases of Successful Product and Platform Modernization </span>
            </h2>
        </div>
                ...
                <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide h-full">
                        <div
                            ...
                            <p class="text-center md:text-start">
                                Organizations can migrate legacy systems to cloud-native architectures to enhance
                                scalability, flexibility, and resource utilization, meeting the growing demands of their
                                business.
                    ...
                    <div class="swiper-slide h-full">
                        <div
                            ...
                            <p class="text-center md:text-start">
                                Businesses can transition from monolithic applications to microservices, enabling
                                independent development, better scalability, and faster feature deployment across the
                                platform.
                    ...
                    <div class="swiper-slide h-full">
                        <div
                            ...
                            <p class="text-center md:text-start">
                                Adopting an API-first strategy allows organizations to streamline integrations, improve
                                internal and external connectivity, and enable new service offerings through
                    ...
                    <div class="swiper-slide h-full">
                        <div
                            ...
                            <p class="text-center md:text-start">
                                Enterprises can safely retire legacy platforms by migrating to modern, cloud-based
                                systems, ensuring enhanced performance, security, and operational efficiency during the
                                transition.
                    ...
                    <div class="swiper-slide h-full">
                        <div
                            ...
                            <p class="text-center md:text-start">
                                Implementing DevOps practices and CI/CD pipelines accelerates the software release
                                cycle, enabling faster updates, better collaboration between development and operations
                                teams, and improved software quality.
                    ...
                    <div class="swiper-slide h-full">
                        <div
                            ...
                            <p class="text-center md:text-start">
                                Modernizing legacy data platforms into cloud-based data warehouses or data lakes enables
                                real-time analytics, improved data governance, and supports advanced AI/ML applications.
                    ...
                    <div class="swiper-slide h-full">
                        <div
                            ...
                            <p class="text-center md:text-start">
                                Migrating to serverless computing models removes the need for managing infrastructure,
                                enabling cost efficiency and allowing the business to scale automatically based on
                                demand.
                    ...
                    <div class="swiper-slide h-full">
                        <div
                            ...
                            <p class="text-center md:text-start">
                                Redesigning outdated user interfaces to modern, intuitive designs improves user
                                satisfaction, engagement, and accessibility, driving better overall platform usability
                                and retention.
                ...
                <div class="w-full flex flex-col gap-5 items-start">
                    ...
                    <div class="flex flex-col gap-5 lg:gap-0 lg:flex-row justify-between">
                        <h2
                            ...
                            <span class="text-gradient">Modernization Services </span>
                        </h2>
                        <a href="https://intellivon.com/ai-strategy-call-booking-confirmation/" target="_blank">
                            <div>
                                <button type="button"
                    ...
                    <p class="text-grey1 text-base font-medium">
                        Our client-first approach ensures that we understand your goals, tailor solutions to your unique
                        challenges, and drive seamless, high-impact product modernization outcomes.
            ...
            <div class="choose-card-wrapper w-full h-[212px] md:w-[409px] m-auto lg:m-0 z-10">
                <div class="choose-card shadow-[0_24px_34px_0_rgba(0,0,0,.078)]">
                    ...
                    <div
                        ...
                        <p class="text-sm">
                            With 11 years of experience in product and platform modernization, we deliver seamless,
                            scalable solutions tailored to meet your unique business needs and future goals.
            ...
            <div class="choose-card-wrapper w-full h-[212px] md:w-[409px] m-auto lg:m-0 z-10">
                <div class="choose-card shadow-[0_24px_34px_0_rgba(0,0,0,.078)]">
                    ...
                    <div
                        ...
                        <p class="text-sm">
                            We don’t offer one-size-fits-all solutions. Intellivon crafts a personalized modernization
                            strategy that aligns with your business objectives, technology stack, and market demands.
            ...
            <div class="choose-card-wrapper w-full h-[212px] md:w-[409px] m-auto lg:m-0 z-10">
                <div class="choose-card shadow-[0_24px_34px_0_rgba(0,0,0,.078)]">
                    ...
                    <div class="choose-card-front bg-white p-6 flex flex-col gap-8 items-center justify-center">
                        ...
                        <h3 class="text-xl font-semibold text-center"> End-to-End Modernization Support</h3>
                    </div>
                    <!-- Back Side -->
                    <div
                        class="choose-card-back bg-white p-6 flex flex-col gap-4 items-center justify-center text-center text-gray-800">
                        ...
                        <p class="text-sm">
                            From assessment and strategy to execution and ongoing optimization, we provide full-service
                            support throughout the entire modernization journey, ensuring lasting value at every stage.
            ...
            <div class="choose-card-wrapper w-full h-[212px] md:w-[409px] m-auto lg:m-0 z-10">
                <div class="choose-card shadow-[0_24px_34px_0_rgba(0,0,0,.078)]">
                    ...
                    <div
                        ...
                        <p class="text-sm">
                            We leverage the latest cloud platforms, microservices, containerization, and AI tools to
                            ensure your product and platform are modern, secure, and future-ready.
            ...
            <div class="choose-card-wrapper w-full h-[212px] md:w-[409px] m-auto lg:m-0 z-10">
                <div class="choose-card shadow-[0_24px_34px_0_rgba(0,0,0,.078)]">
                    ...
                    <div
                        ...
                        <p class="text-sm">
                            Our expertise ensures that all modernization efforts comply with industry standards and
                            regulatory requirements, minimizing risks and ensuring governance is built into the process.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="choose-card-wrapper w-full h-[212px] md:w-[409px] m-auto lg:m-0 z-10">
                <div class="choose-card shadow-[0_24px_34px_0_rgba(0,0,0,.078)]">
                    ...
                    <div
                        ...
                        <p class="text-sm">
                            Intellivon is committed to being your long-term partner. We don’t just modernize your
                            systems; we help you continuously innovate and stay ahead of technological trends.
    ...
    <div class="container">
        ...
        <div class="w-full flex flex-col gap-3 items-start">
            ...
            <h2 class="text-4xl font-bold text-black1 font-urbanist leading-snug tracking-[0.5px] w-full md:gap-3">
                Tech Stack Driving Your
                <span class="text-gradient">Product and Platform Modernization</span>
            </h2>
            <div class="w-full flex flex-col lg:flex-row justify-between">
                <p
                    ...
                    We utilize cutting-edge technologies like AI, IoT, and blockchain, combined with cloud and
                    microservices architectures, to create future-ready, scalable platforms and products for our
                    clients.
            ...
            <div class="swiper techSwiper">
                <div class="swiper-wrapper min-h-auto">
                    ...
                    <div class="swiper-slide border-2 border-[#99899d] rounded-[30px]">
                        ...
                        <div class="swiper-slide border-2 border-[#99899d] rounded-[30px]">
                            <div class="flex flex-col w-full items-center gap-5 py-10 lg:py-20">
                                <h3 class="font-bold text-3xl text-center"> Microservices & Architecture</h3>
                                <div class="flex flex-wrap justify-center gap-6 mt-5 max-w-[1200px] mx-auto">
                                    <!-- Use same layout -->
                                    <div
                                        class="technology-edge w-[260px] lg:w-[280px] rounded-full flex items-center gap-3 px-6 py-3 bg-white shadow-sm">
                        ...
                        <div class="swiper-slide border-2 border-[#99899d] rounded-[30px]">
                            <div class="flex flex-col w-full items-center gap-5 py-10 lg:py-20">
                                <h3 class="font-bold text-3xl text-center"> Data & Analytics</h3>
                                <div class="flex flex-wrap justify-center gap-6 mt-5 max-w-[1200px] mx-auto">
                                    <!-- Use same layout -->
                                    <div
                                        class="technology-edge w-[260px] lg:w-[280px] rounded-full flex items-center gap-3 px-6 py-3 bg-white shadow-sm">
                        ...
                        <div class="swiper-slide border-2 border-[#99899d] rounded-[30px]">
                            <div class="flex flex-col w-full items-center gap-5 py-10 lg:py-20">
                                <h3 class="font-bold text-3xl text-center"> Databases</h3>
                                <div class="flex flex-wrap justify-center gap-6 mt-5 max-w-[1200px] mx-auto">
                                    <!-- Use same layout -->
                                    <div
                                        class="technology-edge w-[260px] lg:w-[280px] rounded-full flex items-center gap-3 px-6 py-3 bg-white shadow-sm">
                        ...
                        <div class="swiper-slide border-2 border-[#99899d] rounded-[30px]">
                            <div class="flex flex-col w-full items-center gap-5 py-10 lg:py-20">
                                <h3 class="font-bold text-3xl text-center"> Frontend & UI/UX Technologies</h3>
                                <div class="flex flex-wrap justify-center gap-6 mt-5 max-w-[1200px] mx-auto">
                                    <!-- Use same layout -->
                                    <div
                                        class="technology-edge w-[260px] lg:w-[280px] rounded-full flex items-center gap-3 px-6 py-3 bg-white shadow-sm">
                        ...
                        <div class="swiper-slide border-2 border-[#99899d] rounded-[30px]">
                            <div class="flex flex-col w-full items-center gap-5 py-10 lg:py-20">
                                <h3 class="font-bold text-3xl text-center"> Artificial Intelligence & Machine Learning
                                </h3>
                                <div class="flex flex-wrap justify-center gap-6 mt-5 max-w-[1200px] mx-auto">
                                    <!-- Use same layout -->
                                    <div
                ...
                <div id="testimonial-slider" class="overflow-hidden relative w-full max-w-full order-1 lg:order-2 z-20">
                    <div id="testimonial-track" class="flex transition-transform duration-500 ease-in-out w-full"
                        ...
                        <div
                            ...
                            <div class="pl-6 h-fit pt-4">
                                <div class="flex flex-col gap-5 font-normal text-black1 mt-5">
                                    Intellivon’s expertise in platform modernization was a game changer for us. Their
                                    team seamlessly integrated cutting-edge technology, helping us improve operational
                                    efficiency by 40%, and launch new features faster than ever.


                                    <div class="text-xl font-medium font-urbanist text-black1">
                                        Sarah Lee, CTO, Global E-Commerce Leader
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div
                            ...
                            <div class="pl-6 h-fit pt-4">
                                <div class="flex flex-col gap-5 font-normal text-black1 mt-5">
                                    Working with Intellivon was a true partnership. They transformed our legacy systems
                                    into scalable, cloud-native platforms, enabling us to innovate at speed and improve
                                    customer satisfaction across the board.

                                    <div class="text-xl font-medium font-urbanist text-black1">
                                        Daniel Cheng, VP of Technology, Financial Services Company
                        ...
                        <div
                            ...
                            <div class="pl-6 h-fit pt-4">
                                <div class="flex flex-col gap-5 font-normal text-black1 mt-5">
                                    Intellivon’s modernization strategies and hands-on approach helped us migrate to a
                                    more flexible, agile platform. The result? A 35% reduction in downtime and faster
                                    go-to-market times for new products.


                                    <div class="text-xl font-medium font-urbanist text-black1">
                                        Michael Thompson, CIO, Leading Logistics Provider
                        ...
                        <div
                            ...
                            <div class="pl-6 h-fit pt-4">
                                <div class="flex flex-col gap-5 font-normal text-black1 mt-5">
                                    Intellivon helped us modernize our IT infrastructure with cutting-edge technologies,
                                    boosting scalability and security. Their team's dedication and insight resulted in a
                                    50% increase in our development speed.


                                    <div class="text-xl font-medium font-urbanist text-black1">
                                        Emily Patel, Director of IT, Manufacturing Industry Giant
                        ...
                        <div
                            ...
                            <div class="pl-6 h-fit pt-4">
                                <div class="flex flex-col gap-5 font-normal text-black1 mt-5">
                                    From strategy to implementation, Intellivon supported us in every phase of
                                    modernization. Their expertise in cloud adoption and microservices made our
                                    transformation smooth, efficient, and aligned with our long-term goals.


                                    <div class="text-xl font-medium font-urbanist text-black1">
                                        James Walker, Head of IT Strategy, Healthtech Innovator
                        ...
                        <div
                            ...
                            <div class="pl-6 h-fit pt-4">
                                <div class="flex flex-col gap-5 font-normal text-black1 mt-5">
                                    Intellivon transformed our outdated systems into a robust, scalable architecture
                                    that allowed us to expand our services globally. Their expertise in cloud and
                                    microservices made all the difference in driving our digital transformation.



                                    <div class="text-xl font-medium font-urbanist text-black1">
                                        Julia Morris, Chief Technology Officer, Global Retailer
                        ...
                        <div
                            ...
                            <div class="pl-6 h-fit pt-4">
                                <div class="flex flex-col gap-5 font-normal text-black1 mt-5">
                                    Thanks to Intellivon’s deep knowledge of modern technologies and their hands-on
                                    approach, we’ve seen a dramatic improvement in system performance and a 40%
                                    reduction in IT costs.



                                    <div class="text-xl font-medium font-urbanist text-black1">
                                        Raj Patel, Director of IT Operations, Leading Financial Institution
                        ...
                        <div
                            ...
                            <div class="pl-6 h-fit pt-4">
                                <div class="flex flex-col gap-5 font-normal text-black1 mt-5">
                                    Intellivon’s platform modernization services allowed us to streamline our entire
                                    tech stack. Their guidance and seamless implementation resulted in improved system
                                    reliability and faster product rollouts across our teams.




                                    <div class="text-xl font-medium font-urbanist text-black1">
                                        Lisa Zhang, VP of Engineering, SaaS Provider
    ...
    <div class="container flex flex-col gap-5 items-center">
        ...
        <div class="flex flex-col w-5/6 mt-5">
            ...
            <div class="faq-item">
                <div class="border-t border-[#7C3BAF] flex justify-between py-5 cursor-pointer">
                    <div class="font-medium text-xl">
                        Q1. What is Product and Platform Modernization?
                    </div>
                    <div class="faq-icon">
                ...
                <div
                    ...
                    <p class="text-base text-[#333]">
                        Product and platform modernization involves updating legacy systems and platforms with advanced
                        technologies like cloud, microservices, and AI. This ensures scalability, agility, and alignment
                        with current business goals, boosting performance and enabling digital transformation.
            ...
            <div class="faq-item">
                <div class="border-t border-[#7C3BAF] flex justify-between py-5 cursor-pointer">
                    <div class="font-medium text-xl">
                        Q2. How Does Product and Platform Modernization Improve Business Efficiency?
                ...
                <div
                    class="faq-answer overflow-hidden max-h-0 opacity-0 transition-all duration-300 ease-in-out px-4 pb-8">
                    <p class="text-base text-[#333]">
                        Modernization optimizes operations by replacing outdated systems, improving integration, and
                        reducing technical debt. It enhances speed, scalability, and automation, which leads to improved
                        business agility, faster decision-making, and significant cost savings.
            ...
            <div class="faq-item">
                <div class="border-t border-[#7C3BAF] flex justify-between py-5 cursor-pointer">
                    <div class="font-medium text-xl">
                        Q3. What are the Benefits of Cloud Adoption in Platform Modernization?
                ...
                <div
                    class="faq-answer overflow-hidden max-h-0 opacity-0 transition-all duration-300 ease-in-out px-4 pb-8">
                    <p class="text-base text-[#333]">
                        Cloud adoption ensures flexibility, scalability, and lower infrastructure costs. It enhances
                        data accessibility, improves security, and supports seamless updates, allowing organizations to
                        scale operations quickly and reduce the burden of maintaining on-premise systems.
            ...
            <div class="faq-item">
                <div class="border-t border-[#7C3BAF] flex justify-between py-5 cursor-pointer">
                    <div class="font-medium text-xl">
                        Q4. How Can Intellivon Help Modernize Legacy Platforms and Products?
                ...
                <div
                    class="faq-answer overflow-hidden max-h-0 opacity-0 transition-all duration-300 ease-in-out px-4 pb-8">
                    <p class="text-base text-[#333]">
                        Intellivon uses a holistic approach to modernize legacy platforms by integrating cloud-native
                        technologies, microservices, and API-led architectures. We streamline transitions, minimize
                        disruptions, and ensure that your systems are future-proof, scalable, and aligned with business
                        goals.
            ...
            <div class="faq-item">
                <div class="border-t border-[#7C3BAF] flex justify-between py-5 cursor-pointer">
                    <div class="font-medium text-xl">
                        Q5. What Technologies are Used in Product and Platform Modernization?
                ...
                <div
                    class="faq-answer overflow-hidden max-h-0 opacity-0 transition-all duration-300 ease-in-out px-4 pb-8">
                    <p class="text-base text-[#333]">
                        We leverage advanced technologies such as cloud computing (AWS, Azure), containerization
                        (Docker, Kubernetes), microservices architecture, DevOps practices, and AI/ML to deliver secure,
                        scalable, and high-performing product and platform solutions.
            ...
            <div class="faq-item">
                <div class="border-t border-[#7C3BAF] flex justify-between py-5 cursor-pointer">
                    <div class="font-medium text-xl">
                        Q6. How Long Does the Product and Platform Modernization Process Take?
                ...
                <div
                    class="faq-answer overflow-hidden max-h-0 opacity-0 transition-all duration-300 ease-in-out px-4 pb-8">
                    <p class="text-base text-[#333]">
                        The timeline depends on the complexity and scope of the project. Typically, modernization takes
                        anywhere from a few weeks for smaller updates to several months for large-scale transformations.
                        We provide clear milestones and timelines for each phase.
            ...
            <div class="faq-item">
                <div class="border-t border-[#7C3BAF] flex justify-between py-5 cursor-pointer">
                    <div class="font-medium text-xl">
                        Q7. What’s the Difference Between Legacy System Upgrade and Platform Modernization?
                ...
                <div
                    class="faq-answer overflow-hidden max-h-0 opacity-0 transition-all duration-300 ease-in-out px-4 pb-8">
                    <p class="text-base text-[#333]">
                        A legacy system upgrade typically involves improving the existing infrastructure with minimal
                        change. In contrast, platform modernization reimagines the architecture by adopting new
                        technologies and practices, such as cloud migration and microservices, to optimize performance,
            ...
            <div class="faq-item">
                <div class="border-t border-[#7C3BAF] flex justify-between py-5 cursor-pointer">
                    <div class="font-medium text-xl">
                        Q8. How Does Platform Modernization Drive Innovation and Competitive Advantage?
                ...
                <div
                    ...
                    <p class="text-base text-[#333]">
                        ...
                        Modernized platforms enable faster product development, seamless integrations, and quicker
                        response to market needs. By adopting new technologies, businesses can improve customer
                        experiences, reduce operational costs, and innovate faster, providing a significant competitive
                        edge.
