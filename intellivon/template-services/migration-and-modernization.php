<?php /* Template Name: Migration and Modernization */ ?>
<?php get_header(); ?>
<!-- Intellivon Menubar Start -->
<!-- Intellivon Menubar End -->
<!-- Content updated by - faiz -->
<!-- HERO SECTION -->
  ...
  <div class="flex">
    <div class="lg:w-full flex flex-col gap-5 px-10 justify-center py-10 lg:p-[150px] lg:text-center">
      <h1 class="font-bold text-4xl lg:text-5xl text-white">
        Cloud Migration to Redefine, Modernize, and
        <span class="text-gradient">Scale Your Enterprise</span>
      </h1>
      <p class="text-white text-lg font-medium">
        Future-proof your enterprise with Intellivon’s expert cloud migration and modernization solutions, driving
        innovation, scalability, and efficiency in the cloud.
      </p>
    ...
    <div class="w-full lg:w-2/3 lg:pl-10 px-10 lg:px-0">
      <div class="flex flex-col gap-5 items-start">
        ...
        <h2 class="text-4xl items-center font-bold text-black1 font-urbanist leading-snug tracking-[0.5px] gap-1">
          Chosen by Industry Leaders for Seamless
          <span class="text-gradient">Cloud Migration and Modernization</span>
        </h2>
        <p class="mb-4 md:mb-0 text-base font-medium text-grey1 mt-2 w-full tracking-[0.25px] pr-5 mb-12">
          We partner with leading global enterprises, delivering cloud solutions that ensure operational efficiency,
          security, and scalability to drive a competitive advantage.
        </p>
      </div>
    </div>
    <!-- Right column: Image -->
      ...
      <div class="w-full pr-5">
        <div class="w-full flex flex-col gap-5 items-start">
          ...
          <h2 class="text-4xl font-bold text-black1 font-urbanist leading-snug tracking-[0.5px] w-full">
            ...
            <span class="text-gradient">Enterprise-Grade Cloud Migration and Modernization </span>
            Services
          </h2>
          <p class="mb-4 md:mb-0 text-base font-medium text-grey1 mt-2 w-full tracking-[0.25px] pr-5 mb-12">
            Our comprehensive cloud migration services ensure smooth transitions, while our modernization strategies
            drive innovation, scalability, and security for enterprise operations.
          </p>
        </div>
      </div>
  ...
  <script>
    const services = [
      ...
      },
      {
        ...
        description:
          "We provide end-to-end cloud security solutions tailored to enterprise needs, ensuring full regulatory compliance, robust encryption, and continuous threat monitoring to safeguard your cloud infrastructure.",
        points: [
          ...
          "Secure identity and access management (IAM) solutions",
          "Real-time vulnerability detection and remediation",
        ],
      },
      {
        title: "AI-Driven Cloud Modernization",
        description:
          "Our AI-powered cloud modernization services enable enterprises to enhance legacy systems, integrate cutting-edge cloud technologies, and optimize workflows for efficiency and scalability, ensuring long-term digital transformation.",
        points: [
          "AI-driven system optimization and integration",
          "Legacy system modernization with minimal disruption",
          "Scalable cloud architecture design",
          "Intelligent automation to optimize workflows",
          "Advanced data analytics and insights",
          "Continuous performance improvements with AI tools",
        ],
      },
      {
        title: "Cloud Data Migration",
        description:
          "We ensure seamless, secure, and efficient data migration from on-premise or legacy systems to the cloud, minimizing downtime and ensuring data integrity throughout the entire process.",
        points: [
          "Secure and automated data transfer tools",
          "Zero-downtime migration planning and execution",
          "Data integrity verification and validation",
          "Real-time migration status tracking",
          "Scalable cloud data storage and management solutions",
...

      {
        ...
        description:
          "Our cloud infrastructure optimization services refine and enhance your cloud environment, ensuring your enterprise operates with the highest levels of performance, cost-efficiency, and scalability.",
        points: [
          ...
          "Infrastructure as Code (IaC) for seamless deployment",
          "Custom cloud architecture designed for enterprise needs",
          "Optimized cloud capacity planning and utilization",
        ],
      },

      {
        ...
        description:
          "We design and implement multi-cloud and hybrid cloud strategies to ensure flexibility, risk mitigation, and scalability, enabling enterprises to leverage the best features of multiple cloud providers.",
        points: [
          "Tailored multi-cloud architecture for your enterprise",
          "Seamless hybrid cloud environment management",
          "Disaster recovery planning across multiple clouds",
          "Vendor-agnostic cloud integration strategies",
          "Real-time cloud performance monitoring across clouds",
          "Scalability and flexibility with diverse cloud providers",
        ],
      },
    ];
    ...
    <div class="flex items-end justify-between mt-6 mb-3">
      ...
      <div class="flex flex-col gap-3 w-full">
        ...
        <h2 class="text-4xl md:gap-3 items-center font-bold text-black1 font-urbanist leading-snug tracking-[0.5px]">
          Our Strategic Approach to Cloud Migration & Modernization
          <span class="text-gradient"> in 3 Steps </span>
        </h2>
        <p class="text-[#333333] w-full lg:w-3/4 text-base font-medium">
          Our structured process ensures seamless cloud migration, from in-depth analysis and strategy development to
          flawless execution and ongoing optimization.
        </p>
      </div>
    </div>
    <!-- Consulting Cards -->
        ...
        <div class="grid grid-cols-2 gap-1 mt-4">
          <div class="p-3 bg-[#F7F7F7] h-44">
            ...
            <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
              Define cloud governance and cost optimization objectives aligned with goals.
            </p>
          </div>
          <div class="p-3 bg-[#F7F7F7] h-44">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
            ...
            <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
              Align KPIs with both business performance and financial success metrics.
            </p>
          </div>
          <div class="p-3 bg-[#F7F7F7] h-44">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
            ...
            <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
              Identify potential security and compliance risks early for mitigation.
            </p>
          </div>
          <div class="p-3 bg-[#F7F7F7] h-44">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
            ...
            <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
              Create a detailed governance and FinOps strategy for cloud management.
            </p>
          </div>
        </div>
      </div>
      ...
      <div class="card w-full lg:w-1/3 p-6 border-2 border-transparent rounded-md"
        ...
        <div class="grid grid-cols-2 gap-1 mt-4">
          <div class="p-3 bg-[#F7F7F7] h-44">
            ...
            <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
              Assess current cloud infrastructure to pinpoint performance and cost inefficiencies.
            </p>
          </div>
          <div class="p-3 bg-[#F7F7F7] h-44">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
            ...
            <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
              Audit cloud usage to uncover opportunities for efficiency improvements.
            </p>
          </div>
          <div class="p-3 bg-[#F7F7F7] h-44">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
            ...
            <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
              Evaluate governance policies to identify and close compliance gaps.
            </p>
          </div>
          <div class="p-3 bg-[#F7F7F7] h-44">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
            ...
            <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
              Identify optimization opportunities across multiple cloud platforms and services.
            </p>
          </div>
        </div>
      </div>
      ...
      <div class="card w-full lg:w-1/3 p-6 border-2 border-transparent rounded-md"
        ...
        <div class="grid grid-cols-2 gap-1 mt-4">
          <div class="p-3 bg-[#F7F7F7] h-44">
            ...
            <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
              Implement AI-driven automation to optimize cloud cost and usage efficiency.
            </p>
          </div>
          <div class="p-3 bg-[#F7F7F7] h-44">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
            ...
            <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
              Enforce governance policies across all cloud services for consistency.
            </p>
          </div>
          <div class="p-3 bg-[#F7F7F7] h-44">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
            ...
            <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
              Monitor financial performance and cloud resource usage in real time.
            </p>
          </div>
          <div class="p-3 bg-[#F7F7F7] h-44">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
            ...
            <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
              Ensure continuous optimization and compliance with industry best practices.
            </p>
          </div>
        </div>
      </div>
      ...
      <div class="w-full flex flex-col gap-5 items-start">
        ...
        <div class="flex flex-col gap-5 lg:gap-0 lg:flex-row justify-between w-full">
          <h2
            ...
            <span class="text-gradient">Cloud Migration and Modernization Services Case Studies</span>
          </h2>
            ...
            <div class="swiper-wrapper bg-[#F2F7FF]">
                ...
                <div class="w-full lg:w-1/2 flex flex-col gap-5 px-5 py-4">
                  <div class="flex flex-col w-full gap-2 pb-4 border-b border-b-[#99899d]">
                    <h3 class="text-xl md:text-3xl font-semibold">
                      Cloud Migration & Core System Modernization for a Global Banking Leader
                    </h3>
                    <div class="text-[#333] leading-7 tracking-wide">
                      <p class="hidden xl:block text-md">
                        We assisted a multinational bank in modernizing its legacy core banking systems. By migrating to
                        a secure public cloud and re-architecting applications into microservices, we improved
                        compliance, enhanced customer experience, and significantly reduced infrastructure costs.
                      </p>
                  ...
                  <ul class="flex flex-col gap-2 list-disc pl-5">
                    <li class="">
                      ...
                      <span>reduction in infrastructure costs</span>
                    </li>
                    <li class="">
                      <span class="xl:text-xl font-semibold">80%</span>
                      <span>reduction in disaster recovery time (from days to minutes)</span>
                    </li>
                    <li class="">
                      <span class="xl:text-xl font-semibold">20%</span>
                      <span>improvement in compliance and customer experience globally</span>
                    </li>
                  </ul>
                  <!-- Explore More button -->
                  <a href="https://intellivon.com/ai-strategy-call-booking-confirmation/" target="_blank">
              ...
              <div
                ...
                <div class="w-full lg:w-1/2 flex flex-col gap-5 px-5 py-4">
                  <div class="flex flex-col w-full gap-2 pb-4 border-b border-b-[#99899d]">
                    <h3 class="text-xl md:text-3xl font-semibold">
                      Cloud Migration for Accelerating Chip Design in a Semiconductor Manufacturer
                    </h3>
                    <div class="text-[#333] leading-7 tracking-wide">
                      <p class="hidden xl:block text-md">
                        We helped a global semiconductor firm migrate complex design workloads to a cloud-native
                        environment. This shift enabled faster product iterations, better collaboration, and substantial
                        savings on capital expenditure, while ensuring data privacy across global teams.
                      </p>
                      <p class="xl:hidden leading-0 line-clamp-5 read-more-content text-sm">
                        We helped a global semiconductor firm migrate complex design workloads to a cloud-native
                        environment. This shift enabled faster product iterations, better collaboration, and substantial
                  ...
                  <ul class="flex flex-col gap-2 list-disc pl-5">
                    <li class="">
                      ...
                      <span>improvement in project turnaround time</span>
                    </li>
                    <li class="">
                      <span class="xl:text-xl font-semibold">30%</span>
                      <span>faster product iterations with cloud-native simulation workloads</span>
                    </li>
                    <li class="">
                      <span class="xl:text-xl font-semibold">25%</span>
                      <span>improvement in data privacy across global teams</span>
                    </li>
                  </ul>
                  <!-- Explore More button -->
                  <a href="https://intellivon.com/ai-strategy-call-booking-confirmation/" target="_blank">
              ...
              <div
                ...
                <div class="w-full lg:w-1/2 flex flex-col gap-5 px-5 py-4">
                  <div class="flex flex-col w-full gap-2 pb-4 border-b border-b-[#99899d]">
                    <h3 class="text-xl md:text-3xl font-semibold">
                      Cloud Migration for Scaling Real-Time Decisioning in Credit Analytics
                    </h3>
                    <div class="text-[#333] leading-7 tracking-wide">
                      <p class="hidden xl:block text-md">
                        We assisted a financial analytics provider in scaling its AI-powered decisioning engines with
                        cloud migration. By integrating elastic compute scaling and advanced analytics services, we
                        achieved faster processing speeds, improved fraud detection, and simplified compliance
                        reporting.
                      </p>
                      <p class="xl:hidden leading-0 line-clamp-5 read-more-content text-sm">
                        We assisted a financial analytics provider in scaling its AI-powered decisioning engines with
                  ...
                  <ul class="flex flex-col gap-2 list-disc pl-5">
                    ...
                    <li class="">
                      <span class="xl:text-xl font-semibold">30%</span>
                      <span>improvement in real-time fraud detection accuracy</span>
                    </li>
                    <li class="">
                      <span class="xl:text-xl font-semibold">40% </span>
                      <span>reduction in time spent on compliance reporting</span>
                    </li>
                  </ul>
                  <!-- Explore More button -->
                  <a href="https://intellivon.com/ai-strategy-call-booking-confirmation/" target="_blank">
              ...
              <div
                ...
                <div class="w-full lg:w-1/2 flex flex-col gap-5 px-5 py-4">
                  <div class="flex flex-col w-full gap-2 pb-4 border-b border-b-[#99899d]">
                    <h3 class="text-xl md:text-3xl font-semibold">
                      Cloud Modernization for Global Agility in a Consumer Goods Enterprise
                    </h3>
                    <div class="text-[#333] leading-7 tracking-wide">
                      <p class="hidden xl:block text-md">
                        We helped a global consumer goods manufacturer modernize its cloud infrastructure. By shifting
                        workloads to a unified cloud platform, we streamlined data governance, improved collaboration,
                        and accelerated product development cycles across 60+ countries.
                      </p>
                      <p class="xl:hidden leading-0 line-clamp-5 read-more-content text-sm">
                        We helped a global consumer goods manufacturer modernize its cloud infrastructure. By shifting
                        workloads to a unified cloud platform, we streamlined data governance, improved collaboration,
                  ...
                  <ul class="flex flex-col gap-2 list-disc pl-5">
                    <li class="">
                      <span class="xl:text-xl font-semibold">30% </span>
                      <span>operational savings achieved</span>
                    </li>
                    <li class="">
                      <span class="xl:text-xl font-semibold">50% </span>
                      <span>
                        reduction in product launch timelines
                      </span>
                    </li>
                    <li class="">
                      <span class="xl:text-xl font-semibold">35% </span>
                      <span>improvement in remote collaboration and data governance</span>
                    </li>
                  </ul>
                  <!-- Explore More button -->
                  <a href="https://intellivon.com/ai-strategy-call-booking-confirmation/" target="_blank">
              ...
              <div
                ...
                <div class="w-full lg:w-1/2 flex flex-col gap-5 px-5 py-4">
                  <div class="flex flex-col w-full gap-2 pb-4 border-b border-b-[#99899d]">
                    <h3 class="text-xl md:text-3xl font-semibold">
                      Hybrid Cloud Migration for Streamlining Patient Data & Research in Healthcare
                    </h3>
                    <div class="text-[#333] leading-7 tracking-wide">
                      <p class="hidden xl:block text-md">
                        We assisted a large healthcare network in unifying its patient databases and R&D systems. With a
                        hybrid cloud architecture, we enabled secure data sharing and faster access to critical
                        insights, improving collaboration between doctors and researchers.
                      </p>
                      <p class="xl:hidden leading-0 line-clamp-5 read-more-content text-sm">
                        We assisted a large healthcare network in unifying its patient databases and R&D systems. With a
                        hybrid cloud architecture, we enabled secure data sharing and faster access to critical
                  ...
                  <ul class="flex flex-col gap-2 list-disc pl-5">
                    <li class="">
                      ...
                      <span>faster access to critical patient and research data</span>
                    </li>
                    <li class="">
                      <span class="xl:text-xl font-semibold">40%</span>
                      <span>improvement in regulatory audits and compliance processes</span>
                    </li>
                    <li class="">
                      <span class="xl:text-xl font-semibold">25%</span>
                      <span>reduction in operational overheads</span>
                    </li>
                  </ul>
                  <!-- Explore More button -->
                  <a href="https://intellivon.com/ai-strategy-call-booking-confirmation/" target="_blank">
    ...
    <div class="w-full">
      ...
      <h2 class="w-full lg:w-11/12 text-4xl gap-3 font-bold text-black1 font-urbanist leading-snug tracking-[0.5px]">
        <span class="text-gradient">
          Real-World Applications of Our Cloud Solutions
        </span>
      </h2>
    </div>
        ...
        <div class="swiper-wrapper">
          ...
          <div class="swiper-slide h-full">
            <div
              ...
              <p class="text-center md:text-start">
                Migrate and modernize outdated on-premise systems to cloud-native architectures, enhancing scalability,
                performance, and agility while reducing maintenance overheads.
              </p>
            </div>
          </div>
          ...
          <div class="swiper-slide h-full">
            <div
              ...
              <p class="text-center md:text-start">
                Implement cloud-based disaster recovery solutions to improve data protection, ensure business
                continuity, and minimize downtime with automated, scalable recovery options.
              </p>
            </div>
          </div>
          ...
          <div class="swiper-slide h-full">
            <div
              ...
              <p class="text-center md:text-start">
                Design and deploy multi-cloud infrastructures to reduce vendor lock-in, optimize cost efficiency, and
                ensure redundancy and resilience across multiple cloud providers.
              </p>
            </div>
          </div>
          <!-- CARD 4 -->
          <div class="swiper-slide h-full">
            <div
              ...
              <p class="text-center md:text-start">
                Migrate entire on-premise data centers to the cloud, optimizing storage, compute resources, and network
                performance, while reducing physical infrastructure costs.
              </p>
            </div>
          </div>
          ...
          <div class="swiper-slide h-full">
            <div
              ...
              <p class="text-center md:text-start">
                Modernize infrastructure to support AI/ML workloads, integrating data pipelines, training models, and
                scalable compute power for real-time insights and decision-making.
              </p>
            </div>
          </div>
          ...
          <div class="swiper-slide h-full">
            <div
              ...
              <p class="text-center md:text-start">
                Redesign and re-architect monolithic applications into microservices, leveraging containerization and
                serverless computing to improve scalability and development speed.
              </p>
            </div>
          </div>
          ...
          <div class="swiper-slide h-full">
            <div
              ...
              <p class="text-center md:text-start">
                Implement AI-driven cloud cost management strategies to optimize resource allocation, reduce
                inefficiencies, and ensure continuous cost savings across cloud environments.
              </p>
            </div>
          </div>
          ...
          <div class="swiper-slide h-full">
            <div
              ...
              <p class="text-center md:text-start">
                Create and manage a hybrid cloud environment, integrating on-premise infrastructure with public cloud
                platforms, enabling secure data sharing and flexibility across environments.
              </p>
            </div>
          </div>
        </div>
        ...
        <div class="w-full flex flex-col gap-5 items-start">
          ...
          <div class="flex flex-col gap-5 lg:gap-0 lg:flex-row justify-between">
            <h2 class="w-full lg:w-7/12 text-4xl flex-wrap gap-3 flex items-center font-bold text-black1 font-urbanist">
              Why Intellivon is
              <span class="text-gradient">Your Trusted Cloud Partner</span>
            </h2>
            <a href="https://intellivon.com/ai-strategy-call-booking-confirmation/" target="_blank">
              <div>
                <button type="button"
          ...
          <p class="text-grey1 text-base font-medium">
            Intellivon combines advanced AI technologies, deep industry knowledge, and customized cloud solutions to
            deliver seamless migrations and modernization that future-proof enterprises.
          </p>
        </div>
      </div>
    </div>
      ...
      <div class="choose-card-wrapper w-full h-[212px] md:w-[409px] m-auto lg:m-0 z-10">
        <div class="choose-card shadow-[0_24px_34px_0_rgba(0,0,0,.078)]">
          ...
          <div
            ...
            <p class="text-sm">
              We leverage cutting-edge AI technologies to optimize every stage of your cloud migration and
              modernization, ensuring data-driven decision-making and real-time optimization for your business.
            </p>
          </div>
        </div>
      </div>
      ...
      <div class="choose-card-wrapper w-full h-[212px] md:w-[409px] m-auto lg:m-0 z-10">
        <div class="choose-card shadow-[0_24px_34px_0_rgba(0,0,0,.078)]">
          ...
          <div class="choose-card-front bg-white p-6 flex flex-col gap-8 items-center justify-center">
            ...
            <h3 class="text-xl font-semibold text-center">
              Custom Enterprise-Scale Solutions
            </h3>
          </div>
          <!-- Back Side -->
          <div
            ...
            <p class="text-sm">
              Our cloud migration strategies are tailored to meet the unique needs of large enterprises, ensuring
              seamless transitions and scalable solutions that align with your business goals.
            </p>
          </div>
        </div>
      </div>
      ...
      <div class="choose-card-wrapper w-full h-[212px] md:w-[409px] m-auto lg:m-0 z-10">
        <div class="choose-card shadow-[0_24px_34px_0_rgba(0,0,0,.078)]">
          ...
          <div class="choose-card-front bg-white p-6 flex flex-col gap-8 items-center justify-center">
            ...
            <h3 class="text-xl font-semibold text-center">High-Stakes Migration Expertise </h3>
          </div>
          <!-- Back Side -->
          <div
            class="choose-card-back bg-white p-6 flex flex-col gap-4 items-center justify-center text-center text-gray-800">
            ...
            <p class="text-sm">
              With years of experience handling complex, mission-critical cloud transformations, we ensure that your
              legacy systems are modernized efficiently and securely with minimal disruption.
            </p>
          </div>
        </div>
      </div>
      ...
      <div class="choose-card-wrapper w-full h-[212px] md:w-[409px] m-auto lg:m-0 z-10">
        <div class="choose-card shadow-[0_24px_34px_0_rgba(0,0,0,.078)]">
          ...
          <div
            ...
            <p class="text-sm">
              We provide hands-on support throughout the entire cloud lifecycle—from planning and migration to
              optimization and management, ensuring continuous improvement and long-term success.
            </p>
          </div>
        </div>
      </div>
      ...
      <div class="choose-card-wrapper w-full h-[212px] md:w-[409px] m-auto lg:m-0 z-10">
        <div class="choose-card shadow-[0_24px_34px_0_rgba(0,0,0,.078)]">
          ...
          <div
            ...
            <p class="text-sm">
              Our advanced AI tools and predictive analytics continuously monitor cloud usage, automatically optimizing
              resource allocation and ensuring long-term cost savings for your enterprise.
            </p>
          </div>
        </div>
      </div>
      ...
      <div class="choose-card-wrapper w-full h-[212px] md:w-[409px] m-auto lg:m-0 z-10">
        <div class="choose-card shadow-[0_24px_34px_0_rgba(0,0,0,.078)]">
          ...
          <div
            ...
            <p class="text-sm">
              Security and regulatory compliance are our top priorities. We integrate the latest encryption, access
              controls, and compliance frameworks into every step of migration and modernization to safeguard your
              business.
            </p>
          </div>
        </div>
  ...
  <div class="container">
    ...
    <div class="w-full flex flex-col gap-3 items-start">
      ...
      <h2 class="text-4xl font-bold text-black1 font-urbanist leading-snug tracking-[0.5px] w-full md:gap-3">
        Leveraging Cutting-Edge Technologies That
        <span class="text-gradient"> Drive Your Cloud Transformation</span>
      </h2>
      <div class="w-full flex flex-col lg:flex-row justify-between">
        <p class="capitalize mb-4 md:mb-0 text-base font-medium text-grey1 mt-2 md:w-8/12 tracking-[0.25px] pr-5">
          We use the latest cloud technologies and AI innovations to ensure your migration and modernization process is
          seamless, secure, and optimized for scalability.
        </p>
        <!-- Buttons -->
      ...
      <div class="flex items-end justify-between mt-6 mb-3">
        <div class="w-full flex flex-col gap-5">
          ...
          <div class="flex flex-col gap-5 lg:gap-0 lg:flex-row justify-between w-full">
            <h2
              class="w-full lg:w-11/12 text-4xl gap-3 font-bold text-black1 font-urbanist leading-snug tracking-[0.5px]">
              <span class="text-gradient">Client Testimonials: Real Impact, Real Results</span>
            </h2>
        ...
        <div id="testimonial-slider" class="overflow-hidden relative w-full max-w-full order-1 lg:order-2 z-20">
          <div id="testimonial-track" class="flex transition-transform duration-500 ease-in-out w-full"
            ...
            <div
              ...
              <div class="pl-6 h-fit pt-4">
                <div class="flex flex-col gap-5 font-normal text-black1 mt-5">
                  Intellivon’s Cloud Governance and FinOps services have revolutionized our cloud cost management. Their
                  tailored approach helped us gain full visibility and optimize spending across multiple platforms,
            ...
            <div
              ...
              <div class="pl-6 h-fit pt-4">
                <div class="flex flex-col gap-5 font-normal text-black1 mt-5">
                  The migration to the cloud with Intellivon was seamless. They not only ensured minimal disruption but
                  also modernized our legacy systems, allowing us to scale efficiently and reduce downtime.
                  <div class="text-xl font-medium font-urbanist text-black1">
                    CTO, Leading E-commerce Enterprise
                  </div>
                </div>
              </div>
            </div>
            ...
            <div
              ...
              <div class="pl-6 h-fit pt-4">
                <div class="flex flex-col gap-5 font-normal text-black1 mt-5">
                  Intellivon’s cloud modernization strategy transformed our infrastructure. Their expertise in AI and
                  machine learning allowed us to optimize operations and reduce processing time, improving both
                  performance and customer satisfaction.
                  <div class="text-xl font-medium font-urbanist text-black1">
                    VP of IT, Financial Services Provider
                  </div>
                </div>
              </div>
            </div>
            ...
            <div
              ...
              <div class="pl-6 h-fit pt-4">
                <div class="flex flex-col gap-5 font-normal text-black1 mt-5">
                  With Intellivon’s help, we successfully migrated our global data centers to the cloud. The result?
                  Enhanced security, faster disaster recovery, and a reduction in total IT overhead.
                  <div class="text-xl font-medium font-urbanist text-black1">
            ...
            <div
              ...
              <div class="pl-6 h-fit pt-4">
                <div class="flex flex-col gap-5 font-normal text-black1 mt-5">
                  Partnering with Intellivon has been a game-changer. Their expertise in hybrid cloud solutions enabled
                  us to seamlessly integrate on-premise and cloud environments, leading to more agile operations and
                  cost savings.
                  <div class="text-xl font-medium font-urbanist text-black1">
                    Head of Cloud Operations, International Healthcare Group
                  </div>
                </div>
              </div>
            </div>
  ...
  <div class="container flex flex-col gap-5 items-center">
    ...
    <div class="flex flex-col w-5/6 mt-5">
      ...
      <div class="faq-item">
        <div class="border-t border-[#7C3BAF] flex justify-between py-5 cursor-pointer">
          <div class="font-medium text-xl">
            Q1. What is cloud migration and why do we need it?
          </div>
          <div class="faq-icon">
        ...
        <div class="faq-answer overflow-hidden max-h-0 opacity-0 transition-all duration-300 ease-in-out px-4 pb-8">
          <p class="text-base text-[#333]">
            Cloud migration involves moving your applications, data, and workloads from on-premise systems to cloud
            environments. It helps enterprises reduce costs, scale more efficiently, and enhance performance and
            security.
          </p>
        </div>
      </div>
      ...
      <div class="faq-item">
        <div class="border-t border-[#7C3BAF] flex justify-between py-5 cursor-pointer">
          <div class="font-medium text-xl">
            Q2. How long does the cloud migration process take?
          </div>
          <div class="faq-icon">
            <svg xmlns="http://www.w3.org/2000/svg" width="27" height="27" viewBox="0 0 27 27" fill="none">
              <path class="vertical-path" d="M13.2227 2.61133V23.7671" stroke="black" stroke-width="4.6301"
        ...
        <div class="faq-answer overflow-hidden max-h-0 opacity-0 transition-all duration-300 ease-in-out px-4 pb-8">
          <p class="text-base text-[#333]">
            The timeline for cloud migration depends on the complexity and scale of your infrastructure. Typically, the
            process can take anywhere from a few weeks to several months, with careful planning and phased execution.
          </p>
        </div>
      </div>
      <!-- FAQ Item 3 -->
      <div class="faq-item">
        <div class="border-t border-[#7C3BAF] flex justify-between py-5 cursor-pointer">
          <div class="font-medium text-xl">
            Q3. Will cloud migration disrupt my business operations?
          </div>
          <div class="faq-icon">
            <svg xmlns="http://www.w3.org/2000/svg" width="27" height="27" viewBox="0 0 27 27" fill="none">
              <path class="vertical-path" d="M13.2227 2.61133V23.7671" stroke="black" stroke-width="4.6301"
        ...
        <div class="faq-answer overflow-hidden max-h-0 opacity-0 transition-all duration-300 ease-in-out px-4 pb-8">
          <p class="text-base text-[#333]">
            We design cloud migrations to minimize downtime and business disruptions. Our team works closely with you to
            ensure smooth transitions, with testing and validation at each stage to ensure business continuity.
          </p>
        </div>
      </div>
      <!-- FAQ Item 4 -->
      <div class="faq-item">
        <div class="border-t border-[#7C3BAF] flex justify-between py-5 cursor-pointer">
          <div class="font-medium text-xl">
            Q4. How can cloud modernization benefit my legacy systems?
          </div>
          <div class="faq-icon">
            <svg xmlns="http://www.w3.org/2000/svg" width="27" height="27" viewBox="0 0 27 27" fill="none">
              <path class="vertical-path" d="M13.2227 2.61133V23.7671" stroke="black" stroke-width="4.6301"
        ...
        <div class="faq-answer overflow-hidden max-h-0 opacity-0 transition-all duration-300 ease-in-out px-4 pb-8">
          <p class="text-base text-[#333]">
            Cloud modernization transforms outdated legacy systems into scalable, efficient, and flexible cloud-based
            solutions. This leads to improved system performance, faster development cycles, and reduced long-term
            maintenance costs.
          </p>
        </div>
      </div>
      ...
      <div class="faq-item">
        ...
        <div class="faq-answer overflow-hidden max-h-0 opacity-0 transition-all duration-300 ease-in-out px-4 pb-8">
          <p class="text-base text-[#333]">
            Yes, cloud migration is highly secure. We implement best-in-class security protocols, including encryption,
            multi-factor authentication, and continuous monitoring to ensure your data is protected throughout the
      ...
      <div class="faq-item">
        <div class="border-t border-[#7C3BAF] flex justify-between py-5 cursor-pointer">
          <div class="font-medium text-xl">
            Q6. How can I manage cloud costs effectively after migration?
          </div>
          <div class="faq-icon">
            <svg xmlns="http://www.w3.org/2000/svg" width="27" height="27" viewBox="0 0 27 27" fill="none">
              <path class="vertical-path" d="M13.2227 2.61133V23.7671" stroke="black" stroke-width="4.6301"
        ...
        <div class="faq-answer overflow-hidden max-h-0 opacity-0 transition-all duration-300 ease-in-out px-4 pb-8">
          <p class="text-base text-[#333]">
            We offer AI-driven cloud cost optimization services, which help you monitor and control your cloud expenses.
            Our FinOps strategies provide visibility into cloud usage, automate cost management, and ensure efficient
            resource allocation.
          </p>
        </div>
      </div>
      ...
      <div class="faq-item">
        <div class="border-t border-[#7C3BAF] flex justify-between py-5 cursor-pointer">
          <div class="font-medium text-xl">
            Q7. What types of businesses can benefit from cloud migration and modernization?
          </div>
          <div class="faq-icon">
            <svg xmlns="http://www.w3.org/2000/svg" width="27" height="27" viewBox="0 0 27 27" fill="none">
              <path class="vertical-path" d="M13.2227 2.61133V23.7671" stroke="black" stroke-width="4.6301"
        ...
        <div class="faq-answer overflow-hidden max-h-0 opacity-0 transition-all duration-300 ease-in-out px-4 pb-8">
          <p class="text-base text-[#333]">
            Cloud migration and modernization benefit businesses of all sizes across industries, whether you're looking
            to scale, improve security, or optimize costs. It’s especially beneficial for enterprises with legacy
            systems in need of transformation.
          </p>
        </div>
      </div>
      ...
      <div class="faq-item">
        <div class="border-t border-[#7C3BAF] flex justify-between py-5 cursor-pointer">
          <div class="font-medium text-xl">
            Q8. What happens if something goes wrong during the migration?
          </div>
          <div class="faq-icon">
            <svg xmlns="http://www.w3.org/2000/svg" width="27" height="27" viewBox="0 0 27 27" fill="none">
              <path class="vertical-path" d="M13.2227 2.61133V23.7671" stroke="black" stroke-width="4.6301"
        ...
        <div class="faq-answer overflow-hidden max-h-0 opacity-0 transition-all duration-300 ease-in-out px-4 pb-8">
          <p class="text-base text-[#333]">
            We have a comprehensive disaster recovery plan and contingency measures in place to address any issues. Our
            team closely monitors the migration process and resolves any problems quickly to minimize disruption to your
            operations.
          </p>
        </div>
      </div>
