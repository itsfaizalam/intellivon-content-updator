<?php /* Template Name: Computer Vision Development */ ?>
<?php get_header(); ?>
  ...
  <div class="flex">
    <div class="lg:w-full flex flex-col gap-5 px-10 justify-center py-10 lg:p-[150px] lg:text-center">
      <h1 class="font-bold text-4xl lg:text-5xl text-white">
        Computer Vision Innovation for 
         <span class="text-gradient">Next-Gen Business Automation</span> 
      </h1>
      <p class="text-white text-lg font-medium">
        Transform raw visual data into actionable intelligence with Intellivon's custom Computer Vision solutions. We enable enterprises to automate processes, enhance accuracy, and unlock real-time decision-making with AI-powered image and video analysis.
      </p>
      ...
      <a href="https://intellivon.com/ai-strategy-call-booking-confirmation/" target="_blank">
        <button
          ...
          Book Your Vision-Driven Strategy Call
    ...
    <div class="w-full lg:w-2/3 lg:pl-10 px-10 lg:px-0">
      <div class="flex flex-col gap-5 items-start">
        ...
        <h2 class="text-4xl items-center font-bold text-black1 font-urbanist leading-snug tracking-[0.5px] gap-1">
          Leading the Way in 
          <span class="text-gradient">Computer Vision for Enterprises</span>
        </h2>
        <p class="mb-4 md:mb-0 text-base font-medium text-grey1 mt-2 w-full tracking-[0.25px] pr-5 mb-12">
          Intellivon helps leading brands innovate with cutting-edge computer vision development, delivering tailor-made solutions that enhance operational performance and business growth.
        </p>
      </div>
    </div>
    <!-- Right column: Image -->
...
<section>
      ...
      <div class="w-full pr-5">
        <div class="w-full flex flex-col gap-5 items-start">
          ...
          <h2 class="text-4xl font-bold text-black1 font-urbanist leading-snug tracking-[0.5px] w-full">
            Purpose-Built Vision Solutions for 
            <span class="text-gradient">
              Industry-Specific Needs
            </span>
          </h2>
          <p class="mb-4 md:mb-0 text-base font-medium text-grey1 mt-2 w-full tracking-[0.25px] pr-5 mb-12">
            Our tailored computer vision solutions address unique challenges across industries, ensuring seamless integration, innovation, and performance optimization for every enterprise.
          </p>
        </div>
      </div>
      ...
      <div class="bg-white rounded-3xl flex flex-col lg:flex-row gap-10 p-8 w-5/6 z-10" id="servicesContainer">
        <div class="flex flex-col gap-5 lg:w-1/3 h-[70vh] overflow-y-scroll pt-5 px-5" id="serviceButtons">
          ...
          <div class="rounded-xl">
            <div
              class="rounded-xl flex items-center justify-center font-bold text-lg p-5 w-full shadow-[0px_4px_24px_-1px_rgba(124,59,175,0.6)]">
              AI-Powered Object Detection and Recognition Solutions
            </div>
          </div>
          <!-- Button 3 -->
          <div
          ...
          <div
            class="rounded-xl flex items-center justify-center font-bold text-lg p-5 w-full shadow-[0px_4px_24px_-1px_rgba(124,59,175,0.6)]">
            Custom Vision-Based Autonomous Systems
          </div>
          <!-- Button 6 -->
          <div
            class="rounded-xl flex items-center justify-center font-bold text-lg p-5 w-full shadow-[0px_4px_24px_-1px_rgba(124,59,175,0.6)]">
            AI-Driven Visual Search Solutions
          </div>
  ...
  <script>
    const services = [
      {
        title: "End-to-End Computer Vision Solution Development",
        description:
          "We provide detailed design and implementation of a custom computer vision solution, addressing the enterprise's unique visual challenges from concept to post-deployment.",
        points: [
...
"Post-deployment support and enhancements",
            ...
            {
        title: "AI-Powered Object Detection and Recognition Solutions",
        description:
          "We develop advanced object detection and recognition systems using deep learning techniques to automate critical visual tasks for enterprises.",
        points: [
"Custom model training for specific use cases",
"Integration with camera and sensor networks",
"Real-time detection accuracy optimization",
"Image and video data augmentation",
"Custom labeling and annotation tools",
"Deployment across a scalable infrastructure",


        ],
      },
      {
        title: "Intelligent Visual Inspection Systems",
        description:
          "Creation of high-performance visual inspection systems for quality control and defect detection in manufacturing and production lines.",
        points: [
"Automated defect detection algorithm development",
"Real-time image processing and analysis",
"Seamless integration with production workflows",
"AI-powered decision-making insights",
...
"System calibration and optimization",
      ...
      {
        title: "Advanced Facial Recognition Systems",
        description:
          "Development of facial recognition solutions for security, customer experience, and employee management applications in large enterprises.",
        points: [
"Custom facial recognition model training",
"Integration with access control systems",
"Real-time recognition and matching",
"Privacy and data security protocols",
"Multi-camera and multi-device synchronization",
"Continuous performance tuning and monitoring",
      ...
      {
        title: "Custom Vision-Based Autonomous Systems",
        description:
          "Design and development of autonomous navigation systems for robotics, drones, and vehicles, leveraging advanced computer vision algorithms.",
        points: [
"Sensor fusion for environmental awareness",
"Object avoidance and path planning algorithms",
"Real-time processing for decision-making",
"Integration with existing autonomous vehicle frameworks",
...
"Compliance with safety standards and regulations",
      ...
      {
        title: "AI-Driven Visual Search Solutions",
        description:
          "Development of AI-powered visual search tools that enable users to search by image rather than keywords, enhancing e-commerce and inventory systems.",
        points: [
"Custom image recognition models",
"Integration with product catalogs and databases",
"Real-time visual search functionality",
"Image retrieval optimization and ranking",
"Cross-platform deployment (mobile, web, etc.)",
    ...
    <div class="flex items-end justify-between mt-6 mb-3">
      ...
      <div class="flex flex-col gap-3 w-full">
        ...
        <h2 class="text-4xl md:gap-3 items-center font-bold text-black1 font-urbanist leading-snug tracking-[0.5px]">
          Our Proven Process for Computer Vision Success
          <span class="text-gradient"> in 3 Steps </span>
        </h2>
        <p class="text-[#333333] w-full lg:w-3/4 text-base font-medium">
         We follow a structured, results-driven process from concept to implementation, ensuring your computer vision solution is efficient, scalable, and impactful.
        </p>
      </div>
    </div>
    <!-- Consulting Cards -->
        ...
        <div class="grid grid-cols-2 gap-1 mt-4">
          <div class="p-3 bg-[#F7F7F7] h-44">
            ...
            <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
              Understand enterprise goals, challenges, and current data landscape.
            </p>
          </div>
          <div class="p-3 bg-[#F7F7F7] h-44">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
            ...
            <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
              Identify high-impact computer vision opportunities aligned to business objectives.
            </p>
          </div>
          <div class="p-3 bg-[#F7F7F7] h-44">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
            ...
            <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
              Assess existing infrastructure and integration needs for seamless implementation.
            </p>
          </div>
          <div class="p-3 bg-[#F7F7F7] h-44">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
            ...
            <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
              Define success metrics, scope, and project milestones collaboratively.
            </p>
          </div>
        </div>
      </div>
      ...
      <div class="card w-full lg:w-1/3 p-6 border-2 border-transparent rounded-md"
        ...
        <div class="grid grid-cols-2 gap-1 mt-4">
          <div class="p-3 bg-[#F7F7F7] h-44">
            ...
            <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
              Collect, clean, and annotate relevant images, videos, or documents.
            </p>
          </div>
          <div class="p-3 bg-[#F7F7F7] h-44">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
            ...
            <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
              Rapidly prototype and demo solutions for real-world stakeholder feedback.
            </p>
          </div>
          <div class="p-3 bg-[#F7F7F7] h-44">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
            ...
            <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
              Design and customize AI models tailored for unique enterprise requirements.
            </p>
          </div>
          <div class="p-3 bg-[#F7F7F7] h-44">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
            ...
            <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
              Architect vision strategy ensuring scalability, robustness, and enterprise alignment.
            </p>
          </div>
        </div>
      </div>
      ...
      <div class="card w-full lg:w-1/3 p-6 border-2 border-transparent rounded-md"
        ...
        <div class="grid grid-cols-2 gap-1 mt-4">
          <div class="p-3 bg-[#F7F7F7] h-44">
            ...
            <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
              Engineer, train, and validate models using latest frameworks and data.
            </p>
          </div>
          <div class="p-3 bg-[#F7F7F7] h-44">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
            ...
            <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
              Integrate solutions across cloud, on-prem, or edge environments smoothly.
            </p>
          </div>
          <div class="p-3 bg-[#F7F7F7] h-44">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
            ...
            <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
              Continuously monitor, optimize, and support models in production.
            </p>
          </div>
          <div class="p-3 bg-[#F7F7F7] h-44">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
            ...
            <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
              Empower teams with training, documentation, and best practice guidance.
            </p>
          </div>
        </div>
      </div>
  ...
  <div class="container flex flex-col gap-5 items-center">
    ...
    <div class="w-full">
      ...
      <h2 class="w-full lg:w-11/12 text-4xl gap-3 font-bold text-black1 font-urbanist leading-snug tracking-[0.5px]">
        <span class="text-gradient">Computer Vision Use Cases </span>That Make A Difference
      </h2>
    </div>
        ...
        <div class="swiper-wrapper">
          ...
          <div class="swiper-slide h-full">
            <div
              ...
              <p class="text-center md:text-start">
                Computer vision systems automatically detect product defects during manufacturing or assembly, ensuring consistent quality, minimizing recalls, reducing manual errors, and saving costs.
              </p>
            </div>
          </div>
          ...
          <div class="swiper-slide h-full">
            <div
              ...
              <p class="text-center md:text-start">
                Visual AI automates operational tasks such as monitoring workflows, verifying compliance, and managing repetitive processes, boosting speed, accuracy, and overall operational efficiency.
              </p>
            </div>
          </div>
          ...
          <div class="swiper-slide h-full">
            <div
              ...
              <p class="text-center md:text-start">
                AI-powered video analytics enable real-time security monitoring, detecting unauthorized access, hazardous behaviors, and compliance breaches across facilities, campuses, and critical infrastructure.
              </p>
            </div>
          </div>
          <!-- CARD 4 -->
          <div class="swiper-slide h-full">
            <div
              ...
              <p class="text-center md:text-start">
                Computer vision tracks inventory levels, performs stock counts, identifies misplaced items, and optimizes supply chains, reducing shrinkage across warehouses and distribution centers.
              </p>
            </div>
          </div>
          ...
          <div class="swiper-slide h-full">
            <div
              ...
              <p class="text-center md:text-start">
                OCR and vision-based pattern recognition extract and validate data from paper and digital documents, automating accounts, procurement, HR, and regulatory workflows.
              </p>
            </div>
          </div>
          <!-- CARD 6 -->
          <div class="swiper-slide h-full">
            <div
              ...
              <p class="text-center md:text-start">
                In retail and digital channels, computer vision analyzes customer behavior, demographics, and product interactions, enabling personalized recommendations, optimized layouts, and better service experiences.
              </p>
            </div>
          </div>
          <!-- CARD 7 -->
          <div class="swiper-slide h-full">
            <div
              ...
              <p class="text-center md:text-start">
                Vision algorithms identify unusual transaction patterns, validate IDs (face/ID matching), and flag suspicious behaviors in real-time, enhancing compliance and minimizing fraud risks.
              </p>
            </div>
          </div>
          <!-- CARD 8 -->
          <div class="swiper-slide h-full">
            <div
              ...
              <p class="text-center md:text-start">
                Computer vision continuously inspects machinery, vehicles, and remote equipment, detecting faults and anomalies with minimal downtime or human intervention, ensuring operational continuity.
              </p>
            </div>
          </div>
        ...
        <div class="w-full flex flex-col gap-5 items-start">
          ...
          <div class="flex flex-col gap-5 lg:gap-0 lg:flex-row justify-between">
            <h2 class="w-full lg:w-7/12 text-4xl flex-wrap gap-3 flex items-center font-bold text-black1 font-urbanist">
              ...
              <span class="text-gradient">Next-Gen Computer Vision Solutions</span>
            </h2>
            <a href="https://intellivon.com/ai-strategy-call-booking-confirmation/" target="_blank">
              <div>
                <button type="button"
          ...
          <p class="text-grey1 text-base font-medium">
            Intellivon combines cutting-edge AI technologies with expert insights to deliver next-gen visual AI solutions that drive innovation and business growth.
          </p>
        </div>
      </div>
    </div>
      ...
      <div class="choose-card-wrapper w-full h-[212px] md:w-[409px] m-auto lg:m-0 z-10">
        <div class="choose-card shadow-[0_24px_34px_0_rgba(0,0,0,.078)]">
          ...
          <div
            ...
            <p class="text-sm">
              Our team consists of expert engineers, AI researchers, and architects, specializing in building and deploying scalable, enterprise-level vision systems.
            </p>
          </div>
        </div>
      </div>
      ...
      <div class="choose-card-wrapper w-full h-[212px] md:w-[409px] m-auto lg:m-0 z-10">
        <div class="choose-card shadow-[0_24px_34px_0_rgba(0,0,0,.078)]">
          ...
          <div
            ...
            <p class="text-sm">
              We design custom vision systems tailored to your business needs, infrastructure, and industry regulations, ensuring a perfect fit for your operations.
            </p>
          </div>
        </div>
      </div>
      ...
      <div class="choose-card-wrapper w-full h-[212px] md:w-[409px] m-auto lg:m-0 z-10">
        <div class="choose-card shadow-[0_24px_34px_0_rgba(0,0,0,.078)]">
          ...
          <div class="choose-card-front bg-white p-6 flex flex-col gap-8 items-center justify-center">
            ...
            <h3 class="text-xl font-semibold text-center">Full-Cycle Development</h3>
          </div>
          <!-- Back Side -->
          <div
            class="choose-card-back bg-white p-6 flex flex-col gap-4 items-center justify-center text-center text-gray-800">
            ...
            <p class="text-sm">
              We manage the entire development lifecycle, from problem discovery and data annotation to training, integration, and real-time deployment, and post-deployment, ensuring seamless solutions.
            </p>
          </div>
        </div>
      </div>
      ...
      <div class="choose-card-wrapper w-full h-[212px] md:w-[409px] m-auto lg:m-0 z-10">
        <div class="choose-card shadow-[0_24px_34px_0_rgba(0,0,0,.078)]">
          ...
          <div
            ...
            <p class="text-sm">
              Our solutions are built for scalability, optimized for cloud and edge environments, handling millions of data points in real time without compromise.
            </p>
          </div>
        </div>
      </div>
      ...
      <div class="choose-card-wrapper w-full h-[212px] md:w-[409px] m-auto lg:m-0 z-10">
        <div class="choose-card shadow-[0_24px_34px_0_rgba(0,0,0,.078)]">
          ...
          <div
            ...
            <p class="text-sm">
              Every layer of our computer vision stack is designed with security, privacy, and compliance, ensuring your data and stakeholders are always protected.
            </p>
          </div>
        </div>
      </div>
      ...
      <div class="choose-card-wrapper w-full h-[212px] md:w-[409px] m-auto lg:m-0 z-10">
        <div class="choose-card shadow-[0_24px_34px_0_rgba(0,0,0,.078)]">
          ...
          <div
            ...
            <p class="text-sm">
              We’ve successfully delivered computer vision solutions for industry leaders, driving measurable improvements in performance, efficiency, and ROI.
            </p>
          </div>
        </div>
      </div>
  ...
  <div class="container">
    ...
    <div class="w-full flex flex-col gap-3 items-start">
      ...
      <h2 class="text-4xl font-bold text-black1 font-urbanist leading-snug tracking-[0.5px] w-full md:gap-3">
        Robust Technologies Fueling Scalable   
        <span class="text-gradient"> Computer Vision Solutions </span>
      </h2>
      <div class="w-full flex flex-col lg:flex-row justify-between">
        <p class="capitalize mb-4 md:mb-0 text-base font-medium text-grey1 mt-2 md:w-8/12 tracking-[0.25px] pr-5">
          We utilize advanced technologies, including deep learning, neural networks, and real-time processing, to develop intelligent and scalable computer vision solutions.
        </p>
        <!-- Buttons -->
    ...
    <div class="mt-10">
      ...
      <div class="swiper techSwiper">
        <div class="swiper-wrapper min-h-auto">
          ...
          <div class="swiper-slide border-2 border-[#99899d] rounded-[30px]">
            <div class="flex flex-col w-full items-center gap-5 py-10 lg:py-20">
              <h3 class="font-bold text-3xl text-center">Model Architectures</h3>
              <div class="flex flex-wrap justify-center gap-6 mt-5 max-w-[1200px] mx-auto">
                <!-- Use same layout -->
                <div
                  class="technology-edge w-[260px] lg:w-[280px] rounded-full flex items-center gap-3 px-6 py-3 bg-white shadow-sm">
          ...
          <div class="swiper-slide border-2 border-[#99899d] rounded-[30px]">
            <div class="flex flex-col w-full items-center gap-5 py-10 lg:py-20">
              <h3 class="font-bold text-3xl text-center">Deployment & Integration Tools</h3>
              <div class="flex flex-wrap justify-center gap-6 mt-5 max-w-[1200px] mx-auto">
                <!-- Use same layout -->
                <div
                  class="technology-edge w-[260px] lg:w-[280px] rounded-full flex items-center gap-3 px-6 py-3 bg-white shadow-sm">
          ...
          <div class="swiper-slide border-2 border-[#99899d] rounded-[30px]">
            <div class="flex flex-col w-full items-center gap-5 py-10 lg:py-20">
              <h3 class="font-bold text-3xl text-center">Hardware/Edge Devices</h3>
              <div class="flex flex-wrap justify-center gap-6 mt-5 max-w-[1200px] mx-auto">
                <!-- Use same layout -->
                <div
                  class="technology-edge w-[260px] lg:w-[280px] rounded-full flex items-center gap-3 px-6 py-3 bg-white shadow-sm">
          ...
          <div class="swiper-slide border-2 border-[#99899d] rounded-[30px]">
            <div class="flex flex-col w-full items-center gap-5 py-10 lg:py-20">
              <h3 class="font-bold text-3xl text-center">Version Control & Collaboration</h3>
              <div class="flex flex-wrap justify-center gap-6 mt-5 max-w-[1200px] mx-auto">
                <!-- Use same layout -->
                <div
                  class="technology-edge w-[260px] lg:w-[280px] rounded-full flex items-center gap-3 px-6 py-3 bg-white shadow-sm">
          ...
          <div class="swiper-slide border-2 border-[#99899d] rounded-[30px]">
            <div class="flex flex-col w-full items-center gap-5 py-10 lg:py-20">
              <h3 class="font-bold text-3xl text-center">Monitoring & Optimization</h3>
              <div class="flex flex-wrap justify-center gap-6 mt-5 max-w-[1200px] mx-auto">
                <!-- Use same layout -->
                <div
                  class="technology-edge w-[260px] lg:w-[280px] rounded-full flex items-center gap-3 px-6 py-3 bg-white shadow-sm">
        ...
        <div id="testimonial-slider" class="overflow-hidden relative w-full max-w-full order-1 lg:order-2 z-20">
          <div id="testimonial-track" class="flex transition-transform duration-500 ease-in-out w-full"
            ...
            <div
              ...
              <div class="pl-6 h-fit pt-4">
                <div class="flex flex-col gap-5 font-normal text-black1 mt-5">
                 Intellivon’s computer vision solution automated our quality control process, dramatically improving defect detection accuracy by 30%. Their expertise in integrating vision AI seamlessly with our production line enabled us to scale efficiently without compromising on quality.
                  <div class="text-xl font-medium font-urbanist text-black1">
                    VP of Operations, Leading Automotive Manufacturer
                  </div>
                </div>
              </div>
            </div>
            ...
            <div
              ...
              <div class="pl-6 h-fit pt-4">
                <div class="flex flex-col gap-5 font-normal text-black1 mt-5">
                  Thanks to Intellivon’s vision-based AI technology, our inventory management process has become 25% more accurate, significantly reducing shrinkage across our warehouses. The real-time data tracking and analysis have empowered us to optimize stock levels and improve overall operational efficiency.
                  <div class="text-xl font-medium font-urbanist text-black1">
                    Logistics Manager, Global Retailer
                  </div>
                </div>
              </div>
            </div>
            ...
            <div
              ...
              <div class="pl-6 h-fit pt-4">
                <div class="flex flex-col gap-5 font-normal text-black1 mt-5">
                  Intellivon’s advanced facial recognition and workflow automation technology have drastically improved patient safety and operational efficiency in our hospital. We’ve seen a 99% reduction in patient identity mix-ups, ensuring more accurate treatment and a better overall experience for our patients.
                  <div class="text-xl font-medium font-urbanist text-black1">
            ...
            <div
              ...
              <div class="pl-6 h-fit pt-4">
                <div class="flex flex-col gap-5 font-normal text-black1 mt-5">
                  Intellivon’s AI-powered security system has revolutionized our surveillance and monitoring operations. The system quickly detects potential hazards and breaches in real-time, allowing us to respond to incidents 40% faster. Their solution has significantly enhanced our ability to maintain a secure environment.
                  <div class="text-xl font-medium font-urbanist text-black1">
                    Security Director, International University
                  </div>
                </div>
              </div>
            </div>
            ...
            <div
              ...
              <div class="pl-6 h-fit pt-4">
                <div class="flex flex-col gap-5 font-normal text-black1 mt-5">
                  Their custom computer vision solution for document processing completely transformed our workflow. By automating data extraction, we’ve reduced manual data entry by 50%, improving speed and accuracy. This has led to faster compliance reporting and overall operational efficiency for our team.
                  <div class="text-xl font-medium font-urbanist text-black1">
                    Head of Compliance, Multinational Bank
                  </div>
                </div>
              </div>
            </div>
  ...
  <div class="container flex flex-col gap-5 items-center">
    ...
    <div class="flex flex-col w-5/6 mt-5">
      ...
      <div class="faq-item">
        <div class="border-t border-[#7C3BAF] flex justify-between py-5 cursor-pointer">
          <div class="font-medium text-xl">
            Q1. What is computer vision development?
          </div>
          <div class="faq-icon">
        ...
        <div class="faq-answer overflow-hidden max-h-0 opacity-0 transition-all duration-300 ease-in-out px-4 pb-8">
          <p class="text-base text-[#333]">
            Computer vision development involves creating systems that enable machines to interpret and process visual data, such as images and videos, for various applications.
          </p>
        </div>
      </div>
      <!-- FAQ Item 2 -->
      <div class="faq-item">
        <div class="border-t border-[#7C3BAF] flex justify-between py-5 cursor-pointer">
          <div class="font-medium text-xl">
            Q2. How can computer vision improve business operations?
          </div>
          <div class="faq-icon">
            <svg xmlns="http://www.w3.org/2000/svg" width="27" height="27" viewBox="0 0 27 27" fill="none">
              <path class="vertical-path" d="M13.2227 2.61133V23.7671" stroke="black" stroke-width="4.6301"
        ...
        <div class="faq-answer overflow-hidden max-h-0 opacity-0 transition-all duration-300 ease-in-out px-4 pb-8">
          <p class="text-base text-[#333]">
            Computer vision can enhance efficiency by automating tasks like quality control, inventory management, and document processing, ultimately reducing errors and operational costs.
          </p>
        </div>
      </div>
      <!-- FAQ Item 3 -->
      <div class="faq-item">
        <div class="border-t border-[#7C3BAF] flex justify-between py-5 cursor-pointer">
          <div class="font-medium text-xl">
            Q3. What industries benefit from computer vision solutions?
          </div>
          <div class="faq-icon">
            <svg xmlns="http://www.w3.org/2000/svg" width="27" height="27" viewBox="0 0 27 27" fill="none">
              <path class="vertical-path" d="M13.2227 2.61133V23.7671" stroke="black" stroke-width="4.6301"
        ...
        <div class="faq-answer overflow-hidden max-h-0 opacity-0 transition-all duration-300 ease-in-out px-4 pb-8">
          <p class="text-base text-[#333]">
            Industries such as manufacturing, healthcare, retail, automotive, and finance use computer vision for quality control, safety monitoring, inventory management, and fraud detection.
          </p>
        </div>
      </div>
      <!-- FAQ Item 4 -->
      <div class="faq-item">
        <div class="border-t border-[#7C3BAF] flex justify-between py-5 cursor-pointer">
          <div class="font-medium text-xl">
            Q4. How does computer vision integrate with existing systems?
          </div>
          <div class="faq-icon">
            <svg xmlns="http://www.w3.org/2000/svg" width="27" height="27" viewBox="0 0 27 27" fill="none">
              <path class="vertical-path" d="M13.2227 2.61133V23.7671" stroke="black" stroke-width="4.6301"
        ...
        <div class="faq-answer overflow-hidden max-h-0 opacity-0 transition-all duration-300 ease-in-out px-4 pb-8">
          <p class="text-base text-[#333]">
            Computer vision solutions can be seamlessly integrated into existing infrastructure via APIs, cloud platforms, or edge devices, ensuring minimal disruption to operations.
          </p>
        </div>
      </div>
      <!-- FAQ Item 5 -->
      <div class="faq-item">
        <div class="border-t border-[#7C3BAF] flex justify-between py-5 cursor-pointer">
          <div class="font-medium text-xl">
            Q5. What are the key technologies used in computer vision?
          </div>
          <div class="faq-icon">
            <svg xmlns="http://www.w3.org/2000/svg" width="27" height="27" viewBox="0 0 27 27" fill="none">
              <path class="vertical-path" d="M13.2227 2.61133V23.7671" stroke="black" stroke-width="4.6301"
        ...
        <div class="faq-answer overflow-hidden max-h-0 opacity-0 transition-all duration-300 ease-in-out px-4 pb-8">
          <p class="text-base text-[#333]">
            Key technologies include machine learning, deep learning (e.g., CNNs), image processing libraries like OpenCV, and frameworks such as TensorFlow and PyTorch.
          </p>
        </div>
      </div>
      <!-- FAQ Item 6 -->
      <div class="faq-item">
        <div class="border-t border-[#7C3BAF] flex justify-between py-5 cursor-pointer">
          <div class="font-medium text-xl">
            Q6. What are the advantages of using AI in computer vision?
          </div>
          <div class="faq-icon">
            <svg xmlns="http://www.w3.org/2000/svg" width="27" height="27" viewBox="0 0 27 27" fill="none">
              <path class="vertical-path" d="M13.2227 2.61133V23.7671" stroke="black" stroke-width="4.6301"
        ...
        <div class="faq-answer overflow-hidden max-h-0 opacity-0 transition-all duration-300 ease-in-out px-4 pb-8">
          <p class="text-base text-[#333]">
            AI-powered computer vision enhances accuracy, speed, and scalability, allowing real-time decision-making, automated inspections, and insights from visual data.
          </p>
        </div>
      </div>
      <!-- FAQ Item 7 -->
      <div class="faq-item">
        <div class="border-t border-[#7C3BAF] flex justify-between py-5 cursor-pointer">
          <div class="font-medium text-xl">
            Q7. How do you ensure data privacy and security in computer vision projects?
          </div>
          <div class="faq-icon">
            <svg xmlns="http://www.w3.org/2000/svg" width="27" height="27" viewBox="0 0 27 27" fill="none">
              <path class="vertical-path" d="M13.2227 2.61133V23.7671" stroke="black" stroke-width="4.6301"
        ...
        <div class="faq-answer overflow-hidden max-h-0 opacity-0 transition-all duration-300 ease-in-out px-4 pb-8">
          <p class="text-base text-[#333]">
            Security is prioritized by implementing robust encryption, secure data storage, compliance with privacy regulations (GDPR, HIPAA), and secure APIs for sensitive data handling.
          </p>
        </div>
      </div>
      <!-- FAQ Item 8 -->
      <div class="faq-item">
        <div class="border-t border-[#7C3BAF] flex justify-between py-5 cursor-pointer">
          <div class="font-medium text-xl">
            Q8. What is the cost of developing a computer vision solution?
          </div>
          <div class="faq-icon">
            <svg xmlns="http://www.w3.org/2000/svg" width="27" height="27" viewBox="0 0 27 27" fill="none">
              <path class="vertical-path" d="M13.2227 2.61133V23.7671" stroke="black" stroke-width="4.6301"
        ...
        <div class="faq-answer overflow-hidden max-h-0 opacity-0 transition-all duration-300 ease-in-out px-4 pb-8">
          <p class="text-base text-[#333]">
            The cost varies based on project complexity, data volume, integration requirements, and scalability. A detailed consultation can provide a tailored estimate for your business needs.
          </p>
        </div>
      </div>
    </div>
