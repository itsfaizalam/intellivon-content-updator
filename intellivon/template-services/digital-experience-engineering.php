<?php /* Template Name: Digital Experience Engineering  */ ?>
<?php get_header(); ?>
  ...
  <div class="flex">
    <div class="lg:w-full flex flex-col gap-5 px-10 justify-center py-10 lg:p-[150px] lg:text-center">
      <h1 class="font-bold text-4xl lg:text-5xl text-white">
        Digital Experience Engineering Services That A
        <span class="text-gradient">ccelerate Digital Transformation</span>
      </h1>
      <p class="text-white text-lg font-medium">Intellivon’s Digital Experience Engineering blends innovative
        technologies, user-first design, and scalable architectures to elevate satisfaction, unlock business value, and
        accelerate your digital transformation.</p>
    ...
    <div class="w-full lg:w-2/3 lg:pl-10 px-10 lg:px-0">
      <div class="flex flex-col gap-5 items-start">
        ...
        <h2 class="text-4xl items-center font-bold text-black1 font-urbanist leading-snug tracking-[0.5px] gap-1">
          Crafting Impactful Digital Experiences for Leading Enterprises
        ...
        <p class="mb-4 md:mb-0 text-base font-medium text-grey1 mt-2 w-full tracking-[0.25px] pr-5 mb-12">
          Enterprises leverage our Digital Experience Engineering to optimize workflows, enhance customer engagement,
          and drive growth, ultimately achieving stronger internal and external outcomes.
        </p>
      </div>
    </div>
    <!-- Right column: Image -->
    ...
    <div class="container flex flex-col items-center lg:pt-14 pb-4 py-5 gap-10">
      ...
      <div class="w-full pr-5">
        <div class="w-full flex flex-col gap-5 items-start">
          ...
          <h2 class="text-4xl font-bold text-black1 font-urbanist leading-snug tracking-[0.5px] w-full">
            End-to-End
            <span class="text-gradient">Digital Experience Engineering Services</span>
          </h2>
          <p class="mb-4 md:mb-0 text-base font-medium text-grey1 mt-2 w-full tracking-[0.25px] pr-5 mb-12">
            Our end-to-end Digital Experience Engineering services integrate innovative technologies and user-centric
            design to create seamless journeys, driving satisfaction and business growth across interaction touchpoints.
          </p>
        </div>
      </div>
      ...
      <div class="bg-white rounded-3xl flex flex-col lg:flex-row gap-10 p-8 w-5/6 z-10" id="servicesContainer">
        <div class="flex flex-col gap-5 lg:w-1/3 h-[70vh] overflow-y-scroll pt-5 px-5" id="serviceButtons">
          ...
          <div
            class="rounded-xl flex items-center justify-center font-bold text-lg p-5 w-full shadow-[0px_4px_24px_-1px_rgba(124,59,175,0.6)]">
            Digital Experience Monitoring & Optimization
          </div>
          <!-- Button 4 -->
          <div
            class="rounded-xl flex items-center justify-center font-bold text-lg p-5 w-full shadow-[0px_4px_24px_-1px_rgba(124,59,175,0.6)]">
    ...
    const services = [
      {
        ...
        description:
          "We craft user-centric interfaces that enhance engagement and satisfaction, focusing on intuitive design for web and mobile platforms.",
        points: [
          "User Research and Persona Development",
          "Wireframing and Prototyping for Interactive Designs",
      ...
      },
      {
        ...
        description:
          "From concept to deployment, we build secure, scalable digital products using the latest technologies to create robust and high-performance solutions.",
        points: [
      ...
      {
        title: "Digital Experience Monitoring & Optimization",
        description:
          "We continuously monitor user interactions and performance, applying data-driven insights to optimize digital experiences, ensuring smooth journeys and continuous improvements..",
        points: [
          "User Behavior Analytics and Insights",
          "Conversion Rate Optimization (CRO)",
          "A/B Testing and Experimentation",
          "Mobile Experience Monitoring and Optimization",
          "Customer Journey Mapping and Analytics",
          "Performance Tuning and Load Time Optimization",
        ],
      },
      {
        title: "Cloud & DevOps Enablement",
        description:
          "We enable rapid deployment, scalable solutions, and streamlined processes with cloud-native architectures and automated pipelines, accelerating innovation and driving efficiency.",
        points: [
          "IaC Implementation",
...

      {
        ...
        description:
          "We improve digital interactions with smart automation, chatbots, and machine learning, creating personalized, efficient experiences that evolve with user needs and business goals.",
        points: [
      ...
      {
        title: "Omnichannel Experience Engineering",
        description:
          "We deliver consistent, seamless brand experiences across all digital channels, ensuring users stay connected wherever they are.",
        points: [
...
<section class="bg-landingGen py-16 lg:py-24 bg-cover px-5 lg:px-10">
  <div class="container">
    <div class="flex items-end justify-between mt-6 mb-3">
      ...
      <div class="flex flex-col gap-3 w-full">
        ...
        <h2 class="text-4xl md:gap-3 items-center font-bold text-black1 font-urbanist leading-snug tracking-[0.5px]">
          Our Process Behind Creating Powerful Digital Experiences
          <span class="text-gradient"> in 3 Steps </span>
        </h2>
        <p class="text-[#333333] w-full lg:w-3/4 text-base font-medium">
          We follow a structured, results-driven approach, integrating cutting-edge technology, user-focused design, and
          scalable architecture to deliver impactful, seamless digital experiences that grow alongside your business.
        </p>
      </div>
    </div>
    <!-- Consulting Cards -->
    <div id="consulting-cards" class="flex flex-col lg:flex-row justify-center bg-white mt-8">
      <!-- Step 1 -->
      <div class="card w-full lg:w-1/3 p-6 border-2 border-transparent bg-zinc-50 rounded-md"
        style="border-radius: 12px; background: linear-gradient(142deg, #fff 0%, #e0faff 99.14%);">
        ...
        <div class="grid grid-cols-2 gap-1 mt-4">
          <div class="p-3 bg-[#F7F7F7] h-44">
            ...
            <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
              Analyze business goals and user experience needs
            </p>
          </div>
          <div class="p-3 bg-[#F7F7F7] h-44">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
            ...
            <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
              Conduct research to understand user personas and their behavior.
            </p>
          </div>
          <div class="p-3 bg-[#F7F7F7] h-44">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
            ...
            <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
              Study competitors to identify digital experience gaps.
            </p>
          </div>
          <div class="p-3 bg-[#F7F7F7] h-44">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
            ...
            <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
              Define measurable objectives for digital transformation success.
            </p>
          </div>
        </div>
      </div>
      ...
      <div class="card w-full lg:w-1/3 p-6 border-2 border-transparent rounded-md"
        ...
        <div class="grid grid-cols-2 gap-1 mt-4">
          <div class="p-3 bg-[#F7F7F7] h-44">
            ...
            <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
              Design wireframes and interactive prototypes for user testing
            </p>
          </div>
          <div class="p-3 bg-[#F7F7F7] h-44">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
            ...
            <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
              Develop intuitive, user-centric design systems.
            </p>
          </div>
          <div class="p-3 bg-[#F7F7F7] h-44">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
            ...
            <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
              Align design concepts with brand identity and user needs.
            </p>
          </div>
          <div class="p-3 bg-[#F7F7F7] h-44">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
            ...
            <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
              Use iterative feedback to refine designs for optimal engagement.
            </p>
          </div>
        </div>
      </div>
      ...
      <div class="card w-full lg:w-1/3 p-6 border-2 border-transparent rounded-md"
        ...
        <div class="grid grid-cols-2 gap-1 mt-4">
          ...
          <div class="p-3 bg-[#F7F7F7] h-44">
            ...
            <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
              Implement modern technologies, cloud platforms, and integrations.
            </p>
          </div>
          <div class="p-3 bg-[#F7F7F7] h-44">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
            ...
            <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
              Perform thorough testing for seamless, high-quality experiences.
            </p>
          </div>
          <div class="p-3 bg-[#F7F7F7] h-44">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
            ...
            <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
              Continuously monitor and optimize for real-time user satisfaction.
            </p>
          </div>
        </div>
      </div>
      ...
      <div class="w-full flex flex-col gap-5 items-start">
        ...
        <div class="flex flex-col gap-5 lg:gap-0 lg:flex-row justify-between w-full">
          <h2
            ...
            Shaping Success in
            <span class="text-gradient">Digital Experience Engineering</span>
          </h2>
            ...
            <div class="swiper-wrapper bg-[#F2F7FF]">
                ...
                <div class="w-full lg:w-1/2 flex flex-col gap-5 px-5 py-4">
                  <div class="flex flex-col w-full gap-2 pb-4 border-b border-b-[#99899d]">
                    <h3 class="text-xl md:text-3xl font-semibold">
                      Revolutionizing E-Commerce User Experience
                    </h3>
                    <div class="text-[#333] leading-7 tracking-wide">
                      <p class="hidden xl:block text-md">
                        We partnered with a global e-commerce leader to completely transform their digital presence by
                        unifying their design systems and migrating to a modern headless architecture. Our team
                        optimized both web and mobile platforms for performance and scalability, ensuring faster site
                        speeds and a seamless shopping experience.
                      </p>
                  ...
                  <ul class="flex flex-col gap-2 list-disc pl-5">
                    <li class="">
                      ...
                      <span>increase in total enterprise sales revenue</span>
                    </li>
                    <li class="">
                      <span class="xl:text-xl font-semibold">40%</span>
                      <span>reduction in IT infrastructure costs</span>
                    </li>
                    <li class="">
                      <span class="xl:text-xl font-semibold">50%</span>
                      <span>decrease in revenue lost to abandoned carts</span>
                    </li>
                  </ul>
                  <!-- Explore More button -->
                  <a href="https://intellivon.com/ai-strategy-call-booking-confirmation/" target="_blank">
              ...
              <div
                ...
                <div class="w-full lg:w-1/2 flex flex-col gap-5 px-5 py-4">
                  <div class="flex flex-col w-full gap-2 pb-4 border-b border-b-[#99899d]">
                    ...
                    <div class="text-[#333] leading-7 tracking-wide">
                      <p class="hidden xl:block text-md">
                        For a multinational supply chain provider, we delivered a digital transformation initiative
                        integrating IoT sensors, advanced analytics, and blockchain for real-time inventory management.
                        By automating critical processes and enhancing data visibility across the supply chain, the
                        enterprise gained unprecedented control over stock levels, restocking, and regulatory
                        compliance.
                      </p>
                      <p class="xl:hidden leading-0 line-clamp-5 read-more-content text-sm">
                        For a multinational supply chain provider, we delivered a digital transformation initiative
                  ...
                  <ul class="flex flex-col gap-2 list-disc pl-5">
                    <li class="">
                      ...
                      <span>faster inventory turnover rates</span>
                    </li>
                    <li class="">
                      <span class="xl:text-xl font-semibold">20%</span>
                      <span>reduction in total operational expenditure</span>
                    </li>
                    <li class="">
                      <span class="xl:text-xl font-semibold">25%</span>
                      <span>improvement in supply chain transparency</span>
                    </li>
                  </ul>
                  <!-- Explore More button -->
                  <a href="https://intellivon.com/ai-strategy-call-booking-confirmation/" target="_blank">
              ...
              <div
                ...
                <div class="w-full lg:w-1/2 flex flex-col gap-5 px-5 py-4">
                  <div class="flex flex-col w-full gap-2 pb-4 border-b border-b-[#99899d]">
                    <h3 class="text-xl md:text-3xl font-semibold">
                      Boosting SaaS Growth through Smarter Onboarding
                    </h3>
                    <div class="text-[#333] leading-7 tracking-wide">
                      <p class="hidden xl:block text-md">
                        A leading SaaS provider engaged us to overhaul their user onboarding. We implemented AI-powered
                        chatbots and embedded real-time analytics, which enabled proactive user guidance and automated
                        support. This streamlined onboarding process reduced churn and improved engagement, directly
                        supporting the company’s growth targets.
                      </p>
                      <p class="xl:hidden leading-0 line-clamp-5 read-more-content text-sm">
                        A leading SaaS provider engaged us to overhaul their user onboarding. We implemented AI-powered
                        chatbots and embedded real-time analytics, which enabled proactive user guidance and automated
                  ...
                  <ul class="flex flex-col gap-2 list-disc pl-5">
                    <li class="">
                      ...
                      <span>growth in recurring subscription revenue</span>
                    </li>
                    <li class="">
                      <span class="xl:text-xl font-semibold">50%</span>
                      <span>decrease in onboarding operational costs</span>
                    </li>
                    <li class="">
                      <span class="xl:text-xl font-semibold">20% </span>
                      <span>increase in overall customer lifetime value</span>
                    </li>
                  </ul>
                  <!-- Explore More button -->
                  <a href="https://intellivon.com/ai-strategy-call-booking-confirmation/" target="_blank">
              ...
              <div
                ...
                <div class="w-full lg:w-1/2 flex flex-col gap-5 px-5 py-4">
                  <div class="flex flex-col w-full gap-2 pb-4 border-b border-b-[#99899d]">
                    <h3 class="text-xl md:text-3xl font-semibold">
                      Securing Legal Tech Platforms for Enhanced Collaboration
                    </h3>
                    <div class="text-[#333] leading-7 tracking-wide">
                      <p class="hidden xl:block text-md">
                        We worked with a legal tech firm to modernize their legacy document management system,
                        developing a secure, cloud-based platform designed for real-time team collaboration. Our
                        solution enhanced user access controls, increased compliance with legal regulations, and
                  ...
                  <ul class="flex flex-col gap-2 list-disc pl-5">
                    <li class="">
                      <span class="xl:text-xl font-semibold">25% </span>
                      reduction in document management operating costs
                    </li>
                    <li class="">
                      <span class="xl:text-xl font-semibold">30% </span>
                      increase in enterprise-wide project throughput
                    </li>
                    <li class="">
                      <span class="xl:text-xl font-semibold">20% </span>
              ...
              <div
                ...
                <div class="w-full lg:w-1/2 flex flex-col gap-5 px-5 py-4">
                  <div class="flex flex-col w-full gap-2 pb-4 border-b border-b-[#99899d]">
                    <h3 class="text-xl md:text-3xl font-semibold">
                      Scaling Media Content Delivery with Personalization
                    </h3>
                    <div class="text-[#333] leading-7 tracking-wide">
                      <p class="hidden xl:block text-md">
                        For a major media company, we re-architected the core content delivery platform by integrating
                        AI-driven recommendation engines and optimizing the streaming infrastructure. The platform now
                        delivers highly personalized experiences to millions of users while lowering delivery costs and
                        increasing ad monetization potential.
                      </p>
                      <p class="xl:hidden leading-0 line-clamp-5 read-more-content text-sm">
                        For a major media company, we re-architected the core content delivery platform by integrating
                        AI-driven recommendation engines and optimizing the streaming infrastructure. The platform now
                  ...
                  <ul class="flex flex-col gap-2 list-disc pl-5">
                    <li class="">
                      ...
                      <span>increase in total platform-generated revenue</span>
                    </li>
                    <li class="">
                      <span class="xl:text-xl font-semibold">20%</span>
                      <span>increase in ad revenue yield</span>
                    </li>
                    <li class="">
                      <span class="xl:text-xl font-semibold">25%</span>
                      reduction in content delivery infrastructure costs
                    </li>
                  </ul>
                  <!-- Explore More button -->
                  <a href="https://intellivon.com/ai-strategy-call-booking-confirmation/" target="_blank">
    ...
    <div class="w-full">
      ...
      <h2 class="w-full lg:w-11/12 text-4xl gap-3 font-bold text-black1 font-urbanist leading-snug tracking-[0.5px]">
        <span class="text-gradient">
          Real World Use Cases of Our Data Experience Engineering Services
        </span>
      </h2>
    </div>
        ...
        <div class="swiper-wrapper">
          ...
          <div class="swiper-slide h-full">
            <div
              ...
              <p class="text-center md:text-start">
                We built a platform that synchronizes customer interactions across web, mobile, chat, and voice, using
                behavioral analytics to adapt journeys and improve real-time support interactions.
              </p>
            </div>
          </div>
          ...
          <div class="swiper-slide h-full">
            <div
              ...
              <div class="flex flex-col md:flex-row gap-5 items-center">
                <!-- SVG Icon -->
                <h3 class="font-bold text-lg text-center md:text-start">
                  Document and Workflow Digitization
                </h3>
              </div>
              <p class="text-center md:text-start">
                Our AI-powered solution automates document ingestion, extracts structured data from unstructured
                sources, and routes documents for approvals, reducing manual data entry and turnaround times
                significantly.
              </p>
            </div>
          </div>
          ...
          <div class="swiper-slide h-full">
            <div
              ...
              <p class="text-center md:text-start">
                We monitor user interactions and system performance, detecting anomalies and automatically triggering UI
                adjustments or backend fixes, ensuring seamless, optimized user experiences without manual intervention.
              </p>
            </div>
          </div>
          <!-- CARD 4 -->
          <div class="swiper-slide h-full">
            <div
              ...
              <p class="text-center md:text-start">
                Leveraging machine learning, we dynamically tailor content, recommendations, and interfaces based on
                user behavior, providing personalized, hyper-relevant experiences across large-scale digital platforms.
              </p>
            </div>
          </div>
          ...
          <div class="swiper-slide h-full">
            <div
              ...
              <div class="flex flex-col md:flex-row gap-5 items-center">
                <!-- SVG Icon -->
                <h3 class="font-bold text-lg text-center md:text-start">
                  Secure API Integration for Legacy Modernization
                </h3>
              </div>
              <p class="text-center md:text-start">
                We integrate legacy systems with modern platforms using microservices and APIs, allowing enterprises to
                expose legacy data to new digital channels, accelerating transformation while maintaining compliance and
                security.
              </p>
            </div>
          </div>
          ...
          <div class="swiper-slide h-full">
            <div
              ...
              <div class="flex flex-col md:flex-row gap-5 items-center">
                <!-- SVG Icon -->
                <h3 class="font-bold text-lg text-center md:text-start">
                  Intelligent Feedback and Analytics
                </h3>
              </div>
              <p class="text-center md:text-start">
                We implement feedback widgets, sentiment analysis, and journey analytics to gather insights at key
                interaction points, enabling us to make data-driven recommendations that continuously optimize user
                experiences.
              </p>
            </div>
          </div>
          ...
          <div class="swiper-slide h-full">
            <div
              ...
              <p class="text-center md:text-start">
                We design digital workspaces for remote teams, integrating communication, document management, and
                project tracking with real-time collaboration features, ensuring security and compliance for distributed
                workforces.
              </p>
            </div>
          </div>
        ...
        <div class="w-full flex flex-col gap-5 items-start">
          ...
          <div class="flex flex-col gap-5 lg:gap-0 lg:flex-row justify-between">
            <h2 class="w-full lg:w-7/12 text-4xl flex-wrap gap-3 flex items-center font-bold text-black1 font-urbanist">
              WhEmpowering Your Business with
              <span class="text-gradient">Next-Level Digital Experiences</span>
            </h2>
            <a href="https://intellivon.com/ai-strategy-call-booking-confirmation/" target="_blank">
              <div>
                <button type="button"
          ...
          <p class="text-grey1 text-base font-medium">
            Intellivon combines innovative technologies, user-centric design, and scalable solutions to deliver digital
            experiences that drive business growth, enhance customer satisfaction, and create long-term operational
            success.
          </p>
        </div>
      </div>
    ...
    <div class="mt-16 grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-5">
        ...
        <div class="choose-card shadow-[0_24px_34px_0_rgba(0,0,0,.078)]">
          ...
          <div class="choose-card-front bg-white p-6 flex flex-col gap-8 items-center justify-center">
            ...
            <h3 class="text-xl font-semibold text-center">
              Adaptive Omnichannel Orchestration
            </h3>
          </div>
          <!-- Back Side -->
          <div
            ...
            <!-- SVG Icon -->
            <p class="text-sm">
              We link channels and create smooth, seamless transitions across web, mobile, chat, and voice, so your
              users never repeat themselves or lose their place.
            </p>
          </div>
        </div>
      </div>
      ...
      <div class="choose-card-wrapper w-full h-[212px] md:w-[409px] m-auto lg:m-0 z-10">
        <div class="choose-card shadow-[0_24px_34px_0_rgba(0,0,0,.078)]">
          ...
          <div
            ...
            <!-- SVG Icon -->
            <p class="text-sm">
              Our personalization engine customizes content, recommendations, and interfaces based on user behavior,
              ensuring every session feels unique while driving deeper engagement and improving conversion rates.
            </p>
          </div>
        </div>
      </div>
      ...
      <div class="choose-card-wrapper w-full h-[212px] md:w-[409px] m-auto lg:m-0 z-10">
        <div class="choose-card shadow-[0_24px_34px_0_rgba(0,0,0,.078)]">
          ...
          <div class="choose-card-front bg-white p-6 flex flex-col gap-8 items-center justify-center">
            <!-- SVG Icon -->
            <h3 class="text-xl font-semibold text-center">Self-Healing Digital Experiences</h3>
          </div>
          <!-- Back Side -->
          <div
            class="choose-card-back bg-white p-6 flex flex-col gap-4 items-center justify-center text-center text-gray-800">
            <!-- SVG Icon -->
            <p class="text-sm">
              We proactively monitor your digital platforms for issues, automatically fixing problems such as checkout
              issues or slow pages, so your users never experience delays or disruptions.
            </p>
          </div>
        </div>
      </div>
      ...
      <div class="choose-card-wrapper w-full h-[212px] md:w-[409px] m-auto lg:m-0 z-10">
        <div class="choose-card shadow-[0_24px_34px_0_rgba(0,0,0,.078)]">
          ...
          <div
            ...
            <!-- SVG Icon -->
            <p class="text-sm">
              We automate repetitive tasks with smart chatbots and workflow tools, freeing up your team to focus on more
              important work, while speeding up responses and improving satisfaction.
            </p>
          </div>
        </div>
      </div>
      ...
      <div class="choose-card-wrapper w-full h-[212px] md:w-[409px] m-auto lg:m-0 z-10">
        <div class="choose-card shadow-[0_24px_34px_0_rgba(0,0,0,.078)]">
          ...
          <div
            ...
            <!-- SVG Icon -->
            <p class="text-sm">
              We help integrate legacy systems with modern platforms, ensuring secure and seamless connections through
              APIs and microservices, so your business can innovate without compromising security or compliance.
            </p>
          </div>
        </div>
      </div>
      ...
      <div class="choose-card-wrapper w-full h-[212px] md:w-[409px] m-auto lg:m-0 z-10">
        <div class="choose-card shadow-[0_24px_34px_0_rgba(0,0,0,.078)]">
          ...
          <div class="choose-card-front bg-white p-6 flex flex-col gap-8 items-center justify-center">
            <!-- SVG Icon -->
            <h3 class="text-xl font-semibold text-center">
              Actionable Experience Analytics
            </h3>
          </div>
          <!-- Back Side -->
          <div
            ...
            <!-- SVG Icon -->
            <p class="text-sm">
              We gather detailed feedback and analytics at every touchpoint, offering clear insights to help you
              continuously refine your digital experiences and meet the evolving needs of your users.
            </p>
          </div>
        </div>
      </div>
  ...
  <div class="container">
    ...
    <div class="w-full flex flex-col gap-3 items-start">
      ...
      <h2 class="text-4xl font-bold text-black1 font-urbanist leading-snug tracking-[0.5px] w-full md:gap-3">
        The Tech Powering
        <span class="text-gradient"> Exceptional Digital Experiences</span>
      </h2>
      <div class="w-full flex flex-col lg:flex-row justify-between">
        <p class="capitalize mb-4 md:mb-0 text-base font-medium text-grey1 mt-2 md:w-8/12 tracking-[0.25px] pr-5">
          Our team of expert developers tailors this tech stack to create highly scalable digital experiences, driving
          performance and ensuring your enterprise achieves measurable, impactful results.
        </p>
        <!-- Buttons -->
      ...
      <div class="swiper techSwiper">
        <div class="swiper-wrapper min-h-auto">
            ...
            <div class="flex flex-col w-full items-center gap-5 py-10 lg:py-20">
              ...
              <div class="flex flex-wrap justify-center gap-6 mt-5 max-w-[1200px] mx-auto">
                ...
                <div
                  ...
                  <h4 class="text-base md:text-xl font-medium text-black2">
                    AWS 
                    <span class="text-[12px] font-normal text-black2 block">(Amazon Web Services)</span>
                  </h4>
                </div>
                <div
                  class="technology-edge w-[260px] lg:w-[280px] rounded-full flex items-center gap-3 px-6 py-3 bg-white shadow-sm">
                ...
                <div
                  ...
                  <h4 class="text-base md:text-xl font-medium text-black2">
                     GCP
                    <span class="text-[12px] font-normal text-black2 block">(Google Cloud Platform)</span>
                  </h4>
                </div>
                <div
                  class="technology-edge w-[260px] lg:w-[280px] rounded-full flex items-center gap-3 px-6 py-3 bg-white shadow-sm">
                ...
                <div
                  ...
                  <h4 class="text-base md:text-xl font-medium text-black2">
                    CI/CD 
                    <span class="text-[12px] font-normal text-black2 block">(Jenkins, GitLab CI)</span>
                  </h4>
                </div>
              </div>
            </div>
            ...
            <div class="flex flex-col w-full items-center gap-5 py-10 lg:py-20">
              ...
              <div class="flex flex-wrap justify-center gap-6 mt-5 max-w-[1200px] mx-auto">
                ...
                <div
                  ...
                  <h4 class="text-base md:text-xl font-medium text-black2">
                    JWT
                    <span class="text-[12px] font-normal text-black2 block">(JSON Web Tokens)</span>
                  </h4>
                </div>
                <div
                  class="technology-edge w-[260px] lg:w-[280px] rounded-full flex items-center gap-3 px-6 py-3 bg-white shadow-sm">
          ...
          <div class="swiper-slide border-2 border-[#99899d] rounded-[30px]">
            <div class="flex flex-col w-full items-center gap-5 py-10 lg:py-20">
              <h3 class="font-bold text-3xl text-center">
                Data Analytics & Personalization Stack
                <span class="text-[12px] font-normal text-black2 block"></span>
              </h3>
              <div class="flex flex-wrap justify-center gap-6 mt-5 max-w-[1200px] mx-auto">
                <!-- Use same layout -->
            ...
            <div class="flex flex-col w-full items-center gap-5 py-10 lg:py-20">
              ...
              <div class="flex flex-wrap justify-center gap-6 mt-5 max-w-[1200px] mx-auto">
                ...
                <div
                  ...
                  <h4 class="text-base md:text-xl font-medium text-black2">
                     NLTK
                    <span class="text-[12px] font-normal text-black2 block">(Natural Language Toolkit)</span>
                  </h4>
                </div>
                <div
                  class="technology-edge w-[260px] lg:w-[280px] rounded-full flex items-center gap-3 px-6 py-3 bg-white shadow-sm">
          ...
          <div class="swiper-slide border-2 border-[#99899d] rounded-[30px]">
            <div class="flex flex-col w-full items-center gap-5 py-10 lg:py-20">
              <h3 class="font-bold text-3xl text-center">
                Content Management & Experience Stack
                <span class="text-[12px] font-normal text-black2 block"></span>
              </h3>
              <div class="flex flex-wrap justify-center gap-6 mt-5 max-w-[1200px] mx-auto">
                <!-- Use same layout -->
                ...
                <div
                  ...
                  <h4 class="text-base md:text-xl font-medium text-black2">
                     AEM
                    <span class="text-[12px] font-normal text-black2 block">(Adobe Experience Manager)</span>
                  </h4>
                </div>
          ...
          <div class="swiper-slide border-2 border-[#99899d] rounded-[30px]">
            <div class="flex flex-col w-full items-center gap-5 py-10 lg:py-20">
              <h3 class="font-bold text-3xl text-center">
                UX/UI Design & Prototyping Stack
                <span class="text-[12px] font-normal text-black2 block"></span>
              </h3>
              <div class="flex flex-wrap justify-center gap-6 mt-5 max-w-[1200px] mx-auto">
                <!-- Use same layout -->
      ...
      <div class="flex items-end justify-between mt-6 mb-3">
        <div class="w-full flex flex-col gap-5">
          ...
          <div class="flex flex-col gap-5 lg:gap-0 lg:flex-row justify-between w-full">
            <h2
              class="w-full lg:w-11/12 text-4xl gap-3 font-bold text-black1 font-urbanist leading-snug tracking-[0.5px]">
              <span class="text-gradient">What Our Clients Say
              </span>
            </h2>
        ...
        <div id="testimonial-slider" class="overflow-hidden relative w-full max-w-full order-1 lg:order-2 z-20">
          <div id="testimonial-track" class="flex transition-transform duration-500 ease-in-out w-full"
            ...
            <div
              ...
              <div class="pl-6 h-fit pt-4">
                <div class="flex flex-col gap-5 font-normal text-black1 mt-5">
                  Our e-commerce platform had high cart abandonment rates and slow load times. Intellivon implemented a
                  seamless omnichannel experience and optimized performance across all devices, resulting in a 40%
                  reduction in cart abandonment.
                  <div class="text-xl font-medium font-urbanist text-black1">
                    John Miller, E-Commerce Director, Global Retailer
                  </div>
                </div>
              </div>
            </div>
            ...
            <div
              ...
              <div class="pl-6 h-fit pt-4">
                <div class="flex flex-col gap-5 font-normal text-black1 mt-5">
                  Our document management system was outdated and inefficient. Intellivon modernized it with a secure,
                  cloud-based platform that improved collaboration and compliance, resulting in fewer manual errors and
                  smoother team operations.
                  <div class="text-xl font-medium font-urbanist text-black1">
                    David Thompson, IT Director, Legal Tech Firm
                  </div>
                </div>
              </div>
            </div>
            ...
            <div
              ...
              <div class="pl-6 h-fit pt-4">
                <div class="flex flex-col gap-5 font-normal text-black1 mt-5">
                  Our media content delivery system struggled with personalization and speed. Intellivon re-architected
                  our platform, incorporating machine learning for smarter recommendations and optimized video
                  streaming, boosting engagement by 35%.
                  <div class="text-xl font-medium font-urbanist text-black1">
                    Karen Scott, Head of Digital, Global Media Company
                  </div>
                </div>
              </div>
            </div>
            ...
            <div
              ...
              <div class="pl-6 h-fit pt-4">
                <div class="flex flex-col gap-5 font-normal text-black1 mt-5">
                  Our supply chain lacked real-time visibility, affecting our response times. Intellivon integrated IoT
                  sensors and real-time analytics, improving inventory management, reducing restocking time by 25%, and
                  enhancing partner trust.
                  <div class="text-xl font-medium font-urbanist text-black1">
                    Mark Williams, Operations Manager, Multinational Logistics Company
                  </div>
                </div>
              </div>
            </div>
  ...
  <div class="container flex flex-col gap-5 items-center">
    ...
    <div class="flex flex-col w-5/6 mt-5">
      ...
      <div class="faq-item">
        <div class="border-t border-[#7C3BAF] flex justify-between py-5 cursor-pointer">
          <div class="font-medium text-xl">
            Q1. What is Digital Experiences Engineering?
          </div>
          <div class="faq-icon">
        ...
        <div class="faq-answer overflow-hidden max-h-0 opacity-0 transition-all duration-300 ease-in-out px-4 pb-8">
          <p class="text-base text-[#333]">
            Digital Experiences Engineering designs personalized, intuitive digital interactions that boost engagement
            and drive business growth, creating seamless experiences across various platforms using the latest
            technologies.
          </p>
        </div>
      </div>
      ...
      <div class="faq-item">
        <div class="border-t border-[#7C3BAF] flex justify-between py-5 cursor-pointer">
          <div class="font-medium text-xl">
            Q2. How does Intellivon's Digital Experiences Engineering leverage AI?
          </div>
          <div class="faq-icon">
            <svg xmlns="http://www.w3.org/2000/svg" width="27" height="27" viewBox="0 0 27 27" fill="none">
              <path class="vertical-path" d="M13.2227 2.61133V23.7671" stroke="black" stroke-width="4.6301"
        ...
        <div class="faq-answer overflow-hidden max-h-0 opacity-0 transition-all duration-300 ease-in-out px-4 pb-8">
          <p class="text-base text-[#333]">
            We utilize AI to create personalized experiences, automate tasks, predict customer behavior, and enhance
            features, enabling businesses to deliver smarter, more relevant digital interactions.
          </p>
        </div>
      </div>
      <!-- FAQ Item 3 -->
      <div class="faq-item">
        <div class="border-t border-[#7C3BAF] flex justify-between py-5 cursor-pointer">
          <div class="font-medium text-xl">
            Q3. What specific services are included in Digital Experiences Engineering?
          </div>
          <div class="faq-icon">
            <svg xmlns="http://www.w3.org/2000/svg" width="27" height="27" viewBox="0 0 27 27" fill="none">
              <path class="vertical-path" d="M13.2227 2.61133V23.7671" stroke="black" stroke-width="4.6301"
        ...
        <div class="faq-answer overflow-hidden max-h-0 opacity-0 transition-all duration-300 ease-in-out px-4 pb-8">
          <p class="text-base text-[#333]">
            Our services include personalized content delivery, automation bots, predictive support systems, and
            data-driven analytics to optimize user engagement and improve retention.
          </p>
        </div>
      </div>
      <!-- FAQ Item 4 -->
      <div class="faq-item">
        <div class="border-t border-[#7C3BAF] flex justify-between py-5 cursor-pointer">
          <div class="font-medium text-xl">
            Q4. How can Digital Experiences Engineering improve customer retention?
          </div>
          <div class="faq-icon">
            <svg xmlns="http://www.w3.org/2000/svg" width="27" height="27" viewBox="0 0 27 27" fill="none">
              <path class="vertical-path" d="M13.2227 2.61133V23.7671" stroke="black" stroke-width="4.6301"
        ...
        <div class="faq-answer overflow-hidden max-h-0 opacity-0 transition-all duration-300 ease-in-out px-4 pb-8">
          <p class="text-base text-[#333]">
            By personalizing content and interactions, we help businesses create engaging, relevant experiences that
            strengthen customer relationships, increase satisfaction, and boost retention rates.
          </p>
        </div>
      </div>
      <!-- FAQ Item 5 -->
      <div class="faq-item">
        <div class="border-t border-[#7C3BAF] flex justify-between py-5 cursor-pointer">
          <div class="font-medium text-xl">
            Q5. What industries can benefit from Intellivon's Digital Experiences Engineering services?
          </div>
          <div class="faq-icon">
            <svg xmlns="http://www.w3.org/2000/svg" width="27" height="27" viewBox="0 0 27 27" fill="none">
              <path class="vertical-path" d="M13.2227 2.61133V23.7671" stroke="black" stroke-width="4.6301"
        ...
        <div class="faq-answer overflow-hidden max-h-0 opacity-0 transition-all duration-300 ease-in-out px-4 pb-8">
          <p class="text-base text-[#333]">
            We work across industries like retail, insurance, manufacturing, and education, helping businesses improve
            operations, enhance customer satisfaction, and personalize user experiences.
          </p>
        </div>
      </div>
      ...
      <div class="faq-item">
        <div class="border-t border-[#7C3BAF] flex justify-between py-5 cursor-pointer">
          <div class="font-medium text-xl">
            Q6. How does personalization fit into Digital Experiences Engineering?
          </div>
          <div class="faq-icon">
            <svg xmlns="http://www.w3.org/2000/svg" width="27" height="27" viewBox="0 0 27 27" fill="none">
              <path class="vertical-path" d="M13.2227 2.61133V23.7671" stroke="black" stroke-width="4.6301"
        ...
        <div class="faq-answer overflow-hidden max-h-0 opacity-0 transition-all duration-300 ease-in-out px-4 pb-8">
          <p class="text-base text-[#333]">
            Personalization is key. We use AI to tailor content, recommendations, and interactions to each user, making
            their experience more relevant and engaging.
          </p>
        </div>
      </div>
      ...
      <div class="faq-item">
        <div class="border-t border-[#7C3BAF] flex justify-between py-5 cursor-pointer">
          <div class="font-medium text-xl">
            Q7. What is Intellivon's approach to Digital Experiences Engineering projects?
          </div>
          <div class="faq-icon">
            <svg xmlns="http://www.w3.org/2000/svg" width="27" height="27" viewBox="0 0 27 27" fill="none">
              <path class="vertical-path" d="M13.2227 2.61133V23.7671" stroke="black" stroke-width="4.6301"
        ...
        <div class="faq-answer overflow-hidden max-h-0 opacity-0 transition-all duration-300 ease-in-out px-4 pb-8">
          <p class="text-base text-[#333]">
            We collaborate closely with clients to understand their needs, explore tailored solutions, and integrate
            custom or pre-trained AI models seamlessly into existing systems for scalable results.
          </p>
        </div>
      </div>
      ...
      <div class="faq-item">
        <div class="border-t border-[#7C3BAF] flex justify-between py-5 cursor-pointer">
          <div class="font-medium text-xl">
            Q8. What outcomes can businesses expect from Intellivon's Digital Experiences Engineering?
          </div>
          <div class="faq-icon">
            <svg xmlns="http://www.w3.org/2000/svg" width="27" height="27" viewBox="0 0 27 27" fill="none">
              <path class="vertical-path" d="M13.2227 2.61133V23.7671" stroke="black" stroke-width="4.6301"
        ...
        <div class="faq-answer overflow-hidden max-h-0 opacity-0 transition-all duration-300 ease-in-out px-4 pb-8">
          <p class="text-base text-[#333]">
            Businesses can expect improved user retention, smarter growth strategies, higher customer satisfaction, task
            automation, and a competitive edge with AI-powered, scalable solutions.
          </p>
        </div>
      </div>
    </div>
