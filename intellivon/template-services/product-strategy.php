<?php /* Template Name: Product Strategy */ ?>
<?php get_header(); ?>
    ...
    <div class="flex">
        <div class="lg:w-full flex flex-col gap-5 px-10 justify-center py-10 lg:p-[150px] lg:text-center">
            <h1 class="font-bold text-4xl lg:text-5xl text-white">
                Unlock
                <span class="text-gradient">Product Strategy Consulting Services That Turn Ideas Into Scalable Solutions
                </span>
            </h1>
            <p class="text-white text-lg font-medium">
                We combine strategic consulting and deep engineering expertise to transform your product ideas into
        ...
        <div class="w-full lg:w-2/3 lg:pl-10 px-10 lg:px-0">
            <div class="flex flex-col gap-5 items-start">
                ...
                <h2
                    ...
                    Trusted by Leading Brands for Product Strategy Excellence
                ...
                <p class="mb-4 md:mb-0 text-base font-medium text-grey1 mt-2 w-full tracking-[0.25px] pr-5 mb-12">
                    We partner with leading global enterprises to help transform their digital product ideas into
                    scalable, innovative solutions through our cutting-edge product strategy consulting services.
...
<section>
        ...
        <div class="container flex flex-col items-center lg:pt-14 pb-4 py-5 gap-10">
            ...
            <div class="w-full pr-5">
                <div class="w-full flex flex-col gap-5 items-start">
                    ...
                    <h2 class="text-4xl font-bold text-black1 font-urbanist leading-snug tracking-[0.5px] w-full">
                        Comprehensive Product Strategy Solutions
                        <span class="text-gradient">
                            for Your Business
                        </span>
                    </h2>
                    <p class="mb-4 md:mb-0 text-base font-medium text-grey1 mt-2 w-full tracking-[0.25px] pr-5 mb-12">
                        Our consulting services focus on crafting tailored product strategies backed by cutting-edge
                        engineering to turn your product ideas into scalable solutions that evolve as your business
                        thrives.
            ...
            <div class="bg-white rounded-3xl flex flex-col lg:flex-row gap-10 p-8 w-5/6 z-10" id="servicesContainer">
                <div class="flex flex-col gap-5 lg:w-1/3 h-[70vh] overflow-y-scroll pt-5 px-5" id="serviceButtons">
                    ...
                    <div
                        class="rounded-xl flex items-center justify-center font-bold text-lg p-5 w-full shadow-[0px_4px_24px_-1px_rgba(124,59,175,0.6)]">
                        AI Product Scaling & Optimization
    ...
    <script>
        const services = [
            {
                title: "AI Product Roadmap Development",
                description:
                    "Intellivon helps businesses create a strategic AI product roadmap that outlines critical milestones, resource allocation, and timeline management, ensuring your AI product evolves with market needs.",
                points: [
            ...
            },
            {
                ...
                description:
                    "Intellivon supports businesses in navigating AI product launches with a tailored market entry strategy, from identifying target customers to positioning the product and building partnerships for success.",
                points: [
            ...
            },
            {
                ...
                description:
                    "Intellivon provides expert guidance on designing intuitive, user-centric AI products, creating prototypes, and developing MVPs, ensuring that the product meets both user needs and business goals.",
                points: [
                    "User-Centric Design Workshops",
                    "Prototype Development and Iteration",
                    "UX/UI Strategy for AI Products",
            ...
            },
            {
                ...
                description:
                    "Intellivon assists in designing innovative AI business models that leverage data, customer insights, and scalable strategies, ensuring your AI product aligns with both market demands and profitability.",
                points: [
                    "Monetization Strategy Design",
                    "Customer Segmentation & Targeting",
                    "Subscription vs. Pay-Per-Use Model Development",
                    "Partnership & Licensing Strategy",
                    "Business KPIs and ROI Definition",
                    "Data Utilization Strategy for Business Value",
                ],

            },

            {
                title: " AI Product Scaling & Optimization",
                description:
                    "Intellivon helps businesses scale AI products efficiently by optimizing performance, ensuring cost-effectiveness, and preparing the product for widespread adoption across multiple platforms.",
                points: [
            ...
            {
                title: "AI Product Lifecycle Management",
                description:
                    "Intellivon offers end-to-end support in managing the full lifecycle of AI products, ensuring long-term success by tracking progress, incorporating feedback, and refining features over time.",
                points: [
                    "Product Launch Strategy",
                    "Ongoing Product Monitoring & Analytics",
                    "Post-Launch Support Planning",
                    "Feature Update and Enhancement Planning",
                    "Customer Feedback Loop Integration",
                    "Long-Term Product Sustainability Strategy",
                ],
        ...
        <div class="flex items-end justify-between mt-6 mb-3">
            ...
            <div class="flex flex-col gap-3 w-full">
                ...
                <h2
                    ...
                    How We Approach Product Strategy Consulting

                    <span class="text-gradient"> in 3 Steps </span>
                </h2>
                <p class="text-[#333333] w-full lg:w-3/4 text-base font-medium">
                    We guide your product through every stage, from ideation and strategy to engineering, deployment,
                    and continuous monitoring, ensuring scalable success at every step.
                ...
                <div class="grid grid-cols-2 gap-1 mt-4">
                    <div class="p-3 bg-[#F7F7F7] h-44">
                        ...
                        <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
                            Collaborate with your team to understand business goals.
                    ...
                    <div class="p-3 bg-[#F7F7F7] h-44">
                        ...
                        <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
                            Analyze your current technology and infrastructure.
                    ...
                    <div class="p-3 bg-[#F7F7F7] h-44">
                        ...
                        <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
                            Identify quick wins and prioritize initiatives.
                        </p>
                    </div>
                    <div class="p-3 bg-[#F7F7F7] h-44">
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
            ...
            <div class="card w-full lg:w-1/3 p-6 border-2 border-transparent rounded-md"
                ...
                <div class="grid grid-cols-2 gap-1 mt-4">
                    <div class="p-3 bg-[#F7F7F7] h-44">
                        ...
                        <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
                            Conduct discovery workshops to align your product roadmap with KPIs.
                    ...
                    <div class="p-3 bg-[#F7F7F7] h-44">
                        ...
                        <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
                            Prioritize the most impactful features based on value and feasibility.
                    ...
                    <div class="p-3 bg-[#F7F7F7] h-44">
                        ...
                        <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
                            Develop a comprehensive technical roadmap to address future needs.
                    ...
                    <div class="p-3 bg-[#F7F7F7] h-44">
                        ...
                        <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
                            Develop a go-to-market strategy that incorporates effective distribution channels.
            ...
            <div class="card w-full lg:w-1/3 p-6 border-2 border-transparent rounded-md"
                ...
                <div class="grid grid-cols-2 gap-1 mt-4">
                    <div class="p-3 bg-[#F7F7F7] h-44">
                        ...
                        <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
                            Implement scalable technical solutions using modern tools and best practices.
                    ...
                    <div class="p-3 bg-[#F7F7F7] h-44">
                        ...
                        <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
                            Ensure compliance with necessary security and regulatory requirements.
                    ...
                    <div class="p-3 bg-[#F7F7F7] h-44">
                        ...
                        <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
                            Continuously monitor product performance using real-time analytics.
                    ...
                    <div class="p-3 bg-[#F7F7F7] h-44">
                        ...
                        <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
                            Optimize the product by acting on feedback and enhancing user experience.
            ...
            <div class="w-full flex flex-col gap-5 items-start">
                ...
                <div class="flex flex-col gap-5 lg:gap-0 lg:flex-row justify-between w-full">
                    <h2
                        ...
                        <span class="text-gradient">Product Strategy Consulting</span>
                    </h2>
                        ...
                        <div class="swiper-wrapper bg-[#F2F7FF]">
                                ...
                                <div class="w-full lg:w-1/2 flex flex-col gap-5 px-5 py-4">
                                    <div class="flex flex-col w-full gap-2 pb-4 border-b border-b-[#99899d]">
                                        <h3 class="text-xl md:text-3xl font-semibold">
                                            Scalable SaaS Platform for Data-Driven Marketing
                                        </h3>
                                        <div class="text-[#333] leading-7 tracking-wide">
                                            <p class="hidden xl:block text-md">
                                                We created a cloud-native SaaS product that consolidates marketing data
                                                and automates campaign management for enterprises, resulting in 40%
                                                faster campaign launches and improved personalization. The platform
                                                enabled marketers to optimize their strategies, resulting in improved
                                                customer engagement.
                                            </p>
                                    ...
                                    <ul class="flex flex-col gap-2 list-disc pl-5">
                                        <li class="">
                                            ...
                                            <span> faster campaign launches</span>
                                        </li>
                                        <li class="">
                                            <span class="xl:text-xl font-semibold">30%</span>
                                            <span>improvement in personalization accuracy</span>
                                        </li>
                                        <li class="">
                                            <span class="xl:text-xl font-semibold">25%</span>
                                            <span>increase in campaign ROI</span>
                                        </li>
                                    </ul>
                                    <!-- Explore More button -->
                            ...
                            <div
                                ...
                                <div class="w-full lg:w-1/2 flex flex-col gap-5 px-5 py-4">
                                    <div class="flex flex-col w-full gap-2 pb-4 border-b border-b-[#99899d]">
                                        ...
                                        <div class="text-[#333] leading-7 tracking-wide">
                                            <p class="hidden xl:block text-md">
                                                We launched a P2P lending platform with automated credit scoring and
                                                risk assessment using machine learning, enabling rapid loan approvals
                                                and expanding access to credit for underserved segments. This platform
                                                increased loan disbursement by 50% and reduced credit risk exposure.
                            ...
                            <div
                                ...
                                <div class="w-full lg:w-1/2 flex flex-col gap-5 px-5 py-4">
                                    <div class="flex flex-col w-full gap-2 pb-4 border-b border-b-[#99899d]">
                                        <h3 class="text-xl md:text-3xl font-semibold">
                                            In-Store Mobile Experience App
                                        </h3>
                                        <div class="text-[#333] leading-7 tracking-wide">
                                            <p class="hidden xl:block text-md">
                                                We created a mobile app for in-store navigation, personalized
                                                promotions, and seamless checkout, enhancing the customer experience and
                                                driving foot traffic. The app increased in-store sales by 15% and
                                                improved the overall customer shopping experience.
                                    ...
                                    <ul class="flex flex-col gap-2 list-disc pl-5">
                                        <li class="">
                                            ...
                                            <span> increase in in-store sales </span>
                                        </li>
                                        <li class="">
                                            <span class="xl:text-xl font-semibold">20%</span>
                                            <span>
                            ...
                            <div
                                ...
                                <div class="w-full lg:w-1/2 flex flex-col gap-5 px-5 py-4">
                                    <div class="flex flex-col w-full gap-2 pb-4 border-b border-b-[#99899d]">
                                        <h3 class="text-xl md:text-3xl font-semibold">
                                            Go-To-Market Strategy for Media and Entertainment

                                        </h3>
                                        <div class="text-[#333] leading-7 tracking-wide">
                                            <p class="hidden xl:block text-md">
                                                We collaborated with a global media and entertainment company to craft a
                                                Go-To-Market Strategy for their new streaming platform. Our team helped
                                                with strategic planning, seamless onboarding for content creators, and
                                                automated deployment, ensuring a smooth market entry. We also focused on
                                                accelerating user adoption, aligning with industry regulations and
                                                security standards.
                                            </p>
                                            <p class="xl:hidden leading-0 line-clamp-5 read-more-content text-sm">
                                                We collaborated with a global media and entertainment company to craft a
                                    ...
                                    <ul class="flex flex-col gap-2 list-disc pl-5">
                                        <li class="">
                                            <span class="xl:text-xl font-semibold">30% </span>
                                            <span>improvement in production efficiency</span>
                                        </li>
                                        <li class="">
                                            <span class="xl:text-xl font-semibold">25% </span>
                                            <span> increase in content creator engagement

                                            </span>
                                        </li>
                                        <li class="">
                                            <span class="xl:text-xl font-semibold"></span>
                                            <span>Enhanced market competitiveness </span>
                                        </li>
                                    </ul>
                                    <!-- Explore More button -->
                                    <a href="https://intellivon.com/ai-strategy-call-booking-confirmation/"
                            ...
                            <div
                                ...
                                <div class="w-full lg:w-1/2 flex flex-col gap-5 px-5 py-4">
                                    <div class="flex flex-col w-full gap-2 pb-4 border-b border-b-[#99899d]">
                                        <h3 class="text-xl md:text-3xl font-semibold">
                                            Technical Roadmap for the Construction Industry

                                        </h3>
                                        <div class="text-[#333] leading-7 tracking-wide">
                                            <p class="hidden xl:block text-md">
                                                Intellivon worked with a leading construction firm to develop a
                                                Technical Roadmap for modernizing their project management software. We
                                                guided the company in integrating AI/ML for data-driven decision-making
                                                and cloud migration for scalability. The roadmap enabled the company to
                                                reduce technical debt, enhance operational efficiency, and develop a
                                                flexible system that could handle future growth.
                                    ...
                                    <ul class="flex flex-col gap-2 list-disc pl-5">
                                        <li class="">
                                            <span class="xl:text-xl font-semibold">40%</span>
                                            <span>reduction in technical debt</span>
                                        </li>
                                        <li class="">
                                            <span class="xl:text-xl font-semibold">30%</span>
                                            <span>
...
<section class="w-full px-5 lg:px-10 py-14 lg:py-20 bg-[#F2F7FF] relative overflow-hidden">
    <div class="container flex flex-col gap-5 items-center">
        ...
        <div class="w-full">
            ...
            <h2
                class="w-full lg:w-11/12 text-4xl gap-3 font-bold text-black1 font-urbanist leading-snug tracking-[0.5px]">
                <span class="text-gradient">Use Cases That Showcase Our Scalable AI Innovation </span>
            </h2>
        </div>
                ...
                <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide h-full">
                        <div
                            ...
                            <p class="text-center md:text-start">
                                At Intellivon, we help you strategically integrate AI into your product roadmap,
                                ensuring that AI technologies align with your business goals to enhance your product’s
                                capabilities and market fit.
                    ...
                    <div class="swiper-slide h-full">
                        <div
                            ...
                            <p class="text-center md:text-start">
                                We design and implement AI strategies to optimize customer experiences across all
                                touchpoints, enhancing personalization, engagement, and support through intelligent
                                recommendations and automated interactions.
                    ...
                    <div class="swiper-slide h-full">
                        <div
                            ...
                            <p class="text-center md:text-start">
                                Intellivon leverages generative AI to drive product innovation, enabling rapid
                                prototyping, feature generation, and experimentation to accelerate your product’s
                                time-to-market and keep you ahead of the competition.
                    ...
                    <div class="swiper-slide h-full">
                        <div
                            ...
                            <p class="text-center md:text-start">
                                We implement AI-driven tools to continuously monitor and improve your product throughout
                                its lifecycle, empowering your team to make data-driven decisions and optimize product
                                performance.
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="swiper-slide h-full">
                        <div
                            ...
                            <p class="text-center md:text-start">
                                At Intellivon, we craft data-powered product strategies by integrating AI analytics that
                                drive better product decisions, enabling enhanced forecasting, trend analysis, and
                    ...
                    <div class="swiper-slide h-full">
                        <div
                            ...
                            <p class="text-center md:text-start">
                                We use AI to analyze competitor data, market trends, and customer feedback, providing
                                insights that inform your product positioning, pricing strategies, and differentiation,
                    ...
                    <div class="swiper-slide h-full">
                        <div
                            ...
                            <p class="text-center md:text-start">
                                Intellivon develops AI models that prioritize features based on user needs, market
                                demands, and business value, optimizing your resource allocation and maximizing the
                ...
                <div class="w-full flex flex-col gap-5 items-start">
                    ...
                    <div class="flex flex-col gap-5 lg:gap-0 lg:flex-row justify-between">
                        <h2
                            ...
                            Why Choose Us As Your Expert
                            <span class="text-gradient">Product Strategy Consultant </span>
                        </h2>
                        <a href="https://intellivon.com/ai-strategy-call-booking-confirmation/" target="_blank">
                            <div>
                                <button type="button"
                    ...
                    <p class="text-grey1 text-base font-medium">
                        We blend strategic insight with hands-on engineering to ensure your product evolves seamlessly,
                        supporting growth and innovation every step of the way.
            ...
            <div class="choose-card-wrapper w-full h-[212px] md:w-[409px] m-auto lg:m-0 z-10">
                <div class="choose-card shadow-[0_24px_34px_0_rgba(0,0,0,.078)]">
                    ...
                    <div
                        ...
                        <p class="text-sm">
                            We apply industry best practices tailored to your needs, ensuring scalable, modular, and
            ...
            <div class="choose-card-wrapper w-full h-[212px] md:w-[409px] m-auto lg:m-0 z-10">
                <div class="choose-card shadow-[0_24px_34px_0_rgba(0,0,0,.078)]">
                    ...
                    <div
                        ...
                        <p class="text-sm">
                            Our expertise in microservices, API-first design, and MACH architectures drive rapid
                            innovation and seamless scalability.
            ...
            <div class="choose-card-wrapper w-full h-[212px] md:w-[409px] m-auto lg:m-0 z-10">
                <div class="choose-card shadow-[0_24px_34px_0_rgba(0,0,0,.078)]">
                    ...
                    <div class="choose-card-front bg-white p-6 flex flex-col gap-8 items-center justify-center">
                        ...
                        <h3 class="text-xl font-semibold text-center"> Collaborative Co-Engineering</h3>
                    </div>
                    <!-- Back Side -->
                    <div
                        class="choose-card-back bg-white p-6 flex flex-col gap-4 items-center justify-center text-center text-gray-800">
                        ...
                        <p class="text-sm">
                            We work closely with your teams in a co-engineering model to enhance innovation,
            ...
            <div class="choose-card-wrapper w-full h-[212px] md:w-[409px] m-auto lg:m-0 z-10">
                <div class="choose-card shadow-[0_24px_34px_0_rgba(0,0,0,.078)]">
                    ...
                    <div
                        ...
                        <p class="text-sm">
                            With our Core-Flexi model, you can scale your team and resources dynamically, ensuring
                            agility and quality.
            ...
            <div class="choose-card-wrapper w-full h-[212px] md:w-[409px] m-auto lg:m-0 z-10">
                <div class="choose-card shadow-[0_24px_34px_0_rgba(0,0,0,.078)]">
                    ...
                    <div
                        ...
                        <p class="text-sm">
                            As certified AWS and Azure partners, we bring expertise in building secure, reliable, and
            ...
            <div class="choose-card-wrapper w-full h-[212px] md:w-[409px] m-auto lg:m-0 z-10">
                <div class="choose-card shadow-[0_24px_34px_0_rgba(0,0,0,.078)]">
                    ...
                    <div
                        ...
                        <p class="text-sm">
                            We track key success metrics to ensure your product delivers real business value and
    ...
    <div class="container">
        ...
        <div class="w-full flex flex-col gap-3 items-start">
            ...
            <h2 class="text-4xl font-bold text-black1 font-urbanist leading-snug tracking-[0.5px] w-full md:gap-3">
                Our Full-Stack
                <span class="text-gradient"> Technology Expertise</span>
            </h2>
            ...
            <div class="swiper techSwiper">
                <div class="swiper-wrapper min-h-auto">
                    ...
                    <div class="swiper-slide border-2 border-[#99899d] rounded-[30px]">
                        ...
                        <div class="swiper-slide border-2 border-[#99899d] rounded-[30px]">
                            <div class="flex flex-col w-full items-center gap-5 py-10 lg:py-20">
                                <h3 class="font-bold text-3xl text-center">Database Technologies</h3>
                                <div class="flex flex-wrap justify-center gap-6 mt-5 max-w-[1200px] mx-auto">
                                    <!-- Use same layout -->
                                    <div
                                        class="technology-edge w-[260px] lg:w-[280px] rounded-full flex items-center gap-3 px-6 py-3 bg-white shadow-sm">
                        ...
                        <div class="swiper-slide border-2 border-[#99899d] rounded-[30px]">
                            <div class="flex flex-col w-full items-center gap-5 py-10 lg:py-20">
                                <h3 class="font-bold text-3xl text-center"> Microservices & API Design</h3>
                                <div class="flex flex-wrap justify-center gap-6 mt-5 max-w-[1200px] mx-auto">
                                    <!-- Use same layout -->
                                    <div
                                        class="technology-edge w-[260px] lg:w-[280px] rounded-full flex items-center gap-3 px-6 py-3 bg-white shadow-sm">
                        ...
                        <div class="swiper-slide border-2 border-[#99899d] rounded-[30px]">
                            <div class="flex flex-col w-full items-center gap-5 py-10 lg:py-20">
                                <h3 class="font-bold text-3xl text-center">Machine Learning & AI</h3>
                                <div class="flex flex-wrap justify-center gap-6 mt-5 max-w-[1200px] mx-auto">
                                    <!-- Use same layout -->
                                    <div
                                        class="technology-edge w-[260px] lg:w-[280px] rounded-full flex items-center gap-3 px-6 py-3 bg-white shadow-sm">
                        ...
                        <div class="swiper-slide border-2 border-[#99899d] rounded-[30px]">
                            <div class="flex flex-col w-full items-center gap-5 py-10 lg:py-20">
                                <h3 class="font-bold text-3xl text-center">Testing & Quality Assurance</h3>
                                <div class="flex flex-wrap justify-center gap-6 mt-5 max-w-[1200px] mx-auto">
                                    <!-- Use same layout -->
                                    <div
                                        class="technology-edge w-[260px] lg:w-[280px] rounded-full flex items-center gap-3 px-6 py-3 bg-white shadow-sm">
                        ...
                        <div class="swiper-slide border-2 border-[#99899d] rounded-[30px]">
                            <div class="flex flex-col w-full items-center gap-5 py-10 lg:py-20">
                                <h3 class="font-bold text-3xl text-center">Project Management & Collaboration Tools</h3>
                                <div class="flex flex-wrap justify-center gap-6 mt-5 max-w-[1200px] mx-auto">
                                    <!-- Use same layout -->
                                    <div
                                        class="technology-edge w-[260px] lg:w-[280px] rounded-full flex items-center gap-3 px-6 py-3 bg-white shadow-sm">
                ...
                <div id="testimonial-slider" class="overflow-hidden relative w-full max-w-full order-1 lg:order-2 z-20">
                    <div id="testimonial-track" class="flex transition-transform duration-500 ease-in-out w-full"
                        ...
                        <div
                            ...
                            <div class="pl-6 h-fit pt-4">
                                <div class="flex flex-col gap-5 font-normal text-black1 mt-5">
                                    Intellivon transformed our product strategy and engineering approach. Their team not
                                    only helped us refine our roadmap but also brought a clear vision for scaling our
                                    product. With their guidance, we successfully launched on time, streamlined our tech
                                    stack, and saw a 30% increase in user engagement within the first quarter. Their
                                    hands-on approach truly made a difference in our product’s growth trajectory.
                        ...
                        <div
                            ...
                            <div class="pl-6 h-fit pt-4">
                                <div class="flex flex-col gap-5 font-normal text-black1 mt-5">
                                    Working with Intellivon was a game-changer for our product development. They aligned
                                    our strategy with real business goals and provided expert engineering support
                                    throughout the process. Thanks to their insights, we reduced development time by 20%
                                    and delivered a more robust product to our customers. Their collaborative approach
                                    fostered innovation and ensured that we stayed on track.
                                    <div class="text-xl font-medium font-urbanist text-black1">
                        ...
                        <div
                            ...
                            <div class="pl-6 h-fit pt-4">
                                <div class="flex flex-col gap-5 font-normal text-black1 mt-5">
                                    Intellivon’s product strategy consulting and engineering expertise helped us not
                                    only shape our product vision but also execute it seamlessly. They helped us adopt a
                                    more scalable architecture and implement key features that directly impacted our
                                    market success. Our customer retention rate improved by 40%, and our time-to-market
                                    was cut in half. We couldn't be happier with the results.

                                    <div class="text-xl font-medium font-urbanist text-black1">
                                        David K, VP of Product
                        ...
                        <div
                            ...
                            <div class="pl-6 h-fit pt-4">
                                <div class="flex flex-col gap-5 font-normal text-black1 mt-5">
                                    Intellivon played a pivotal role in turning our product idea into a scalable
                                    solution. Their thorough approach to defining strategy, along with their engineering
                                    expertise, allowed us to make critical decisions that set us up for long-term
                                    success. The product is now thriving in the market, and we've experienced a 25%
                                    boost in sales and improved customer satisfaction scores.
                        ...
                        <div
                            ...
                            <div class="pl-6 h-fit pt-4">
                                <div class="flex flex-col gap-5 font-normal text-black1 mt-5">
                                    The team at Intellivon helped us navigate complex product challenges with ease. They
                                    provided invaluable strategic direction while seamlessly integrating engineering
                                    solutions that supported our vision. The result was a product that exceeded our
                                    expectations and a 50% increase in market share. Their ability to align business
                                    goals with technical execution is unmatched.

                                    <div class="text-xl font-medium font-urbanist text-black1">
                                        Michael P, Chief Product Officer
    ...
    <div class="container flex flex-col gap-5 items-center">
        ...
        <div class="flex flex-col w-5/6 mt-5">
            ...
            <div class="faq-item">
                <div class="border-t border-[#7C3BAF] flex justify-between py-5 cursor-pointer">
                    <div class="font-medium text-xl">
                        Q1. What is product strategy consulting?
                    </div>
                    <div class="faq-icon">
                ...
                <div
                    ...
                    <p class="text-base text-[#333]">
                        Product strategy consulting helps businesses define, plan, and execute a successful product
                        roadmap. It aligns product vision with business goals, ensuring market fit, scalability, and
                        long-term growth.
            ...
            <div class="faq-item">
                <div class="border-t border-[#7C3BAF] flex justify-between py-5 cursor-pointer">
                    <div class="font-medium text-xl">
                        Q2. Why should my company hire a product strategy consultant?
                ...
                <div
                    class="faq-answer overflow-hidden max-h-0 opacity-0 transition-all duration-300 ease-in-out px-4 pb-8">
                    <p class="text-base text-[#333]">
                        A product strategy consultant brings expertise in market analysis, product development, and
                        business alignment. They help avoid costly mistakes, optimize resources, and guide your product
            ...
            <div class="faq-item">
                <div class="border-t border-[#7C3BAF] flex justify-between py-5 cursor-pointer">
                    <div class="font-medium text-xl">
                        Q3. How can product strategy consulting benefit my business?
                ...
                <div
                    class="faq-answer overflow-hidden max-h-0 opacity-0 transition-all duration-300 ease-in-out px-4 pb-8">
                    <p class="text-base text-[#333]">
                        It can streamline product development, enhance market positioning, ensure alignment with
                        business goals, and improve customer satisfaction. This leads to increased revenue and a more
            ...
            <div class="faq-item">
                <div class="border-t border-[#7C3BAF] flex justify-between py-5 cursor-pointer">
                    <div class="font-medium text-xl">
                        Q4. What does a typical product strategy consulting process involve?
                    </div>
                    <div class="faq-icon">
                        <svg xmlns="http://www.w3.org/2000/svg" width="27" height="27" viewBox="0 0 27 27" fill="none">
                            <path class="vertical-path" d="M13.2227 2.61133V23.7671" stroke="black"
                ...
                <div
                    class="faq-answer overflow-hidden max-h-0 opacity-0 transition-all duration-300 ease-in-out px-4 pb-8">
                    <p class="text-base text-[#333]">
                        It involves understanding your business goals, analyzing your market, defining product features,
                        and creating a detailed roadmap. The process includes both strategy and engineering, ensuring
            ...
            <div class="faq-item">
                <div class="border-t border-[#7C3BAF] flex justify-between py-5 cursor-pointer">
                    <div class="font-medium text-xl">
                        Q5. How do product strategy consultants help with scaling my product?
                ...
                <div
                    class="faq-answer overflow-hidden max-h-0 opacity-0 transition-all duration-300 ease-in-out px-4 pb-8">
                    <p class="text-base text-[#333]">
                        They assess your current product’s capabilities, help prioritize scalable features, and build a
                        technology roadmap for growth. Consultants also focus on optimizing your product architecture
            ...
            <div class="faq-item">
                <div class="border-t border-[#7C3BAF] flex justify-between py-5 cursor-pointer">
                    <div class="font-medium text-xl">
                        Q6. What industries benefit from product strategy consulting?
                ...
                <div
                    class="faq-answer overflow-hidden max-h-0 opacity-0 transition-all duration-300 ease-in-out px-4 pb-8">
                    <p class="text-base text-[#333]">
                        Product strategy consulting benefits a wide range of industries, including tech, healthcare,
                        finance, retail, and SaaS. Consultants provide tailored strategies that align with specific
            ...
            <div class="faq-item">
                <div class="border-t border-[#7C3BAF] flex justify-between py-5 cursor-pointer">
                    <div class="font-medium text-xl">
                        Q7. How long does a product strategy consulting engagement last?
                    </div>
                    <div class="faq-icon">
                        <svg xmlns="http://www.w3.org/2000/svg" width="27" height="27" viewBox="0 0 27 27" fill="none">
                            <path class="vertical-path" d="M13.2227 2.61133V23.7671" stroke="black"
                ...
                <div
                    class="faq-answer overflow-hidden max-h-0 opacity-0 transition-all duration-300 ease-in-out px-4 pb-8">
                    <p class="text-base text-[#333]">
                        The duration depends on the project's complexity and scope, but typical engagements last between
                        3 and 6 months. This includes discovery, strategy creation, and initial execution phases.
            ...
            <div class="faq-item">
                <div class="border-t border-[#7C3BAF] flex justify-between py-5 cursor-pointer">
                    <div class="font-medium text-xl">
                        Q8. How can I measure the success of a product strategy consulting engagement?
                ...
                <div
                    class="faq-answer overflow-hidden max-h-0 opacity-0 transition-all duration-300 ease-in-out px-4 pb-8">
                    <p class="text-base text-[#333]">
                        Success can be measured through KPIs, such as increased market share, user engagement, customer
                        retention, and ROI. Consultants track these metrics throughout the process to ensure the product
