<?php /* Template Name: Product and Platform Engineering */ ?>
<?php get_header(); ?>
  ...
  <div class="flex">
    <div class="lg:w-full flex flex-col gap-5 px-10 justify-center py-10 lg:p-[150px] lg:text-center">
      <h1 class="font-bold text-4xl lg:text-5xl text-white">
        ...
        <span class="text-gradient">Services Driving Enterprise Success</span>
      </h1>
      <p class="text-white text-lg font-medium">
        From ideation to post-launch monitoring, we engineer enterprise-grade digital products that evolve with your business.
      </p>
    ...
    <div class="w-full lg:w-2/3 lg:pl-10 px-10 lg:px-0">
      <div class="flex flex-col gap-5 items-start">
        ...
        >
          ...
          <span class="text-gradient">Scalable Product Engineering</span>
        </h2>
        <p
          class="mb-4 md:mb-0 text-base font-medium text-grey1 mt-2 w-full tracking-[0.25px] pr-5 mb-12"
        >
          As a digital product transformation partner for leading enterprises, we turn bold ideas into scalable products, aligning engineering precision with business success.
        </p>
      </div>
    </div>
    <!-- Right column: Image -->
        ...
        <div class="w-full flex flex-col gap-5 items-start">
          ...
          Our 
            <span class="text-gradient"
              > Digital Product and Platform Engineering Services</span
            >
          </h2>
          <p
            class="mb-4 md:mb-0 text-base font-medium text-grey1 mt-2 w-full tracking-[0.25px] pr-5 mb-12"
          >
            We combine technical precision, agile methods, and human-centered design to create scalable digital platforms that deliver measurable business impact and long-term value.
          </p>
        </div>
      </div>
      ...
      >
        ...
        >
          ...
          <div
            class="rounded-xl flex items-center justify-center font-bold text-lg p-5 w-full shadow-[0px_4px_24px_-1px_rgba(124,59,175,0.6)]"
          >
            Co-Engineering & Agile Collaboration
          </div>
          <!-- Button 4 -->
          <div
            class="rounded-xl flex items-center justify-center font-bold text-lg p-5 w-full shadow-[0px_4px_24px_-1px_rgba(124,59,175,0.6)]"
          ...
          <div
            class="rounded-xl flex items-center justify-center font-bold text-lg p-5 w-full shadow-[0px_4px_24px_-1px_rgba(124,59,175,0.6)]"
          >
            Product Modernization & Technology Consulting
          </div>
          <!-- Button 6 -->
          <div
            class="rounded-xl flex items-center justify-center font-bold text-lg p-5 w-full shadow-[0px_4px_24px_-1px_rgba(124,59,175,0.6)]"
    ...
    const services = [
      {
        ...
        description:
          "We help transform your product ideas into scalable, market-ready solutions. From ideation to launch, we enable fast, reliable releases while ensuring alignment with your business goals and customer needs.",
        points: [
...
"Data-Driven Product Strategy and Analytics",
        ],
      },
      {
        title: "Digital Platform Development",
        description:
          "We design and implement robust digital platforms that ensure scalability, performance, and security. Our expertise in cloud-native backends, API-first design, and data-driven platforms empowers your enterprise to manage vast amounts of data, streamline operations, and integrate seamlessly with external systems.",
        points: [
"Cloud-Native Architecture Design",
...
"Security-First Platform Development",
        ],
      },
      {
        title: "Co-Engineering & Agile Collaboration",
        description:
          "OWe provide flexible, on-demand engineering teams that integrate seamlessly with your internal teams. Our agile, domain-specific experts help accelerate your digital transformation, working alongside you to deliver high-quality, scalable solutions that meet your unique business needs.",
        points: [
...
"Continuous Improvement and Iteration",
      ...
      {
        title: "Cloud-Native & DevOps Enablement",
        description:
          "Optimize your cloud infrastructure with our expertise in CI/CD, cloud automation, and performance engineering. We implement scalable, resilient cloud solutions, ensuring your product is agile, secure, and able to scale as your business grows, with continuous monitoring and proactive incident management.",
        points: [
"CI/CD Pipeline Development",
"Cloud Infrastructure Optimization",
"Cloud Automation and Orchestration",
"Performance Monitoring and Tuning",
"Incident Management and Proactive Support",
"Scalable Cloud Solutions Architecture",
        ],
      },

      {
        title: "Product Modernization & Technology Consulting",
        description:
          "We help you modernize legacy systems and optimize your technology stack for the future. Our comprehensive assessments identify areas for improvement, enabling you to maximize ROI and ensure that your systems remain reliable, secure, and competitive in a fast-evolving digital landscape.",
        points: [
"Legacy System Assessment and Optimization",
...
"Application Performance and Scalability Enhancement",
        ],
      },
  ...
  <div class="container">
    <div class="flex items-end justify-between mt-6 mb-3">
      ...
      <div class="flex flex-col gap-3 w-full">
        ...
        >
          How We Engineer Digital Products and Platforms for Business Growth
          <span class="text-gradient"> in 3 Steps </span>
        </h2>
        <p class="text-[#333333] w-full lg:w-3/4 text-base font-medium">
          We manage the entire product lifecycle, prioritizing market fit over technical complexity to ensure success from conception through market delivery and beyond.
        </p>
      </div>
    </div>
    <!-- Consulting Cards -->
      ...
      >
        ...
        <div class="grid grid-cols-2 gap-1 mt-4">
          <div class="p-3 bg-[#F7F7F7] h-44">
            ...
            <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
              Outline the product roadmap, considering features and development processes.
            </p>
          </div>
          <div class="p-3 bg-[#F7F7F7] h-44">
            <svg
          ...
          <div class="p-3 bg-[#F7F7F7] h-44">
            ...
            <p class="text-[12px] md:text-[15px] font-normal text-grey3 mt-2">
              Define the tools, infrastructure, and design requirements for development.
            </p>
          </div>
          <div class="p-3 bg-[#F7F7F7] h-44">
            <svg
    ...
    <div class="flex flex-col items-end justify-between mt-6 mb-3 w-full">
      <div class="w-full flex flex-col gap-5 items-start">
        ...
        >
          ...
          >
            Our Product and Platform Engineering
            ...
            <div class="swiper-wrapper bg-[#F2F7FF]">
                ...
                <div class="w-full lg:w-1/2 flex flex-col gap-5 px-5 py-4">
                  ...
                  >
                    <h3 class="text-xl md:text-3xl font-semibold">
                      Digital Platform Development for Capital Market Firm
                    </h3>
                    <div class="text-[#333] leading-7 tracking-wide">
                      <p class="hidden xl:block text-md">
                        Intellivon partnered with a leading capital market firm to develop a scalable digital platform for managing financial transactions and market data. By leveraging cloud-native backends and API-first design, we enabled the firm to securely handle vast amounts of data, streamline operations, and integrate seamlessly with external financial systems, ensuring a robust solution for real-time trading and compliance.
                      </p>
                      <p
              ...
              >
                <div class="w-full lg:w-1/2 flex flex-col gap-5 px-5 py-4">
                  ...
                  >
                    <h3 class="text-xl md:text-3xl font-semibold">
                      Scalable Infrastructure for High-Traffic Performance
                    </h3>
                    <div class="text-[#333] leading-7 tracking-wide">
                      <p class="hidden xl:block text-md">
                        A SaaS company was experiencing performance issues due to increasing user demand. We engineered a high-performance, scalable cloud infrastructure that enabled them to handle 10x more users without a drop in speed or uptime. By optimizing their platform’s architecture, we ensured seamless user experiences even during peak traffic, improving both user satisfaction and system reliability.
                      </p>
                      <p
                        class="xl:hidden leading-0 line-clamp-5 read-more-content text-sm"
                      >
              ...
              >
                <div class="w-full lg:w-1/2 flex flex-col gap-5 px-5 py-4">
                  ...
                  >
                    ...
                    <div class="text-[#333] leading-7 tracking-wide">
                      <p class="hidden xl:block text-md">
                        A national public broadcaster needed to modernize its content management system to meet digital demands. We engineered a cloud-native platform with real-time editing, automated transcoding, and adaptive streaming, enabling seamless multi-platform delivery. The platform handled unpredictable spikes in viewership and significantly improved content publishing speed.
                      </p>
                      <p
                        class="xl:hidden leading-0 line-clamp-5 read-more-content text-sm"
                      >
                  ...
                  <ul class="flex flex-col gap-2 list-disc pl-5">
                    <li class="">
                        ...
                        reduction in content publishing time
                    </li>
                    <li class="">
                        <span class="xl:text-xl font-semibold">99.99%</span>
                        uptime during major national events
                    </li>
                    <li class="">
                        <span class="xl:text-xl font-semibold">45% </span>
                        increase in seamless multiplatform delivery
                    </li>
                  </ul>
                  <!-- Explore More button -->
                  <a
              ...
              >
                <div class="w-full lg:w-1/2 flex flex-col gap-5 px-5 py-4">
                  ...
                  >
                    <h3 class="text-xl md:text-3xl font-semibold">
                      IoT-Driven Urban Mobility Platform
                    </h3>
                    <div class="text-[#333] leading-7 tracking-wide">
                      <p class="hidden xl:block text-md">
                        A regional smart city authority faced challenges in improving urban mobility. We delivered an IoT-driven platform for real-time traffic data aggregation, predictive analytics, and mobile applications for citizens. This system enhanced route optimization, increased public transport usage, and laid the foundation for future smart city initiatives.
                      </p>
                      <p
                        class="xl:hidden leading-0 line-clamp-5 read-more-content text-sm"
                      >
                  ...
                  <ul class="flex flex-col gap-2 list-disc pl-5">
                    <li class="">
                      <span class="xl:text-xl font-semibold">20% </span>
                       reduction in average city commute times
                    </li>
                    <li class="">
                      <span class="xl:text-xl font-semibold">30% </span>
                    ...
                    <li class="">
                      <span class="xl:text-xl font-semibold"></span>
                      Scalable platform for future smart city integrations
                    </li>
                  </ul>
                  <!-- Explore More button -->
                  <a
              ...
              >
                <div class="w-full lg:w-1/2 flex flex-col gap-5 px-5 py-4">
                  ...
                  >
                    ...
                    <div class="text-[#333] leading-7 tracking-wide">
                      <p class="hidden xl:block text-md">
                        We worked with a retail company that faced high cart abandonment rates due to a slow and complicated checkout process. Our engineering team has developed a streamlined, fast-loading checkout system that integrates with real-time inventory management. This not only simplified the purchasing process but also reduced friction, leading to higher conversion rates and increased revenue.
                      </p>
                      <p
                        class="xl:hidden leading-0 line-clamp-5 read-more-content text-sm"
                      >
...
>
  <div class="container flex flex-col gap-5 items-center">
    ...
    <div class="w-full">
      ...
      >
        <span class="text-gradient">
          Specific AI Use Cases Delivering Measurable Impact
        </span>
      </h2>
    </div>
        ...
        <div class="swiper-wrapper">
          ...
          <div class="swiper-slide h-full">
            ...
            >
              ...
              <p class="text-center md:text-start">
                End-to-end digital platforms that automate contract processes, utilizing AI for clause detection, risk scoring, and regulatory compliance to streamline contract management.
              </p>
            </div>
          </div>
          ...
          <div class="swiper-slide h-full">
            ...
            >
              <div class="flex flex-col md:flex-row gap-5 items-center">
                ...
                <h3 class="font-bold text-lg text-center md:text-start">
                  Document Intelligence Hubs
                </h3>
              </div>
              <p class="text-center md:text-start">
                Custom AI-powered architectures that ingest, classify, and search millions of unstructured documents, integrating NLP, OCR, and knowledge graphs for decision support.
              </p>
            </div>
          </div>
          ...
          <div class="swiper-slide h-full">
            ...
            >
              <div class="flex flex-col md:flex-row gap-5 items-center">
                ...
                <h3 class="font-bold text-lg text-center md:text-start">
                  Automated Regulatory Reporting Portals
                </h3>
              </div>
              <p class="text-center md:text-start">
                Secure systems that compile, validate, and deliver regulatory filings, ensuring compliance with alerts for anomalies, policy changes, and comprehensive audit trails.
              </p>
            </div>
          </div>
          <!-- CARD 4 -->
          <div class="swiper-slide h-full">
            ...
            >
              <div class="flex flex-col md:flex-row gap-5 items-center">
                ...
                <h3 class="font-bold text-lg text-center md:text-start">
                  Secure Digital Boardroom Solutions
                </h3>
              </div>
              <p class="text-center md:text-start">
                Confidential executive platforms that enable board-level collaboration with granular access control, audit trails, and real-time versioning to maintain compliance and reduce risk.
              </p>
            </div>
          </div>
          ...
          <div class="swiper-slide h-full">
            ...
            >
              <div class="flex flex-col md:flex-row gap-5 items-center">
                ...
                <h3 class="font-bold text-lg text-center md:text-start">
                  Global Multi-Language Systems
                </h3>
              </div>
              <p class="text-center md:text-start">
                AI-driven platforms that translate and localize documentation for multinational enterprises, supporting compliance and operational continuity across jurisdictions and legal requirements.
              </p>
            </div>
          </div>
          ...
          <div class="swiper-slide h-full">
            ...
            >
              ...
              <p class="text-center md:text-start">
                Secure, cloud-based environments for M&A, utilizing AI to auto-index, redact, and analyze sensitive content, ensuring faster, compliant due diligence cycles.
              </p>
            </div>
          </div>
          ...
          <div class="swiper-slide h-full">
            ...
            >
              ...
              <p class="text-center md:text-start">
                Integrated systems for managing technical documentation, automating version control, access, and compliance for complex assets in regulated sectors like energy and manufacturing.
              </p>
            </div>
          </div>
        ...
        <div class="w-full flex flex-col gap-5 items-start">
          ...
          <div class="flex flex-col gap-5 lg:gap-0 lg:flex-row justify-between">
            ...
            >
              ...
              <span class="text-gradient">Product and Platform Engineering Needs</span>
            </h2>
            <a
              href="https://intellivon.com/ai-strategy-call-booking-confirmation/"
              target="_blank"
          ...
          <p class="text-grey1 text-base font-medium">
            We transform ideas into innovative digital products and platforms, leveraging deep domain knowledge, data-driven methodologies, and agile development to gain a competitive edge.
          </p>
        </div>
      </div>
    </div>
      ...
      >
        <div class="choose-card shadow-[0_24px_34px_0_rgba(0,0,0,.078)]">
          ...
          >
            ...
            <p class="text-sm">
              We apply industry-leading best practices and frameworks tailored to key product engineering objectives, ensuring scalability and performance.
            </p>
          </div>
        </div>
      </div>
      ...
      >
        <div class="choose-card shadow-[0_24px_34px_0_rgba(0,0,0,.078)]">
          ...
          >
            ...
            <p class="text-sm">
              With years of experience, our co-engineering approach integrates seamlessly with client teams, enabling rapid scaling and pivots. 
            </p>
          </div>
        </div>
      </div>
      ...
      >
        <div class="choose-card shadow-[0_24px_34px_0_rgba(0,0,0,.078)]">
          ...
          >
            ...
            <h3 class="text-xl font-semibold text-center">Core-Flexi Resourcing</h3>
          </div>
          <!-- Back Side -->
          <div
            class="choose-card-back bg-white p-6 flex flex-col gap-4 items-center justify-center text-center text-gray-800"
          >
            ...
            <p class="text-sm">
              Our unique resource model provides on-demand access to domain experts and engineering talent, enabling efficient delivery at any stage.
            </p>
          </div>
        </div>
      </div>
      ...
      >
        <div class="choose-card shadow-[0_24px_34px_0_rgba(0,0,0,.078)]">
          ...
          >
            ...
            <h3 class="text-xl font-semibold text-center">
              Cloud-Native and MACH Expertise
            </h3>
          </div>
          <!-- Back Side -->
          <div
          ...
          >
            ...
            <p class="text-sm">
              We leverage cloud-native technologies and MACH principles (Microservices, API-first, Headless) to create flexible, future-ready solutions.
            </p>
          </div>
        </div>
      </div>
      ...
      >
        <div class="choose-card shadow-[0_24px_34px_0_rgba(0,0,0,.078)]">
          ...
          >
            ...
            <p class="text-sm">
              Our teams are skilled in front-end, back-end, DevOps, data engineering, and AI/ML, delivering holistic, complex solutions.
            </p>
          </div>
        </div>
      </div>
      ...
      >
        <div class="choose-card shadow-[0_24px_34px_0_rgba(0,0,0,.078)]">
          ...
          >
            ...
            <p class="text-sm">
              We focus on understanding end-user needs delivering products that empower users, and drive measurable business value.
            </p>
          </div>
        </div>
      </div>
  ...
  <div class="container">
    ...
    <div class="w-full flex flex-col gap-3 items-start">
      ...
      <div class="w-full flex flex-col lg:flex-row justify-between">
        ...
        >
          We use a diverse tech stack to deliver scalable, secure, and high-performance products, ensuring seamless integrations and reliability tailored to your business needs.
        </p>
        <!-- Buttons -->
        ...
        >
          ...
          >
            ...
            >
              ...
              <div class="pl-6 h-fit pt-4">
                <div class="flex flex-col gap-5 font-normal text-black1 mt-5">
                  Intellivon played a crucial role in scaling our digital solutions. Their team’s approach to UX-led engineering ensured our product resonated with users, while their expertise in microservices and serverless architecture allowed us to scale quickly and securely. The partnership led to improved performance, and we saw a 40% increase in user engagement within just six months.
                  <div class="text-xl font-medium font-urbanist text-black1">
                    Jessica Park, CTO, Renowned Tech Enterprise
                  </div>
                </div>
              </div>
            </div>
            ...
            >
              ...
              <div class="pl-6 h-fit pt-4">
                <div class="flex flex-col gap-5 font-normal text-black1 mt-5">
                  Thanks to Intellivon's agile Co-Engineering model, we were able to pivot quickly in a fast-paced market. Their engineers seamlessly integrated with our team, and their deep cloud-native and MACH expertise helped us modernize our infrastructure. As a result, our platform is now scalable, more resilient, and capable of handling a 50% increase in traffic during peak times.
                  <div class="text-xl font-medium font-urbanist text-black1">
                    David Reynolds, VP of Engineering, Leading SaaS Company
                  </div>
                </div>
              </div>
            </div>
            ...
            >
              ...
              <div class="pl-6 h-fit pt-4">
                <div class="flex flex-col gap-5 font-normal text-black1 mt-5">
                  We had been struggling to scale our e-commerce platform, but Intellivon’s team delivered exactly what we needed. Their expertise in API-first development and modular architecture helped us optimize the platform’s backend while ensuring a smooth customer experience. The end result was a 30% reduction in cart abandonment and a noticeable improvement in conversion rates.
                  <div class="text-xl font-medium font-urbanist text-black1">
                    Rachel Simmons, Head of Product, Global Retail Leader
                  </div>
                </div>
              </div>
            </div>
            ...
            >
              ...
              <div class="pl-6 h-fit pt-4">
                <div class="flex flex-col gap-5 font-normal text-black1 mt-5">
                  Intellivon’s ability to implement a scalable solution that balanced technical complexity with user-centric design was a game-changer for us. Their approach to building our platform using Agile PODs and microservices allowed us to enhance system reliability while focusing on delivering real value to users. The solution has significantly improved operational efficiency, leading to a 35% reduction in system downtimes.
                  <div class="text-xl font-medium font-urbanist text-black1">
                    Mark Williams, Director of Operations, Financial Services Provider
                  </div>
                </div>
              </div>
            </div>
            ...
            >
              ...
              <div class="pl-6 h-fit pt-4">
                <div class="flex flex-col gap-5 font-normal text-black1 mt-5">
                  We couldn’t have achieved the growth we’ve seen without Intellivon’s digital product engineering expertise. Their ability to assess market fit, combined with cloud-native technologies and a robust DevSecOps framework, allowed us to scale securely and quickly. With Intellivon’s help, we’ve expanded our customer base by 60% while ensuring seamless data flow across systems.
                  <div class="text-xl font-medium font-urbanist text-black1">
                    Emily Johnson, CPO, Leading Healthcare Provider
                  </div>
                </div>
              </div>
            </div>
  ...
  <div class="container flex flex-col gap-5 items-center">
    ...
    <div class="flex flex-col w-5/6 mt-5">
      ...
      <div class="faq-item">
        ...
        >
          <div class="font-medium text-xl">
            Q1. What are Data Products and Platform Engineering services?
          </div>
          <div class="faq-icon">
            <svg
              xmlns="http://www.w3.org/2000/svg"
        ...
        >
          <p class="text-base text-[#333]">
            Data Products and Platform Engineering services focus on building scalable digital platforms and products using advanced data engineering, cloud technologies, and modern architecture practices to enable data-driven decision-making.
          </p>
        </div>
      </div>
      <!-- FAQ Item 2 -->
      <div class="faq-item">
        ...
        >
          <div class="font-medium text-xl">
            Q2. How do Data Products and Platform Engineering services help businesses?
          </div>
          <div class="faq-icon">
            <svg
              xmlns="http://www.w3.org/2000/svg"
        ...
        >
          <p class="text-base text-[#333]">
            These services help businesses by providing scalable, secure, and reliable data solutions, enabling real-time insights, improved operations, and enhanced customer experiences through efficient data integration and management.
          </p>
        </div>
      </div>
      <!-- FAQ Item 3 -->
      <div class="faq-item">
        ...
        >
          <div class="font-medium text-xl">
            Q3. What technologies are used in Data Products and Platform Engineering?
          </div>
          <div class="faq-icon">
            <svg
              xmlns="http://www.w3.org/2000/svg"
        ...
        >
          <p class="text-base text-[#333]">
            Technologies include cloud-native solutions, microservices, serverless architecture, APIs, IaaS/PaaS, MACH principles, and modern data platforms such as AWS, Google Cloud, Azure, and Kubernetes.
          </p>
        </div>
      </div>
      <!-- FAQ Item 4 -->
      <div class="faq-item">
        ...
        >
          <div class="font-medium text-xl">
            Q4. Why is cloud-native architecture important for Data Products?
          </div>
          <div class="faq-icon">
            <svg
              xmlns="http://www.w3.org/2000/svg"
        ...
        >
          <p class="text-base text-[#333]">
            Cloud-native architecture ensures scalability, flexibility, and resilience, enabling businesses to manage large volumes of data with agility and reduced operational costs, while enhancing data security and accessibility.
          </p>
        </div>
      </div>
      <!-- FAQ Item 5 -->
      <div class="faq-item">
        ...
        >
          <div class="font-medium text-xl">
            Q5. How do you ensure data security in Data Products and Platform Engineering?
          </div>
          <div class="faq-icon">
            <svg
              xmlns="http://www.w3.org/2000/svg"
        ...
        >
          <p class="text-base text-[#333]">
            We implement DevSecOps practices, end-to-end encryption, role-based access control, and regular security assessments to ensure that data products and platforms are secure and compliant with regulations.
          </p>
        </div>
      </div>
      ...
      <div class="faq-item">
        ...
        >
          <div class="font-medium text-xl">
            Q6. What is the role of microservices in Data Platform Engineering?
          </div>
          <div class="faq-icon">
            <svg
              xmlns="http://www.w3.org/2000/svg"
        ...
        >
          <p class="text-base text-[#333]">
            Microservices break down complex systems into manageable, independent components, allowing for better scalability, maintainability, and flexibility. This architecture enables rapid updates, efficient data processing, and continuous integration.
          </p>
        </div>
      </div>
      ...
      <div class="faq-item">
        ...
        >
          <div class="font-medium text-xl">
            Q7. How can Data Products improve decision-making for businesses?
          </div>
          <div class="faq-icon">
            <svg
              xmlns="http://www.w3.org/2000/svg"
        ...
        >
          <p class="text-base text-[#333]">
            Data products provide real-time, actionable insights by integrating and analyzing vast amounts of data, enabling businesses to make informed, data-driven decisions that drive growth, efficiency, and innovation.
          </p>
        </div>
      </div>
      ...
      <div class="faq-item">
        ...
        >
          <div class="font-medium text-xl">
            Q8. What is the typical timeline for developing a Data Product or Platform?
          </div>
          <div class="faq-icon">
            <svg
              xmlns="http://www.w3.org/2000/svg"
        ...
        >
          <p class="text-base text-[#333]">
            The timeline depends on project scope and complexity. On average, the development of a scalable data product or platform can take between 3 to 6 months, from planning to deployment and testing.
          </p>
        </div>
      </div>
    </div>
