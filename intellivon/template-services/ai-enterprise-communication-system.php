<?php /* Template Name: AI Enterprise Communication System */ ?>
<?php get_header(); ?>
  ...
  <div class="flex">
    <div class="lg:w-full flex flex-col gap-5 px-10 justify-center py-10 lg:p-[150px] lg:text-center">
      <h1 class="font-bold text-4xl lg:text-5xl text-white">
        Unlock 
         <span class="text-gradient">Smarter AI Enterprise Communication With AI </span> 
      </h1>
    ...
    <div class="w-full lg:w-2/3 lg:pl-10 px-10 lg:px-0">
      <div class="flex flex-col gap-5 items-start">
        ...
        <h2 class="text-4xl items-center font-bold text-black1 font-urbanist leading-snug tracking-[0.5px] gap-1">
          Clients Leveraging AI to Revolutionize Communication
  ...
  <div class="container flex flex-col gap-5 items-center">
    ...
    <div class="w-full">
      ...
      <h2 class="w-full lg:w-11/12 text-4xl gap-3 font-bold text-black1 font-urbanist leading-snug tracking-[0.5px]">
        <span class="text-gradient">Real Use Cases Of Our AI-Driven  </span>Enterprise Communication Services
      </h2>
    </div>
        ...
        <div class="choose-card shadow-[0_24px_34px_0_rgba(0,0,0,.078)]">
          ...
          <div class="choose-card-front bg-white p-6 flex flex-col gap-8 items-center justify-center">
            ...
            <h3 class="text-xl font-semibold text-center">
              Seamless Legacy IntegrationComputer Vision Expertise
            </h3>
          </div>
          <!-- Back Side -->
          <div
      ...
      <div class="choose-card-wrapper w-full h-[212px] md:w-[409px] m-auto lg:m-0 z-10">
        <div class="choose-card shadow-[0_24px_34px_0_rgba(0,0,0,.078)]">
          ...
          <div
            ...
            <p class="text-sm">
              Break down language barriers with accurate, real-time translations, enabling smooth collaboration among global teams across different regions and departments.We manage the entire development lifecycle, from problem discovery and data annotation to training, integration, and real-time deployment, and post-deployment, ensuring seamless solutions.
            </p>
          </div>
        </div>
      </div>
